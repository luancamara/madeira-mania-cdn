...
echo "Gerando loader..."
{
  ...
  echo '</style>'
  echo '<script>'
  echo '(function(){var p=location.pathname;if(/\/checkout\/cart/.test(p)){document.documentElement.classList.add("mm-cart-loading")}document.documentElement.classList.add("mm-footer-loading")})();'
  echo '</script>'
  echo ''

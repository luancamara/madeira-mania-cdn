...
`,document.head.appendChild(x)}})(),(function(){if(!document.getElementById("mm-pedidos-css")){var x=document.createElement("style");x.id="mm-pedidos-css",x.textContent=`/* =============================================
   ...
   Abordagem B: reestrutura progressiva sobre o DOM nativo (jQuery, sem React).
   Tudo gated por classes que o pedidos.js põe no <html> SÓ depois de rodar
   com sucesso: .mm-consulta-on (login) e .mm-ped-on (resultado).
   Se o JS falhar, nada disso aplica e a tela nativa segue intacta.
   Paleta: verde base #4b664a · CTA #1b7a45 · borda #dbe1db · radius 4/8/12
   ============================================= */
...
/* botão "Consultar Pedido" do header do login (era azul) */
.mm-consulta-on .login-header .button-consultar-pedido,
.mm-consulta-on .button-consultar-pedido.mobile {
...
/* chevron do voltar: SVG inline com stroke azul hardcoded */
...
/* ícones nativos dos campos (sprites azuis) ficam órfãos no layout novo */
.mm-consulta-on #form-consulta-pedido .ipt-ctn > span[class*="icon-"] {
  display: none !important;
}

/* alinha campos, hint e botão na mesma largura, centralizado */
...
/* layout do form: mata os floats nativos (o hint injetado desalinha o
   layout 2-colunas original) — campos empilhados full-width */
.mm-consulta-on #form-consulta-pedido form {
  display: flex !important;
  flex-direction: column !important;
  gap: 14px;
...
.mm-consulta-on #form-consulta-pedido .ipt-ctn { width: 100% !important; }
...
.mm-consulta-on #form-consulta-pedido .ipt-ctn input.field {
  ...
  max-width: 100% !important;
  box-sizing: border-box !important;
  border: 1px solid #dbe1db !important;
  border-radius: 8px !important;
...
.mm-consulta-on #form-consulta-pedido .ipt-ctn input.field:focus {
  border-color: #1b7a45 !important;
  box-shadow: 0 0 0 3px rgba(27, 122, 69, .12) !important;
  outline: none;
}

/* botão submit (era azul Magazord) */
...
.mm-consulta-on #form-consulta-pedido button.button-login:hover {
  background: #166638 !important;
}

/* hint sob o nº do pedido (injetado) */
.mm-cp-hint {
  display: block;
  margin: 6px 2px 0;
  font-size: 12px;
...
/* --- nova hierarquia via flex order (sem mover DOM) ---
   hero (0) → status+itens (1) → resumo financeiro (2) */
...
.mm-ped-on .status-pedido   { order: 1; width: 100% !important; }
...
#mm-ped-hero .mm-ped-hero-info { min-width: 0; }
...
#mm-ped-hero .mm-ped-copy:hover { border-color: #1b7a45; color: #1b7a45; }
#mm-ped-hero .mm-ped-copy.mm-copiado { border-color: #1b7a45; color: #1b7a45; background: #eef7f1; }
...
#mm-ped-hero .mm-ped-hero-wa:hover { background: #166638; }
#mm-ped-hero .mm-ped-hero-wa svg { flex-shrink: 0; }

/* --- TÍTULOS DE SEÇÃO (Status do pedido / Itens do Pedido) --- */
.mm-ped-on .status-pedido h3 {
  color: #1a1a1a !important;
  font-weight: 700 !important;
}
.mm-ped-on .status-pedido .line-detalhes { background: #dbe1db !important; }

/* --- TIMELINE / STEPPER ---
   Ícones e conectores são elementos DOM reais injetados pelo pedidos.js
   (.mm-step-dot / .mm-step-line). Os pseudo-elements nativos do Magazord
   (badges de check) são desligados pra não colidir. */
...
.mm-ped-on .item-historico .data-hora-etapa::after {
  content: none !important;
  display: none !important;
}

/* círculo do ícone (injetado) */
...
.mm-ped-on .mm-step-dot svg { width: 20px; height: 20px; display: block; }
.mm-ped-on .item-historico.status-success .mm-step-dot {
  background: #1b7a45;
  color: #fff;
}

/* etapa atual (primeira waiting): anel verde + pulso */
@keyframes mm-ped-pulse {
  0%   { box-shadow: 0 0 0 0 rgba(27, 122, 69, .30); }
  70%  { box-shadow: 0 0 0 9px rgba(27, 122, 69, 0); }
...
.mm-ped-on .item-historico.mm-atual .mm-step-dot {
  ...
  border-color: #1b7a45;
  color: #1b7a45;
  animation: mm-ped-pulse 2.2s ease-out infinite;
}
...
.mm-ped-on .item-historico.status-waiting strong { color: #98a598; }
.mm-ped-on .item-historico.mm-atual strong { color: #1b7a45 !important; }
...
/* conector entre etapas (injetado; desktop: horizontal na altura do círculo) */
...
.mm-ped-on .item-historico.status-success .mm-step-line { background: #1b7a45; }

/* --- BLOCO ENTREGA / RASTREIO (injetado) --- */
#mm-ped-entrega {
  margin: 18px 0 4px;
  border: 1px solid #dbe1db;
  border-radius: 12px;
...
#mm-ped-entrega a { color: #1b7a45 !important; font-weight: 700; }

/* --- ITENS DO PEDIDO --- */
.mm-ped-on .itens-pedido { margin-top: 24px; }
...
.mm-ped-on .pedido-item .item-principal { gap: 14px; }
...
.mm-ped-on .pedido-item .link-produto:hover .nome-produto { color: #1b7a45 !important; }
...
/* --- RESUMO FINANCEIRO / ENDEREÇO (desce pra baixo) --- */
...
.mm-ped-on .resumo-info .title-info strong { color: #4b664a !important; }
.mm-ped-on .resumo-info .title-info svg { display: none !important; }
.mm-ped-on .resumo-info .title-info::before {
  content: '';
  width: 16px;
  height: 16px;
  margin-right: 7px;
...
.mm-ped-on .resumo-endereco .title-info::before {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%234b664a' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'%3E%3Cpath d='M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0'/%3E%3Ccircle cx='12' cy='10' r='3'/%3E%3C/svg%3E");
}
.mm-ped-on .resumo-forma-pagamento .title-info::before {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%234b664a' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'%3E%3Crect width='20' height='14' x='2' y='5' rx='2'/%3E%3Cline x1='2' x2='22' y1='10' y2='10'/%3E%3C/svg%3E");
}
.mm-ped-on .resumo-pagamento .title-info::before {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%234b664a' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'%3E%3Cpath d='M21 12V7H5a2 2 0 0 1 0-4h14v4'/%3E%3Cpath d='M3 5v14a2 2 0 0 0 2 2h16v-5'/%3E%3Cpath d='M18 12a2 2 0 0 0 0 4h4v-4Z'/%3E%3C/svg%3E");
}
.mm-ped-on .resumo-info,
.mm-ped-on .resumo-info .dado-list { color: #555; font-size: 13px; line-height: 1.5; }
.mm-ped-on .resumo-info .valor { color: #1b7a45 !important; font-weight: 700; }
.mm-ped-on .resumo-info .descontos .valor { color: #c0392b !important; }
.mm-ped-on .resumo-info .resumo-total {
  border-top: 1px solid #f0f0f0;
  margin-top: 10px;
  padding-top: 10px;
  font-weight: 700;
...
@media (max-width: 768px) {
  /* hero empilha */
  #mm-ped-hero { flex-direction: column; align-items: stretch; padding: 16px; }
  #mm-ped-hero .mm-ped-hero-wa { justify-content: center; }
  ...
  /* data encosta na direita da linha */
  .mm-ped-on .item-historico .data-hora-etapa {
    margin-top: 0;
    margin-left: auto;
    text-align: right;
  ...
  /* containers nativos têm min-width/width fixa que estoura os 375px —
     força tudo a caber na tela (o article.main-content nativo tem 505px
     fixos no mobile: bug herdado do Magazord) */
  ...
  .mm-ped-on .mm-ped-acoes a { text-align: center; justify-content: center; }
}
...
🚀 Navegando para: ${i.url}`,"info"),i.url?window.location.href=i.url:(this.log("❌ URL não encontrada para navegação","error"),x(".variation-pill-group").removeClass("is-loading"))}}setTimeout(function(){x(".product-variations-pills-container").remove(),x(".derivacoes-produto").remove();const h=new M;h.init(),window.GerenciadorVariacoesPillsMagazord=h},100)})(typeof jQuery<"u"?jQuery:window.jQuery||window.$),(function(){"use strict";function x(){if(!(typeof jQuery>"u"&&typeof $>"u")){var o=typeof jQuery<"u"?jQuery:$;o(document).ajaxComplete(function(l,p,y){y.url&&y.url.indexOf("checkout/cart")!==-1&&setTimeout(function(){window.dispatchEvent(new CustomEvent("reactItemAddedToCart"))},100)})}}function I(){var o=document.querySelector("#cart-preview-area .border-t.border-solid");if(!(!o||o.querySelector(".installment-total"))){var l=0,p=document.querySelectorAll("#cart-preview-area .cart-item");if(p.forEach(function(P){var V=parseFloat(P.getAttribute("data-item-price"))||0,K=parseInt(P.getAttribute("data-item-quantity"))||1;l+=V*K}),!(l<=0)){var y=(l/12).toFixed(2).replace(".",","),A=document.createElement("div");A.className="installment-total",A.textContent="ou 12x de R$ "+y;var k=o.querySelector(".valor-pix");k&&k.parentNode&&k.parentNode.insertBefore(A,k.nextSibling)}}}var N='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" aria-hidden="true"><path d="M5 12h14"/></svg>',M='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" aria-hidden="true"><path d="M12 5v14M5 12h14"/></svg>',h='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6M14 11v6"/><path d="M9 6V4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2"/></svg>';function i(){I();var o=document.querySelectorAll("#cart-preview-area .cart-item, .content-cart .cart-item");o.forEach(function(l){if(!l.querySelector(".qty-btn-minus")){var p=l.querySelector(".qtd-value");if(p){var y=l.querySelector(".cart-remove-item"),A=y?y.getAttribute("data-id"):null;if(A){var k=l.querySelector(".prod-remove");k&&!p.contains(y)&&(p.appendChild(y),k.style.display="none");var P=p.parentElement,V=null;if(P)for(var K=0;K<P.children.length;K++){var X=P.children[K];if(X!==p&&X.classList&&X.classList.contains("valor")){V=X;break}}V&&!p.contains(V)&&p.appendChild(V);var J=parseInt(l.getAttribute("data-item-quantity"));if(!J||isNaN(J)){var t=p.textContent.match(/(\d+)/);J=t?parseInt(t[1]):1}var a=document.createElement("button");a.className="qty-btn-minus",a.type="button",a.setAttribute("aria-label","Diminuir quantidade"),a.innerHTML=N,a.addEventListener("click",function(s){s.preventDefault(),s.stopPropagation();var f=parseInt(n.textContent)||1;if(f<=1){var b=l.querySelector(".cart-remove-item");b&&b.click();return}gt(l,A,-1,n,a,e)});var n=document.createElement("span");n.className="qty-display",n.textContent=J;var e=document.createElement("button");e.className="qty-btn-plus",e.type="button",e.setAttribute("aria-label","Aumentar quantidade"),e.innerHTML=M,e.addEventListener("click",function(s){s.preventDefault(),s.stopPropagation(),gt(l,A,1,n,a,e)});var r=document.createElement("div");r.className="mm-qty-wrap",r.appendChild(a),r.appendChild(n),r.appendChild(e),p.insertBefore(r,p.firstChild),y&&(y.innerHTML=h,y.setAttribute("aria-label","Remover produto"))}}}})}function m(){document.addEventListener("click",function(o){var l=o.target.closest(".cart-remove-item");if(!(!l||!l.closest("#cart-preview-area"))){o.preventDefault(),o.stopPropagation(),o.stopImmediatePropagation();var p=l.getAttribute("data-id");if(p){var y=l.closest(".cart-item"),A=y&&y.querySelector(".prod-nome")?.textContent?.trim()||"este produto",k=A.length>50?A.substring(0,50)+"…":A,P=document.getElementById("mm-confirm-overlay");P&&P.remove();var V=document.createElement("div");V.id="mm-confirm-overlay",V.className="mm-confirm-overlay",V.innerHTML='<div class="mm-confirm-card"><p class="mm-confirm-title">Remover produto?</p><p class="mm-confirm-desc">'+k.replace(/&/g,"&amp;").replace(/</g,"&lt;")+'</p><div class="mm-confirm-actions"><button class="mm-confirm-btn mm-confirm-btn-cancel">Manter</button><button class="mm-confirm-btn mm-confirm-btn-delete">Remover</button></div></div>',document.body.appendChild(V),V.querySelector(".mm-confirm-btn-cancel").addEventListener("click",function(){V.remove()}),V.querySelector(".mm-confirm-btn-delete").addEventListener("click",function(){V.remove(),window.__mmDeleteItem&&y?window.__mmDeleteItem(y,p):typeof Zord<"u"&&Zord.checkout&&Zord.checkout.deleteItem(parseInt(p))}),V.addEventListener("click",function(K){K.target===V&&V.remove()})}}},!0)}function c(){document.addEventListener("click",function(o){var l=o.target.closest(".finalizar-compra");l&&l.closest("#cart-preview-area")&&(o.preventDefault(),o.stopPropagation(),window.location.href="/checkout/identify")},!0)}function u(o,l){var p="cep=&cupom-desconto=&nenhumCreditoSelecionado=true&id="+encodeURIComponent(String(l))+"&area=main-cart";return fetch("/checkout/cart?operation="+encodeURIComponent(o),{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/x-www-form-urlencoded",Accept:"text/html,application/json,*/*","X-Requested-With":"XMLHttpRequest"},body:p}).then(function(y){if(!y.ok)throw new Error("HTTP "+y.status);return y.text()})}var d=1500,z=2e3,g="mm_cep",F="mm_cart_snapshot",q=1800*1e3;function T(){try{var o=localStorage.getItem(g)||"",l=o.replace(/\D/g,"");if(l.length===8)return l}catch{}return null}function v(o){return!o||o.length!==8?"":o.slice(0,5)+"-"+o.slice(5)}function O(o){if(!o||o.length!==8)return z;var l=parseInt(o.slice(0,2),10);return isNaN(l)?z:l>=1&&l<=39||l>=80&&l<=99?d:z}function W(){try{var o=localStorage.getItem(F);if(!o)return null;var l=JSON.parse(o);return!l||!l.ts||Date.now()-l.ts>q?null:l}catch{return null}}function D(o){var l=[];return o.forEach(function(p){var y=(p.querySelector(".prod-nome a, .prod-nome")||{}).textContent||"",A=p.querySelector(".qty-display"),k=A?parseInt(A.textContent):parseInt(p.getAttribute("data-item-quantity"))||1;l.push(y.trim().slice(0,30)+"x"+k)}),l.sort().join("|")}function H(o){if(!o||!Array.isArray(o.items))return"";var l=o.items.map(function(p){return(p.name||"").trim().slice(0,30)+"x"+(p.quantity||1)});return l.sort().join("|")}var R='<svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><polyline points="20 6 9 17 4 12"/></svg>',B='<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M18 6 6 18M6 6l12 12"/></svg>',tn=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"];function rn(o){if(!o)return null;var l=String(o).match(/\d+/g);return!l||!l.length?null:Math.max.apply(null,l.map(Number))}function on(o,l){for(var p=new Date(o.getTime()),y=0;y<l;){p.setDate(p.getDate()+1);var A=p.getDay();A!==0&&A!==6&&y++}return p}function pn(o){var l=new Date,p="dia "+o.getDate()+" de "+tn[o.getMonth()];return o.getFullYear()!==l.getFullYear()&&(p+=" de "+o.getFullYear()),p}function jn(o){var l=rn(o);if(!l||l<1)return null;var p=on(new Date,l);return"Receba até "+pn(p)}var cn={},_n=4e3,On={};function fn(o,l){if(!o||o.length!==8)return Promise.resolve(null);if(cn[o])return cn[o];if(!l){var p=On[o]||0;if(Date.now()-p<_n)return Promise.resolve(null)}var y="cep="+encodeURIComponent(o.slice(0,5)+"-"+o.slice(5))+"&cupom-desconto=&nenhumCreditoSelecionado=true&area=main-cart",A=fetch("/checkout/cart?operation=atualizaValoresCarrinho",{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/x-www-form-urlencoded",Accept:"text/html,application/json,*/*","X-Requested-With":"XMLHttpRequest"},body:y}).then(function(k){if(!k.ok)throw new Error("HTTP "+k.status);return k.text()}).then(function(k){return On[o]=Date.now(),Hn(k)}).catch(function(){return null}).then(function(k){return delete cn[o],k});return cn[o]=A,A}function Hn(o){try{var l=new DOMParser().parseFromString(o,"text/html"),p=l.querySelector("#resumo-compra .frete-calculado")||l.querySelector(".frete-calculado");if(!p)return null;var y="",A=p.querySelector(".frete-location .city");A&&(y=A.textContent.trim());var k=null,P="",V="",K=p.querySelector(".info-frete-selec");if(K){var X=K.querySelector(".dias-entrega"),J=K.querySelector(".info-title span, .info-title");X&&(P=(X.textContent||"").trim()),J&&(V=(J.textContent||"").trim())}var t=p.querySelector(".line.valor-frete .value, .value.valor-frete")||p.querySelector(".valor-compra-frete .value");if(t){var a=(t.textContent||"").trim();if(/gr[áa]tis/i.test(a))k=0;else{var n=a.match(/[\d.,]+/);if(n){var e=parseFloat(n[0].replace(/\./g,"").replace(",","."));isNaN(e)||(k=e)}}}if(k==null){var r=p.querySelector(".servico-frete");if(r){var s=parseFloat(r.getAttribute("data-valor-frete")||"0");if(isNaN(s)||(k=s),V||(V=r.getAttribute("data-servico-frete")||""),!P){var f=r.querySelector(".dias-entrega");f&&(P=(f.textContent||"").trim())}}}if(k==null)return null;var b=null,w=l.querySelector(".total-boleto .value, .totais-valor.total-boleto .value");if(w){var E=(w.textContent||"").trim(),_=E.match(/[\d.,]+/);if(_){var L=parseFloat(_[0].replace(/\./g,"").replace(",","."));isNaN(L)||(b=L)}}return{city:y,shipping:k,shippingDeadline:P,shippingName:V,totalPix:b}}catch{return null}}function Fn(o,l,p){if(!(!o||!p)){Dn(o);try{let K=function(X){for(var J=0;J<A.length;J++)if(A[J]&&A[J].name===X)return A[J];return null};var y=W()||{};y.ts=Date.now(),y.cepValue=l.slice(0,5)+"-"+l.slice(5),y.shipping=p.shipping,y.shippingDeadline=p.shippingDeadline,y.shippingName=p.shippingName,y.shippingCity=p.city,p.totalPix!=null&&(y.subtotalPix=p.totalPix);var A=y.items&&y.items.length?y.items:[],k=o.querySelectorAll(".cart-item:not(.mm-removing)");y.items=Array.prototype.map.call(k,function(X){var J=X.querySelector(".prod-nome a, .prod-nome"),t=(J&&J.textContent||"").trim(),a=X.querySelector(".qty-display"),n=a?parseInt(a.textContent):parseInt(X.getAttribute("data-item-quantity"))||1,e=K(t);return e&&e.quantity===n&&(e.lineTotalPix>0||e.lineTotal>0||e.imgSrc)?e:{name:t,quantity:n}}),localStorage.setItem(F,JSON.stringify(y))}catch{}var P=o.querySelectorAll(".cart-item:not(.mm-removing)"),V=0;P.forEach(function(K){var X=K.querySelector(".valor");if(X){var J=Mn(X.textContent);isNaN(J)||(V+=J)}}),o.querySelector(".box-total-btn")?Kn(o):Ln(o)}}function yn(o){var l=T();if(l){var p=W(),y=H(p),A=D(o.querySelectorAll(".cart-item:not(.mm-removing)")),k=p&&p.cepValue&&p.cepValue.replace(/\D/g,"")===l,P=p&&p.shipping!=null&&!isNaN(p.shipping);p&&y===A&&k&&P||fn(l).then(function(V){V&&Fn(o,l,V)})}}function vn(o){return String(o||"").replace(/[&<>"']/g,function(l){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[l]})}function kn(o){if(!o)return null;var l=o.querySelector(".box-total-btn");if(l)return{host:l,before:l.querySelector(".total")};var p=o.querySelector(".area-finalizar-compra");if(p)return{host:p,before:p.firstElementChild};var y=o.querySelector(".finalizar-compra");if(y&&y.parentElement){var A=y.parentElement;return{host:A,before:A.firstElementChild}}return null}function Tn(o){if(!o)return null;var l=o.closest(".carrinho-rapido-ctn");return l||(o.closest("#cart-preview-area")?ft():null)}function Cn(o,l,p,y){if(o){var A=kn(o);if(A){var k=A.host;o.classList.add("mm-ship-scope");var P=T(),V=W(),K=D(o.querySelectorAll(".cart-item:not(.mm-removing)")),X=H(V),J=V&&X===K,t=O(P),a=l>=t,n=Math.max(0,t-l),e=Math.max(0,Math.min(100,l/t*100)),r=k.querySelector(".mm-cart-ship");if(!r){r=document.createElement("div"),r.className="mm-cart-ship",r.setAttribute("role","group"),r.setAttribute("aria-label","Informações de frete");var s=A.before;s&&s.parentNode===k?k.insertBefore(r,s):k.insertBefore(r,k.firstChild)}if(r.classList.toggle("is-free",a),Gn(r),r.dataset.mmEditing!=="1"){var f=V&&V.cepValue&&V.cepValue.replace(/\D/g,"")===P,b=P&&J&&f&&V.shippingCity,w=b?jn(V.shippingDeadline):null,E="";if(E+='<div class="mm-cart-ship-location">',P){var _=v(P);if(b&&(_+=" · "+vn(V.shippingCity)),E+='<span class="mm-cart-ship-label">Envio para</span><div class="mm-cart-ship-location-value"><span>'+_+'</span><button class="mm-cart-ship-edit" type="button" data-mm-ship="edit">Trocar</button></div>',w){var L=vn(w);y&&p>0?L+=" · <strong>"+vn(Sn(p))+"</strong>":y&&p===0&&(L+=" · <strong>Grátis</strong>"),E+='<span class="mm-cart-ship-deadline">'+L+"</span>"}}else E+='<span class="mm-cart-ship-label">Calcule o frete</span><div class="mm-cart-ship-location-value"><span style="color:#9CA3AF;font-weight:500;">Informe seu CEP</span><button class="mm-cart-ship-edit" type="button" data-mm-ship="edit">Calcular</button></div>';E+="</div>";var Q=a?"Frete grátis desbloqueado":"Faltam "+Sn(n)+" para frete grátis",Z=parseFloat(o.dataset.mmShipPct||"0")||0;E+='<div class="mm-cart-ship-progress">',E+='<div class="mm-cart-ship-bar" role="progressbar" aria-valuenow="'+Math.round(l)+'" aria-valuemin="0" aria-valuemax="'+Math.round(t)+'" aria-valuetext="'+vn(Q)+'" aria-label="Progresso para frete grátis"><div class="mm-cart-ship-bar-fill" style="width:'+Z.toFixed(1)+'%"></div></div>',E+='<p class="mm-cart-ship-nudge'+(a?" is-free":"")+'">',a?E+=R+"Frete grátis garantido":E+="Faltam <strong>"+vn(Sn(n))+"</strong> para frete grátis",E+="</p>",E+="</div>",r.innerHTML=E;var j=r.querySelector(".mm-cart-ship-bar-fill");j&&requestAnimationFrame(function(){j.style.width=e.toFixed(1)+"%"});var G=o.dataset.mmShipWasFree==="1";a&&!G&&Z>0&&(r.classList.remove("mm-just-unlocked"),r.offsetWidth,r.classList.add("mm-just-unlocked"),setTimeout(function(){r.classList.remove("mm-just-unlocked")},1400)),o.dataset.mmShipWasFree=a?"1":"",o.dataset.mmShipPct=e.toFixed(1)}}}}var Yn='<svg class="mm-cart-ship-spinner" width="14" height="14" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"><style>.mm-sp{animation:mm-spin 1.2s linear infinite;transform-origin:center}.mm-sp circle{stroke:#4B664A;stroke-width:3;fill:none;stroke-linecap:round;stroke-dasharray:44;stroke-dashoffset:16;animation:mm-sp-dash 1.2s ease-in-out infinite}@keyframes mm-spin{to{transform:rotate(360deg)}}@keyframes mm-sp-dash{0%{stroke-dashoffset:44}50%{stroke-dashoffset:8}100%{stroke-dashoffset:44}}</style><g class="mm-sp"><circle cx="12" cy="12" r="9.5"/></g></svg>';function Vn(o){if(o){var l=o.querySelector(".mm-cart-ship-deadline");if(l)l.innerHTML="Recalculando frete "+Yn;else{var p=o.querySelector(".mm-cart-ship-location");if(p){var y=document.createElement("span");y.className="mm-cart-ship-deadline",y.innerHTML="Recalculando frete "+Yn,p.appendChild(y)}}var A=kn(o);A&&A.host.classList.add("mm-ship-loading")}}function Dn(o){if(o){var l=kn(o);l&&l.host.classList.remove("mm-ship-loading")}}function Gn(o){!o||o.dataset.mmShipBound||(o.dataset.mmShipBound="1",o.addEventListener("click",function(l){var p=l.target.closest('[data-mm-ship="edit"]');if(p){l.preventDefault(),l.stopPropagation(),Xn(o);return}var y=l.target.closest('[data-mm-ship="cancel"]');if(y){l.preventDefault(),l.stopPropagation(),it(o);return}l.target.closest(".mm-cart-ship-cep-form")&&l.stopPropagation()},!0))}function Xn(o){var l=o.querySelector(".mm-cart-ship-location");if(l){o.dataset.mmEditing="1";var p=T()||"";l.innerHTML='<span class="mm-cart-ship-label">Digite seu CEP</span><form class="mm-cart-ship-cep-form" data-mm-ship-form="1" novalidate><input class="mm-cart-ship-cep-input" type="text" inputmode="numeric" autocomplete="postal-code" placeholder="00000-000" maxlength="9" value="'+vn(v(p))+'" aria-label="CEP" /><button class="mm-cart-ship-cep-save" type="submit">OK</button><button class="mm-cart-ship-cep-cancel" type="button" data-mm-ship="cancel" aria-label="Cancelar">'+B+"</button></form>";var y=l.querySelector(".mm-cart-ship-cep-input"),A=l.querySelector("form");y&&(setTimeout(function(){try{y.focus(),y.select()}catch{}},10),y.addEventListener("input",function(){y.classList.remove("is-invalid");var k=y.value.replace(/\D/g,"").slice(0,8);y.value=k.length>5?k.slice(0,5)+"-"+k.slice(5):k}),y.addEventListener("keydown",function(k){k.key==="Escape"&&(k.preventDefault(),it(o))})),A&&A.addEventListener("submit",function(k){k.preventDefault(),k.stopPropagation(),wt(o)})}}function it(o){o.dataset.mmEditing="";var l=Tn(o);if(l){var p=l.querySelectorAll(".cart-item:not(.mm-removing)"),y=0;p.forEach(function(A){var k=A.querySelector(".valor");if(k){var P=Mn(k.textContent);isNaN(P)||(y+=P)}}),Cn(l,y)}}function wt(o){var l=o.querySelector(".mm-cart-ship-cep-input");if(l){var p=l.value.replace(/\D/g,"");if(p.length!==8){l.classList.add("is-invalid"),l.focus();return}try{localStorage.setItem(g,p)}catch{}var y=o.querySelector(".mm-cart-ship-cep-save");y&&(y.disabled=!0,y.textContent="...");var A=Tn(o);try{var k=W();k&&(k.cepValue="",localStorage.setItem(F,JSON.stringify(k)))}catch{}it(o),fn(p).then(function(P){P&&A&&Fn(A,p,P)})}}function Mn(o){if(!o)return NaN;var l=String(o).replace(/\s/g,"").match(/([\d.,]+)/);return l?parseFloat(l[1].replace(/\./g,"").replace(",",".")):NaN}function Sn(o){return isNaN(o)?"":"R$ "+o.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2})}function mn(o){if(isNaN(o))return"";var l=o.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2}),p=l.split(",");return"R$&nbsp;"+p[0]+'<span class="mm-cents">,'+(p[1]||"00")+"</span>"}function mt(o){var l=0;return Array.prototype.forEach.call(o,function(p){var y=parseFloat(p.getAttribute("data-item-price"))||0,A=parseInt(p.getAttribute("data-item-quantity"));if(!A||isNaN(A)){var k=p.querySelector(".qty-display");k?A=parseInt(k.textContent)||1:A=1}l+=y*A}),l}function ct(o){var l=o.querySelectorAll(".cart-item:not(.mm-removing)");l.forEach(function(p){var y=parseFloat(p.getAttribute("data-item-price"))||0,A=parseInt(p.getAttribute("data-item-quantity"));if(!A||isNaN(A)){var k=p.querySelector(".qty-display");k?A=parseInt(k.textContent)||1:A=1}var P=p.querySelector(".valor");P&&y>0&&(P.innerHTML=mn(y*A))})}function et(o){if(!(!o||o.dataset.mmTotalRatio)){var l=o.querySelectorAll(".cart-item");if(l.length){var p=mt(l),y=o.querySelector(".box-total-btn .linha-total .valor-final > .valor > strong")||o.querySelector(".box-total-btn .linha-total .valor-final strong");if(y&&p>.01){var A=Mn(y.textContent);isNaN(A)||(o.dataset.mmTotalRatio=String(A/p))}}}}function dt(o,l){var p=o.querySelector(".box-total-btn .linha-total");if(p){var y=p.parentElement.querySelector(".mm-cart-savings");if(y&&y.remove(),!(!l||l<.01)){var A=document.createElement("span");A.className="mm-cart-savings",A.textContent="Você economiza "+Sn(l)+" com PIX",p.nextSibling?p.parentElement.insertBefore(A,p.nextSibling):p.parentElement.appendChild(A)}}}function Kn(o,l){if(o){et(o);var p=o.querySelectorAll(".cart-item:not(.mm-removing)"),y=mt(p),A=o.querySelector(".box-total-btn .linha-total .valor-final > .valor > strong")||o.querySelector(".box-total-btn .linha-total .valor-final strong"),k=parseFloat(o.dataset.mmTotalRatio||"0.95")||.95,P=y*k,V=y-P,K=T(),X=W(),J=H(X),t=D(p),a=X&&X.cepValue&&X.cepValue.replace(/\D/g,"")===K,n=!!(K&&X&&a&&X.shipping!=null&&!isNaN(X.shipping)),e=o.dataset.mmShipPendingFetch==="1";!n&&e&&K&&X&&X.shipping!=null&&(n=!0);var r=n?parseFloat(X.shipping):0,s=P+r,f=y+r;if(A){var b=Mn(A.textContent);if(l)(isNaN(b)||Math.abs(s-b)>.005)&&(A.innerHTML=mn(s));else if(!isNaN(b)&&Math.abs(s-b)>.005){var w=o.querySelector(".box-total-btn .linha-total .valor-final");w&&(w.classList.remove("mm-pop"),w.offsetWidth,w.classList.add("mm-pop"),setTimeout(function(){w.classList.remove("mm-pop")},450)),ut(A,b,s)}else A.innerHTML=mn(s)}var E=o.querySelector(".box-total-btn .valor-final.card");if(E){var _=f/12;E.innerHTML="<span>ou em até <strong>12x</strong> de <strong>"+Sn(_)+"</strong> no cartão</span>"}var L=o.querySelector(".box-total-btn .linha-total .valor-final .tipo-pagto");L&&(L.textContent="No PIX"),dt(o,V),Cn(o,y,r,n);try{var Q=0;p.forEach(function(j){var G=j.querySelector(".qty-display");G&&(Q+=parseInt(G.textContent)||0)});var Z=document.getElementById("mm-h-cart-count");Z&&(Q>0?(Z.textContent=Q>99?"99+":String(Q),Z.hidden=!1):Z.hidden=!0)}catch{}}}function Jn(){var o=document.querySelector(".carrinho-rapido-ctn");if(!(!o||!o.querySelector(".box-total-btn"))){var l=o.querySelectorAll(".cart-item:not(.mm-removing)");if(l.length){var p=o.querySelector(".box-total-btn .linha-total .valor-final > .valor > strong")||o.querySelector(".box-total-btn .linha-total .valor-final strong");if(p){var y=mt(l);if(y>.01){var A=parseFloat(o.dataset.mmTotalRatio||"0.95")||.95,k=T(),P=W(),V=P&&P.cepValue&&P.cepValue.replace(/\D/g,"")===k,K=!!(k&&P&&V&&P.shipping!=null&&!isNaN(P.shipping));!K&&o.dataset.mmShipPendingFetch==="1"&&k&&P&&P.shipping!=null&&(K=!0);var X=K?parseFloat(P.shipping):0,J=y*A+X,t=Mn(p.textContent);(isNaN(t)||Math.abs(J-t)>.01)&&Kn(o,!0)}}}}}function ft(){var o=document.querySelector('#cart-preview-area > div[class*="z-[9999]"]');if(o)return o;var l=document.querySelector(".carrinho-rapido-ctn");return l&&!l.querySelector(".box-total-btn")&&l.querySelector(".valor-pix")?l:null}function zt(o,l){var p=o.querySelector(".installment-total");if(!(!p||!p.parentElement)){var y=p.parentElement,A=y.querySelector(".mm-cart-savings-mobile");if(!l||l<.01){A&&A.remove();return}var k="Você economiza "+Sn(l)+" com PIX";if(A){A.textContent!==k&&(A.textContent=k);return}var P=document.createElement("span");P.className="mm-cart-savings-mobile",P.textContent=k,p.nextSibling?y.insertBefore(P,p.nextSibling):y.appendChild(P)}}function zn(o,l,p){if(!(!o||!o.classList||!o.classList.contains("carrinho-rapido-ctn"))&&!o.querySelector(".box-total-btn")){var y=o.querySelector(".area-finalizar-compra");if(!(!y||!(l>0))){var A=y.querySelector(".forma-pix"),k=A?A.parentElement:null;if(k){var P=l*p,V=l/12,K=l-P;k.classList.add("mm-native-pay-hidden");var X=y.querySelector(".mm-cart-total-b");X||(X=document.createElement("div"),X.className="mm-cart-total-b",X.innerHTML='<span class="mm-tb-label">Total</span><span class="mm-tb-row"><strong class="mm-tb-value"></strong><span class="mm-tb-pix">No PIX</span></span><span class="mm-tb-savings"></span><span class="mm-tb-parcela"></span>',k.nextSibling?y.insertBefore(X,k.nextSibling):y.appendChild(X));var J=X.querySelector(".mm-tb-value"),t=Sn(P);J&&J.textContent!==t&&(J.textContent=t);var a=X.querySelector(".mm-tb-savings");if(a)if(K>=.01){var n="Você economiza "+Sn(K)+" com PIX";a.textContent!==n&&(a.textContent=n),a.style.display=""}else a.style.display="none";var e=X.querySelector(".mm-tb-parcela");if(e){var r="ou em até 12x de "+Sn(V)+" no cartão";e.textContent!==r&&(e.textContent=r)}}}}}function Ln(o){if(o=o||ft(),!(!o||o.querySelector(".box-total-btn")||!o.querySelector(".valor-pix"))){var l=o.querySelectorAll(".cart-item:not(.mm-removing)"),p=l.length,y=document.getElementById("mm-h-cart-count");if(y&&p>0){var A=p>99?"99+":String(p);(y.textContent!==A||y.hidden)&&(y.textContent=A,y.hidden=!1)}if(l.length){var k=mt(l);if(k>0){Array.prototype.forEach.call(l,function(Z){var j=parseFloat(Z.getAttribute("data-item-price"))||0;if(j>0){var G=parseInt(Z.getAttribute("data-item-quantity"));if(!G||isNaN(G)){var an=Z.querySelector(".qty-display");G=an&&parseInt(an.textContent)||1}var en=Z.querySelector(".valor");if(en){var hn=j*G,ln=en.querySelector("span")||en,bn=Mn(ln.textContent);(isNaN(bn)||Math.abs(bn-hn)>.005)&&(ln.textContent=Sn(hn))}}});var P=o.querySelector(".valor-pix"),V=P?P.querySelector("span")||P:null;if(!o.dataset.mmMobileRatio&&V){var K=Mn(V.textContent);if(!isNaN(K)&&K>0){var X=K/k;X>.8&&X<=1.0001&&(o.dataset.mmMobileRatio=String(X))}}var J=parseFloat(o.dataset.mmMobileRatio||"0.95");if(J>.8&&J<=1.0001||(J=.95),V){var t=k*J,a=Mn(V.textContent);(isNaN(a)||Math.abs(a-t)>.005)&&(V.textContent=Sn(t))}var n=o.querySelector(".installment-total");if(n){var e=k/12,r=Mn(n.textContent);(isNaN(r)||Math.abs(r-e)>.005)&&(n.textContent="ou 12x de "+Sn(e))}var s=T(),f=W(),b=f&&f.cepValue&&f.cepValue.replace(/\D/g,"")===s,w=!!(s&&f&&b&&f.shipping!=null&&!isNaN(f.shipping)),E=w?parseFloat(f.shipping):0,_=(s||"")+"|"+k.toFixed(2)+"|"+(w?1:0)+"|"+E,L=o.querySelector(".mm-cart-ship"),Q=L&&L.dataset.mmEditing==="1";!Q&&(!L||o.dataset.mmMobShipSig!==_)&&(o.dataset.mmMobShipSig=_,Cn(o,k,E,w)),yn(o),zt(o,k-k*J),zn(o,k,J)}}}}function ut(o,l,p){if(!o||isNaN(l)||isNaN(p))return;var y=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(y){o.innerHTML=mn(p);return}var A=420,k=performance.now();function P(V){return 1-Math.pow(1-V,3)}(function V(K){var X=Math.min(1,(K-k)/A);o.innerHTML=mn(l+(p-l)*P(X)),X<1&&requestAnimationFrame(V)})(k)}function gt(o,l,p,y,A,k){if(!(!o||!l)){var P=parseInt(y.textContent)||1,V=P+p;if(!(V<1)){var t=o.closest(".carrinho-rapido-ctn");et(t),A.disabled=!0,k.disabled=!0;var K=parseFloat(o.getAttribute("data-item-price"))||0;y.textContent=V,o.setAttribute("data-item-quantity",V);var X=o.querySelector(".valor");if(X){var J=K*V;X.textContent=Sn(J),X.classList.remove("mm-pop"),X.offsetWidth,X.classList.add("mm-pop"),setTimeout(function(){X.classList.remove("mm-pop")},450)}var t=o.closest(".carrinho-rapido-ctn"),a=p>0?"adicionaItem":"removeItem";T()&&t&&(t.dataset.mmShipPendingFetch="1"),Kn(t),Ln(),T()&&Vn(t),u(a,l).catch(function(){y.textContent=P,o.setAttribute("data-item-quantity",P),X&&(X.innerHTML=mn(K*P)),t&&(t.dataset.mmShipPendingFetch=""),Kn(t),Ln()}).then(function(){A.disabled=!1,k.disabled=!1;var n=T();n&&t?(Vn(t),fn(n,!0).then(function(e){t.dataset.mmShipPendingFetch="",e?Fn(t,n,e):Dn(t)})):t&&(t.dataset.mmShipPendingFetch="")})}}}function bt(o,l){if(!(!o||!l)){var p=o.closest(".carrinho-rapido-ctn");et(p);var y=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,A=y?0:360;y||o.classList.add("mm-removing"),setTimeout(function(){o.parentNode&&o.parentNode.removeChild(o);var k=p?p.querySelectorAll(".cart-item:not(.mm-removing)"):[],P=k.length===0;if(P){if(p){p.dataset.mmShipPendingFetch="";var V=p.querySelector(".mm-cart-ship");V&&V.remove();var K=p.querySelector(".box-total-btn, .area-finalizar-compra");K&&(K.style.display="none")}typeof window.__mmForceEmptyCartState=="function"&&window.__mmForceEmptyCartState(p)}else Kn(p),T()&&Vn(p);var X=document.getElementById("mm-h-cart-count"),J=document.getElementById("mm-h-cart"),t=k.length;X&&(X.textContent=t>99?"99+":String(t),X.hidden=t===0),J&&J.setAttribute("aria-label","Carrinho, "+t+" "+(t===1?"item":"itens")),Ln()},A),u("deleteItem",l).catch(function(){}).then(function(){var k=p?p.querySelectorAll(".cart-item:not(.mm-removing)"):[],P=document.getElementById("mm-h-cart-count");if(P&&(P.textContent=k.length>99?"99+":String(k.length),P.hidden=k.length===0),k.length===0){p&&(p.dataset.mmShipPendingFetch="");return}var V=T();V&&p?(p.dataset.mmShipPendingFetch="1",Vn(p),fn(V,!0).then(function(K){p.dataset.mmShipPendingFetch="",K?Fn(p,V,K):Dn(p)})):p&&(p.dataset.mmShipPendingFetch="")})}}window.__mmDeleteItem=bt;var qt=null,vt=new Set,at=null;function qn(o){if(!o)return NaN;var l=String(o).replace(/\s/g,"").match(/([\d.,]+)/);if(!l)return NaN;var p=l[1].replace(/\./g,"").replace(",","."),y=parseFloat(p);return isNaN(y)?NaN:y}function nt(o){return isNaN(o)?"":"R$ "+o.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2})}function At(o,l,p){if(!o||isNaN(l)||isNaN(p))return;at&&cancelAnimationFrame(at);var y=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(y){o.textContent=nt(p);return}var A=420,k=performance.now();function P(K){return 1-Math.pow(1-K,3)}function V(K){var X=K-k,J=Math.min(1,X/A),t=l+(p-l)*P(J);o.textContent=nt(t),J<1?at=requestAnimationFrame(V):at=null}at=requestAnimationFrame(V)}function st(o){return o?o.querySelector(".box-total-btn .linha-total .valor-final > .valor > strong")||o.querySelector(".box-total-btn .linha-total .valor-final strong")||o.querySelector(".valor-pix strong")||o.querySelector(".valor-pix"):null}function xt(o){return o?o.querySelector(".box-total-btn .linha-total .valor-final"):null}function Bn(o){var l=xt(o);l&&(l.classList.remove("mm-pop"),l.offsetWidth,l.classList.add("mm-pop"),setTimeout(function(){l.classList.remove("mm-pop")},450))}function Un(){var o=document.querySelector(".carrinho-rapido-ctn");if(o){var l=o.querySelectorAll(".cart-item:not(.mm-removing)");if(l.length>0){var p=o.querySelector(".box-total-btn");p&&p.dataset.mmTotalEnhanced!=="1"&&(et(o),ct(o),Kn(o),p.dataset.mmTotalEnhanced="1",o.dataset.mmShipRendered="1",yn(o))}o.querySelector(".box-total-btn")||Ln(o);var y=o.querySelectorAll(".cart-item"),A=new Set;y.forEach(function(k){var P=k.id||k.getAttribute("data-item-id")||"";P&&(A.add(P),!vt.has(P)&&vt.size>0&&(k.classList.add("mm-added"),setTimeout(function(){k.classList.remove("mm-added")},500)))}),vt=A}}function tt(){var o=document.querySelector(".carrinho-rapido-ctn");if(!(!o||o.dataset.mmAnimObserved)){o.dataset.mmAnimObserved="1",Un();var l=new MutationObserver(function(){clearTimeout(tt._t),tt._t=setTimeout(Un,60)});l.observe(o,{childList:!0,subtree:!0,characterData:!0})}}function lt(){x(),m(),c();var o=document.getElementById("cart-preview-area");if(o){var l=new MutationObserver(function(){setTimeout(i,100),setTimeout(tt,150),setTimeout(Ln,180),setTimeout(Jn,220)});l.observe(o,{childList:!0,subtree:!0})}setInterval(i,800),setInterval(tt,800),setInterval(Ln,800),setInterval(Jn,800),i(),tt(),Ln(),Jn()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",lt):lt()})(),(function x(){"use strict";var I="mm_cep",N="mm_cart_snapshot",M=18e5,h="mm_onepage_draft",i=1440*60*1e3,m=2e3,c="https://magazord-public.s3.sa-east-1.amazonaws.com/madeiramania/resources/Design%20sem%20nome%20(1).svg",u="https://api.whatsapp.com/send?phone=5511915299488&text="+encodeURIComponent("Olá! Estou no checkout e gostaria de tirar uma dúvida sobre meu pedido."),d=location.pathname,z=d.indexOf("/checkout/cart")!==-1,g=d.indexOf("/checkout/identify")!==-1,F=d.indexOf("/checkout/onepage")!==-1,q=d.indexOf("/checkout/payment")!==-1,T=d.indexOf("/checkout/done")!==-1;if(T){try{localStorage.removeItem("mm_onepage_draft")}catch{}return}if(!z&&!g&&!F&&!q)return;x._retries=(x._retries||0)+1;var v=document.querySelector("#checkout-main-area");if(!v){try{var O=document.body&&document.body.textContent||"",W=/muito tempo inativo|realize login novamente/i.test(O);if((F||g)&&(W||x._retries>=40)&&!sessionStorage.getItem("mm_checkout_recovery")){sessionStorage.setItem("mm_checkout_recovery","1"),location.href="/checkout/cart";return}}catch{}x._retries<40&&setTimeout(x,400);return}try{sessionStorage.removeItem("mm_checkout_recovery")}catch{}function D(t){return isNaN(t)||t<0?"R$ 0,00":"R$ "+t.toFixed(2).replace(".",",").replace(/(\d)(?=(\d{3})+,)/g,"$1.")}function H(t){if(!t)return 0;var a=String(t).match(/(-?[\d.]+,\d{2})/);return a&&parseFloat(a[1].replace(/\./g,"").replace(",","."))||0}function R(t){return String(t||"").replace(/[&<>"']/g,function(a){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[a]})}var B={truck:'<svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20 8h-3V4H3c-1.1 0-2 .9-2 2v11h2a3 3 0 0 0 6 0h6a3 3 0 0 0 6 0h2v-5l-3-4zM6 18.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm12 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm.5-7H17V9.5h2.04l1.46 2-.04 0z"/></svg>',check:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>',checkCircle:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>',bolt:'<svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>',shield:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 1 3 5v6c0 5.5 3.8 10.7 9 12 5.2-1.3 9-6.5 9-12V5l-9-4zm-1.4 16L6 12.4l1.4-1.4 3.2 3.2 6.8-6.8L18.8 8.8 10.6 17z"/></svg>',lock:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zM9 6c0-1.66 1.34-3 3-3s3 1.34 3 3v2H9V6z"/></svg>',card:'<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>',rotate:'<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.74 9.74 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/></svg>',minus:'<svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M3 7h8" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/></svg>',plus:'<svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M7 3v8M3 7h8" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/></svg>',trash:'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',close:'<svg width="12" height="12" viewBox="0 0 14 14" fill="none"><path d="M10.5 3.5l-7 7M3.5 3.5l7 7" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/></svg>',arrow:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>',tag:'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.59 13.41 13.42 20.58a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg>',whats:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893A11.821 11.821 0 0 0 20.464 3.488"/></svg>',box:'<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>'},tn={get:function(t){try{return localStorage.getItem(t)}catch{return null}},set:function(t,a){try{localStorage.setItem(t,a)}catch{}},remove:function(t){try{localStorage.removeItem(t)}catch{}}};function rn(t){try{var a={ts:Date.now(),items:t.items.map(function(n){return{name:n.name,variant:n.variant,imgSrc:n.imgSrc,quantity:n.quantity,lineTotal:n.lineTotal,lineTotalPix:n.lineTotalPix,isPix:n.isPix,deposito:n.deposito}}),subtotalPix:t.subtotalPix,subtotalFull:t.subtotalFull,discount:t.discount,couponCode:t.couponCode,shipping:t.shipping,shippingDeadline:t.shippingDeadline,shippingName:t.shippingName,shippingCity:t.shippingCity,shippingOptions:t.shippingOptions,cepValue:t.cepValue};tn.set(N,JSON.stringify(a))}catch{}}function on(){try{var t=tn.get(N);if(!t)return null;var a=JSON.parse(t);return!a||!a.ts||Date.now()-a.ts>M?null:a}catch{return null}}function pn(){try{for(var t=["mm-op-email","mm-op-nome","mm-op-cpf","mm-op-tel","mm-op-cep","mm-op-rua","mm-op-num","mm-op-comp","mm-op-bairro","mm-op-cidade","mm-op-uf"],a={ts:Date.now()},n=0,e=0;e<t.length;e++){var r=document.getElementById(t[e]);r&&r.value&&(a[t[e]]=r.value,n++)}if(n===0){window._mmDraftDebug&&console.log("[mm-draft] skip save (0 fields)");return}tn.set(h,JSON.stringify(a)),window._mmDraftDebug&&console.log("[mm-draft] saved",n,"fields",a)}catch(s){window._mmDraftDebug&&console.warn("[mm-draft] save failed",s)}}function jn(){try{var t=tn.get(h);if(!t)return null;var a=JSON.parse(t);return!a||!a.ts?null:Date.now()-a.ts>i?(tn.remove(h),null):a}catch{return null}}function cn(){try{tn.remove(h)}catch{}}function _n(){var t=jn();if(!t)return window._mmDraftDebug&&console.log("[mm-draft] no draft to restore"),null;for(var a=["mm-op-email","mm-op-nome","mm-op-cpf","mm-op-tel","mm-op-cep","mm-op-rua","mm-op-num","mm-op-comp","mm-op-bairro","mm-op-cidade","mm-op-uf"],n=0,e=0;e<a.length;e++){var r=document.getElementById(a[e]);if(r&&t[a[e]]){try{var s=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;s.call(r,t[a[e]])}catch{r.value=t[a[e]]}r.dispatchEvent(new Event("input",{bubbles:!0})),/^mm-op-(rua|bairro|cidade|uf)$/.test(a[e])&&(r.dataset.mmCepFill="1"),n++}}return window._mmDraftDebug&&console.log("[mm-draft] restored",n,"fields from draft",t),t}function On(){for(var t={items:[],subtotalPix:0,subtotalFull:0,discount:0,shipping:null,shippingRaw:"",shippingDeadline:"",shippingName:"",shippingCity:"",shippingOptions:[],couponCode:"",cepValue:"",canFinalize:!1,hasFinalizar:!1},a=v.querySelectorAll(".cart-item"),n=0;n<a.length;n++){var e=a[n],r=e.querySelector('.qtd-item[id^="item_carrinho_"]'),s=r&&r.id.match(/item_carrinho_(\d+)/),f=s?parseInt(s[1],10):null,b=e.querySelector("figure img")||e.querySelector("#product-img")||e.querySelector("img"),w=e.querySelector(".nome-produto .link")||e.querySelector("figure a"),E=e.querySelector(".column-valor-produto .valor"),_=E?E.textContent.trim():"",L=!!e.querySelector(".column-valor-produto .sub");t.items.push({dataId:f,sku:e.getAttribute("data-item-id")||"",name:e.getAttribute("data-item-name")||e.getAttribute("data-name")||"",variant:e.getAttribute("data-item-variant")||"",brand:e.getAttribute("data-item-brand")||"",category:e.getAttribute("data-item-category")||"",priceUnit:parseFloat(e.getAttribute("data-item-price")||"0"),lineTotal:parseFloat(e.getAttribute("data-valor")||"0"),quantity:parseInt(e.getAttribute("data-item-quantity")||"1",10),deposito:e.getAttribute("data-item-deposito")==="1",imgSrc:b?b.getAttribute("src")||b.currentSrc:"",href:w?w.getAttribute("href"):"",lineTotalPix:H(_),isPix:L}),t.subtotalFull+=parseFloat(e.getAttribute("data-valor")||"0")}var Q=v.querySelector("#resumo-compra .resumo-valores .value");Q&&(t.subtotalPix=H(Q.textContent)),t.subtotalPix<=0&&(t.subtotalPix=t.items.reduce(function(yt,Ft){return yt+(Ft.lineTotalPix||0)},0));var Z=v.querySelector("#resumo-compra .discount-value");Z&&(t.discount=H(Z.textContent));var j=v.querySelector("#resumo-compra .txt-cupom, #resumo-compra .alert.alert-type-1");if(j){var G=j.textContent.match(/([A-Z0-9]{3,})/);G&&(t.couponCode=G[1])}var an=v.querySelector("#resumo-compra .frete-calculado, .frete-calculado");if(an&&an.textContent.trim()){t.shippingRaw=an.textContent.trim();var en=an.querySelector(".frete-location .city");en&&(t.shippingCity=en.textContent.trim());for(var hn=an.querySelectorAll(".servico-frete"),ln=0;ln<hn.length;ln++){var bn=hn[ln],Rn=bn.querySelector('input[type="radio"]'),S=bn.querySelector(".dias-entrega"),C=parseFloat(bn.getAttribute("data-valor-frete")||"0"),U=bn.getAttribute("data-servico-frete")||"",nn=S?S.textContent.trim().replace(/\s+/g," ").replace(/\s*-\s*$/,"").trim():"",Y=nn.match(/(\d+(?:\s*[aà]\s*\d+)?\s*dias?(?:\s*[úu]teis)?)/i),dn=Y?Y[1].replace(/\s+/g," "):nn;t.shippingOptions.push({id:Rn?Rn.value:"",name:U,deadline:dn,value:C,isFree:C===0,isSelected:Rn?Rn.checked:!1})}var un=t.shippingOptions.filter(function(yt){return yt.isSelected})[0];if(!un&&t.shippingOptions.length>0&&(un=t.shippingOptions[0]),un)t.shipping=un.value,t.shippingName=un.name,t.shippingDeadline=un.deadline;else{var xn=an.querySelector(".info-frete-selec"),wn=an.querySelector(".dias-entrega, .info-frete-selec .dias-entrega"),En=an.querySelector(".valor-frete .value, .value.valor-frete"),Nn=an.querySelector(".info-frete-selec .info-title span, .info-title span");if(En){var An=En.textContent.trim();if(/gr[aá]tis/i.test(An))t.shipping=0;else{var $n=H(An);$n>0&&(t.shipping=$n)}}if(wn){var Wn=wn.textContent.match(/(\d+(?:\s*[aà]\s*\d+)?\s*dias?(?:\s*\([^)]+\))?(?:\s*[úu]teis)?)/i);Wn&&(t.shippingDeadline=Wn[1].replace(/\s+/g," ").replace(/\(s\)/,"").trim())}if(Nn&&(t.shippingName=Nn.textContent.trim()),t.shipping===null)if(/gr[aá]tis/i.test(t.shippingRaw))t.shipping=0;else{var pt=H(t.shippingRaw);pt>0&&(t.shipping=pt)}if(!t.shippingDeadline){var gn=t.shippingRaw.match(/(\d+(?:\s*[aà]\s*\d+)?)\s*dias?/i);gn&&(t.shippingDeadline=gn[1]+" dias úteis")}}}var ht=v.querySelector("#cep, .input-cep");return ht&&(t.cepValue=ht.value||""),t.hasFinalizar=!!v.querySelector("#finalizar-compra"),t.canFinalize=t.items.length>0,t}function fn(t){t=t||"cart";var a='<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 1 3 5v6c0 5.5 3.8 10.7 9 12 5.2-1.3 9-6.5 9-12V5l-9-4zm-1.4 16L6 12.4l1.4-1.4 3.2 3.2 6.8-6.8L18.8 8.8 10.6 17z"/></svg>';function n(e,r){var s=e===t,f="mm-checkout-step"+(s?" is-active":""),b=s?' aria-current="step"':"";return'<li class="'+f+'"'+b+'><span class="mm-checkout-step-label">'+r+"</span></li>"}return'<header class="mm-checkout-header"><a class="mm-checkout-header-logo" href="/" aria-label="Madeira Mania - voltar à home"><img src="'+c+'" alt="Madeira Mania" width="180" height="44"></a><nav class="mm-checkout-steps" aria-label="Etapas do checkout"><ol>'+n("cart","Carrinho")+'<li class="mm-checkout-step-sep" aria-hidden="true">›</li>'+n("delivery","Entrega")+'<li class="mm-checkout-step-sep" aria-hidden="true">›</li>'+n("payment","Pagamento")+'</ol></nav><div class="mm-checkout-secure">'+a+'<span class="mm-checkout-secure-text"><strong>Compra 100% segura</strong><small>Site protegido por SSL</small></span></div></header>'}function Hn(t){var a=t.imgSrc?'<img src="'+R(t.imgSrc)+'" alt="'+R(t.name)+'" loading="lazy">':"",n=t.href?'<a class="mm-item-name" href="'+R(t.href)+'">'+R(t.name)+"</a>":'<span class="mm-item-name">'+R(t.name)+"</span>",e=t.variant?'<p class="mm-item-variant">'+R(t.variant)+"</p>":"",r=t.deposito?'<span class="mm-item-badge">'+B.bolt+"<span>Pronta entrega · Envio em 24h</span></span>":"",s=t.quantity<=1?' disabled aria-disabled="true"':"",f;if(t.lineTotalPix>0&&t.isPix){var b='<span class="mm-item-price-sub">no PIX</span>',w=t.quantity>1?D(t.lineTotalPix/t.quantity)+" cada":"";f='<div class="mm-item-price"><span class="mm-item-price-value">'+D(t.lineTotalPix)+"</span>"+b+(w?'<span class="mm-item-price-unit">'+w+"</span>":"")+"</div>"}else{var E=t.quantity>1?D(t.priceUnit)+" cada":"";f='<div class="mm-item-price"><span class="mm-item-price-value">'+D(t.lineTotal)+"</span>"+(E?'<span class="mm-item-price-unit">'+E+"</span>":"")+"</div>"}return'<div class="mm-item" data-mm-id="'+t.dataId+'"><div class="mm-item-thumb">'+a+'</div><div class="mm-item-body">'+n+e+r+"</div>"+f+'<div class="mm-item-controls"><div class="mm-qty" role="group" aria-label="Quantidade"><button type="button" class="mm-qty-btn" data-mm-act="dec"'+s+' aria-label="Diminuir quantidade">'+B.minus+'</button><span class="mm-qty-value">'+t.quantity+'</span><button type="button" class="mm-qty-btn" data-mm-act="inc" aria-label="Aumentar quantidade">'+B.plus+'</button></div><button type="button" class="mm-item-remove" data-mm-act="remove" aria-label="Remover item" title="Remover">'+B.trash+"</button></div></div>"}function Fn(t){return t.items.length?t.items.map(Hn).join(""):'<div class="mm-empty"><div class="mm-empty-icon">'+B.box+'</div><h3 class="mm-empty-title">Seu carrinho está vazio</h3><p class="mm-empty-desc">Explore nossos móveis e encontre a peça certa para sua casa.</p><a class="mm-empty-cta" href="/">Explorar produtos '+B.arrow+'</a><p class="mm-empty-perks">Frete grátis acima de R$ 2.000 · 12x sem juros · 7% off no PIX</p></div>'}function yn(t){for(var a="",n=0;n<t;n++)a+='<div class="mm-skel-item"><div class="mm-skel mm-skel-thumb"></div><div class="mm-skel-lines"><div class="mm-skel mm-skel-line w-3-4"></div><div class="mm-skel mm-skel-line w-1-2"></div><div class="mm-skel mm-skel-line w-1-3"></div></div><div class="mm-skel-lines"><div class="mm-skel mm-skel-line w-1-2"></div></div></div>';return a}function vn(t){var a=t.subtotalFull>0?t.subtotalFull:t.subtotalPix,n='<div class="mm-row"><span class="mm-row-label">Subtotal</span><span class="mm-row-value">'+D(a)+"</span></div>";if(t.shipping!==null){var e;t.shipping===0?e='<span class="mm-row-value is-free">'+B.check+" Grátis</span>":e='<span class="mm-row-value">'+D(t.shipping)+"</span>";var r='<span class="mm-row-label">Frete';t.shippingName&&(r+=' <span class="mm-row-sub">· '+R(t.shippingName)+"</span>"),t.shippingDeadline&&(r+=' <span class="mm-row-sub">· '+R(t.shippingDeadline)+"</span>"),r+="</span>",n+='<div class="mm-row">'+r+e+"</div>"}t.discount>0&&(n+='<div class="mm-row"><span class="mm-row-label">Desconto</span><span class="mm-row-value is-discount">− '+D(t.discount)+"</span></div>");var s="";if(t.shipping!==null){var f=Math.max(0,a+t.shipping-t.discount),b=Math.max(0,t.subtotalPix+t.shipping-t.discount),w=f-b,E=f/12;s='<div class="mm-total"><div class="mm-total-label">Total</div><div class="mm-total-value">'+D(f)+'</div><div class="mm-total-pix"><span>'+D(b)+" à vista no PIX</span>"+(w>0?'<span class="mm-total-pix-save">economia de '+D(w)+"</span>":"")+'</div><div class="mm-total-parcela">ou 12x de '+D(E)+" sem juros no cartão</div></div>"}else s='<div class="mm-total"><div class="mm-total-label">Subtotal</div><div class="mm-total-value">'+D(t.subtotalPix)+'</div><div class="mm-total-pix"><span>à vista no PIX</span></div><div class="mm-total-pending">Informe seu CEP para ver o frete e o total final.</div></div>';var _;return t.couponCode?_='<div class="mm-coupon-applied"><span class="mm-coupon-applied-left">'+B.tag+"<span>"+R(t.couponCode)+'</span></span><button type="button" data-mm-act="coupon-remove" aria-label="Remover cupom">'+B.close+"</button></div>":_='<div class="mm-coupon"><button type="button" class="mm-coupon-toggle" data-mm-act="coupon-toggle">'+B.tag+'<span>Tenho um cupom</span></button><form class="mm-coupon-form" data-mm-act="coupon-submit"><input type="text" class="mm-input" name="mm-coupon-code" placeholder="CUPOM" autocomplete="off" autocapitalize="characters" spellcheck="false" /><button type="submit" class="mm-btn-secondary">Aplicar</button></form></div>','<div class="mm-sum-stack"><div class="mm-rows">'+n+"</div>"+_+s+"</div>"}function kn(){var t=document.getElementById("mm-layout");if(t)return t.parentElement!==v&&v.insertBefore(t,v.firstChild),t;var a=document.createElement("div");return a.id="mm-layout",a.innerHTML=fn("cart")+'<div class="mm-grid"><section class="mm-items"><h2 class="mm-h">Carrinho</h2><div class="mm-items-card"><div id="mm-item-list">'+yn(2)+'</div></div></section><aside class="mm-sum"><h2 class="mm-h">Resumo</h2><div class="mm-sum-card"><div class="mm-cep"><div class="mm-cep-label"><span class="mm-cep-label-text">Calcular frete</span><a class="mm-cep-label-link" href="https://buscacepinter.correios.com.br/app/endereco/index.php" target="_blank" rel="noopener">Não sei meu CEP</a></div><div class="mm-cep-row"><input type="text" class="mm-input" id="mm-cep-input" name="mm_cep_calc" inputmode="numeric" maxlength="9" placeholder="00000-000" autocomplete="off" data-lpignore="true" data-1p-ignore="true" data-bwignore="true" data-form-type="other" aria-label="CEP" /><button type="button" class="mm-btn-secondary" data-mm-act="calc-cep">Calcular</button></div></div><div id="mm-sum-dynamic"></div><button type="button" class="mm-cta" data-mm-act="finalizar">Finalizar compra'+B.arrow+'</button><div class="mm-trust"><span class="mm-trust-item">'+B.lock+'<span>Pagamento seguro</span></span><span class="mm-trust-item">'+B.rotate+'<span>7 dias para troca</span></span><span class="mm-trust-item">'+B.card+'<span>12x sem juros</span></span></div><a class="mm-help" href="'+u+'" target="_blank" rel="noopener" data-mm-track="help-whats">'+B.whats+"<span><strong>Ficou com alguma dúvida?</strong> Fale com a gente no WhatsApp</span></a></div></aside></div>",v.insertBefore(a,v.firstChild),v.classList.add("mm-shadow-mode"),document.body.classList.add("mm-checkout-rebuild"),document.documentElement.classList.remove("mm-cart-loading"),a}function Tn(){var t=On(),a=document.getElementById("mm-item-list");a&&(a.innerHTML=Fn(t));var n=document.getElementById("mm-sum-dynamic");n&&(n.innerHTML=vn(t));var e=document.querySelector(".mm-cta");e&&(e.disabled=!t.canFinalize,e.style.opacity=t.canFinalize?"1":"0.5",e.style.pointerEvents=t.canFinalize?"auto":"none");var r=document.getElementById("mm-cep-input");if(r&&!r.matches(":focus")){var s=tn.get(I),f=t.cepValue||s||"";f&&(r.value=Cn(f))}return t.items&&t.items.length>0&&rn(t),t}function Cn(t){var a=String(t||"").replace(/\D/g,"").slice(0,8);return a.length<=5?a:a.slice(0,5)+"-"+a.slice(5)}function Yn(t){var a=String(t||"").replace(/\D/g,"");a.length===8&&tn.set(I,a)}function Vn(t){t=t||0;var a=tn.get(I);if(!(!a||a.length!==8)){var n=v.querySelector("#cep, .input-cep");if(!n){t<12&&setTimeout(function(){Vn(t+1)},350);return}var e=v.querySelector("#resumo-compra .frete-calculado");if(e&&e.textContent.trim()){var r=document.getElementById("mm-cep-input");r&&!r.value&&(r.value=Cn(a));return}var s=document.getElementById("mm-cep-input");s&&!s.value&&(s.value=Cn(a)),n.value=Cn(a),Dn(n),setTimeout(function(){Gn()},200)}}function Dn(t){try{var a=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;a.call(t,t.value)}catch{}t.dispatchEvent(new Event("input",{bubbles:!0})),t.dispatchEvent(new Event("change",{bubbles:!0}))}function Gn(){try{if(window.Zord&&window.Zord.Cart&&typeof window.Zord.Cart.calculaFreteCarrinho=="function"){window.Zord.Cart.calculaFreteCarrinho();return}}catch{}var t=v.querySelector("#resumo-compra .calcula-frete > button, .area-frete button");t&&t.click()}function Xn(){var t=document.getElementById("mm-layout");!t||t._mmBound||(t._mmBound=!0,t.addEventListener("click",function(a){var n=a.target.closest("[data-mm-act]");if(n){var e=n.getAttribute("data-mm-act"),r=n.closest(".mm-item"),s=r?parseInt(r.getAttribute("data-mm-id"),10):null;switch(e){case"inc":it(s,r,"inc");break;case"dec":it(s,r,"dec");break;case"remove":wt(s,r);break;case"calc-cep":Mn();break;case"coupon-toggle":var f=n.closest(".mm-coupon");if(f){f.classList.add("is-open");var b=f.querySelector("input");b&&setTimeout(function(){b.focus()},100)}break;case"coupon-remove":mn();break;case"finalizar":mt();break}}}),t.addEventListener("submit",function(a){var n=a.target.closest('[data-mm-act="coupon-submit"]');if(n){a.preventDefault();var e=n.querySelector("input");e&&Sn(e.value.trim())}}),t.addEventListener("input",function(a){a.target&&a.target.id==="mm-cep-input"&&(a.target.value=Cn(a.target.value))}),t.addEventListener("keydown",function(a){a.key==="Enter"&&a.target&&a.target.id==="mm-cep-input"&&(a.preventDefault(),Mn())}))}function it(t,a,n){if(!(!t||!a)&&!(!window.Zord||!window.Zord.checkout)){a.classList.add("is-updating");try{n==="inc"?window.Zord.checkout.adicionaQuantidade(t):window.Zord.checkout.removeQuantidade(t)}catch(e){console.warn("[mm-cart] qty change failed",e),a.classList.remove("is-updating")}}}function wt(t,a){if(!(!t||!a)&&!(!window.Zord||!window.Zord.checkout)){a.classList.add("is-updating"),a.style.transition="opacity 200ms, transform 200ms",a.style.opacity="0",a.style.transform="translateX(-12px)";try{typeof window.Zord.checkout.deleteItem=="function"?window.Zord.checkout.deleteItem(t):window.Zord.checkout.removeQuantidade(t)}catch(n){console.warn("[mm-cart] remove failed",n),a.classList.remove("is-updating"),a.style.opacity="1",a.style.transform=""}}}function Mn(){var t=document.getElementById("mm-cep-input");if(t){var a=(t.value||"").replace(/\D/g,"");if(a.length!==8){t.focus(),t.classList.add("mm-input-error"),setTimeout(function(){t.classList.remove("mm-input-error")},1200);return}Yn(a);var n=v.querySelector("#cep, .input-cep");n&&(n.value=Cn(a),Dn(n)),Gn()}}function Sn(t){if(t&&!(!window.Zord||!window.Zord.checkout)){var a=v.querySelector("#cupom-desconto");a&&(a.value=t.toUpperCase(),Dn(a));try{window.Zord.checkout.addCupomDesconto()}catch(n){console.warn("[mm-cart] coupon apply failed",n)}}}function mn(){if(!(!window.Zord||!window.Zord.checkout))try{window.Zord.checkout.removeCupomDesconto()}catch(t){console.warn("[mm-cart] coupon remove failed",t)}}function mt(){try{var t=On();t.items&&t.items.length>0&&rn(t)}catch{}var a=document.getElementById("finalizar-compra");if(a){a.click();return}location.href="/checkout/identify"}if(z){let t=function(n){if(n=n||0,n>30){a();return}var e=v.querySelectorAll(".cart-item").length>0,r=v.querySelector("#resumo-compra");e||r||n>8?a():setTimeout(function(){t(n+1)},250)},a=function(){kn(),Xn(),Tn(),Vn(),typeof jQuery<"u"&&jQuery(document).ajaxComplete(function(r,s,f){if(!(!f||!f.url)){var b=f.url;(b.indexOf("checkout/cart")!==-1||b.indexOf("atualiza")!==-1||b.indexOf("cupom")!==-1||b.indexOf("frete")!==-1||b.indexOf("removeItem")!==-1||b.indexOf("adicionaItem")!==-1)&&(setTimeout(Tn,120),setTimeout(function(){var w=On();w.shipping!==null&&w.cepValue&&Yn(w.cepValue)},200))}});try{var n=new MutationObserver(function(r){a._mutTimer&&clearTimeout(a._mutTimer),a._mutTimer=setTimeout(Tn,200)}),e=[v.querySelector("#cart-area"),v.querySelector(".cart-area"),v.querySelector("#resumo-compra")].filter(Boolean);e.forEach(function(r){n.observe(r,{childList:!0,subtree:!0,characterData:!0})})}catch{}};if(!document.getElementById("mm-checkout-cro-done")){var ct=document.createElement("div");ct.id="mm-checkout-cro-done",ct.style.display="none",document.body.appendChild(ct)}t()}function et(t){if(!t||!t.items||!t.items.length)return'<aside class="mm-id-sum mm-sum"><h2 class="mm-h">Resumo</h2><div class="mm-sum-card"><div class="mm-sum-empty"><p>Não conseguimos carregar o resumo do seu pedido.</p><a class="mm-btn-secondary" href="/checkout/cart">Voltar ao carrinho</a></div></div></aside>';var a=3,n=t.items.slice(0,a),e=t.items.length-a,r=n.map(function(G){var an=G.quantity>1?'<strong class="mm-id-thumb-qty">'+G.quantity+"×</strong> ":"",en=!G.imgSrc&&!(G.lineTotalPix>0)&&!(G.lineTotal>0);if(en)return'<div class="mm-id-thumb"><div class="mm-id-thumb-img"><span class="mm-skel" style="display:block;width:100%;height:100%"></span></div><div class="mm-id-thumb-body"><p class="mm-id-thumb-name">'+an+R(G.name)+"</p>"+(G.variant?'<p class="mm-id-thumb-variant">'+R(G.variant)+"</p>":"")+'</div><div class="mm-id-thumb-price"><span class="mm-skel" style="display:inline-block;width:56px;height:15px"></span></div></div>';var hn=G.imgSrc?'<img src="'+R(G.imgSrc)+'" alt="'+R(G.name)+'" loading="lazy">':'<div class="mm-id-thumb-placeholder">'+B.box+"</div>",ln=G.lineTotalPix>0?G.lineTotalPix:G.lineTotal;return'<div class="mm-id-thumb"><div class="mm-id-thumb-img">'+hn+'</div><div class="mm-id-thumb-body"><p class="mm-id-thumb-name">'+an+R(G.name)+"</p>"+(G.variant?'<p class="mm-id-thumb-variant">'+R(G.variant)+"</p>":"")+'</div><div class="mm-id-thumb-price">'+D(ln)+"</div></div>"}).join("");e>0&&(r+='<div class="mm-id-thumb-more">+ '+e+" "+(e===1?"item":"itens")+" a mais</div>");var s=t.subtotalFull>0?t.subtotalFull:t.subtotalPix,f='<div class="mm-row"><span class="mm-row-label">Subtotal</span><span class="mm-row-value">'+D(s)+"</span></div>";if(t.shipping!==null&&t.shipping!==void 0){var b;t.shipping===0?b='<span class="mm-row-value is-free">'+B.check+" Grátis</span>":b='<span class="mm-row-value">'+D(t.shipping)+"</span>",f+='<div class="mm-row"><span class="mm-row-label">Frete'+(t.shippingDeadline?' <span class="mm-row-sub">· '+R(t.shippingDeadline)+"</span>":"")+"</span>"+b+"</div>"}t.discount>0&&(f+='<div class="mm-row"><span class="mm-row-label">Desconto'+(t.couponCode?' <span class="mm-row-sub">· '+R(t.couponCode)+"</span>":"")+'</span><span class="mm-row-value is-discount">− '+D(t.discount)+"</span></div>");var w,E=t.shipping!==null&&t.shipping!==void 0?t.shipping:0;if(t.shipping!==null&&t.shipping!==void 0){var _=Math.max(0,s+E-(t.discount||0)),L=Math.max(0,t.subtotalPix+E-(t.discount||0)),Q=_-L,Z=_/12;w='<div class="mm-total"><div class="mm-total-label">Total</div><div class="mm-total-value">'+D(_)+'</div><div class="mm-total-pix"><span>'+D(L)+" à vista no PIX</span>"+(Q>0?'<span class="mm-total-pix-save">economia de '+D(Q)+"</span>":"")+'</div><div class="mm-total-parcela">ou 12x de '+D(Z)+" sem juros</div></div>"}else{var j=s/12;w='<div class="mm-total"><div class="mm-total-label">Subtotal</div><div class="mm-total-value">'+D(t.subtotalPix)+'</div><div class="mm-total-pix"><span>à vista no PIX</span></div><div class="mm-total-parcela">ou 12x de '+D(j)+" sem juros</div></div>"}return'<aside class="mm-id-sum mm-sum"><h2 class="mm-h">Resumo do pedido</h2><div class="mm-sum-card"><div class="mm-id-thumbs">'+r+'</div><div class="mm-rows">'+f+"</div>"+w+'<a class="mm-id-edit-cart" href="/checkout/cart"><span>Editar carrinho</span></a></div><a class="mm-help mm-sum-help" href="'+u+'" target="_blank" rel="noopener" data-mm-track="help-whats-sum">'+B.whats+"<span><strong>Ficou com alguma dúvida?</strong> Fale com a gente no WhatsApp</span></a></aside>"}function dt(){var t='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',a='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>',n='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="16" rx="2"/><line x1="7" y1="9" x2="17" y2="9"/><line x1="7" y1="13" x2="17" y2="13"/><line x1="7" y1="17" x2="13" y2="17"/></svg>',e='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>';return'<section class="mm-id-form-col"><h2 class="mm-id-h2">Quase lá! Identifique-se</h2><p class="mm-id-sub">Informe seu e-mail para finalizar a compra de forma rápida e segura.</p><form class="mm-id-form" data-mm-act="identify-submit" novalidate><div class="mm-input-wrap"><span class="mm-input-icon" aria-hidden="true">'+t+'</span><input type="email" id="mm-id-email" name="mm-email" class="mm-input" placeholder="seu@email.com" autocomplete="email" inputmode="email" required></div><p class="mm-id-microcopy">'+B.lock+'<span>Seu e-mail é seguro · Não compartilhamos com terceiros</span></p><button type="submit" class="mm-cta">Continuar'+B.arrow+'</button></form><div class="mm-id-divider"><span>ou</span></div><div class="mm-id-google-slot"></div><button type="button" class="mm-id-guest-toggle" data-mm-act="guest-go" aria-label="Continuar como visitante"><span class="mm-id-guest-icon" aria-hidden="true">'+a+'</span><span class="mm-id-guest-label">Continuar como visitante (sem criar conta)</span><span class="mm-id-guest-arrow" aria-hidden="true">'+B.arrow+'</span></button><div class="mm-trust mm-id-trust"><span class="mm-trust-item">'+B.lock+'<span>Pagamento seguro</span></span><span class="mm-trust-item">'+B.rotate+'<span>7 dias para troca</span></span><span class="mm-trust-item">'+B.shield+'<span>Garantia 12 meses</span></span></div><p class="mm-id-lgpd">Ao continuar, você concorda com nossa <a href="/politica-de-privacidade" target="_blank" rel="noopener">Política de Privacidade</a></p></section>'}function Kn(t){var a=document.getElementById("mm-layout");if(a)return a.parentElement!==v&&v.insertBefore(a,v.firstChild),a;var n=document.createElement("div");return n.id="mm-layout",n.classList.add("mm-id-layout"),n.innerHTML=fn("delivery")+'<div class="mm-grid mm-id-grid">'+dt()+et(t)+"</div>",v.insertBefore(n,v.firstChild),document.body.classList.add("mm-checkout-rebuild"),Jn(),v.classList.add("mm-shadow-mode"),document.documentElement.classList.remove("mm-cart-loading"),n}function Jn(){var t=document.querySelector(".mm-id-google-slot"),a=v.querySelector(".social-login-area");if(!(!t||!a)&&!t.contains(a))try{t.appendChild(a),t.classList.add("is-loaded")}catch{}}function ft(t){tn.set("mm_user_email",t);var a=v.querySelector("#login");if(!a)return!1;a.value=t,Dn(a);var n=a.closest("form"),e=n?n.querySelector('button.button-send, button[type="submit"]'):null;return e?(e.click(),!0):n?(n.submit(),!0):!1}function zt(){var t=document.getElementById("mm-layout");!t||t._mmBound||(t._mmBound=!0,t.addEventListener("submit",function(a){var n=a.target.closest('[data-mm-act="identify-submit"]');if(n){a.preventDefault();var e=n.querySelector("#mm-id-email"),r=e?e.value.trim():"";if(!r||!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(r)){e&&(e.classList.add("mm-input-error"),e.focus(),setTimeout(function(){e.classList.remove("mm-input-error")},1500));return}var s=ft(r);if(s){var f=n.querySelector(".mm-cta");f&&f.classList.add("is-loading")}return}}),t.addEventListener("click",function(a){var n=a.target.closest("[data-mm-act]");if(n){var e=n.getAttribute("data-mm-act");e==="guest-go"&&(tn.set("mm_checkout_mode","guest"),n.classList.add("is-loading"),location.href="/checkout/onepage")}}))}function zn(t){try{var a=new DOMParser().parseFromString(t,"text/html"),n=a.querySelector("#checkout-main-area");if(!n)return null;for(var e=[],r=n.querySelectorAll(".cart-item"),s=0,f=0;f<r.length;f++){var b=r[f],w=b.querySelector("figure img")||b.querySelector("#product-img")||b.querySelector("img"),E=b.querySelector(".column-valor-produto .valor"),_=parseFloat(b.getAttribute("data-valor")||"0"),L=E?H(E.textContent):0;e.push({name:b.getAttribute("data-item-name")||b.getAttribute("data-name")||"",variant:b.getAttribute("data-item-variant")||"",imgSrc:w&&w.getAttribute("src")||"",quantity:parseInt(b.getAttribute("data-item-quantity")||"1",10),lineTotal:_,lineTotalPix:L,isPix:!!b.querySelector(".column-valor-produto .sub"),deposito:b.getAttribute("data-item-deposito")==="1"}),s+=_}if(e.length===0)return null;var Q=n.querySelector("#resumo-compra .resumo-valores .value"),Z=Q?H(Q.textContent):0;Z<=0&&(Z=e.reduce(function(nn,Y){return nn+(Y.lineTotalPix||0)},0));var j=n.querySelector("#resumo-compra .discount-value"),G=j?H(j.textContent):0,an=n.querySelector("#resumo-compra .txt-cupom, #resumo-compra .alert.alert-type-1"),en="";if(an){var hn=an.textContent.match(/([A-Z0-9]{3,})/);hn&&(en=hn[1])}var ln=n.querySelector("#resumo-compra .frete-calculado"),bn=null,Rn="";if(ln&&ln.textContent.trim()){var S=ln.textContent.trim();if(/gr[aá]tis/i.test(S))bn=0;else{var C=H(S);C>0&&(bn=C)}var U=S.match(/(\d+)\s*dias?/i);U&&(Rn=U[1]+" dias úteis")}return{ts:Date.now(),items:e,subtotalPix:Z,subtotalFull:s,discount:G,couponCode:en,shipping:bn,shippingDeadline:Rn,cepValue:""}}catch{return null}}function Ln(t){try{fetch("/checkout/cart",{credentials:"include",headers:{"X-Requested-With":"XMLHttpRequest"}}).then(function(a){return a.text()}).then(function(a){var n=zn(a);n&&tn.set(N,JSON.stringify(n)),t(n)}).catch(function(){t(null)})}catch{t(null)}}function ut(t){var a=document.querySelector("#mm-layout .mm-id-sum");if(a){var n=a.parentNode;if(n){var e=document.createElement("div");e.innerHTML=et(t);var r=e.firstChild;r&&n.replaceChild(r,a)}}}function gt(){Ln(function(t){t&&t.items&&t.items.length>0&&ut(t)})}if(g){let t=function(n){if(n=n||0,n>30){a();return}var e=v.querySelector("#login, #login-form-etapa-01");e||n>8?a():setTimeout(function(){t(n+1)},250)},a=function(){var n=on();Kn(n),zt(),Jn(),setTimeout(Jn,600),setTimeout(Jn,1500),gt(),setTimeout(function(){var e=document.getElementById("mm-id-email");e&&!("ontouchstart"in window)&&e.focus()},250)};t()}function bt(t){var a=String(t||"").replace(/\D/g,"").slice(0,11);return a.length<=3?a:a.length<=6?a.slice(0,3)+"."+a.slice(3):a.length<=9?a.slice(0,3)+"."+a.slice(3,6)+"."+a.slice(6):a.slice(0,3)+"."+a.slice(3,6)+"."+a.slice(6,9)+"-"+a.slice(9)}function qt(t){var a=String(t||"").replace(/\D/g,"").slice(0,11);return a.length<=2?a.length?"("+a:"":a.length<=6?"("+a.slice(0,2)+") "+a.slice(2):a.length<=10?"("+a.slice(0,2)+") "+a.slice(2,6)+"-"+a.slice(6):"("+a.slice(0,2)+") "+a.slice(2,7)+"-"+a.slice(7)}function vt(t){var a=String(t||"").replace(/\D/g,"").slice(0,8);return a.length<=5?a:a.slice(0,5)+"-"+a.slice(5)}function at(t,a){var n=String(t||"").replace(/\D/g,"");if(n.length!==8){a(null);return}try{fetch("https://viacep.com.br/ws/"+n+"/json/",{headers:{Accept:"application/json"}}).then(function(e){return e.json()}).then(function(e){if(!e||e.erro){a(null);return}a({logradouro:e.logradouro||"",bairro:e.bairro||"",cidade:e.localidade||"",estado:e.uf||""})}).catch(function(){a(null)})}catch{a(null)}}var qn={mail:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z"/></svg>',user:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',doc:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11zM8 12h8v2H8zm0 4h5v2H8z"/></svg>',phone:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20.01 15.38c-1.23 0-2.42-.2-3.53-.56-.35-.12-.74-.03-1.01.24l-1.57 1.97c-2.83-1.35-5.48-3.9-6.89-6.83l1.95-1.66c.27-.28.35-.67.24-1.02-.37-1.11-.56-2.3-.56-3.53 0-.54-.45-.99-.99-.99H4.19C3.65 3 3 3.24 3 3.99 3 13.28 10.73 21 20.01 21c.71 0 .99-.63.99-1.18v-3.45c0-.54-.45-.99-.99-.99z"/></svg>',pin:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>',home:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg>',pix:'<svg width="24" height="24" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true"><path d="M11.917 11.71a2.046 2.046 0 0 1-1.454-.602l-2.1-2.1a.4.4 0 0 0-.551 0l-2.108 2.108a2.044 2.044 0 0 1-1.454.602h-.414l2.66 2.66c.83.83 2.177.83 3.007 0l2.667-2.668h-.253zM4.25 4.282c.55 0 1.066.214 1.454.602l2.108 2.108a.39.39 0 0 0 .552 0l2.1-2.1a2.044 2.044 0 0 1 1.453-.602h.253L9.503 1.623a2.127 2.127 0 0 0-3.007 0l-2.66 2.66h.414z"/><path d="m14.377 6.496-1.612-1.612a.307.307 0 0 1-.114.023h-.733c-.379 0-.75.154-1.017.422l-2.1 2.1a1.005 1.005 0 0 1-1.425 0L5.268 5.32a1.448 1.448 0 0 0-1.018-.422h-.9a.306.306 0 0 1-.109-.021L1.623 6.496c-.83.83-.83 2.177 0 3.008l1.618 1.618a.305.305 0 0 1 .108-.022h.901c.38 0 .75-.153 1.018-.421L7.375 8.57a1.034 1.034 0 0 1 1.426 0l2.1 2.1c.267.268.638.421 1.017.421h.733c.04 0 .079.01.114.024l1.612-1.612c.83-.83.83-2.178 0-3.008z"/></svg>',cardBig:'<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4V6h16v2z"/></svg>',barcode:'<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M2 6h2v12H2zm3 0h1v12H5zm2 0h3v12H7zm4 0h1v12h-1zm3 0h2v12h-2zm3 0h1v12h-1zm2 0h3v12h-3z"/></svg>',editPencil:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04a.996.996 0 0 0 0-1.41l-2.34-2.34a.996.996 0 0 0-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>'};function nt(t){var a=t?' value="'+R(t)+'"':"";return'<section class="mm-op-form-col"><h2 class="mm-id-h2">Falta pouco. Onde entregar?</h2><p class="mm-id-sub">Preencha seus dados e o endereço de entrega — o frete é calculado automaticamente.</p><form class="mm-op-form" data-mm-act="onepage-submit" novalidate><div class="mm-op-card"><h3 class="mm-op-card-title">'+qn.user+'<span>Quem vai receber</span></h3><div class="mm-op-grid-2"><div class="mm-input-wrap mm-op-col-2"><span class="mm-input-icon" aria-hidden="true">'+qn.mail+'</span><input type="email" id="mm-op-email" class="mm-input" placeholder="seu@email.com" autocomplete="email" inputmode="email" required'+a+'></div><div class="mm-input-wrap mm-op-col-2"><span class="mm-input-icon" aria-hidden="true">'+qn.user+'</span><input type="text" id="mm-op-nome" class="mm-input" placeholder="Nome completo" autocomplete="name" required></div><div class="mm-input-wrap"><span class="mm-input-icon" aria-hidden="true">'+qn.doc+'</span><input type="tel" id="mm-op-cpf" class="mm-input" placeholder="CPF" inputmode="numeric" autocomplete="off" maxlength="14" required></div><div class="mm-input-wrap"><span class="mm-input-icon" aria-hidden="true">'+qn.phone+'</span><input type="tel" id="mm-op-tel" class="mm-input" placeholder="(11) 91234-5678" inputmode="tel" autocomplete="tel" maxlength="15" required></div></div><p class="mm-op-microcopy-soft">Usamos seus dados só pra emitir nota fiscal e te avisar da entrega.</p></div><div class="mm-op-card"><h3 class="mm-op-card-title">'+qn.pin+'<span>Endereço de entrega</span></h3><div class="mm-op-grid-2"><div class="mm-input-wrap"><span class="mm-input-icon" aria-hidden="true">'+qn.pin+'</span><input type="tel" id="mm-op-cep" class="mm-input" placeholder="CEP — 00000-000" inputmode="numeric" autocomplete="postal-code" maxlength="9" required><span class="mm-input-status" id="mm-op-cep-status" aria-live="polite"></span></div><a class="mm-op-cep-help" href="https://buscacepinter.correios.com.br/app/endereco/index.php" target="_blank" rel="noopener">Não sei meu CEP</a><div class="mm-input-wrap mm-op-col-2"><span class="mm-input-icon" aria-hidden="true">'+qn.home+'</span><input type="text" id="mm-op-rua" class="mm-input" placeholder="Rua, Av, Travessa..." autocomplete="address-line1" required></div><div class="mm-input-wrap"><input type="tel" id="mm-op-num" class="mm-input mm-input-noicon" placeholder="Número" inputmode="numeric" required></div><div class="mm-input-wrap"><input type="text" id="mm-op-comp" class="mm-input mm-input-noicon" placeholder="Complemento (opcional)" autocomplete="address-line2"></div><div class="mm-input-wrap mm-op-col-2"><input type="text" id="mm-op-bairro" class="mm-input mm-input-noicon" placeholder="Bairro" autocomplete="address-level3" required></div><div class="mm-input-wrap"><input type="text" id="mm-op-cidade" class="mm-input mm-input-noicon" placeholder="Cidade" autocomplete="address-level2" required></div><div class="mm-input-wrap"><input type="text" id="mm-op-uf" class="mm-input mm-input-noicon" placeholder="UF" maxlength="2" autocomplete="address-level1" required></div></div><div class="mm-op-frete" id="mm-op-frete-slot"></div></div><button type="submit" class="mm-cta mm-op-cta">Última etapa: pagamento'+B.arrow+'</button><p class="mm-id-microcopy mm-op-cta-sub">'+B.lock+'<span>Você revisa tudo antes de finalizar</span></p></form><div class="mm-trust mm-id-trust"><span class="mm-trust-item">'+B.lock+'<span>Pagamento seguro</span></span><span class="mm-trust-item">'+B.rotate+'<span>7 dias para troca</span></span><span class="mm-trust-item">'+B.shield+"<span>Garantia 12 meses</span></span></div></section>"}function At(t,a){var n=document.getElementById("mm-layout");if(n)return n.parentElement!==v&&v.insertBefore(n,v.firstChild),n;var e=document.createElement("div");return e.id="mm-layout",e.classList.add("mm-id-layout"),e.classList.add("mm-op-layout"),e.innerHTML=fn("delivery")+'<div class="mm-grid mm-id-grid mm-op-grid">'+nt(a)+et(t)+"</div>",v.insertBefore(e,v.firstChild),document.body.classList.add("mm-checkout-rebuild"),v.classList.add("mm-shadow-mode"),document.documentElement.classList.remove("mm-cart-loading"),e}function st(t){var a=document.getElementById("mm-op-frete-slot");if(a){if(t==="loading"){a.innerHTML='<div class="mm-op-frete-loading"><div class="mm-op-frete-spinner"></div><span>Calculando frete...</span></div>';return}if(t==="error"){a.innerHTML='<div class="mm-op-frete-error"><span>Não conseguimos calcular o frete. Confira o CEP e tente novamente.</span></div>';return}var n=t.value===0,e=n?'<strong class="mm-op-frete-value is-free">Grátis</strong>':'<strong class="mm-op-frete-value">'+D(t.value)+"</strong>",r=t.name?'<span class="mm-op-frete-name">'+R(t.name)+"</span>":"",s=t.deadline?'<span class="mm-op-frete-deadline">Entrega em '+R(t.deadline)+"</span>":"",f=t.city?'<span class="mm-op-frete-city">para '+R(t.city)+"</span>":"",b="";if(t.options&&t.options.length>1){b='<div class="mm-op-frete-options"><button type="button" class="mm-op-frete-toggle" data-mm-act="toggle-frete-opts" aria-expanded="false">Ver outras opções ('+t.options.length+')</button><div class="mm-op-frete-options-list" hidden>';for(var w=0;w<t.options.length;w++){var E=t.options[w],_=E.isSelected?" is-selected":"",L=E.isFree?'<span class="mm-op-frete-opt-value is-free">Grátis</span>':'<span class="mm-op-frete-opt-value">'+D(E.value)+"</span>";b+='<button type="button" class="mm-op-frete-opt'+_+'" data-mm-act="op-ship-select" data-ship-id="'+R(E.id)+'" aria-pressed="'+(E.isSelected?"true":"false")+'"><span class="mm-op-frete-opt-radio" aria-hidden="true"><span></span></span><span class="mm-op-frete-opt-body"><span class="mm-op-frete-opt-name">'+R(E.name||"Padrão")+"</span>"+(E.deadline?'<span class="mm-op-frete-opt-deadline">'+R(E.deadline)+"</span>":"")+"</span>"+L+"</button>"}b+="</div></div>"}a.innerHTML='<div class="mm-op-frete-card'+(n?" is-free":"")+'"><div class="mm-op-frete-icon">'+B.truck+'</div><div class="mm-op-frete-body"><div class="mm-op-frete-row">'+r+e+"</div>"+s+f+"</div></div>"+b}}function xt(){function t(nn){if(!nn)return"";var Y=nn.match(/(\d+(?:\s*[aà]\s*\d+)?)\s*dias?(?:\s*\([^)]+\))?\s*([úu]teis)?/i);return Y?Y[1].replace(/\s+/g," ")+" dias úteis":""}function a(nn){for(var Y=[],dn=nn.querySelectorAll(".servico-frete"),un=0;un<dn.length;un++){var xn=dn[un],wn=xn.querySelector('input[type="radio"]'),En=xn.querySelector(".dias-entrega"),Nn=parseFloat(xn.getAttribute("data-valor-frete")||"0"),An=xn.getAttribute("data-servico-frete")||"",$n=En?En.textContent.trim():"",Wn=$n.match(/(\d+(?:\s*[aà]\s*\d+)?\s*dias?(?:\s*[úu]teis)?)/i);Y.push({id:wn?wn.value:"",name:An,deadline:Wn?Wn[1].replace(/\s+/g," "):$n,value:Nn,isFree:Nn===0,isSelected:wn?wn.checked:!1})}return Y}var n=v.querySelector(".frete-calculado");if(n&&n.textContent.trim()){var e=a(n),r=n.querySelector(".frete-location .city"),s=r?r.textContent.trim():"",f=e.filter(function(nn){return nn.isSelected})[0]||e[0];if(f)return{value:f.value,name:f.name,deadline:f.deadline,city:s,options:e};var b=n.querySelector(".info-frete-selec .info-title span, .info-title span"),w=n.querySelector(".info-frete-selec .dias-entrega, .dias-entrega"),E=n.querySelector(".value.valor-frete, .valor-frete .value"),_=n.textContent,L=null;if(E&&(/gr[aá]tis/i.test(E.textContent)?L=0:L=H(E.textContent)),L===null&&(/gr[aá]tis/i.test(_)?L=0:L=H(_)||null),L!==null)return{value:L,name:b?b.textContent.trim():"",deadline:t(w?w.textContent:_),city:s,options:[]}}var Q=v.querySelector(".line-entrega"),Z=v.querySelector(".value.valor-frete, .valor-frete .value");if(Q||Z){var j=((Q||Z).textContent||"").trim(),G=on(),an=G&&G.shippingName||"",en=G&&G.shippingDeadline||"",hn=G&&G.shippingCity||"",ln=G?G.shippingOptions||[]:[];if(j){var bn=(v.querySelector(".nome-servico-frete, .info-frete-selec .info-title span")||{}).textContent||"",Rn=(v.querySelector(".info-entrega, .prazo-entrega, .line-entrega .sub, .info-frete-selec .dias-entrega")||{}).textContent||"",S=t(Rn)||t(j)||en,C=bn.trim()||an;if(/gr[aá]tis/i.test(j))return{value:0,deadline:S,name:C,city:hn,options:ln};var U=H(j);if(U>0)return{value:U,deadline:S,name:C,city:hn,options:ln}}if(G&&G.shipping!==null&&G.shipping!==void 0)return{value:G.shipping,deadline:en,name:an,city:hn,options:ln}}return null}function Bn(){var t=document.getElementById("mm-op-cep");if(!t)return;var a=(t.value||"").replace(/\D/g,"");if(a.length!==8)return;if(Bn._lastCep===a){var n=document.getElementById("mm-op-frete-slot");if(n&&n.querySelector(".mm-op-frete-card"))return}Bn._lastCep=a;var e=(Bn._token||0)+1;Bn._token=e,Yn(a);var r=v.querySelector("#cep, .input-cep");r&&(r.value=Cn(a),Dn(r)),st("loading");try{window.Zord&&window.Zord.Cart&&typeof window.Zord.Cart.calculaFreteCarrinho=="function"&&window.Zord.Cart.calculaFreteCarrinho()}catch{}var s=0,f=18;function b(){if(Bn._token===e){s++;var w=xt();if(w){st(w);var E=on();E&&(E.shipping=w.value,E.shippingDeadline=w.deadline,E.shippingName=w.name||"",E.shippingCity=w.city||"",E.shippingOptions=w.options||[],tn.set(N,JSON.stringify(E)),ut(E));return}s<f?setTimeout(b,350):st("error")}}setTimeout(b,400)}function Un(){var t=document.getElementById("mm-layout");if(!t||t._mmOpBound)return;t._mmOpBound=!0,t.addEventListener("click",function(n){var e=n.target.closest('[data-mm-act="toggle-frete-opts"]');if(e){n.preventDefault();var r=e.parentElement.querySelector(".mm-op-frete-options-list");if(r){var s=r.hasAttribute("hidden");s?r.removeAttribute("hidden"):r.setAttribute("hidden",""),e.setAttribute("aria-expanded",s?"true":"false"),e.textContent=s?"Ocultar opções":"Ver outras opções"}return}var f=n.target.closest('[data-mm-act="op-ship-select"]');if(f){n.preventDefault();var b=f.getAttribute("data-ship-id");if(!b)return;var w=v.querySelector('.servico-frete input[type="radio"][value="'+b+'"]');if(!w){console.warn("[mm-op] modalidade não encontrada no DOM:",b);return}for(var E=t.querySelectorAll(".mm-op-frete-opt"),_=0;_<E.length;_++){var L=E[_],Q=L.getAttribute("data-ship-id")===b;L.classList.toggle("is-selected",Q),L.setAttribute("aria-pressed",Q?"true":"false")}w.checked=!0,w.click(),setTimeout(function(){var Z=xt();if(Z){st(Z);var j=on();j&&(j.shipping=Z.value,j.shippingDeadline=Z.deadline,j.shippingName=Z.name||"",j.shippingOptions=Z.options||[],tn.set(N,JSON.stringify(j)),ut(j))}},700);return}}),t.addEventListener("submit",function(n){var e=n.target.closest('[data-mm-act="onepage-submit"]');if(e){n.preventDefault();var r={email:(document.getElementById("mm-op-email")||{}).value||"",nome:(document.getElementById("mm-op-nome")||{}).value||"",cpf:(document.getElementById("mm-op-cpf")||{}).value||"",tel:(document.getElementById("mm-op-tel")||{}).value||"",cep:(document.getElementById("mm-op-cep")||{}).value||"",rua:(document.getElementById("mm-op-rua")||{}).value||"",num:(document.getElementById("mm-op-num")||{}).value||"",comp:(document.getElementById("mm-op-comp")||{}).value||"",bairro:(document.getElementById("mm-op-bairro")||{}).value||"",cidade:(document.getElementById("mm-op-cidade")||{}).value||"",uf:(document.getElementById("mm-op-uf")||{}).value||""},s=[];if(/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(r.email.trim())||s.push("mm-op-email"),r.nome.trim().split(/\s+/).length<2&&s.push("mm-op-nome"),r.cpf.replace(/\D/g,"").length!==11&&s.push("mm-op-cpf"),r.tel.replace(/\D/g,"").length<10&&s.push("mm-op-tel"),r.cep.replace(/\D/g,"").length!==8&&s.push("mm-op-cep"),r.rua.trim()||s.push("mm-op-rua"),r.num.trim()||s.push("mm-op-num"),r.bairro.trim()||s.push("mm-op-bairro"),r.cidade.trim()||s.push("mm-op-cidade"),r.uf.trim()||s.push("mm-op-uf"),s.length){s.forEach(function(w){var E=document.getElementById(w);E&&(E.classList.add("mm-input-error"),setTimeout(function(){E.classList.remove("mm-input-error")},1800))});var f=document.getElementById(s[0]);f&&(f.focus(),f.scrollIntoView({block:"center",behavior:"smooth"}));return}var b=e.querySelector(".mm-cta");b&&b.classList.add("is-loading"),tn.set("mm_user_email",r.email.trim()),o(r)}}),t.addEventListener("input",function(n){var e=n.target;if(e){if(e.dataset&&e.dataset.mmCepFill==="1"&&delete e.dataset.mmCepFill,e.id==="mm-op-cpf")e.value=bt(e.value);else if(e.id==="mm-op-tel")e.value=qt(e.value);else if(e.id==="mm-op-cep"){e.value=vt(e.value);var r=e.value.replace(/\D/g,"");r.length===8&&tt(r)}else e.id==="mm-op-uf"&&(e.value=(e.value||"").replace(/[^A-Za-z]/g,"").toUpperCase().slice(0,2));e.id&&e.id.indexOf("mm-op-")===0&&(Un._draftTimer&&clearTimeout(Un._draftTimer),Un._draftTimer=setTimeout(pn,400))}});function a(){Un._draftTimer&&(clearTimeout(Un._draftTimer),Un._draftTimer=null),pn()}t.addEventListener("blur",function(n){var e=n.target;e&&e.id&&e.id.indexOf("mm-op-")===0&&a()},!0),window.addEventListener("beforeunload",a)}function tt(t){var a=document.getElementById("mm-op-cep-status");a&&(a.className="mm-input-status is-loading",a.textContent="Buscando..."),at(t,function(n){if(a&&(a.className="mm-input-status"),!n){a&&(a.className="mm-input-status is-error",a.textContent="CEP não encontrado",setTimeout(function(){a.className="mm-input-status",a.textContent=""},2500));return}a&&(a.className="mm-input-status is-ok",a.innerHTML=B.check,setTimeout(function(){a.className="mm-input-status",a.innerHTML=""},1800));var e=[["mm-op-rua",n.logradouro],["mm-op-bairro",n.bairro],["mm-op-cidade",n.cidade],["mm-op-uf",n.estado]];e.forEach(function(s){var f=document.getElementById(s[0]);!f||!s[1]||(!f.value||f.dataset.mmCepFill==="1")&&(f.value=s[1],f.dataset.mmCepFill="1")});var r=document.getElementById("mm-op-num");r&&setTimeout(function(){r.focus()},100),Bn._t&&clearTimeout(Bn._t),Bn._t=setTimeout(Bn,200)})}function lt(t){if(!document.getElementById("mm-op-overlay")){var a=document.createElement("div");a.id="mm-op-overlay",a.innerHTML='<div class="mm-op-overlay-card"><div class="mm-op-overlay-spinner"></div><p class="mm-op-overlay-text">'+R(t||"Processando...")+"</p></div>",document.body.appendChild(a)}}function o(t){var a=t.nome.trim(),n=t.email.trim(),e=t.rua.trim(),r=t.bairro.trim(),s=t.cidade.trim(),f=t.uf.trim(),b=Cn(t.cep.replace(/\D/g,""));tn.set("mm_user_email",n);var w=function(E,_){var L=v.querySelector(E);if(!L)return!1;try{var Q=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;Q.call(L,_)}catch{L.value=_}return L.dispatchEvent(new Event("input",{bubbles:!0})),L.dispatchEvent(new Event("change",{bubbles:!0})),L.dispatchEvent(new Event("blur",{bubbles:!0})),!0};w("#nome-completo_2",a),w("#cpf_2",t.cpf),w("#email_3",n),w("#telefone_2",t.tel),w("#cep",b),w("#destinatario",a),w("#logradouro",e),w("#numero",t.num),w("#complemento",t.comp),w("#bairro",r),w("#cidade",s),w("#estado",f),lt("Indo para o pagamento..."),setTimeout(function(){var E=document.getElementById("mm-layout");E&&(E.style.display="none"),v.classList.remove("mm-shadow-mode");function _(j){var G=v.querySelector("#"+j);return G?G.closest("form"):null}function L(){var j=_("nome-completo_2");if(!j)return!1;var G=j.querySelector('button[type="submit"], input[type="submit"], button:not([type])');return G?(G.click(),!0):typeof j.requestSubmit=="function"?(j.requestSubmit(),!0):(j.submit(),!0)}function Q(){var j=document.querySelector(".mz-toast-popup.error, .swal2-toast.swal2-icon-error");if(j&&/inativo|realize login/i.test(j.textContent||""))return"error";for(var G=document.querySelectorAll('button, [type="submit"]'),an=0;an<G.length;an++){var en=(G[an].textContent||"").toLowerCase();if(en.indexOf("cadastrar endere")!==-1&&G[an].offsetParent!==null)return"ready"}return"wait"}function Z(){var j=_("cep");if(!j)return!1;var G=j.querySelector('button[type="submit"], input[type="submit"], button:not([type])');return G?(G.click(),!0):typeof j.requestSubmit=="function"?(j.requestSubmit(),!0):(j.submit(),!0)}setTimeout(function(){L();var j=0;(function G(){j++;var an=Q();if(an==="error"){var en=document.getElementById("mm-op-overlay");en&&en.remove();return}if(an!=="ready"&&j<20){setTimeout(G,400);return}Z();var hn=0;function ln(){hn++;var bn=document.querySelector('input[name="forma-pagto"], #forma-pagto-pix, #forma-pagto-cartao, #forma-pagto-boleto');if(bn&&bn.offsetParent!==null){try{p(t)}catch{var Rn=document.getElementById("mm-op-overlay");Rn&&Rn.remove();var S=document.getElementById("mm-layout");S&&(S.style.display="none")}return}if(hn<30)setTimeout(ln,250);else{var C=document.getElementById("mm-op-overlay");C&&C.remove()}}setTimeout(ln,800)})()},150)},100)}function l(){var t={pix:null,cartao:null,boleto:null},a=[];try{a=window.Zord&&window.Zord.Calculo&&window.Zord.Calculo.FormasPagamentoPedido||[]}catch{}a.forEach(function(L){var Q=L.formaPagamento&&L.formaPagamento.id,Z=L.formaPagamento&&L.formaPagamento.isCartao,j=L.condicoes||[];!j.length||!Z||(!t.cartao||j.length>t.cartao.condicoes.length)&&(t.cartao={formaId:Q,valorTotal:j[0].valorTotal,condicoes:j.map(function(G){return{nome:G.condicaoPagamento&&G.condicaoPagamento.nome,numParcelas:G.condicaoPagamento&&G.condicaoPagamento.numeroParcelas,valorParcela:G.valorParcela,valorTotal:G.valorTotal}})})});function n(L){if(!L)return 0;var Q=L.getAttribute&&L.getAttribute("data-valor-total");if(Q){var Z=parseFloat(Q);if(Z>0)return Z}var j=(L.textContent||"").replace(/[^\d,.]/g,"");return j.indexOf(",")!==-1&&(j=j.replace(/\./g,"").replace(",",".")),parseFloat(j)||0}var e=document.querySelector("#valor-total-pedido-pix, .valor-total-pix[data-valor-total]"),r=n(e);if(r>0)t.pix={formaId:17,valorTotal:r};else{var s=a.find&&a.find(function(L){return L.formaPagamento&&L.formaPagamento.id===17});s&&s.condicoes&&s.condicoes[0]&&(t.pix={formaId:17,valorTotal:s.condicoes[0].valorTotal})}var f=document.querySelector("#valor-total-pedido-boleto, .valor-total-boleto[data-valor-total]"),b=n(f);if(b>0)t.boleto={valorTotal:b};else{var w=a.find&&a.find(function(L){var Q=L.formaPagamento&&L.formaPagamento.id,Z=L.formaPagamento&&L.formaPagamento.isCartao;return!Z&&Q!==17&&L.condicoes&&L.condicoes.length});w&&(t.boleto={formaId:w.formaPagamento.id,valorTotal:w.condicoes[0].valorTotal})}if(!t.cartao){var E=document.querySelector(".valor-parcela-cartao");if(E){var _=n(E);_>0&&(t.cartao={valorTotal:_*12,condicoes:[]})}}return t}function p(t){var a=on(),n=l();v.classList.add("mm-shadow-mode"),document.body.classList.add("mm-checkout-rebuild");var e=document.getElementById("mm-layout");(!e||e.parentElement!==v)&&(e&&e.parentElement&&e.parentElement.removeChild(e),e=document.createElement("div"),e.id="mm-layout",v.insertBefore(e,v.firstChild)),e.className="mm-op-layout mm-op-step3-layout",e.style.display="",e.innerHTML=y(a,t,n),document.documentElement.classList.remove("mm-cart-loading");var r=document.getElementById("mm-op-overlay");r&&r.remove();try{window.scrollTo({top:0,behavior:"smooth"})}catch{window.scrollTo(0,0)}K(t,n)}function y(t,a,n){var e=typeof renderGlobalFooter=="function"?renderGlobalFooter():"";return fn("payment")+'<main class="mm-op-main"><div class="mm-op-step3-grid"><section class="mm-op-step3-left">'+k(n)+P()+'</section><aside class="mm-op-step3-sum-wrap">'+A(a)+V(t,n,"pix")+"</aside></div></main>"+e}function A(t){var a=t||{},n=R(a.nome||""),e=R(a.email||""),r=R(a.cpf||""),s=R(a.tel||""),f=R(a.rua||""),b=R(a.num||""),w=a.comp?", "+R(a.comp):"",E=R(a.bairro||""),_=R(a.cidade||""),L=R(a.uf||""),Q=R(a.cep||"");return'<div class="mm-op-step3-completed"><div class="mm-op-completed-card" data-section="dados"><div class="mm-op-completed-head"><span class="mm-op-completed-check">'+B.check+'</span><h3 class="mm-op-completed-title">Dados pessoais</h3><a href="/checkout/onepage" class="mm-op-completed-edit" data-mm-act="edit-dados" aria-label="Editar dados">'+qn.editPencil+' Editar</a></div><dl class="mm-op-completed-body">'+(n?"<div><dt>Nome</dt><dd>"+n+"</dd></div>":"")+(e?"<div><dt>E-mail</dt><dd>"+e+"</dd></div>":"")+(r?"<div><dt>CPF</dt><dd>"+r+"</dd></div>":"")+(s?"<div><dt>Telefone</dt><dd>"+s+"</dd></div>":"")+'</dl></div><div class="mm-op-completed-card" data-section="endereco"><div class="mm-op-completed-head"><span class="mm-op-completed-check">'+B.check+'</span><h3 class="mm-op-completed-title">Endereço de entrega</h3><a href="/checkout/onepage" class="mm-op-completed-edit" data-mm-act="edit-endereco" aria-label="Editar endereço">'+qn.editPencil+' Editar</a></div><address class="mm-op-completed-address">'+f+", "+b+w+"<br>"+E+" — "+_+"/"+L+"<br>"+(Q?"CEP "+Q:"")+"</address></div></div>"}function k(t){var a=t.pix?t.pix.valorTotal:0,n=t.cartao?t.cartao.valorTotal:0,e=t.boleto?t.boleto.valorTotal:0,r=n>a?n-a:0,s=null;t.cartao&&t.cartao.condicoes&&t.cartao.condicoes.length&&(s=t.cartao.condicoes[t.cartao.condicoes.length-1]);var f=s?"até "+s.numParcelas+"x de "+D(s.valorParcela)+" sem juros":n>0?"até 12x sem juros":"Cartão de crédito",b='<label class="mm-op-pay-radio is-active" data-forma="pix"><input type="radio" name="mm-pay" value="pix" checked><div class="mm-op-pay-head"><span class="mm-op-pay-radio-dot" aria-hidden="true"></span><span class="mm-op-pay-icon">'+qn.pix+'</span><div class="mm-op-pay-body"><span class="mm-op-pay-title">PIX</span><span class="mm-op-pay-sub">Aprovação instantânea · em 1 minuto</span></div><div class="mm-op-pay-price">'+(r>0?'<span class="mm-op-pay-badge-save">Economize '+D(r)+"</span>":"")+'<span class="mm-op-pay-amount">'+D(a)+'</span></div></div><div class="mm-op-pay-detail"><ul class="mm-op-pay-benefits"><li>'+B.check+"<span>QR Code e Copia-e-Cola após confirmar</span></li><li>"+B.check+"<span>Pedido aprovado em até 1 minuto</span></li><li>"+B.check+"<span>Pagamento 100% seguro · sem dados de cartão</span></li></ul></div></label>",w='<div class="mm-op-pay-brands"><img src="https://public-resources.zordcdn.com.br/assets/global/payment-vector/cartao-visa.svg" alt="Visa" width="32" height="20"><img src="https://public-resources.zordcdn.com.br/assets/global/payment-vector/cartao-mastercard.svg" alt="Mastercard" width="32" height="20"><img src="https://public-resources.zordcdn.com.br/assets/global/payment-vector/cartao-american-express.svg" alt="American Express" width="32" height="20"><img src="https://public-resources.zordcdn.com.br/assets/global/payment-vector/cartao-elo.svg" alt="Elo" width="32" height="20"><img src="https://public-resources.zordcdn.com.br/assets/global/payment-vector/cartao-hipercard.svg" alt="Hipercard" width="32" height="20"></div>',E='<span class="mm-op-req" aria-hidden="true">*</span>';function _(j){return'<span class="mm-op-field-err" id="'+j+'-err" role="alert" aria-live="polite"></span>'}var L='<div class="mm-op-card-form"><div class="mm-op-card-field mm-op-card-field-full"><label for="mm-pay-card-num">Número do cartão'+E+'</label><div class="mm-input-wrap mm-input-wrap-card"><span class="mm-input-icon" aria-hidden="true">'+B.card+'</span><input id="mm-pay-card-num" type="tel" class="mm-input" inputmode="numeric" autocomplete="off" data-mmac="cc-number" placeholder="0000 0000 0000 0000" maxlength="23" aria-describedby="mm-pay-card-num-err" aria-required="true" disabled><span class="mm-op-card-brand-detected" aria-live="polite"></span></div>'+_("mm-pay-card-num")+'</div><div class="mm-op-card-field mm-op-card-field-full"><label for="mm-pay-card-name">Nome impresso no cartão'+E+'</label><input id="mm-pay-card-name" type="text" class="mm-input mm-input-noicon" autocomplete="off" data-mmac="cc-name" placeholder="Como aparece no cartão" maxlength="100" aria-describedby="mm-pay-card-name-err" aria-required="true" disabled>'+_("mm-pay-card-name")+'</div><div class="mm-op-card-field mm-op-card-field-half"><label for="mm-pay-card-exp">Validade'+E+'</label><input id="mm-pay-card-exp" type="tel" class="mm-input mm-input-noicon" inputmode="numeric" autocomplete="off" data-mmac="cc-exp" placeholder="MM/AA" maxlength="5" aria-describedby="mm-pay-card-exp-err" aria-required="true" disabled>'+_("mm-pay-card-exp")+'</div><div class="mm-op-card-field mm-op-card-field-half"><label for="mm-pay-card-cvv">CVV'+E+'</label><input id="mm-pay-card-cvv" type="tel" class="mm-input mm-input-noicon" inputmode="numeric" autocomplete="off" data-mmac="cc-csc" placeholder="000" maxlength="4" aria-describedby="mm-pay-card-cvv-err" aria-required="true" disabled>'+_("mm-pay-card-cvv")+'</div><div class="mm-op-card-field mm-op-card-field-full"><label for="mm-pay-card-installments">Condições de pagamento'+E+'</label><select id="mm-pay-card-installments" class="mm-input mm-input-noicon mm-op-card-installments" aria-describedby="mm-pay-card-installments-err" aria-required="true" disabled><option value="">Digite o cartão pra ver as condições</option></select>'+_("mm-pay-card-installments")+"</div></div>",Q='<label class="mm-op-pay-radio" data-forma="cartao"><input type="radio" name="mm-pay" value="cartao"><div class="mm-op-pay-head"><span class="mm-op-pay-radio-dot" aria-hidden="true"></span><span class="mm-op-pay-icon">'+qn.cardBig+'</span><div class="mm-op-pay-body"><span class="mm-op-pay-title">Cartão de Crédito</span><span class="mm-op-pay-sub">'+R(f)+'</span></div><div class="mm-op-pay-price"><span class="mm-op-pay-amount">'+D(n)+'</span></div></div><div class="mm-op-pay-detail">'+w+L+"</div></label>",Z='<label class="mm-op-pay-radio" data-forma="boleto"><input type="radio" name="mm-pay" value="boleto"><div class="mm-op-pay-head"><span class="mm-op-pay-radio-dot" aria-hidden="true"></span><span class="mm-op-pay-icon">'+qn.barcode+'</span><div class="mm-op-pay-body"><span class="mm-op-pay-title">Boleto Bancário</span><span class="mm-op-pay-sub">Aprovação em 1 a 3 dias úteis</span></div><div class="mm-op-pay-price"><span class="mm-op-pay-amount">'+D(e)+'</span></div></div><div class="mm-op-pay-detail"><ul class="mm-op-pay-benefits"><li>'+B.check+"<span>Código de barras enviado por e-mail</span></li><li>"+B.check+"<span>Pagamento em banco, lotérica ou app</span></li><li>"+B.check+"<span>Vencimento em 3 dias úteis</span></li></ul></div></label>";return'<section class="mm-op-step3-card" aria-labelledby="mm-op-step3-h"><div class="mm-op-step3-heading"><h2 id="mm-op-step3-h" class="mm-h">Como você quer pagar?</h2><p class="mm-op-step3-sub">Última etapa · escolha sua forma de pagamento '+(r>0?"· PIX tem desconto de "+D(r):"")+'</p></div><div class="mm-op-pay-radios" role="radiogroup" aria-label="Forma de pagamento">'+b+Q+Z+'</div><button type="button" class="mm-cta mm-op-cta mm-op-finalizar" data-mm-act="finalizar-compra">'+B.lock+'<span class="mm-op-finalizar-label">Finalizar compra · '+D(a)+'</span></button><p class="mm-op-finalizar-sub">'+B.shield+"<span>Pagamento seguro · criptografia SSL-256 · seus dados não são armazenados</span></p></section>"}function P(){return'<div class="mm-op-trust-payment"><div class="mm-op-trust-payment-row"><span class="mm-trust-item">'+B.lock+'<span>Site 100% seguro</span></span><span class="mm-trust-item">'+B.shield+'<span>Garantia 12 meses</span></span><span class="mm-trust-item">'+B.rotate+'<span>7 dias pra trocar</span></span><span class="mm-trust-item">'+B.whats+'<span>Atendimento humano</span></span></div><p class="mm-op-trust-payment-note">Ao finalizar, você concorda com os <a href="/termos-de-uso" target="_blank" rel="noopener">termos de compra</a> e a <a href="/politica-privacidade" target="_blank" rel="noopener">política de privacidade</a>.</p></div>'}function V(t,a,n){if(!t||!t.items||!t.items.length)return'<aside class="mm-id-sum mm-sum mm-op-step3-sum"><h2 class="mm-h">Resumo</h2><div class="mm-sum-card"><p class="mm-sum-empty">Não conseguimos carregar o resumo do seu pedido.</p></div></aside>';var e=a.pix?a.pix.valorTotal:0,r=a.cartao?a.cartao.valorTotal:0,s=a.boleto?a.boleto.valorTotal:0,f=r>e?r-e:0,b=n==="pix"?e:n==="boleto"?s:r,w=n==="pix"?"no PIX":n==="boleto"?"no boleto":"no cartão",E=3,_=t.items.slice(0,E),L=t.items.length-E,Q=_.map(function(en){var hn=en.imgSrc?'<img src="'+R(en.imgSrc)+'" alt="'+R(en.name)+'" loading="lazy">':'<div class="mm-id-thumb-placeholder">'+B.box+"</div>",ln=en.quantity>1?'<strong class="mm-id-thumb-qty">'+en.quantity+"×</strong> ":"",bn=en.lineTotalPix>0?en.lineTotalPix:en.lineTotal;return'<div class="mm-id-thumb"><div class="mm-id-thumb-img">'+hn+'</div><div class="mm-id-thumb-body"><p class="mm-id-thumb-name">'+ln+R(en.name)+"</p>"+(en.variant?'<p class="mm-id-thumb-variant">'+R(en.variant)+"</p>":"")+'</div><div class="mm-id-thumb-price">'+D(bn)+"</div></div>"}).join("");L>0&&(Q+='<div class="mm-id-thumb-more">+ '+L+" "+(L===1?"item":"itens")+" a mais</div>");var Z=t.subtotalFull>0?t.subtotalFull:t.subtotalPix,j='<div class="mm-row"><span class="mm-row-label">Subtotal</span><span class="mm-row-value">'+D(Z)+"</span></div>";if(t.shipping!==null&&t.shipping!==void 0){var G=t.shipping===0?'<span class="mm-row-value is-free">'+B.check+" Grátis</span>":'<span class="mm-row-value">'+D(t.shipping)+"</span>";j+='<div class="mm-row"><span class="mm-row-label">Frete'+(t.shippingDeadline?' <span class="mm-row-sub">· '+R(t.shippingDeadline)+"</span>":"")+"</span>"+G+"</div>"}t.discount>0&&(j+='<div class="mm-row"><span class="mm-row-label">Cupom'+(t.couponCode?' <span class="mm-row-sub">· '+R(t.couponCode)+"</span>":"")+'</span><span class="mm-row-value is-discount">− '+D(t.discount)+"</span></div>"),f>0&&n==="pix"&&(j+='<div class="mm-row mm-row-pix-discount"><span class="mm-row-label">'+B.bolt+' Desconto PIX</span><span class="mm-row-value is-discount">− '+D(f)+"</span></div>");var an='<div class="mm-total"><div class="mm-total-label">Total</div><div class="mm-total-value" data-mm-total>'+D(b)+'</div><div class="mm-total-pix" data-mm-total-sub><span>'+w+"</span></div></div>";return'<aside class="mm-id-sum mm-sum mm-op-step3-sum" data-active-forma="'+R(n)+'"><h2 class="mm-h">Resumo do pedido</h2><div class="mm-sum-card"><div class="mm-id-thumbs">'+Q+'</div><div class="mm-sum-rows">'+j+"</div>"+an+"</div></aside>"}function K(t,a){var n=document.getElementById("mm-layout");if(!n||n._mmStep3Bound)return;n._mmStep3Bound=!0;var e=on(),r={activeForma:"pix",cardNumValid:!1,cardBrand:null,cardInstallments:null,submitting:!1};n.addEventListener("click",function(S){var C=S.target.closest(".mm-op-pay-radio");if(C){var U=C.querySelector('input[type="radio"]');U&&!U.checked&&(S.preventDefault(),U.checked=!0,E(C.getAttribute("data-forma")));return}if(S.target.closest('[data-mm-act="finalizar-compra"]')){S.preventDefault(),Rn();return}var nn=S.target.closest('[data-mm-act="edit-dados"], [data-mm-act="edit-endereco"]');if(nn){S.preventDefault(),location.reload();return}}),n.addEventListener("input",function(S){var C=S.target;!C||!C.id||(C.id==="mm-pay-card-num"?j(C):C.id==="mm-pay-card-exp"?G(C):C.id==="mm-pay-card-cvv"&&(C.value=(C.value||"").replace(/\D/g,"").slice(0,4)))}),n.addEventListener("change",function(S){if(S.target&&S.target.id==="mm-pay-card-installments"){var C=S.target,U=C.options[C.selectedIndex];U&&U.value&&(r.cardInstallments={numero:parseInt(U.value,10),label:U.textContent||""},hn(U.value),f("mm-pay-card-installments"))}}),n.addEventListener("blur",function(S){var C=S.target;if(!(!C||!C.id)){var U=["mm-pay-card-num","mm-pay-card-name","mm-pay-card-exp","mm-pay-card-cvv"];U.indexOf(C.id)!==-1&&b(C.id)}},!0),n.addEventListener("focus",function(S){var C=S.target;!C||!C.id||/^mm-pay-card-/.test(C.id)&&f(C.id)},!0);function s(S,C){var U=document.getElementById(S),nn=document.getElementById(S+"-err");U&&(U.classList.add("mm-input-error"),U.setAttribute("aria-invalid","true")),nn&&(nn.textContent=C,nn.classList.add("is-visible"))}function f(S){var C=document.getElementById(S),U=document.getElementById(S+"-err");C&&(C.classList.remove("mm-input-error"),C.removeAttribute("aria-invalid")),U&&(U.textContent="",U.classList.remove("is-visible"))}function b(S){var C=document.getElementById(S);if(!C)return!0;var U=(C.value||"").trim();if(S==="mm-pay-card-num"){var nn=U.replace(/\D/g,"");return nn?nn.length<13?(s(S,"Número do cartão incompleto"),!1):w(nn)?(f(S),!0):(s(S,"Número do cartão inválido — confira os dígitos"),!1):(s(S,"Informe o número do cartão"),!1)}if(S==="mm-pay-card-name")return U?U.split(/\s+/).length<2?(s(S,"Use o nome completo como aparece no cartão"),!1):(f(S),!0):(s(S,"Informe o nome impresso no cartão"),!1);if(S==="mm-pay-card-exp"){var Y=U.replace(/\D/g,"");if(Y.length!==4)return s(S,"Informe a validade no formato MM/AA"),!1;var dn=parseInt(Y.slice(0,2),10),un=parseInt(Y.slice(2),10);if(dn<1||dn>12)return s(S,"Mês inválido (01 a 12)"),!1;var xn=new Date,wn=xn.getFullYear()%100,En=xn.getMonth()+1;return un<wn||un===wn&&dn<En?(s(S,"Cartão expirado"),!1):(f(S),!0)}if(S==="mm-pay-card-cvv"){var Nn=U.replace(/\D/g,"");return Nn.length<3?(s(S,"CVV deve ter 3 ou 4 dígitos"),!1):(f(S),!0)}return S==="mm-pay-card-installments"?U?(f(S),!0):(s(S,"Selecione o número de parcelas"),!1):!0}function w(S){for(var C=0,U=!1,nn=S.length-1;nn>=0;nn--){var Y=parseInt(S.charAt(nn),10);U&&(Y*=2,Y>9&&(Y-=9)),C+=Y,U=!U}return C%10===0}function E(S){if(!(!S||r.activeForma===S)){r.activeForma=S,n.querySelectorAll(".mm-op-pay-radio").forEach(function(Y){Y.classList.toggle("is-active",Y.getAttribute("data-forma")===S)});var C=document.getElementById("forma-pagto-"+S);if(C&&!C.checked)try{C.click()}catch{}var U=n.querySelectorAll(".mm-op-card-form input, .mm-op-card-form select"),nn=S==="cartao";U.forEach(function(Y){Y.disabled=!nn,nn?Y.dataset.mmac&&Y.setAttribute("autocomplete",Y.dataset.mmac):Y.setAttribute("autocomplete","off")}),_(S),S==="cartao"&&setTimeout(function(){var Y=document.getElementById("mm-pay-card-num");Y&&!Y.value&&Y.focus()},250)}}function _(S){var C=n.querySelector(".mm-op-step3-sum");if(C){C.setAttribute("data-active-forma",S);var U=a.pix?a.pix.valorTotal:0,nn=a.cartao?a.cartao.valorTotal:0,Y=a.boleto?a.boleto.valorTotal:0,dn=nn>U?nn-U:0,un=S==="pix"?U:S==="boleto"?Y:nn,xn=S==="pix"?"no PIX":S==="boleto"?"no boleto":"no cartão",wn=C.querySelector("[data-mm-total]");if(wn){var En=wn.textContent||"",Nn=H(En);Nn!==un?L(wn,Nn,un,360):wn.textContent=D(un)}var An=C.querySelector("[data-mm-total-sub] span");An&&An.textContent!==xn&&(An.textContent=xn);var $n=C.querySelector(".mm-sum-rows"),Wn=$n?$n.querySelector(".mm-row-pix-discount"):null;if(S==="pix"&&dn>0){if(!Wn&&$n){var pt=document.createElement("div");pt.innerHTML='<div class="mm-row mm-row-pix-discount"><span class="mm-row-label">'+B.bolt+' Desconto PIX</span><span class="mm-row-value is-discount">− '+D(dn)+"</span></div>",$n.appendChild(pt.firstChild)}}else Wn&&Wn.remove();Q(S)}}function L(S,C,U,nn){S._mmAnimToken&&cancelAnimationFrame(S._mmAnimToken);var Y=null,dn=U-C;function un(xn){Y||(Y=xn);var wn=xn-Y,En=Math.min(1,wn/nn),Nn=1-Math.pow(1-En,3),An=C+dn*Nn;S.textContent=D(An),En<1?S._mmAnimToken=requestAnimationFrame(un):(S.textContent=D(U),S._mmAnimToken=null)}S._mmAnimToken=requestAnimationFrame(un)}function Q(S){var C=n.querySelector(".mm-op-finalizar-label");if(C){var U=S==="pix"?a.pix&&a.pix.valorTotal:S==="boleto"?a.boleto&&a.boleto.valorTotal:a.cartao&&a.cartao.valorTotal;C.textContent="Finalizar compra · "+D(U||0)}}function Z(S){var C=(S||"").replace(/\D/g,"");return C?/^4/.test(C)?"visa":/^(5[1-5]|22[2-9]|2[3-6]|27[01]|2720)/.test(C)?"mastercard":/^3[47]/.test(C)?"amex":/^(4011|4312|4389|4514|4573|5041|5066|5067|509|6277|6362|6363|650|6516|6550)/.test(C)?"elo":/^(606282|384100|384140|384160|606|637095|637568|637599|637609|637612)/.test(C)?"hipercard":null:null}function j(S){var C=(S.value||"").replace(/\D/g,"").slice(0,19),U=C.replace(/(\d{4})(?=\d)/g,"$1 ");if(U!==S.value){var nn=S.selectionStart;S.value=U;try{S.setSelectionRange(nn+1,nn+1)}catch{}}var Y=Z(C);r.cardBrand=Y,r.cardNumValid=C.length>=13;var dn=n.querySelector(".mm-op-card-brand-detected");dn&&(dn.className="mm-op-card-brand-detected"+(Y?" is-"+Y:""),dn.textContent=Y?Y.toUpperCase():""),C.length>=6&&(an(C),bn())}function G(S){var C=(S.value||"").replace(/\D/g,"").slice(0,4),U=C.length>2?C.slice(0,2)+"/"+C.slice(2):C;if(S.value=U,C.length===4){var nn=C.slice(0,2),Y="20"+C.slice(2);en("pag-cartao-mes-validade",String(parseInt(nn,10))),en("pag-cartao-ano-validade",Y)}}function an(S){var C=document.getElementById("pag-cartao-numero");if(C){try{var U=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;U.call(C,S)}catch{C.value=S}C.dispatchEvent(new Event("input",{bubbles:!0})),C.dispatchEvent(new Event("change",{bubbles:!0})),C.dispatchEvent(new Event("blur",{bubbles:!0}))}}function en(S,C){var U=document.getElementById(S);if(U){try{var nn=Object.getOwnPropertyDescriptor(window.HTMLSelectElement.prototype,"value").set;nn.call(U,C)}catch{U.value=C}U.dispatchEvent(new Event("change",{bubbles:!0}))}}function hn(S){en("pag-cartao-parcela",S)}var ln=null;function bn(){if(ln)return;var S=document.getElementById("pag-cartao-parcela");if(!S)return;var C=document.getElementById("mm-pay-card-installments");if(!C)return;function U(){var nn=S.querySelectorAll("option");if(!(nn.length<=1)){var Y="";nn.forEach(function(dn){if(!dn.value){Y+='<option value="">Selecione as parcelas</option>';return}Y+='<option value="'+R(dn.value)+'">'+R(dn.textContent.trim())+"</option>"}),C.innerHTML=Y,C.options.length>1&&(C.selectedIndex=1,r.cardInstallments={numero:parseInt(C.options[1].value,10)||1,label:C.options[1].textContent},hn(C.options[1].value))}}U(),ln=new MutationObserver(U),ln.observe(S,{childList:!0,subtree:!0})}function Rn(){if(console.log("[mm-checkout] submitFinalizar() entry",{submitting:r.submitting,activeForma:r.activeForma}),r.submitting)return;var S=r.activeForma,C=n.querySelector(".mm-op-finalizar");if(!C){console.log("[mm-checkout] submitFinalizar: no .mm-op-finalizar btn");return}if(S==="cartao"){var U=["mm-pay-card-num","mm-pay-card-name","mm-pay-card-exp","mm-pay-card-cvv","mm-pay-card-installments"],nn=U.filter(function(sn){return!b(sn)});if(console.log("[mm-checkout] validation",{errorCount:nn.length,errors:nn}),nn.length){var Y=document.getElementById(nn[0]);if(Y){Y.focus();try{Y.scrollIntoView({block:"center",behavior:"smooth"})}catch{}}return}var dn=document.getElementById("mm-pay-card-name"),un=document.getElementById("mm-pay-card-cvv"),xn=document.getElementById("pag-cartao-titular");if(xn){try{var wn=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;wn.call(xn,dn.value.trim())}catch{xn.value=dn.value.trim()}xn.dispatchEvent(new Event("input",{bubbles:!0})),xn.dispatchEvent(new Event("blur",{bubbles:!0}))}var En=document.getElementById("pag-cartao-vericacao");if(En){try{var Nn=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;Nn.call(En,un.value.replace(/\D/g,""))}catch{En.value=un.value.replace(/\D/g,"")}En.dispatchEvent(new Event("input",{bubbles:!0})),En.dispatchEvent(new Event("blur",{bubbles:!0}))}var An=document.getElementById("pag-cartao-cpf");if(An&&t&&t.cpf){try{var $n=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;$n.call(An,t.cpf)}catch{An.value=t.cpf}An.dispatchEvent(new Event("input",{bubbles:!0})),An.dispatchEvent(new Event("blur",{bubbles:!0}))}}r.submitting=!0,C.classList.add("is-loading"),C.setAttribute("aria-busy","true");var Wn=C.querySelector(".mm-op-finalizar-label");if(Wn&&(Wn.textContent="Processando pagamento..."),lt("Finalizando seu pedido..."),S==="cartao"){var pt=document.getElementById("mm-pay-card-installments");pt&&pt.value&&hn(pt.value)}window.__mmCheckoutDebug=window.__mmCheckoutDebug||[];function gn(sn,Pn){var In={t:new Date().toISOString(),msg:sn,data:Pn};window.__mmCheckoutDebug.push(In),console.log("[mm-checkout]",sn,Pn||"")}function ht(){if(gn("doSubmit() called",{forma:S}),S==="cartao"){var sn=document.getElementById("aceito-termos-bcash-one-card");sn&&!sn.checked&&(sn.checked=!0,sn.dispatchEvent(new Event("change",{bubbles:!0}))),gn("terms",{checked:sn?.checked})}var Pn=S==="pix"?"form-pag-pix":S==="boleto"?"form-pag-boleto":"form-pag-cartao",In=document.getElementById(Pn);if(!In){gn("ERROR: form not found",{formId:Pn}),alert("Erro interno: formulário de pagamento não encontrado. Recarregue a página."),r.submitting=!1,C.classList.remove("is-loading");var Zn=document.getElementById("mm-op-overlay");Zn&&Zn.remove();return}S==="cartao"&&gn("pre-submit cartao state",{numero:document.getElementById("pag-cartao-numero")?.value,bandeira:document.getElementById("pag-cartao-bandeira")?.value,parcela:document.getElementById("pag-cartao-parcela")?.value,titular:document.getElementById("pag-cartao-titular")?.value,mes:document.getElementById("pag-cartao-mes-validade")?.value,ano:document.getElementById("pag-cartao-ano-validade")?.value,cvv:document.getElementById("pag-cartao-vericacao")?.value?.length,cpf:document.getElementById("pag-cartao-cpf")?.value,tokenMp:document.getElementById("pag-cartao-token-mp")?.value?.substring(0,20)});var Qn=In.querySelector('button.button-success, button[type="submit"], input[type="submit"]');if(Qn)gn("clicking native button",{text:Qn.textContent?.trim()}),Qn.click();else if(typeof In.requestSubmit=="function"){gn("no native btn, using requestSubmit");try{In.requestSubmit()}catch(rt){gn("requestSubmit error",rt.message),In.submit()}}else gn("no native btn, using form.submit()"),In.submit();setTimeout(function(){if(r.submitting&&location.pathname.indexOf("/onepage")!==-1){gn("8s failsafe: still on /onepage, removing overlay"),r.submitting=!1,C.classList.remove("is-loading");var rt=document.getElementById("mm-op-overlay");rt&&rt.remove(),v.classList.remove("mm-shadow-mode"),n&&(n.style.display="none")}},8e3),setTimeout(function(){v.classList.remove("mm-shadow-mode"),n&&(n.style.display="none")},600)}function yt(){r.submitting=!1,C.classList.remove("is-loading"),C.removeAttribute("aria-busy");var sn=C.querySelector(".mm-op-finalizar-label");sn&&(sn.textContent="Finalizar compra");var Pn=document.getElementById("mm-op-overlay");Pn&&Pn.remove()}function Ft(){var sn=Date.now(),Pn=1e4;(function In(){var Zn=document.getElementById("pag-cartao-token-mp"),Qn=Zn?(Zn.value||"").trim():"",rt=Qn&&Qn!=="loading..."&&Qn.length>10;if(rt){gn("fallback: token ready"),ht();return}if(Date.now()-sn>=Pn){gn("fallback: timeout",{lastVal:Qn}),ht();return}setTimeout(In,200)})()}function Pt(){if(gn("generateMpTokenAndSubmit() start"),typeof Mercadopago>"u"){gn("Mercadopago global missing, falling back to wait strategy"),Ft();return}var sn=document.getElementById("pag-cartao-token-mp"),Pn=sn?(sn.value||"").trim():"";if(Pn&&Pn!=="loading..."&&Pn.length>10){gn("token already present, submitting",{len:Pn.length}),ht();return}var In=(document.getElementById("mm-pay-card-num")?.value||"").replace(/\D/g,""),Zn=(document.getElementById("mm-pay-card-exp")?.value||"").replace(/\D/g,""),Qn=(document.getElementById("mm-pay-card-cvv")?.value||"").replace(/\D/g,""),rt=(document.getElementById("mm-pay-card-name")?.value||"").trim(),Tt=(t&&t.cpf||document.getElementById("mm-op-cpf")?.value||"").replace(/\D/g,"");if(!In||!Zn||!Qn||!rt||!Tt){gn("missing card fields",{num:In.length,exp:Zn.length,cvv:Qn.length,name:!!rt,doc:Tt.length}),alert("Preencha todos os dados do cartão antes de finalizar."),yt();return}var Mt=Zn.slice(0,2),Lt=Zn.length===4?"20"+Zn.slice(2):Zn.slice(2);gn("calling Mercadopago.createToken",{numLen:In.length,month:Mt,year:Lt});try{Mercadopago.createToken({cardNumber:In,securityCode:Qn,cardExpirationMonth:Mt,cardExpirationYear:Lt,cardholderName:rt,docType:"CPF",docNumber:Tt},function(kt,ot){if(gn("createToken callback",{status:kt,hasId:!!(ot&&ot.id),err:ot&&ot.error}),kt===200||kt===201){if(sn){var It=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;It.call(sn,ot.id),sn.dispatchEvent(new Event("input",{bubbles:!0})),sn.dispatchEvent(new Event("change",{bubbles:!0}))}ht()}else{var Bt="Não foi possível validar os dados do cartão.";ot&&ot.cause&&ot.cause[0]&&ot.cause[0].description&&(Bt=ot.cause[0].description),alert(Bt),yt()}})}catch(kt){gn("createToken exception",kt.message),Ft()}}S==="cartao"?Pt():setTimeout(ht,500)}}if(F){let t=function(n){if(n=n||0,n>30){a();return}var e=v.querySelector("#cep, .box-area-dados, #nome-completo_2");e||n>8?a():setTimeout(function(){t(n+1)},250)},a=function(){var n=on(),e=tn.get("mm_user_email")||"";tn.remove("mm_checkout_mode"),typeof window._mmDraftDebug>"u"&&(window._mmDraftDebug=!1),At(n,e),Un();var r=_n(),s=tn.get(I),f=s&&String(s).replace(/\D/g,"").length===8;f?st("loading"):n&&typeof n.shipping=="number"&&n.shipping>0&&st({value:n.shipping,name:n.shippingName||"",deadline:n.shippingDeadline||"",city:n.shippingCity||"",options:n.shippingOptions||[]});try{var b=Array.from(v.querySelectorAll("a, button")).find(function(_){var L=(_.textContent||"").toLowerCase();return L.indexOf("sem cadastro")!==-1&&_.offsetParent!==null});b&&!b.classList.contains("active")&&b.click()}catch{}gt();var w=tn.get(I);if(w&&w.length===8){var E=document.getElementById("mm-op-cep");E&&(E.value=Cn(w),setTimeout(function(){tt(w)},400))}setTimeout(function(){if(!("ontouchstart"in window))for(var _=["mm-op-email","mm-op-nome","mm-op-cpf","mm-op-tel","mm-op-cep"],L=0;L<_.length;L++){var Q=document.getElementById(_[L]);if(Q&&!Q.value){Q.focus();break}}},350)};t()}if(q){document.documentElement.classList.remove("mm-cart-loading");var X=v.querySelector('input[placeholder*="numero do cart" i]');X&&(X.inputMode="numeric");var J=v.querySelector('input[placeholder*="000" i]');J&&(!J.maxLength||J.maxLength<=4)&&(J.inputMode="numeric")}setTimeout(function(){document.documentElement.classList.contains("mm-cart-loading")&&(console.warn("[mm-cart] failsafe: removing mm-cart-loading after 2s timeout"),document.documentElement.classList.remove("mm-cart-loading"))},2e3)})(),(function(){var I=window.location.pathname,N=/^\/login\/?$/.test(I),M=I.indexOf("/cliente/pedidos")===0;if(!N&&!M)return;var h="5511915299488",i='<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>';function m(g){return"https://api.whatsapp.com/send?phone="+h+"&text="+encodeURIComponent(g)}function c(g){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",g):g()}function u(){function g(v){var O=v.slice(0,14);if(O.length<=11)return O.length>9?O.slice(0,3)+"."+O.slice(3,6)+"."+O.slice(6,9)+"-"+O.slice(9):O.length>6?O.slice(0,3)+"."+O.slice(3,6)+"."+O.slice(6):O.length>3?O.slice(0,3)+"."+O.slice(3):O;var W=O.slice(0,2)+"."+O.slice(2,5)+"."+O.slice(5,8)+"/"+O.slice(8,12);return O.length>12&&(W+="-"+O.slice(12)),W}function F(v){if(!(!v||v.getAttribute("data-mm-mask"))){v.setAttribute("data-mm-mask","1"),v.setAttribute("maxlength","18"),v.setAttribute("inputmode","numeric"),v.addEventListener("input",function(){var W=g(this.value.replace(/\D/g,""));this.value!==W&&(this.value=W)});var O=v.form;O&&!O.getAttribute("data-mm-mask")&&(O.setAttribute("data-mm-mask","1"),O.addEventListener("submit",function(){v.value=g(v.value.replace(/\D/g,""))}))}}var q=0;if((function v(){var O=document.getElementById("form-consulta-pedido"),W=document.getElementById("cpfcnpj");if(!O||!W)return++q<20?void setTimeout(v,250):void 0;F(W);var D=document.getElementById("numero-pedido");if(D&&!O.querySelector(".mm-cp-hint")){var H=document.createElement("span");H.className="mm-cp-hint",H.textContent="O número do pedido está no e-mail de confirmação da compra.";var R=D.closest(".line")||D.parentElement;R.appendChild(H)}var B=O.querySelector("form");if(B&&!O.querySelector(".mm-cp-wa")){var tn=document.createElement("div");tn.className="mm-cp-wa",tn.innerHTML='Não encontra os dados? <a href="'+m("Olá! Preciso de ajuda para consultar o meu pedido.")+'" target="_blank" rel="noopener">'+i+" Fale com a gente</a>",B.insertAdjacentElement("afterend",tn)}document.documentElement.classList.add("mm-consulta-on")})(),/#consultar?-?pedido/i.test(window.location.hash)){var T=0;(function v(){var O=document.getElementById("btn-consulta"),W=document.getElementById("form-consulta-pedido");W&&W.offsetParent!==null||(O&&O.click(),++T<10&&setTimeout(v,400))})()}}var d={"recebimento-pedido":"Pedido recebido","confirmacao-pagamento":"Pagamento confirmado","emissao-nota":"Nota fiscal emitida",transporte:"Em transporte",entrega:"Entregue"};function z(){var g=document.querySelector(".detalhes-pedido");if(!(!g||g.getAttribute("data-mm-ped"))){g.setAttribute("data-mm-ped","1");var F=g.querySelector(".numero-pedido"),q=F?(F.textContent.match(/[\d]+/)||[""])[0]:"",T=g.querySelector(".resumo-data strong"),v=T?T.textContent.trim().split(" ")[0]:"",O=g.querySelectorAll(".item-historico.status-waiting");O.length&&O[0].classList.add("mm-atual");for(var W='viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"',D={"recebimento-pedido":"<svg "+W+'><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><path d="M3 6h18"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>',"confirmacao-pagamento":"<svg "+W+'><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>',"emissao-nota":"<svg "+W+'><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7z"/><path d="M15 2v5h5"/><path d="M8 13h8"/><path d="M8 17h5"/></svg>',transporte:"<svg "+W+'><path d="M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2"/><path d="M15 18H9"/><path d="M19 18h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.62l-3.48-4.35A1 1 0 0 0 17.52 8H14"/><circle cx="17" cy="18" r="2"/><circle cx="7" cy="18" r="2"/></svg>',entrega:"<svg "+W+'><path d="M3 10.18v8.82a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-8.82"/><path d="M2.5 10.5 12 3l9.5 7.5"/><path d="m9 15 2 2 4-4"/></svg>'},H=g.querySelectorAll(".item-historico"),R=0;R<H.length;R++){var B=H[R];if(!B.querySelector(".mm-step-dot")){var tn="";for(var rn in D)if(B.classList.contains(rn)){tn=D[rn];break}var on=document.createElement("span");on.className="mm-step-dot",on.innerHTML=tn,B.insertAdjacentElement("afterbegin",on);var pn=document.createElement("span");pn.className="mm-step-line",B.appendChild(pn)}}var jn=g.querySelectorAll(".item-historico.status-success"),cn="Pedido recebido";if(jn.length){var _n=jn[jn.length-1];for(var On in d)if(_n.classList.contains(On)){cn=d[On];break}}if(!document.getElementById("mm-ped-hero")&&q){var fn=document.createElement("div");fn.id="mm-ped-hero",fn.innerHTML='<div class="mm-ped-hero-info"><h1 class="mm-ped-num">Pedido #'+q+' <button type="button" class="mm-ped-copy" aria-label="Copiar número do pedido">copiar</button></h1><div class="mm-ped-meta">'+(v?"<span>Feito em "+v+"</span>":"")+'<span class="mm-ped-badge">'+cn+'</span></div></div><a class="mm-ped-hero-wa" target="_blank" rel="noopener" href="'+m("Olá! Gostaria de saber sobre o meu pedido #"+q+".")+'">'+i+" Falar sobre este pedido</a>",g.insertAdjacentElement("afterbegin",fn);var Hn=fn.querySelector(".mm-ped-copy");Hn.addEventListener("click",function(){var Xn=this;try{navigator.clipboard.writeText(q).then(function(){Xn.textContent="copiado ✓",Xn.classList.add("mm-copiado"),setTimeout(function(){Xn.textContent="copiar",Xn.classList.remove("mm-copiado")},2e3)})}catch{}})}var Fn=g.querySelector(".status-pagamento-pedido");if(Fn&&!document.getElementById("mm-ped-entrega")){var yn=document.createElement("div");yn.id="mm-ped-entrega";for(var vn=null,kn=g.querySelectorAll("a[href]"),Tn=0;Tn<kn.length;Tn++){var Cn=(kn[Tn].textContent||"")+" "+kn[Tn].href;if(/rastre/i.test(Cn)&&!/politica/i.test(kn[Tn].href)){vn=kn[Tn];break}}var Yn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2"/><path d="M15 18H9"/><path d="M19 18h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.62l-3.48-4.35A1 1 0 0 0 17.52 8H14"/><circle cx="17" cy="18" r="2"/><circle cx="7" cy="18" r="2"/></svg>';vn?(yn.classList.add("mm-tem-rastreio"),yn.innerHTML=Yn+'<span>Seu pedido está a caminho — <a href="'+vn.href+'" target="_blank" rel="noopener">acompanhe o rastreio aqui</a>.</span>'):yn.innerHTML=Yn+'<span>O código de rastreio aparece aqui assim que o pedido for despachado. Enquanto isso, acompanhe as etapas acima ou veja nossa <a href="/politica-de-entrega" target="_blank" rel="noopener">política de entrega</a>.</span>',Fn.insertAdjacentElement("afterend",yn)}var Vn=document.querySelector(".btn-comprar-novamente"),Dn=document.querySelector(".btn-ajuda-pedido"),Gn=Vn||Dn?(Vn||Dn).parentElement:null;Gn&&!Gn.classList.contains("mm-ped-acoes")&&(Gn.classList.add("mm-ped-acoes"),Gn.parentElement!==g&&g.appendChild(Gn)),document.documentElement.classList.add("mm-ped-on")}}c(function(){try{N&&u(),M&&z()}catch(g){window.console&&console.warn&&console.warn("[mm-pedidos]",g)}})})()})();

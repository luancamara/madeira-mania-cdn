...
`),document.body.insertBefore(T,document.body.firstChild),document.documentElement.classList.remove("mm-header-loading");var g=(function(){try{var o=Array.from(document.scripts).find(function(t){return t.src&&t.src.indexOf("madeira-mania.js")!==-1});if(o&&o.src.indexOf("localhost")!==-1)return"http://localhost:8080/assets/mega-hero/";if(o){var n=o.src.match(/@([^/]+)/);if(n)return"https://cdn.jsdelivr.net/gh/luancamara/madeira-mania-cdn@"+n[1]+"/dist/assets/mega-hero/"}return"https://cdn.jsdelivr.net/gh/luancamara/madeira-mania-cdn@main/dist/assets/mega-hero/"}catch{return"https://cdn.jsdelivr.net/gh/luancamara/madeira-mania-cdn@main/dist/assets/mega-hero/"}})(),i={"sala-de-estar":"Sala de Estar","sala-de-jantar":"Sala de Jantar",cozinha:"Cozinha","bar-e-cafe":"Bar e Café",quarto:"Quarto",escritorio:"Escritório",lavanderia:"Lavanderia",banheiro:"Banheiro"},m=T.querySelector(".mm-h-mega-hero-img"),d=T.querySelector(".mm-h-mega-hero-label");Object.keys(i).forEach(function(o){var n=new Image;n.src=g+o+".jpg"});function h(o){m&&(m.onerror=function(){m.style.visibility="hidden"},m.style.visibility="",m.src=g+o+".jpg",m.alt=i[o]||"",d&&(d.textContent=i[o]||""))}h("sala-de-estar"),T.querySelectorAll(".mm-h-mega-heading-link[data-hero]").forEach(function(o){o.addEventListener("mouseenter",function(){h(o.dataset.hero)})});var f=T.querySelectorAll(".mm-h-nav-item[data-menu]"),E=null,v=null;f.forEach(function(o){o.addEventListener("mouseenter",function(){clearTimeout(v),clearTimeout(E),E=setTimeout(function(){f.forEach(function(t){t.classList.remove("is-open");var e=t.querySelector(".mm-h-nav-link");e&&e.setAttribute("aria-expanded","false")}),o.classList.add("is-open");var n=o.querySelector(".mm-h-nav-link");n&&n.setAttribute("aria-expanded","true")},150)}),o.addEventListener("mouseleave",function(){clearTimeout(E),v=setTimeout(function(){o.classList.remove("is-open");var n=o.querySelector(".mm-h-nav-link");n&&n.setAttribute("aria-expanded","false")},200)})}),document.addEventListener("keydown",function(o){o.key==="Escape"&&f.forEach(function(n){n.classList.remove("is-open");var t=n.querySelector(".mm-h-nav-link");t&&t.setAttribute("aria-expanded","false")})});var F=T.querySelector('.mm-h-nav-item[data-menu="ambientes"] > .mm-h-nav-link');F&&F.addEventListener("click",function(o){o.preventDefault()});var z=document.getElementById("mm-h-search-overlay"),C=document.getElementById("mm-h-buscar"),u=document.getElementById("mm-h-search-close"),U=document.getElementById("mm-h-search-input"),Z=z&&z.querySelector(".mm-h-search-backdrop"),N=null;function H(){z&&(N=document.activeElement,z.hidden=!1,document.body.style.overflow="hidden",setTimeout(function(){U&&U.focus()},50))}function D(){z&&(z.hidden=!0,document.body.style.overflow="",N&&N.focus&&N.focus())}C&&C.addEventListener("click",H),u&&u.addEventListener("click",D),Z&&Z.addEventListener("click",D),document.addEventListener("keydown",function(o){if(o.key==="Escape"&&z&&!z.hidden){D();return}if(o.key==="/"&&z&&z.hidden){var n=document.activeElement&&document.activeElement.tagName;n!=="INPUT"&&n!=="TEXTAREA"&&!(document.activeElement&&document.activeElement.isContentEditable)&&(o.preventDefault(),H())}}),z&&z.addEventListener("keydown",function(o){if(!(o.key!=="Tab"||z.hidden)){var n=z.querySelectorAll("button, input, a[href]");if(n.length!==0){var t=n[0],e=n[n.length-1];o.shiftKey&&document.activeElement===t?(o.preventDefault(),e.focus()):!o.shiftKey&&document.activeElement===e&&(o.preventDefault(),t.focus())}}});var M=document.getElementById("mm-h-search-results"),tn=document.getElementById("mm-h-search-suggestions"),pn=[{label:"Mesa de jantar",q:"mesa de jantar"},{label:"Mesa de centro",q:"mesa de centro"},{label:"Rack para TV",q:"rack"},{label:"Guarda-roupas",q:"guarda-roupas"},{label:"Cristaleira",q:"cristaleira"},{label:"Aparador",q:"aparador"},{label:"Buffet",q:"buffet"},{label:"Painel para TV",q:"painel"},{label:"Cabeceira",q:"cabeceira"},{label:"Cômoda",q:"comoda"},{label:"Estante",q:"estante"},{label:"Home theater",q:"home theater"}],dn="mm_recent_searches";function gn(){try{var o=localStorage.getItem(dn);if(!o)return[];var n=JSON.parse(o);return Array.isArray(n)?n.slice(0,5):[]}catch{return[]}}function Pn(o){if(o)try{var n=gn().filter(function(t){return t&&t.toLowerCase()!==o.toLowerCase()});n.unshift(o),localStorage.setItem(dn,JSON.stringify(n.slice(0,5)))}catch{}}function xn(o){return String(o).replace(/[&<>"']/g,function(n){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[n]})}var Xn='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>',Bn='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg>',un="mm_search_cache_v1",Dn=600*1e3,Fn=20,Tn=null;function wn(){try{return JSON.parse(sessionStorage.getItem(un)||"{}")}catch{return{}}}function Ln(o){try{var n=Object.keys(o);if(n.length>Fn){n.sort(function(e,r){return o[e].ts-o[r].ts});for(var t=0;t<n.length-Fn;t++)delete o[n[t]]}sessionStorage.setItem(un,JSON.stringify(o))}catch{}}function Qn(o){var n=wn(),t=n[o.toLowerCase()];return!t||Date.now()-t.ts>Dn?null:t.products}function Cn(o,n){var t=wn();t[o.toLowerCase()]={ts:Date.now(),products:n},Ln(t)}function Zn(o){for(var n="itens:",t=0;(t=o.indexOf(n,t))!==-1;){var e=o.indexOf("[",t);if(e===-1)return null;for(var r=0,s=!1,c=!1,b=-1,A=e;A<o.length;A++){var O=o.charAt(A);if(c){c=!1;continue}if(O==="\\"){c=!0;continue}if(O==='"'){s=!s;continue}if(!s){if(O==="[")r++;else if(O==="]"&&(r--,r===0)){b=A;break}}}if(b!==-1){var L=o.substring(e,b+1);try{var R=JSON.parse(L);if(Array.isArray(R)&&R.length>0)return R}catch{}}t=e+1}return null}function fn(o){var n=Zn(o);if(!n)return[];for(var t=[],e=0;e<n.length&&t.length<6;e++){var r=n[e];if(r){var s=r.titulo||r.nome||"";if(s){var c=r.link||"";c&&c.charAt(0)!=="/"&&c.indexOf("http")!==0&&(c="/"+c);var b=r.midia_url||"",A=parseFloat(r.valor),O=parseFloat(r.valor_de),L=isNaN(A)?"":"R$ "+A.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2}),R=!isNaN(O)&&O>A?"R$ "+O.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2}):"",I="";typeof r.percentual_off=="number"&&r.percentual_off>0&&(I="-"+Math.round(r.percentual_off)+"%"),t.push({href:c,title:s,img:b,price:L,oldPrice:R,discount:I})}}}return t}function En(o){var n=o.toLowerCase().trim();if(!n||n.length<3)return Promise.resolve([]);var t=Qn(n);if(t)return Promise.resolve(t);if(Tn)try{Tn.abort()}catch{}Tn=typeof AbortController<"u"?new AbortController:null;var e="/busca?q="+encodeURIComponent(n),r={credentials:"same-origin",headers:{Accept:"text/html"}};return Tn&&(r.signal=Tn.signal),fetch(e,r).then(function(s){if(!s.ok)throw new Error("HTTP "+s.status);return s.text()}).then(function(s){var c=fn(s);return Cn(n,c),c}).catch(function(s){return s&&s.name==="AbortError"?null:[]})}function Rn(o){var n=o.img?'<img src="'+xn(o.img)+'" alt="" loading="lazy" width="64" height="64"/>':'<div class="mm-h-search-product-noimg"></div>',t=o.price?'<span class="mm-h-search-product-price">'+xn(o.price)+"</span>":"",e=o.oldPrice&&o.oldPrice!==o.price?'<span class="mm-h-search-product-oldprice">'+xn(o.oldPrice)+"</span>":"",r=o.discount?'<span class="mm-h-search-product-discount">'+xn(o.discount)+"</span>":"";return'<a class="mm-h-search-product" href="'+xn(o.href)+'" data-recent="1"><span class="mm-h-search-product-thumb">'+n+r+'</span><span class="mm-h-search-product-body"><span class="mm-h-search-product-name">'+xn(o.title)+'</span><span class="mm-h-search-product-prices">'+e+t+"</span></span></a>"}function On(){if(M){var o=gn();if(!o.length){M.hidden=!0,M.innerHTML="",tn&&(tn.hidden=!1);return}var n='<div class="mm-h-search-section">';n+='<span class="mm-h-search-sug-label">Buscas recentes</span>',n+='<ul class="mm-h-search-list">';for(var t=0;t<o.length;t++){var e=o[t];n+='<li><a class="mm-h-search-result" href="/busca?q='+encodeURIComponent(e)+'"><span class="mm-h-search-result-icon">'+Bn+'</span><span class="mm-h-search-result-label">'+xn(e)+"</span></a></li>"}n+="</ul></div>",M.innerHTML=n,M.hidden=!1,tn&&(tn.hidden=!1)}}function Yn(o){if(!M)return"";tn&&(tn.hidden=!0);var n=o.trim();if(n.length<2)return On(),"";var t=n.toLowerCase(),e=pn.filter(function(b){return b.label.toLowerCase().indexOf(t)!==-1||b.q.toLowerCase().indexOf(t)!==-1}).slice(0,4),r="";r+='<ul class="mm-h-search-list">',r+='<li><a class="mm-h-search-result mm-h-search-result-primary" href="/busca?q='+encodeURIComponent(n)+'" data-recent="1"><span class="mm-h-search-result-icon">'+Xn+'</span><span class="mm-h-search-result-label">Buscar por <strong>&ldquo;'+xn(n)+'&rdquo;</strong></span><span class="mm-h-search-result-arrow" aria-hidden="true">&rarr;</span></a></li>';for(var s=0;s<e.length;s++){var c=e[s];r+='<li><a class="mm-h-search-result" href="/busca?q='+encodeURIComponent(c.q)+'" data-recent="1"><span class="mm-h-search-result-icon">'+Xn+'</span><span class="mm-h-search-result-label">'+xn(c.label)+"</span></a></li>"}return r+="</ul>",n.length>=3&&(r+='<div class="mm-h-search-products-section" data-q="'+xn(n)+'"><span class="mm-h-search-sug-label">Produtos</span><div class="mm-h-search-products-grid mm-h-search-products-loading"><div class="mm-h-search-product-skel"></div><div class="mm-h-search-product-skel"></div><div class="mm-h-search-product-skel"></div><div class="mm-h-search-product-skel"></div></div></div>'),M.innerHTML=r,M.hidden=!1,n}function dt(o){var n=Yn(o);!n||n.length<3||En(n).then(function(t){if(U){var e=(U.value||"").trim();if(e===n&&t!==null){var r=M&&M.querySelector('.mm-h-search-products-section[data-q="'+n.replace(/"/g,'\\"')+'"]');if(r){var s=r.querySelector(".mm-h-search-products-grid");if(s){if(s.classList.remove("mm-h-search-products-loading"),!t||t.length===0){r.innerHTML='<span class="mm-h-search-sug-label">Nenhum produto encontrado para &ldquo;'+xn(n)+"&rdquo;</span>";return}for(var c="",b=0;b<t.length;b++)c+=Rn(t[b]);s.innerHTML=c}}}}})}var qn=null;if(U){U.addEventListener("input",function(){clearTimeout(qn);var o=U.value;qn=setTimeout(function(){!o||o.trim().length<2?On():dt(o)},300)}),M&&M.addEventListener("click",function(o){var n=o.target.closest&&o.target.closest("a[data-recent]");if(n){var t=n.getAttribute("href").split("q=")[1];t&&Pn(decodeURIComponent(t.replace(/\+/g," ")))}});var kn=z&&z.querySelector(".mm-h-search-form");kn&&kn.addEventListener("submit",function(){Pn((U.value||"").trim())})}C&&C.addEventListener("click",function(){On()});var hn=document.getElementById("mm-h-drawer"),nt=document.getElementById("mm-h-drawer-close"),mt=hn&&hn.querySelector(".mm-h-drawer-backdrop");function Nn(){hn&&(hn.hidden=!1,document.body.style.overflow="hidden",setTimeout(function(){var o=hn.querySelector(".mm-h-drawer-close");o&&o.focus()},100))}function tt(){!hn||hn.hidden||(hn.classList.add("mm-h-drawer-closing"),document.body.style.overflow="",setTimeout(function(){hn.hidden=!0,hn.classList.remove("mm-h-drawer-closing");var o=document.getElementById("mm-h-burger");o&&o.focus()},320))}var jn=document.getElementById("mm-h-burger");if(jn&&jn.addEventListener("click",Nn),nt&&nt.addEventListener("click",tt),mt&&mt.addEventListener("click",tt),document.addEventListener("keydown",function(o){o.key==="Escape"&&hn&&!hn.hidden&&tt()}),hn){var et=0;hn.addEventListener("touchstart",function(o){et=o.touches[0].clientX},{passive:!0}),hn.addEventListener("touchend",function(o){var n=o.changedTouches[0].clientX;et-n>80&&tt()},{passive:!0})}hn&&hn.querySelectorAll(".mm-h-drawer-section summary").forEach(function(o){o.addEventListener("click",function(n){n.preventDefault();var t=o.parentElement,e=t.querySelector("ul");if(e)if(t.open)e.style.maxHeight=e.scrollHeight+"px",e.style.opacity="1",requestAnimationFrame(function(){e.style.maxHeight="0",e.style.opacity="0",e.style.paddingTop="0",e.style.paddingBottom="0"}),setTimeout(function(){t.open=!1,e.style.maxHeight="",e.style.opacity="",e.style.paddingTop="",e.style.paddingBottom=""},300);else{t.open=!0;var r=e.scrollHeight;e.style.maxHeight="0",e.style.opacity="0",e.style.paddingTop="0",e.style.paddingBottom="0",requestAnimationFrame(function(){e.style.maxHeight=r+"px",e.style.opacity="1",e.style.paddingTop="",e.style.paddingBottom=""}),setTimeout(function(){e.style.maxHeight="",e.style.opacity=""},320)}})});var bt=document.getElementById("mm-h-cart"),Ft=null,_n=null;function Un(){var o=document.querySelector(".carrinho-rapido-ctn");return o||document.querySelector('#cart-preview-area > div.z-\\[9999\\], #cart-preview-area > div[class*="z-[9999]"]')}function gt(o){return!!(o&&o.className&&o.className.indexOf("z-[9999]")!==-1)}var xt='<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M18 6 6 18M6 6l12 12"/></svg>';function wt(o){if(o){var n=o.querySelector(".close-car-fast");n&&!n.innerHTML.trim()&&(n.innerHTML=xt,n.setAttribute("aria-label","Fechar carrinho"),n.setAttribute("role","button"),n.setAttribute("tabindex","0"))}}function Tt(o){!o||o.dataset.mmCloseWired||(o.dataset.mmCloseWired="1",o.addEventListener("click",function(n){var t=n.target;t&&t.closest&&(t.closest(".close-car-fast")||t.closest(".icon-arrow-bottom"))&&(n.preventDefault(),n.stopPropagation(),l())},!0),o.addEventListener("keydown",function(n){(n.key==="Enter"||n.key===" ")&&n.target&&n.target.closest&&n.target.closest(".close-car-fast")&&(n.preventDefault(),l())}))}function yt(o){if(o){if(!o.dataset.mmLifted){o.dataset.mmLifted="1",o.style.position="fixed",o.style.display="block",o.style.zIndex="200";for(var n=o.parentElement;n&&!n.classList.contains("header-middle");)n.style.zIndex="auto",n.style.transform="none",n.style.filter="none",n.style.isolation="auto",n=n.parentElement}Tt(o),wt(o)}}var lt=[{href:"/rack-atenas-cor-naturalle-largura-220-cm",name:"Rack Atenas 220cm",img:"https://madeiramania.cdn.magazord.com.br/img/2025/12/produto/5519/am-2501-mavaular-rack-atenas-220-naturalle-lado.jpg?ims=200x200",priceFrom:"R$ 1.615,49",priceTo:"R$ 1.032,30"},{href:"/rack-atenas-cor-naturalle-largura-180-cm",name:"Rack Atenas 180cm",img:"https://madeiramania.cdn.magazord.com.br/img/2025/12/produto/5419/am-2501-mavaular-rack-atenas-180-naturalle.jpg?ims=200x200",priceFrom:"R$ 1.688,71",priceTo:"R$ 942,31"},{href:"/buffet-arcus-cor-naturalle-largura-92-cm",name:"Buffet Arcus 92cm",img:"https://madeiramania.cdn.magazord.com.br/img/2025/12/produto/5439/am-2501-mavaular-arcus-02-pts-naturalle.jpg?ims=200x200",priceFrom:"R$ 1.359,09",priceTo:"R$ 807,30"},{href:"/buffet-atenas-cor-naturalle",name:"Buffet Atenas",img:"https://madeiramania.cdn.magazord.com.br/img/2025/12/produto/4237/am-2502-mavaular-buffet-atenas-naturalle.jpg?ims=200x200",priceFrom:"R$ 2.124,07",priceTo:"R$ 1.032,30"}],Hn='<svg viewBox="0 0 48 48" width="56" height="56" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 14 8 20v22a4 4 0 0 0 4 4h24a4 4 0 0 0 4-4V20l-4-6z"/><path d="M8 20h32"/><path d="M32 28a8 8 0 0 1-16 0"/></svg>';function st(){try{if(typeof Zord<"u"&&typeof Zord.get=="function"){var o=Zord.get("cart.size");if(typeof o=="number"&&o>0)return o;if(typeof o=="string"&&/^\d+$/.test(o)&&parseInt(o,10)>0)return parseInt(o,10)}}catch{}var n=document.querySelector("#cart-preview-area .item-ctn, .carrinho-container .item-ctn");if(n){var t=(n.textContent||"").trim();if(t&&/\d/.test(t)){var e=parseInt(t.replace(/\D/g,""),10);if(!isNaN(e))return e}}var r=document.querySelector(".carrinho-rapido-ctn");if(r){var s=0;if(r.querySelectorAll(".cart-item").forEach(function(c){c.closest(".mm-cart-empty-wrapper")||s++}),s>0)return s}return 0}function Lt(o){if(st()!==0||!o)return!1;var n=o.querySelector(".box-empty-cart");if(!n)return!1;var t=getComputedStyle(n);return!(t.display==="none"||t.visibility==="hidden")}function ut(o){if(!o)return!1;var n=st();if(n===0)return!1;var t=0;return o.querySelectorAll(".cart-item").forEach(function(e){e.closest(".mm-cart-empty-wrapper")||t++}),t>0}function Et(o){if(o){o.classList.remove("mm-cart-has-empty-enhancement");var n=o.querySelector(":scope > .mm-cart-empty-wrapper");n&&n.remove()}}function kt(o){if(o){var n=o.querySelector(".content-cart");if(n){if(ut(n)){Et(n);return}var t=n.querySelectorAll(".cart-item").length===0;if(!(!Lt(n)&&!(t&&st()===0))&&!n.querySelector(":scope > .mm-cart-empty-wrapper")){var e=document.createElement("div");e.className="mm-cart-empty-wrapper";for(var r="",s=0;s<lt.length;s++){var c=lt[s];r+='<a class="mm-cart-suggestion-card" href="'+c.href+'"><span class="mm-cart-suggestion-thumb"><img src="'+c.img+'" alt="" loading="lazy" width="80" height="80"/></span><span class="mm-cart-suggestion-body"><span class="mm-cart-suggestion-name">'+c.name+'</span><span class="mm-cart-suggestion-price"><span class="mm-cart-suggestion-price-from">'+c.priceFrom+'</span><span class="mm-cart-suggestion-price-to">'+c.priceTo+"</span></span></span></a>"}e.innerHTML='<div class="mm-cart-empty-hero"><div class="mm-cart-empty-icon">'+Hn+'</div><h3 class="mm-cart-empty-title">Seu carrinho está vazio</h3><p class="mm-cart-empty-copy">Dê uma olhada nos móveis que nossos clientes mais amam.</p></div><div class="mm-cart-suggestions"><span class="mm-cart-suggestions-label">Você pode gostar de</span><div class="mm-cart-suggestions-grid">'+r+"</div></div>",n.classList.add("mm-cart-has-empty-enhancement"),n.appendChild(e)}}}}function Jn(o){try{document.querySelectorAll("#cart-preview-area .item-ctn, .carrinho-container .item-ctn, .item-ctn").forEach(function(n){n.textContent="0"})}catch{}o&&kt(o)}window.__mmForceEmptyCartState=Jn;function Vn(o,n){try{if(typeof Zord>"u"||!Zord.checkout||typeof Zord.checkout.atualizaPreview!="function"){n();return}var t=st();if(t===0){n();return}if(o.querySelector(".cart-item")){n();return}Zord.checkout.atualizaPreview();var e=Date.now(),r=2e3;(function s(){if(o.querySelector(".cart-item")){n();return}if(Date.now()-e>=r){n();return}setTimeout(s,50)})()}catch{n()}}function ft(){if(window.innerWidth<=767){var o=document.querySelector("#cart-preview-area a.link-cart")||document.querySelector('#cart-preview-area a[href*="/checkout/cart"]');if(o){let s=function(b){!b||b.dataset.mmCloseWired||(b.dataset.mmCloseWired="1",b.addEventListener("click",function(A){var O=A.target;if(!(!O||!O.closest)){var L=O.closest('[class*="text-error-700"]');if(!L)for(var R=O,I=0;I<4&&R&&R!==b;I++){if((R.textContent||"").trim()==="Fechar"){L=R;break}R=R.parentElement}L&&(A.preventDefault(),A.stopImmediatePropagation(),b.classList.remove("translate-x-[0]"),b.classList.add("translate-x-[100%]"),delete b.dataset.mmUserOpened,document.body.style.overflow="")}},!0))},c=function(){var b=document.querySelector('#cart-preview-area > div[class*="z-[9999]"]');b&&(b.dataset.mmUserOpened="1",b.className.indexOf("translate-x-[0]")===-1&&(b.classList.remove("translate-x-[100%]"),b.classList.add("translate-x-[0]")),s(b))};document.documentElement.dataset.mmCartOpening="1",o.dataset.mmBypass="1",o.click(),delete o.dataset.mmBypass,setTimeout(c,120),setTimeout(c,380),setTimeout(c,700),setTimeout(function(){delete document.documentElement.dataset.mmCartOpening},800);return}window.location.href="/checkout/cart";return}var n=Un();if(n){Vn(n,function(){a(n)});return}var t=0,e=14,r=!1;(function s(){if(t++,n=Un(),n){Vn(n,function(){a(n)});return}if(!r&&t>=2){r=!0;try{typeof Zord<"u"&&Zord.checkout&&typeof Zord.checkout.atualizaPreview=="function"&&Zord.checkout.atualizaPreview()}catch{}}t<e?setTimeout(s,200):window.location.href="/checkout/cart"})()}function a(o){var n=gt(o);n||(yt(o),wt(o)),kt(o);var t=o.querySelector(".content-cart");if(t&&!t.dataset.mmObserved){t.dataset.mmObserved="1";var e=new MutationObserver(function(){kt(o)});e.observe(t,{childList:!0,subtree:!0,attributes:!1})}if(n){o.classList.remove("translate-x-[100%]"),o.classList.add("translate-x-[0]");var r=o.querySelector('.group.cursor-pointer, [class*="text-error-700"]');r&&!r.dataset.mmWired&&(r.dataset.mmWired="1",r.addEventListener("click",function(s){s.preventDefault(),s.stopPropagation(),l()},!0))}else o.classList.add("mm-drawer-open");!n&&!_n&&(_n=document.createElement("div"),_n.id="mm-h-cart-scrim",_n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:150;opacity:0;transition:opacity 320ms;",_n.addEventListener("click",l),document.body.appendChild(_n),requestAnimationFrame(function(){_n.style.opacity="1"})),document.body.style.overflow="hidden"}function l(){var o=Un();if(o&&(gt(o)?(o.classList.remove("translate-x-[0]"),o.classList.add("translate-x-[100%]")):o.classList.remove("mm-drawer-open")),_n){_n.style.opacity="0";var n=_n;setTimeout(function(){n&&n.parentNode&&n.parentNode.removeChild(n)},320),_n=null}document.body.style.overflow=""}bt&&bt.addEventListener("click",function(o){o.preventDefault(),ft()}),window.innerWidth<=767&&(function o(){var n=document.querySelector('#cart-preview-area > [class*="z-[9999]"]');if(!n){setTimeout(o,500);return}if(!n.dataset.mmGuardWired){n.dataset.mmGuardWired="1";var t=new MutationObserver(function(){if(n.className.indexOf("translate-x-[0]")===-1){delete n.dataset.mmUserOpened;return}document.documentElement.dataset.mmCartOpening||n.dataset.mmUserOpened||(n.classList.remove("translate-x-[0]"),n.classList.add("translate-x-[100%]"))});t.observe(n,{attributes:!0,attributeFilter:["class"]})}})(),document.addEventListener("click",function(o){var n=o.target.closest('#cart-preview-area a.link-cart, header.ra-header > .header-bottom a[href*="/checkout/cart"], header.ra-header > .header-bottom a[href*="carrinho"]');if(n){if(n.dataset.mmBypass)return;o.preventDefault(),o.stopPropagation(),ft()}},!0);var p=document.querySelector("header.ra-header > .header-bottom");p&&p.addEventListener("click",function(o){var n=o.target.closest('a[href*="carrinho"], a[href*="/checkout/cart"], [class*="carrinho"]');n&&(o.preventDefault(),o.stopPropagation(),ft())},!0),document.addEventListener("keydown",function(o){o.key==="Escape"&&_n&&l()});var y=document.getElementById("mm-h-cart-count"),q=document.getElementById("mm-h-cart");function S(){if(y){var o=st();o>0?(y.textContent=o>99?"99+":String(o),y.hidden=!1):y.hidden=!0,q&&q.setAttribute("aria-label","Carrinho, "+o+" "+(o===1?"item":"itens"));var n=Un();n&&n.dataset.mmLifted&&kt(n)}}window.addEventListener("reactItemAddedToCart",S),typeof jQuery<"u"&&(jQuery(document).on("reactItemAddedToCart",S),jQuery(document).ajaxComplete(function(o,n,t){t&&t.url&&t.url.indexOf("checkout/cart")!==-1&&setTimeout(S,150)})),setTimeout(S,500),setTimeout(S,2e3),setTimeout(S,5e3);function B(){var o=document.querySelector("#cart-preview-area .item-ctn, .carrinho-container .item-ctn");if(!(!o||o.dataset.mmObserved)){o.dataset.mmObserved="1";var n=new MutationObserver(S);n.observe(o,{childList:!0,characterData:!0,subtree:!0})}}B(),setTimeout(B,1e3),setTimeout(B,3e3);var _=new MutationObserver(function(o){for(var n=0;n<o.length;n++)for(var t=o[n].addedNodes,e=0;e<t.length;e++){var r=t[e];if(r.nodeType===1){var s=r.classList&&r.classList.contains("popup-adicionado-ao-carrinho")||r.querySelector&&r.querySelector(".popup-adicionado-ao-carrinho");if(s){setTimeout(S,120),setTimeout(S,700);return}}}});_.observe(document.body,{childList:!0,subtree:!0});var Y=-1;setInterval(function(){var o=st();o!==Y&&(Y=o,S())},1e3);var V=0,en=!1,J=24;function mn(){var o=window.scrollY,n=o-V;o>J&&n>0?T.classList.add("is-compact"):(o<=J||n<0)&&T.classList.remove("is-compact"),V=o,en=!1}window.addEventListener("scroll",function(){en||(requestAnimationFrame(mn),en=!0)},{passive:!0})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",x):x()})(),(function(){if(!document.getElementById("mm-org-schema")){var P=document.querySelector('.logo img, header img[alt*="logo" i], header img[alt*="Madeira" i]'),j=P&&P.getAttribute("src")||"";j&&j.indexOf("http")!==0&&(j="https://www.madeiramania.com.br"+j);var T={"@context":"https://schema.org","@type":"OnlineStore","@id":"https://www.madeiramania.com.br/#organization",name:"Madeira Mania",url:"https://www.madeiramania.com.br",description:"Loja online de móveis com preços abaixo dos marketplaces. Racks, mesas, cristaleiras, sofás, camas e estantes com entrega para todo o Brasil. Até 12x sem juros ou 7% de desconto no PIX.",sameAs:["https://www.instagram.com/madeiramaniabr/","https://www.facebook.com/madeiramaniabr/","https://www.reclameaqui.com.br/empresa/madeira-mania-comercio-de-moveis-ltda/","https://www.youtube.com/@madeiramaniabr","https://www.tiktok.com/@madeiramaniabr"],contactPoint:[{"@type":"ContactPoint",telephone:"+55-11-91529-9488",contactType:"customer service",availableLanguage:"Portuguese"},{"@type":"ContactPoint",url:"https://wa.me/5511915299488",contactType:"customer service",description:"WhatsApp"}],hasMerchantReturnPolicy:{"@type":"MerchantReturnPolicy",applicableCountry:"BR",returnPolicyCategory:"https://schema.org/MerchantReturnFiniteReturnWindow",merchantReturnDays:7,returnMethod:"https://schema.org/ReturnByMail"}};j&&j.indexOf("http")===0&&(T.logo=j);var g=document.createElement("script");g.type="application/ld+json",g.id="mm-org-schema",g.textContent=JSON.stringify(T),document.head.appendChild(g)}})(),(function x(){x._retries=(x._retries||0)+1;var P=document.querySelector("#produto-react-app");if(!P||!P.querySelector(".informacoes-compra-produto")){x._retries<30&&setTimeout(x,500);return}if((function(){var g=P.querySelector("#container-swiper"),i=P.querySelector(".swiper-pagination");if(!g||!i)return;var m=i.querySelectorAll(".swiper-pagination-bullet");if(m.length<2)return;var d=P.querySelector(".gallery-main");if(d)for(var h=d.querySelectorAll(".button-prev, .button-next"),f=0;f<h.length;f++)h[f].style.display="none";var E=document.createElement("div");E.id="mm-gallery-counter",E.style.cssText=["position: absolute","top: 12px","left: 12px","background: rgba(255,255,255,0.85)","color: #333","font-size: 12px","font-weight: 500","padding: 3px 10px","border-radius: 12px","z-index: 10","pointer-events: none","font-family: -apple-system, BlinkMacSystemFont, sans-serif","letter-spacing: 0.5px"].join(";"),d&&(d.style.position="relative",d.appendChild(E));function v(){var z=i.querySelector(".swiper-pagination-bullet-active"),C=i.querySelectorAll(".swiper-pagination-bullet");if(!(!z||!C.length)){var u=Array.prototype.indexOf.call(C,z)+1;E.textContent=u+" / "+C.length}}v();var F=new MutationObserver(v);F.observe(i,{subtree:!0,attributes:!0,attributeFilter:["class"]})})(),(function(){var g=P.querySelector(".avaliacoes");if(g){for(var i=document.querySelectorAll("script:not([src])"),m=0,d=0,h=0;h<i.length;h++){var f=i[h].textContent;if(!(f.indexOf("Zord.avaliacoes")===-1&&f.indexOf("produtoAvaliacoes")===-1)){var E=f.match(/produtoAvaliacoes\s*:\s*(\d+)/),v=f.match(/\bnota\s*:\s*(?:Number\()?([\d.]+)/);if(E&&(m=parseInt(E[1],10)),v&&(d=parseFloat(v[1])),m>0)break}}if(m===0){g.style.display="none";return}for(var F=(d%1===0,d.toFixed(1)),z="",C=1;C<=5;C++)C<=Math.floor(d)||C-d<1&&C-d>0?z+='<span style="color:#f5a623;font-size:14px;">&#9733;</span>':z+='<span style="color:#ddd;font-size:14px;">&#9733;</span>';var u=m===1?"avaliação":"avaliações";g.innerHTML='<a href="#avaliacoes" style="display:inline-flex;align-items:center;gap:4px;text-decoration:none;color:#555;font-size:13px;">'+z+' <span style="font-weight:600;color:#1a1a1a;">'+F+'</span> <span style="color:#777;">('+m+" "+u+")</span></a>",g.style.display="",g.style.marginTop="4px"}})(),(function(){var g=P.querySelector("h1");if(g){var i=g.parentElement.querySelector(".text-secondary-700.text-xs");if(i){var m=g.textContent.toLowerCase().replace(/\s+/g," ").trim(),d=i.textContent.toLowerCase().replace(/\s+/g," ").trim(),h=d.split(/[\s\-:,]+/).filter(function(E){return E.length>2}),f=h.filter(function(E){return m.indexOf(E)!==-1});f.length>=h.length*.6&&(i.style.display="none")}}})(),(function(){var g=P.querySelector(".informacoes-compra-produto");if(!g||document.getElementById("mm-action-row"))return;var i=g.querySelector(".salvar-favoritos"),m=g.querySelector(".exibe-botao-whatsapp"),d=g.querySelector(".compartilhar-produto");if(!i&&!m&&!d)return;var h=document.createElement("div");h.id="mm-action-row";function f(){var H=document.createElementNS("http://www.w3.org/2000/svg","svg");H.setAttribute("width","18"),H.setAttribute("height","18"),H.setAttribute("viewBox","0 0 24 24"),H.setAttribute("fill","none"),H.setAttribute("stroke","currentColor"),H.setAttribute("stroke-width","2"),H.setAttribute("stroke-linecap","round"),H.setAttribute("stroke-linejoin","round");var D=document.createElementNS("http://www.w3.org/2000/svg","path");return D.setAttribute("d","M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8M16 6l-4-4-4 4M12 2v13"),H.appendChild(D),H}function E(){var H=document.createElementNS("http://www.w3.org/2000/svg","svg");H.setAttribute("width","18"),H.setAttribute("height","18"),H.setAttribute("viewBox","0 0 24 24"),H.setAttribute("fill","none"),H.setAttribute("stroke","currentColor"),H.setAttribute("stroke-width","2"),H.setAttribute("stroke-linecap","round"),H.setAttribute("stroke-linejoin","round");var D=document.createElementNS("http://www.w3.org/2000/svg","path");return D.setAttribute("d","M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"),H.appendChild(D),H}if(i){var v=document.createElement("div");v.className="salvar-favoritos";var F=document.createElement("button");F.setAttribute("aria-label","Favoritar"),F.appendChild(E()),F.addEventListener("click",function(){var H=i.querySelector("button");H&&H.click()}),v.appendChild(F),h.appendChild(v),i.style.cssText+=";position:absolute !important;width:1px !important;height:1px !important;overflow:hidden !important;clip:rect(0,0,0,0) !important;"}if(m&&(m.style.display="none"),d){var z=document.createElement("div");z.className="compartilhar-produto";var C=document.createElement("button");C.setAttribute("aria-label","Compartilhar"),C.appendChild(f()),C.addEventListener("click",function(){var H=d.querySelector("button");H&&H.click()}),z.appendChild(C),h.appendChild(z),d.style.cssText+=";position:absolute !important;width:1px !important;height:1px !important;overflow:hidden !important;clip:rect(0,0,0,0) !important;"}var u=g.querySelector("#area-comprar");if(u){for(var U=u,Z=u.nextElementSibling;Z;){var N=window.getComputedStyle(Z).position;if(N==="fixed"||N==="sticky")U=Z,Z=Z.nextElementSibling;else break}U.parentNode.insertBefore(h,U.nextSibling)}else g.appendChild(h)})(),(function(){var g=P.querySelector(".comprar-fixo.area-compra-float");if(!(!g||g.querySelector("#mm-sticky-old-price"))){var i=P.querySelector(".informacoes-compra-produto");if(i){var m=i.querySelector(".line-through");if(m){var d=m.textContent.trim(),h=g.querySelector(".price-fixed");if(h){var f=document.createElement("span");f.id="mm-sticky-old-price",f.textContent=d,f.style.cssText=["text-decoration: line-through","color: #999","font-size: 11px","display: block","line-height: 1.2","margin-bottom: 1px"].join(";"),h.insertBefore(f,h.firstChild)}}}}})(),(function(){var g=P.querySelector(".informacoes-compra-produto");if(!(!g||document.getElementById("mm-trust-badges"))){var i=g.querySelector("#area-comprar");if(i){var m=document.createElement("div");m.id="mm-trust-badges",m.style.cssText=["display: flex","justify-content: center","align-items: center","flex-wrap: wrap","gap: 6px 10px","padding: 8px 0","margin-top: 2px"].join(";");var d=[{icon:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>',text:"Compra Segura"},{icon:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"/></svg>',text:"Troca 7 dias"},{icon:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 12 15 16 10" stroke="#4b664a"/></svg>',text:"Reclame Aqui"}],h="display:inline-flex;align-items:center;gap:4px;font-size:11px;color:#777;white-space:nowrap;";d.forEach(function(E,v){var F=document.createElement("span");if(F.style.cssText=h,F.innerHTML=E.icon+" "+E.text,m.appendChild(F),v<d.length-1){var z=document.createElement("span");z.textContent="|",z.style.cssText="color:#ddd;font-size:10px;",m.appendChild(z)}});for(var f=i.nextElementSibling;f&&window.getComputedStyle(f).position==="fixed";)f=f.nextElementSibling;f?g.insertBefore(m,f):g.appendChild(m)}}})(),(function(){var g=P.querySelector(".informacoes-compra-produto");if(!(!g||document.getElementById("mm-whatsapp-cta"))){var i=(document.querySelector("#prod-nome")||{}).value||"",m=(document.querySelector("#prod-valor")||{}).value||"",d=window.location.origin+window.location.pathname+(/^#derivacao=/.test(window.location.hash)?window.location.hash:""),h="5511915299488",f="";m&&(f=parseFloat(m).toLocaleString("pt-BR",{style:"currency",currency:"BRL"}));var E="Olá! Tenho interesse no "+i.trim();f&&(E+=" ("+f+")"),E+=". "+d;var v="https://api.whatsapp.com/send?phone="+h+"&text="+encodeURIComponent(E),F=document.createElement("a");F.id="mm-whatsapp-cta",F.href=v,F.target="_blank",F.rel="noopener noreferrer";var z='<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" style="flex-shrink:0;"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>';F.innerHTML=z+"<span>Compre pelo WhatsApp</span>";var C=document.getElementById("mm-action-row"),u=document.getElementById("mm-trust-badges"),U=C||u;U&&U.parentNode===g&&g.insertBefore(F,U.nextElementSibling)}})(),(function(){var g=P.querySelector(".informacoes-compra-produto");if(!(!g||document.getElementById("mm-stock-indicator"))){for(var i=10,m=document.querySelectorAll("script:not([src])"),d=-1,h=0;h<m.length;h++){var f=m[h].textContent,E=f.match(/"qtde_estoque"\s*:\s*(\d+)/);if(E){d=parseInt(E[1],10);break}}var v=d-i;if(!(v<1||v>9)){var F=document.createElement("div");F.id="mm-stock-indicator",F.style.cssText=["display: flex","align-items: center","gap: 6px","padding: 8px 12px","background: #fff8f0","border: 1px solid #fde0c2","border-radius: 8px","font-size: 13px","color: #c65d00","font-weight: 500","margin-top: 4px"].join(";");var z=v===1?"unidade":"unidades";F.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#c65d00" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>Restam apenas <strong>'+v+"</strong> "+z+" em estoque";var C=g.firstElementChild;C&&C.parentNode.insertBefore(F,C.nextElementSibling)}}})(),(function(){if(!document.getElementById("mm-trust-block")){var g=window.innerWidth>=769,i=document.createElement("div");i.id="mm-trust-block",i.style.cssText=["background: #f7f8f7","display: flex","align-items: center","justify-content: center","gap: "+(g?"40px":"10px"),"padding: "+(g?"14px 24px":"12px 16px"),g?"flex-direction: row":"flex-direction: column",g?"border-top: 1px solid #e8ece8":"border-radius: 10px",g?"border-bottom: 1px solid #e8ece8":"",g?"margin: 0":"margin-top: 10px"].filter(Boolean).join(";");var m=[{icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',label:"Atendimento",desc:"Seg à Sex 8h-18h"},{icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',label:"Garantia",desc:"12 meses fabricação"},{icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"/></svg>',label:"Trocas",desc:"Até 7 dias"},{icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="3" width="15" height="13"/><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>',label:"Frete",desc:"Todo o Brasil"},{icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>',label:"12x sem juros",desc:"No cartão"}],d="display:flex;align-items:center;gap:8px;",h="font-size:13px;font-weight:600;color:#1a1a1a;line-height:1.2;",f="font-size:11px;color:#777;line-height:1.2;";if(m.forEach(function(C){var u=document.createElement("div");u.style.cssText=d,u.innerHTML=C.icon+'<div><div style="'+h+'">'+C.label+'</div><div style="'+f+'">'+C.desc+"</div></div>",i.appendChild(u)}),g){var E=document.querySelector("#pagina-produto-react-app");if(E&&E.nextSibling)E.parentNode.insertBefore(i,E.nextSibling);else{var v=document.querySelector(".main-produto");v&&v.appendChild(i)}}else{var F=P.querySelector(".informacoes-compra-produto"),z=F?F.querySelector(".calculo-frete"):null;z?z.parentNode.insertBefore(i,z.nextElementSibling):F&&F.appendChild(i)}}})(),(function(){var g=P.querySelector(".informacoes-compra-produto");if(!g||document.getElementById("mm-inline-payments"))return;var i=g.querySelector(".form-pag-link");if(!i)return;var m=parseFloat(i.getAttribute("data-valor"))||0,d=parseFloat(i.getAttribute("data-valor-pix"))||0;if(m<=0)return;for(var h=[],f=1;f<=12;f++)h.push({vezes:f,valor:(m/f).toFixed(2).replace(".",",")});function E(gn){return"R$ "+gn.toFixed(2).replace(".",",")}var v=m-d,F=document.createElement("div");F.id="mm-inline-payments",F.style.cssText=["padding: 12px 0","border-top: 1px solid #f0f0f0","margin-top: 4px"].join(";");var z=window.innerWidth>=769,C="display:flex;align-items:center;gap:6px;padding:"+(z?"2px":"4px")+" 0;font-size:13px;color:#444;",u="width:5px;height:5px;border-radius:50%;background:#4b664a;flex-shrink:0;",U='<div style="'+C+'"><span style="'+u+'"></span><span><strong style="color:#1a1a1a;">PIX: '+E(d)+"</strong>"+(v>0?' <span style="color:#2e7d32;font-size:12px;font-weight:600;">(economize '+E(v)+")</span>":"")+"</span></div>";if(z)F.innerHTML=U+'<button id="mm-toggle-parcelas" style="background:none;border:none;color:#4b664a;font-size:13px;font-weight:500;padding:2px 0 0;cursor:pointer;display:flex;align-items:center;gap:4px;">Ver todas as parcelas <span style="font-size:10px;">&#9660;</span></button><div id="mm-more-parcelas" style="display:none;"></div>';else{for(var Z="",N=0;N<3;N++)Z+='<div style="'+C+'"><span style="'+u+'"></span><span>'+h[N].vezes+"x de R$ "+h[N].valor+" sem juros</span></div>";F.innerHTML=U+Z+'<button id="mm-toggle-parcelas" style="background:none;border:none;color:#4b664a;font-size:13px;font-weight:500;padding:6px 0 0;cursor:pointer;display:flex;align-items:center;gap:4px;">Ver todas as parcelas <span style="font-size:10px;">&#9660;</span></button><div id="mm-more-parcelas" style="display:none;"></div>'}for(var H="",D=z?0:3,M=D;M<12;M++)H+='<div style="'+C+'"><span style="'+u+'"></span><span>'+h[M].vezes+"x de R$ "+h[M].valor+" sem juros</span></div>";var tn=i.closest("div");tn&&(tn.parentNode.insertBefore(F,tn),i.style.display="none");var pn=document.getElementById("mm-more-parcelas");pn&&(pn.innerHTML=H);var dn=document.getElementById("mm-toggle-parcelas");dn&&pn&&dn.addEventListener("click",function(){var gn=pn.style.display!=="none";pn.style.display=gn?"none":"block",dn.innerHTML=gn?'Ver todas as parcelas <span style="font-size:10px;">&#9660;</span>':'Ver menos <span style="font-size:10px;">&#9650;</span>'})})(),(function(){var g=document.querySelector(".recomendacao-ctn-0.accordion"),i=document.querySelector(".descricao-produto.accordion");if(!(!g||!i)){var m=g.parentNode;if(!(!m||m!==i.parentNode)){var d=Array.prototype.slice.call(m.children),h=d.indexOf(g),f=d.indexOf(i);h<f&&m.insertBefore(i,g)}}})(),(function(){var g=document.querySelector("#cep");if(!g)return;var i="mm_cep",m=g.closest(".area-calculo");if(m){var d=m.querySelector("button");d&&d.addEventListener("click",function(){var z=g.value.replace(/\D/g,"");if(z.length===8)try{localStorage.setItem(i,z)}catch{}})}var h=null;try{h=localStorage.getItem(i)}catch{}if(!h||h.length!==8||g.value.replace(/\D/g,"").length>0)return;var f=h.substring(0,5)+"-"+h.substring(5);function E(z,C){z.focus();try{z.setSelectionRange(0,(z.value||"").length)}catch{}try{document.execCommand("delete")}catch{}try{document.execCommand("insertText",!1,C)}catch{}}function v(){var z=g.closest(".calculo-frete");return!!(z&&/R\$\s*\d/.test(z.innerText))}function F(z){z<=0||v()||(E(g,f),setTimeout(function(){if(!v()){var C=g.closest(".area-calculo"),u=C&&C.querySelector("button:not([disabled])");u&&u.click(),setTimeout(function(){v()||F(z-1)},2e3)}},2500))}setTimeout(function(){F(3)},600)})(),(function(){for(var g=document.querySelectorAll('.exibe-botao-whatsapp a[href*="whatsapp"]'),i=0;i<g.length;i++){var m=g[i].getAttribute("href");m&&m.indexOf("null")!==-1&&g[i].setAttribute("href",m.replace(/\s*null\s*/g," ").replace(/\s{2,}/g," "))}var d=document.querySelector(".exibe-botao-whatsapp");if(d){var h=new MutationObserver(function(){var f=d.querySelector('a[href*="whatsapp"]');f&&f.href.indexOf("null")!==-1&&f.setAttribute("href",f.getAttribute("href").replace(/\s*null\s*/g," ").replace(/\s{2,}/g," "))});h.observe(d,{subtree:!0,attributes:!0,attributeFilter:["href"]})}})(),(function(){var g=P.querySelector(".informacoes-compra-produto");if(!(!g||document.getElementById("mm-envio-badge"))){for(var i=!1,m=P.querySelectorAll(".tag-produto .text-tag, .tag-produto"),d=0;d<m.length;d++)if(m[d].textContent.toLowerCase().indexOf("envio")!==-1){i=!0;break}if(!i)for(var h=document.querySelectorAll("script:not([src])"),f=0;f<h.length;f++){var E=h[f].textContent.match(/"qtde_estoque"\s*:\s*(\d+)/);if(E){parseInt(E[1],10)>10&&(i=!0);break}}if(i){var v=document.createElement("div");v.id="mm-envio-badge",v.style.cssText=["display: inline-flex","align-items: center","gap: 6px","padding: 4px 0","font-size: 13px","color: #1a1a1a","margin-top: 4px"].join(";"),v.innerHTML='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#c65d00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0;"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg><span><strong style="color:#1a1a1a;">Pronta entrega</strong> <span style="color:#777;font-weight:400;">·</span> <span style="color:#555;font-weight:400;">Enviamos em 24h</span></span>';var F=g.firstElementChild;F&&F.nextElementSibling&&F.parentNode.insertBefore(v,F.nextElementSibling)}}})(),(function(){for(var g=P.querySelectorAll(".tag-1.tag-produto"),i=0;i<g.length;i++){var m=g[i].textContent.trim();(m.indexOf("%")!==-1||m.indexOf("OFF")!==-1)&&(g[i].style.display="none")}})(),(function(){for(var g=document.querySelectorAll('a[href*="avaliacoes"], a[href="#avaliacoes"]'),i=0;i<g.length;i++)g[i].addEventListener("click",function(m){m.preventDefault();var d=document.querySelector("#avaliacoes")||document.querySelector(".container-avaliacoes");d&&d.scrollIntoView({behavior:"smooth",block:"start"})})})(),(function(){var g=P.querySelector("h1");if(!(!g||document.getElementById("mm-brand"))){var i=document.querySelector("#prod-marca");if(!(!i||!i.value||i.value.trim()==="")){var m=document.createElement("span");m.id="mm-brand",m.style.cssText="display:block;font-size:13px;color:#777;font-weight:400;margin-top:2px;",m.textContent="por "+i.value.trim();var d=g.parentElement;if(d){var h=g.nextElementSibling;h?d.insertBefore(m,h):d.appendChild(m)}}}})(),(function(){var g=document.getElementById("mm-trust-badges");if(g){for(var i=g.querySelectorAll("span"),m=0;m<i.length;m++)if(i[m].textContent.indexOf("Reclame")!==-1){var d=document.querySelector('footer .reclame-aqui a, footer a[href*="reclameaqui"]'),h=d?d.href:"https://www.reclameaqui.com.br/empresa/madeira-mania-comercio-de-moveis-ltda/";i[m].innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 12 15 16 10" stroke="#4b664a"/></svg> <a href="'+h+'" target="_blank" rel="noopener" style="color:#777;text-decoration:none;">RA Verificada</a>'}}})(),(function(){var g=P.querySelector(".informacoes-compra-produto");if(g){var i=g.querySelector(".calculo-frete");if(i){g.style.cssText+=";display:flex !important;flex-direction:column !important;",i.style.cssText+=";order:20 !important;";var m=document.getElementById("mm-trust-block");m&&(m.style.cssText+=";order:30 !important;")}}})(),(function(){var g=P.querySelector(".informacoes-compra-produto");if(!(!g||document.getElementById("mm-mini-specs"))){var i=document.querySelector(".descricao-produto"),m={};if(i)for(var d=i.querySelectorAll("td"),h=0;h<d.length-1;h+=2){var f=d[h].textContent.trim().toLowerCase(),E=d[h+1].textContent.trim();f.indexOf("largura")!==-1&&(m.largura=E),f.indexOf("altura")!==-1&&(m.altura=E),f.indexOf("profundidade")!==-1&&(m.profundidade=E),f.indexOf("material")!==-1&&(m.material=E),f.indexOf("dobradi")!==-1&&(m.dobradicas=E),(f.indexOf("pes")!==-1||f.indexOf("pés")!==-1)&&(m.pes=E)}if(!(!m.largura&&!m.material)){var v=[];if(m.material&&v.push(m.material),m.dobradicas&&v.push("Dobradiças "+m.dobradicas),m.pes&&v.push("Pés: "+m.pes),m.largura&&v.push(m.largura+" × "+(m.altura||"")+" × "+(m.profundidade||"")),v.length!==0){var F=document.createElement("div");F.id="mm-mini-specs",F.style.cssText="padding:8px 0;border-top:1px solid #f0f0f0;margin-top:4px;";var z="";v.forEach(function(u){z+='<div style="display:flex;align-items:center;gap:6px;padding:2px 0;font-size:13px;color:#555;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0;"><polyline points="20 6 9 17 4 12"/></svg><span>'+u+"</span></div>"}),F.innerHTML=z;var C=g.querySelector("#area-comprar");C&&g.insertBefore(F,C)}}}})(),(function(){if(window.innerWidth<769||document.getElementById("mm-desktop-sticky"))return;var g=P.querySelector(".informacoes-compra-produto");if(!g)return;var i=g.querySelector(".line-through"),m=(document.querySelector("#prod-valor-principal")||{}).value,d=(document.querySelector("#prod-valor")||{}).value,h=(document.querySelector("#prod-nome")||{}).value||"",f=h.split(" - ")[0]||h;if(!m)return;var E=i?i.textContent.trim():"",v=parseFloat(m).toLocaleString("pt-BR",{style:"currency",currency:"BRL"}),F=d?parseFloat(d).toLocaleString("pt-BR",{style:"currency",currency:"BRL"}):"",z=d?(parseFloat(d)/12).toFixed(2).replace(".",","):"",C=document.createElement("div");C.id="mm-desktop-sticky",C.style.cssText=["position: fixed","top: -60px","left: 0","width: 100%","height: 56px","background: #ffffff","border-bottom: 1px solid #e8ece8","box-shadow: 0 2px 8px rgba(0,0,0,0.06)","z-index: 100","display: flex","align-items: center","justify-content: center","padding: 0 24px","transition: top 0.25s ease","font-family: -apple-system, BlinkMacSystemFont, sans-serif"].join(";");var u="display:flex;align-items:center;gap:16px;max-width:1200px;width:100%;",U="font-size:14px;font-weight:500;color:#1a1a1a;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:300px;",Z="display:flex;align-items:center;gap:8px;margin-left:auto;",N="text-decoration:line-through;color:#999;font-size:12px;",H="font-size:15px;font-weight:600;color:#1a1a1a;",D="font-size:12px;color:#666;",M="display:inline-flex;align-items:center;justify-content:center;padding:8px 20px;background:#4b664a;color:#fff;border:none;border-radius:8px;font-size:14px;font-weight:500;cursor:pointer;white-space:nowrap;";C.innerHTML='<div style="'+u+'"><span style="'+U+'">'+f+'</span><div style="'+Z+'">'+(E?'<span style="'+N+'">'+E+"</span>":"")+'<span style="'+H+'">'+v+' <small style="font-weight:400;font-size:11px;color:#666;">PIX</small></span>'+(z?'<span style="'+D+'">12x R$ '+z+"</span>":"")+'</div><button id="mm-desktop-sticky-btn" style="'+M+'">Comprar</button></div>',document.body.appendChild(C);var tn=document.getElementById("mm-desktop-sticky-btn");tn&&tn.addEventListener("click",function(){var gn=P.querySelector(".btn-comprar");gn&&gn.click()});var pn=g.querySelector("#area-comprar");if(!pn)return;function dn(){var gn=pn.getBoundingClientRect();C.style.top=gn.bottom<0?"0px":"-60px"}window.addEventListener("scroll",dn,{passive:!0}),dn()})(),(function(){var g=[".selos-seguranca",".formas-pagto"];g.forEach(function(i){var m=document.querySelector("footer "+i);m&&m.classList.contains("closed")&&(m.classList.remove("closed"),m.classList.add("open"))})})(),window.innerWidth>=769){var j=P.querySelector(".informacoes-compra-produto");j&&(j.style.setProperty("gap","12px","important"),j.style.setProperty("row-gap","12px","important"))}document.body.classList.add("mm-ready")})();var zt=document.currentScript;(function x(){x._retries=(x._retries||0)+1;var P=document.querySelector("#produto-react-app");if(!P||!P.querySelector(".informacoes-compra-produto")){x._retries<30&&setTimeout(x,500);return}if(!document.getElementById("mm-product-schema")){var j=P.querySelector("h1"),T=j?j.textContent.trim():"";if(T){var g=document.querySelector('link[rel="canonical"]'),i=g?g.href:location.href.split("?")[0],m=document.querySelector("#prod-marca"),d=m?m.value.trim():"";!d&&window.dataLayer&&window.dataLayer[0]&&(d=window.dataLayer[0].brand||"");var h=P.querySelector(".form-pag-link"),f=document.querySelector("#prod-valor-principal"),E=document.querySelector("#prod-valor"),v=0,F=0;h&&(v=parseFloat(h.getAttribute("data-valor-pix"))||0,F=parseFloat(h.getAttribute("data-valor"))||0),!F&&E&&(F=parseFloat(E.value)||0),!v&&f&&(v=parseFloat(f.value)||0);var z=v>0?v:F;if(!(z<=0)){var C="";window.dataLayer&&window.dataLayer[0]&&(C=window.dataLayer[0].sku||"");var u="",U="";window.dataLayer&&window.dataLayer[0]&&(u=window.dataLayer[0].category||"",U=window.dataLayer[0].category2||"");for(var Z=document.querySelector("#prod-deposito"),N=Z?Z.value==="1":!0,H=[],D=P.querySelectorAll(".gallery-main img, #block-imagem img"),M=0;M<D.length;M++){var tn=D[M].getAttribute("src")||D[M].getAttribute("data-src")||"";tn&&tn.indexOf("http")===0&&H.indexOf(tn)===-1&&H.push(tn)}if(H.length===0){var pn=document.querySelector('meta[property="og:image"]');pn&&pn.content&&H.push(pn.content)}var dn=document.querySelector('meta[name="description"]'),gn=dn?dn.content.trim():"";if(!gn){var Pn=document.querySelector(".descricao-produto .accordion-content p");Pn&&(gn=Pn.textContent.trim().substring(0,500))}for(var xn=0,Xn=0,Bn=document.querySelectorAll("script:not([src])"),un=0;un<Bn.length;un++){var Dn=Bn[un].textContent;if(!(Dn.indexOf("Zord.avaliacoes")===-1&&Dn.indexOf("produtoAvaliacoes")===-1)){var Fn=Dn.match(/produtoAvaliacoes\s*:\s*(\d+)/),Tn=Dn.match(/\bnota\s*:\s*(?:Number\()?([\d.]+)/);Fn&&(xn=parseInt(Fn[1],10)),Tn&&(Xn=parseFloat(Tn[1]))}}var wn={"@context":"https://schema.org","@type":"Product",name:T,url:i,image:H,description:gn,sku:C,brand:{"@type":"Brand",name:d||"Madeira Mania"},offers:{"@type":"Offer",url:i,price:z.toFixed(2),priceCurrency:"BRL",availability:N?"https://schema.org/InStock":"https://schema.org/OutOfStock",itemCondition:"https://schema.org/NewCondition",seller:{"@type":"Organization",name:"Madeira Mania"},hasMerchantReturnPolicy:{"@type":"MerchantReturnPolicy",applicableCountry:"BR",returnPolicyCategory:"https://schema.org/MerchantReturnFiniteReturnWindow",merchantReturnDays:7,returnMethod:"https://schema.org/ReturnByMail"},shippingDetails:{"@type":"OfferShippingDetails",shippingDestination:{"@type":"DefinedRegion",addressCountry:"BR"},deliveryTime:{"@type":"ShippingDeliveryTime",handlingTime:{"@type":"QuantitativeValue",minValue:1,maxValue:3,unitCode:"DAY"},transitTime:{"@type":"QuantitativeValue",minValue:5,maxValue:20,unitCode:"DAY"}}}}};F>0&&(wn.offers.priceSpecification=[{"@type":"UnitPriceSpecification",price:v>0?v.toFixed(2):z.toFixed(2),priceCurrency:"BRL",name:"PIX"},{"@type":"UnitPriceSpecification",price:(F/12).toFixed(2),priceCurrency:"BRL",name:"12x sem juros",referenceQuantity:{"@type":"QuantitativeValue",value:12,unitCode:"MON"}}]),xn>0&&Xn>0&&(wn.aggregateRating={"@type":"AggregateRating",ratingValue:Xn.toFixed(1),bestRating:"5",worstRating:"1",reviewCount:String(xn)}),u&&(wn.category=u+(U?" > "+U:""));var Ln=document.createElement("script");Ln.type="application/ld+json",Ln.id="mm-product-schema",Ln.textContent=JSON.stringify(wn),document.head.appendChild(Ln),zt&&zt.parentNode&&zt.parentNode.removeChild(zt)}}}})();var qt=document.currentScript;(function x(){x._retries=(x._retries||0)+1;var P=document.querySelector("#produto-react-app"),j=P?P.querySelector("h1"):null;if(!j){x._retries<30&&setTimeout(x,500);return}if(!document.getElementById("mm-breadcrumb-schema")){var T=[],g=1;T.push({"@type":"ListItem",position:g++,name:"Home",item:"https://www.madeiramania.com.br"});var i=document.querySelectorAll('.breadcrumb a, nav[aria-label*="breadcrumb" i] a, .migalha a, .breadcrumb-item a');if(i.length>0)for(var m=0;m<i.length;m++){var d=i[m],h=d.textContent.trim(),f=d.href;!h||h.toLowerCase()==="home"||h.toLowerCase()==="início"||!f||f==="#"||T.push({"@type":"ListItem",position:g++,name:h,item:f})}else if(window.dataLayer&&window.dataLayer[0]){var E=window.dataLayer[0].category||"",v=window.dataLayer[0].category2||"";E&&T.push({"@type":"ListItem",position:g++,name:E,item:"https://www.madeiramania.com.br/"+E.toLowerCase().replace(/\s+/g,"-").replace(/[àáâã]/g,"a").replace(/[éêë]/g,"e").replace(/[íî]/g,"i").replace(/[óôõ]/g,"o").replace(/[úû]/g,"u").replace(/ç/g,"c")}),v&&v!==E&&T.push({"@type":"ListItem",position:g++,name:v,item:"https://www.madeiramania.com.br/"+v.toLowerCase().replace(/\s+/g,"-").replace(/[àáâã]/g,"a").replace(/[éêë]/g,"e").replace(/[íî]/g,"i").replace(/[óôõ]/g,"o").replace(/[úû]/g,"u").replace(/ç/g,"c")})}if(T.push({"@type":"ListItem",position:g,name:j.textContent.trim()}),!(T.length<2)){var F={"@context":"https://schema.org","@type":"BreadcrumbList",itemListElement:T},z=document.createElement("script");z.type="application/ld+json",z.id="mm-breadcrumb-schema",z.textContent=JSON.stringify(F),document.head.appendChild(z),qt&&qt.parentNode&&qt.parentNode.removeChild(qt)}}})();var At=document.currentScript;(function x(){x._retries=(x._retries||0)+1;var P=document.querySelector(".descricao-produto");if(!P){x._retries<30&&setTimeout(x,500);return}if(!document.getElementById("mm-faq-section")){var j=[{q:"Como funciona a entrega de móveis?",a:"Enviamos para todo o Brasil por transportadora especializada em móveis. O prazo varia de 5 a 20 dias úteis dependendo da sua região. Você pode calcular o frete e prazo exato informando seu CEP na página do produto, acima do botão de compra."},{q:"O móvel vem montado ou precisa montar?",a:"A maioria dos móveis é enviada desmontada para garantir segurança no transporte. Cada produto inclui manual de montagem com instruções passo a passo e todas as ferragens necessárias. Produtos de madeira maciça geralmente exigem apenas encaixe simples de pés ou portas."},{q:"Vocês entregam em apartamento e zona rural?",a:"Sim, entregamos em apartamentos e áreas urbanas em todo o Brasil. Para zonas rurais, a disponibilidade depende da região — consulte informando seu CEP. A entrega é realizada até a portaria ou térreo do edifício."},{q:"E se o produto chegar com defeito?",a:"Você tem 7 dias para solicitar troca ou devolução a partir do recebimento, conforme o Código de Defesa do Consumidor (Art. 49). Basta entrar em contato pelo nosso WhatsApp com fotos do defeito. Todos os produtos possuem garantia de 12 meses contra defeitos de fabricação."},{q:"Quais as formas de pagamento?",a:"Aceitamos PIX com 7% de desconto (processado na hora), cartão de crédito em até 12x sem juros (Visa, Mastercard, Elo, American Express) e boleto bancário. O pagamento via PIX agiliza o despacho do seu pedido."},{q:"O preço de vocês é realmente menor que nos marketplaces?",a:"Sim. Como vendemos direto ao consumidor, sem comissões de marketplace, nossos preços são consistentemente 10% a 25% menores que MadeiraMadeira, Mercado Livre e outros. Compare o mesmo produto pelo código SKU do fabricante e confira a diferença."},{q:"Como funciona a garantia?",a:"Todos os produtos possuem garantia de 12 meses contra defeitos de fabricação, além do direito de arrependimento de 7 dias garantido pelo CDC. Móveis de madeira maciça, com os cuidados adequados, possuem durabilidade superior a 30 anos."}];if(!document.getElementById("mm-faq-styles")){var T=document.createElement("style");T.id="mm-faq-styles",T.textContent=["#mm-faq-section button:focus-visible { outline: 2px solid #4b664a; outline-offset: 2px; border-radius: 4px; }","#mm-faq-section button:active { opacity: 0.7; }","@media (prefers-reduced-motion: reduce) { #mm-faq-section * { transition: none !important; } }"].join(`
`),document.head.appendChild(T)}var g=document.createElement("div");g.id="mm-faq-section",g.style.cssText=["margin: 24px 0","padding: 0 8px"].join(";");var i=document.createElement("h2");i.style.cssText=["font-size: 18px","font-weight: 700","color: #1a1a1a","margin-bottom: 16px","padding-bottom: 8px","border-bottom: 2px solid #4b664a"].join(";"),i.textContent="Perguntas Frequentes",g.appendChild(i);var m=document.createElement("div");m.style.cssText=["display: flex","flex-direction: column","gap: 0"].join(";"),j.forEach(function(v,F){var z=document.createElement("div");z.style.cssText="border-bottom: 1px solid #e8ece8;";var C=document.createElement("button");C.setAttribute("aria-expanded","false"),C.setAttribute("aria-controls","mm-faq-answer-"+F),C.style.cssText=["display: flex","justify-content: space-between","align-items: center","width: 100%","padding: 16px 0","background: none","border: none","cursor: pointer","text-align: left","font-size: 15px","font-weight: 600","color: #1a1a1a","line-height: 1.4","font-family: inherit","-webkit-tap-highlight-color: transparent"].join(";");var u=document.createElement("span");u.textContent=v.q,u.style.cssText="flex: 1; padding-right: 12px;";var U=document.createElement("span");U.textContent="+",U.style.cssText=["font-size: 20px","font-weight: 300","color: #4b664a","flex-shrink: 0","transition: transform 0.2s ease","width: 24px","text-align: center"].join(";"),C.appendChild(u),C.appendChild(U);var Z=document.createElement("div");Z.id="mm-faq-answer-"+F,Z.setAttribute("role","region"),Z.setAttribute("aria-labelledby","mm-faq-q-"+F),C.id="mm-faq-q-"+F,Z.style.cssText=["max-height: 0","overflow: hidden","transition: max-height 0.3s ease, padding 0.3s ease","font-size: 14px","line-height: 1.6","color: #444"].join(";");var N=document.createElement("div");N.style.cssText="padding: 0 0 14px 0;",N.textContent=v.a,Z.appendChild(N),C.addEventListener("click",function(){var H=C.getAttribute("aria-expanded")==="true";H?(Z.style.maxHeight="0px",U.textContent="+",C.setAttribute("aria-expanded","false")):(Z.style.maxHeight=Z.scrollHeight+"px",U.textContent="−",C.setAttribute("aria-expanded","true"))}),C.addEventListener("touchstart",function(){C.style.opacity="0.7"},{passive:!0}),C.addEventListener("touchend",function(){C.style.opacity="1"},{passive:!0}),z.appendChild(C),z.appendChild(Z),m.appendChild(z)}),g.appendChild(m);var d=document.querySelector(".produtos-relacionados"),h=document.querySelector(".container-avaliacoes");if(d&&d.nextSibling?d.parentNode.insertBefore(g,d.nextSibling):h?h.parentNode.insertBefore(g,h):P.parentNode.appendChild(g),!document.getElementById("mm-faq-schema")){var f={"@context":"https://schema.org","@type":"FAQPage",mainEntity:j.map(function(v){return{"@type":"Question",name:v.q,acceptedAnswer:{"@type":"Answer",text:v.a}}})},E=document.createElement("script");E.type="application/ld+json",E.id="mm-faq-schema",E.textContent=JSON.stringify(f),document.head.appendChild(E)}At&&At.parentNode&&At.parentNode.removeChild(At)}})(),(function x(){x._retries=(x._retries||0)+1;var P=document.querySelector("#produto-react-app");if(!P||!P.querySelector("h1")){x._retries<30&&setTimeout(x,500);return}if(!document.querySelector('meta[property="og:title"]')){var j=P.querySelector("h1"),T=j?j.textContent.trim():document.title,g=document.querySelector('meta[name="description"]'),i=g?g.content.trim():"";if(!i){var m=document.querySelector(".descricao-produto .accordion-content p");m&&(i=m.textContent.trim().substring(0,200))}i||(i=T+" - Compre online na Madeira Mania com até 12x sem juros ou 7% de desconto no PIX.");var d=document.querySelector('link[rel="canonical"]'),h=d?d.href:location.href.split("?")[0],f="",E=P.querySelector(".gallery-main img, #block-imagem img");if(E&&(f=E.getAttribute("src")||E.getAttribute("data-src")||""),!f){var v=document.querySelector('meta[property="og:image"]');v&&(f=v.content)}var F=P.querySelector(".form-pag-link"),z=F&&parseFloat(F.getAttribute("data-valor-pix"))||0;if(z>0){var C="R$ "+z.toFixed(2).replace(".",",");i.indexOf("R$")===-1&&(i=i.replace(/\.$/,"")+" | A partir de "+C+" no PIX.")}i.length>200&&(i=i.substring(0,197)+"...");var u=[{property:"og:type",content:"product"},{property:"og:title",content:T},{property:"og:description",content:i},{property:"og:url",content:h},{property:"og:site_name",content:"Madeira Mania"},{property:"og:locale",content:"pt_BR"}];f&&(u.push({property:"og:image",content:f}),u.push({property:"og:image:width",content:"600"}),u.push({property:"og:image:height",content:"600"})),u.push({name:"twitter:card",content:"summary_large_image"}),u.push({name:"twitter:title",content:T}),u.push({name:"twitter:description",content:i}),f&&u.push({name:"twitter:image",content:f}),u.forEach(function(U){var Z=document.createElement("meta");U.property&&Z.setAttribute("property",U.property),U.name&&Z.setAttribute("name",U.name),Z.setAttribute("content",U.content),document.head.appendChild(Z)})}})(),(function(x){"use strict";if(!document.getElementById("produto-react-app")&&!document.getElementById("pagina-produto-react-app"))return;const P="3.0.0";window.innerWidth>=1500&&x(document).ready(function(){function g(){x(".gallery-main .swiper-slide img").each(function(){var i=this,m=x(this).closest(".swiper-slide"),d=m.closest(".swiper");function h(){var f=i.naturalWidth,E=i.naturalHeight;f&&E&&f===E&&d.css({"max-width":f+"px",overflow:"hidden"})}i.complete?h():i.addEventListener("load",h)})}g()}),window._variacoesMagazordCarregado&&(console.log(`%c⚠️ Variações Magazord v${P} - Substituindo instância anterior`,"color: #ff9800; font-weight: bold"),window.GerenciadorVariacoesPillsMagazord&&x(".product-variations-pills-container").remove()),window._variacoesMagazordCarregado=P,console.log(`%c🚀 Variações Magazord v${P} (dataProduct) - Inicializando...`,"color: #2196f3; font-weight: bold");const j={formatoNome:{separador:" - ",separadorTipoValor:": ",exibirNomeCompleto:!1,primeiraParte:"nome_base"},labels:{ALTURA:"Altura",LARGURA:"Largura",ILUMINACAO:"Iluminação",ILUMINAÇÃO:"Iluminação",PROFUNDIDADE:"Profundidade",COR:"Cor",ACABAMENTO:"Acabamento",TAMANHO:"Tamanho",PORTAS:"Número de Portas",ESPELHO:"Espelho",GAVETAS:"Gavetas",MODELO:"Modelo",MATERIAL:"Material",LUGARES:"Lugares",FORMATO:"Formato"},variacoesComImagem:["COR","ACABAMENTO"],ignorarPalavras:[],selectors:{areaProdutosSugeridos:".sugestoes-cores",areaVariacoes:".derivacoes-produto .area-derivacoes",containerProduto:".info-produto, .box-info-produto, main",subtituloProduto:".informacoes-compra-produto .text-secondary-700.text-xs"},retry:{maxTentativas:10,intervaloMs:500,usarMutationObserver:!0},debug:!0,performance:{useRequestAnimationFrame:!0,debounceDelay:150}};class T{constructor(){this.variacoes={},this.produtoAtualId=null,this.produtos=[],this.tentativasDeCarregamento=0,this.observer=null,this.inicializado=!1}init(){this.log("🎯 Gerenciador de Variações Magazord v3 (dataProduct)","info"),this.log("🎨 Swatches de imagem para cores + Pills para outras variações","info"),this.esperarDOMPronto()}esperarDOMPronto(){if(typeof jQuery>"u"){setTimeout(()=>this.esperarDOMPronto(),100);return}x(document).ready(()=>{this.log("✅ DOM pronto! Aguardando dataProduct...","success"),this.esperarDataProduct()})}esperarDataProduct(){typeof dataProduct<"u"&&dataProduct.listaProdutosSugeridos?(this.log("✅ dataProduct encontrado!","success"),this.tentarCarregar()):(this.log("⏳ Aguardando dataProduct...","info"),setTimeout(()=>this.esperarDataProduct(),300))}tentarCarregar(){this.tentativasDeCarregamento++,this.log(`
...
🎉 Inicialização concluída com sucesso!`,"success"),j.retry.usarMutationObserver&&this.observarMudancasDOM()):this.tentativasDeCarregamento<j.retry.maxTentativas?setTimeout(()=>this.tentarCarregar(),j.retry.intervaloMs):this.log("❌ Número máximo de tentativas atingido.","error")}observarMudancasDOM(){this.log("ℹ️ MutationObserver desativado - dados carregados via dataProduct","info")}log(i,m="log",d=null){if(!j.debug)return;const h={info:"color: #2196f3; font-weight: bold",success:"color: #4caf50; font-weight: bold",warning:"color: #ff9800; font-weight: bold",error:"color: #f44336; font-weight: bold",log:"color: #666"};console.log(`%c${i}`,h[m]||h.log),d&&console.log(d)}carregarProdutos(){if(this.produtos=[],typeof dataProduct>"u"||!dataProduct.listaProdutosSugeridos)return this.log("❌ dataProduct ou listaProdutosSugeridos não encontrado","error"),!1;const i=dataProduct.listaProdutosSugeridos,m=dataProduct.produto,d=dataProduct.hostImagem||"";if(this.log(`📦 Encontrados ${i.length} produtos sugeridos + produto atual`,"info"),m&&m.complemento){const h=m.midia_path&&m.midia_arquivo_nome?`${d}/${m.midia_path}${m.midia_arquivo_nome}`:"",f={id:m.derivacao_id||m.produto_id,nomeCompleto:m.complemento.trim(),estoque:m.qtde_estoque,url:m.link?`/${m.link}`:"",imagem:h,imagemData:h,elemento:null,variacoes:{},nomeBase:"",nomeExibicao:"",isAtual:!0};this.produtoAtualId=f.id,this.extrairVariacoesDoNome(f),this.produtos.push(f),this.log(`   ✓ Produto atual: "${f.nomeCompleto}"`,"success")}return i.forEach((h,f)=>{const E=h.complemento||h.nome||"";if(!E)return;const v=h.derivacao_id||h.produto_id;if(v===this.produtoAtualId){this.log(`   ⏭️ Ignorando duplicata: "${E}"`,"info");return}const F=h.midia_path&&h.midia_arquivo_nome?`${d}/${h.midia_path}${h.midia_arquivo_nome}`:"",z={id:v||f,nomeCompleto:E.trim(),estoque:h.qtde_estoque,url:h.link?`/${h.link}`:"",imagem:F,imagemData:F,elemento:null,variacoes:{},nomeBase:"",nomeExibicao:"",isAtual:!1};this.extrairVariacoesDoNome(z),this.produtos.push(z),this.log(`   ✓ Sugerido: "${z.nomeCompleto}"`,"log")}),this.produtos.length===0?!1:(this.log("✅ Produtos carregados e processados:","success",this.produtos),!0)}normalizarSeparadores(i){const m=["–","—","−","‐","‑","⁃"];let d=i;return m.forEach(h=>{const f=new RegExp(`\\s${h}\\s`,"g");d=d.replace(f," - ")}),d}extrairVariacoesDoNome(i){const d=this.normalizarSeparadores(i.nomeCompleto).split(j.formatoNome.separador);this.log(`
📝 Processando: "${i.nomeCompleto}"`,"log"),j.formatoNome.primeiraParte==="nome_base"&&(i.nomeBase=d[0].trim(),d.shift()),d.forEach(h=>{const f=h.trim();if(f&&f.includes(j.formatoNome.separadorTipoValor)){const[E,...v]=f.split(j.formatoNome.separadorTipoValor),F=v.join(j.formatoNome.separadorTipoValor).trim(),z=this.normalizarTipo(E.trim());if(j.ignorarPalavras.includes(z))return;i.variacoes[z]=F,this.log(`   ✓ ${z}: ${F}`,"success")}}),i.nomeExibicao=j.formatoNome.exibirNomeCompleto?i.nomeCompleto:i.nomeBase||i.nomeCompleto,Object.keys(i.variacoes).length===0&&(i.variacoes.MODELO=i.nomeCompleto,i.nomeExibicao=i.nomeCompleto)}normalizarTipo(i){return i.toUpperCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").trim()}processarVariacoes(){this.log(`
🔄 Processando variações...`,"info");const i=new Set;this.produtos.forEach(m=>{Object.keys(m.variacoes).forEach(d=>i.add(d))}),i.forEach(m=>{const d=new Set,h={};this.produtos.forEach(E=>{const v=E.variacoes[m];v&&(d.add(v),h[v]||(h[v]=[]),h[v].push(E))});const f=Array.from(d).sort();this.variacoes[m]={label:j.labels[m]||m,valores:f,produtosPorValor:h,usarImagem:j.variacoesComImagem.includes(m)},this.log(`   📊 ${m}: ${f.length} valor(es) único(s) → [${f.join(", ")}]`,f.length>1?"success":"warning")}),this.log("✅ Variações processadas:","success",this.variacoes)}renderizarVariacoes(){this.log(`
🎨 Renderizando variações...`,"info");let i=x(j.selectors.areaVariacoes);if(i.length===0&&(this.criarAreaVariacoes(),i=x(j.selectors.areaVariacoes)),Object.keys(this.variacoes).length===0)return;const m=x("<div>",{class:"product-variations-pills-container"});let d=0;if(Object.keys(this.variacoes).forEach(h=>{const f=this.variacoes[h];if(f.valores.length<=1){this.log(`⏭️ Ignorando "${h}" - apenas ${f.valores.length} valor(es)`,"info");return}if(f.usarImagem){const E=this.criarGrupoSwatches(h,f);m.append(E),d++}}),Object.keys(this.variacoes).forEach(h=>{const f=this.variacoes[h];if(!(f.valores.length<=1)&&!f.usarImagem){const E=this.criarGrupoPills(h,f);m.append(E),d++}}),d===0){this.log("ℹ️ Nenhuma variação com múltiplas opções - ocultando área","info"),i.closest(".derivacoes-produto").hide(),x(j.selectors.subtituloProduto).hide();return}j.performance.useRequestAnimationFrame&&window.requestAnimationFrame?requestAnimationFrame(()=>{i.empty().append(m),this.log(`✅ ${d} variação(ões) renderizada(s)!`,"success"),this.atualizarNomeProduto()}):(i.empty().append(m),this.log(`✅ ${d} variação(ões) renderizada(s)!`,"success"),this.atualizarNomeProduto())}criarAreaVariacoes(){const i=x(j.selectors.areaProdutosSugeridos);i.length>0?i.before('<div class="derivacoes-produto"><div class="area-derivacoes"></div></div>'):x("body").prepend('<div class="derivacoes-produto"><div class="area-derivacoes"></div></div>')}criarGrupoSwatches(i,m){const d=this.obterValorAtualParaTipo(i),h=x("<div>",{class:"variation-pill-group variation-pill-group--swatches","data-variacao-tipo":i,role:"group","aria-labelledby":`pill-label-${i.toLowerCase()}`}),f=x("<div>",{class:"variation-pill-label",id:`pill-label-${i.toLowerCase()}`});f.append(x("<span>").text(m.label+":")),f.append(x("<span>",{class:"variation-pill-label-value","data-label-value":i}).text(d||""));const E=x("<div>",{class:"variation-swatches-container",role:"radiogroup","aria-labelledby":`pill-label-${i.toLowerCase()}`});return m.valores.forEach((v,F)=>{const z=m.produtosPorValor[v],C=z.some(pn=>pn.estoque===void 0||pn.estoque>0),u=v===d,U=`pill-${i.toLowerCase()}-${this.sanitizeId(v)}`,Z=this.encontrarMelhorProdutoParaSwatch(i,v,z);let N=null;Z&&(N=Z.imagemData||Z.imagem);const H=x("<input>",{type:"radio",class:"variation-pill-input",id:U,name:`variation-${i}`,value:v,"data-variacao-tipo":i,"data-produtos":JSON.stringify(z.map(pn=>({id:pn.id,url:pn.url}))),checked:u,disabled:!C,"aria-label":`${m.label}: ${v}${C?"":" (Indisponível)"}`}),D=x("<label>",{class:"variation-color-swatch-wrapper",for:U,"data-tooltip":v}),M=x("<div>",{class:"variation-color-swatch","data-valor":v,tabindex:u?0:-1});N?M.append(x("<img>",{src:N,alt:v,class:"variation-color-swatch-image",loading:"lazy"})):M.css({"background-color":"#E5E7EB",display:"flex","align-items":"center","justify-content":"center","font-size":"14px",color:"#6B7280"}).text(v.charAt(0).toUpperCase());const tn=x("<span>",{class:"variation-color-swatch-name",text:v,title:v});D.append(M).append(tn),E.append(H).append(D)}),h.append(f).append(E),h}criarGrupoPills(i,m){const d=this.obterValorAtualParaTipo(i),h=x("<div>",{class:"variation-pill-group variation-pill-group--pills","data-variacao-tipo":i,role:"group","aria-labelledby":`pill-label-${i.toLowerCase()}`}),f=x("<div>",{class:"variation-pill-label",id:`pill-label-${i.toLowerCase()}`});f.append(x("<span>").text(m.label+":")),f.append(x("<span>",{class:"variation-pill-label-value","data-label-value":i}).text(d||""));const E=x("<div>",{class:"variation-pills-container",role:"radiogroup","aria-labelledby":`pill-label-${i.toLowerCase()}`});return m.valores.forEach((v,F)=>{const z=m.produtosPorValor[v],C=z.some(D=>D.estoque===void 0||D.estoque>0),u=v===d,U=`pill-${i.toLowerCase()}-${this.sanitizeId(v)}`,Z=x("<input>",{type:"radio",class:"variation-pill-input",id:U,name:`variation-${i}`,value:v,"data-variacao-tipo":i,"data-produtos":JSON.stringify(z.map(D=>({id:D.id,url:D.url}))),checked:u,disabled:!C,"aria-label":`${m.label}: ${v}${C?"":" (Indisponível)"}`});let N=v;C||(N+=' <span class="variation-pill-badge">Indisponível</span>');const H=x("<label>",{class:"variation-pill",for:U,html:N,"data-valor":v,tabindex:u?0:-1});E.append(Z).append(H)}),h.append(f).append(E),h}sanitizeId(i){return i.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}encontrarMelhorProdutoParaSwatch(i,m,d){const h=this.produtos.find(F=>F.isAtual||F.id===this.produtoAtualId);if(!h||d.length===0)return d[0]||null;if(d.length===1)return d[0];const f=h.variacoes;let E=null,v=-1;return d.forEach(F=>{let z=0;Object.keys(f).forEach(C=>{C!==i&&F.variacoes[C]===f[C]&&z++}),(F.imagemData||F.imagem)&&(z+=.5),z>v&&(v=z,E=F)}),this.log(`   🎯 Melhor produto para ${i}="${m}": score=${v}`,"log"),E||d[0]}obterValorAtualParaTipo(i){const m=this.produtos.find(d=>d.isAtual||d.id===this.produtoAtualId);return m?m.variacoes[i]:null}atualizarNomeProduto(){const i=this.produtos.find(d=>d.isAtual||d.id===this.produtoAtualId);if(!i)return;["h1.nome-produto",".product-name h1",".info-produto h1",'h1[itemprop="name"]',".box-info-produto h1"].forEach(d=>{const h=x(d);h.length>0&&h.text(i.nomeExibicao)})}bindEventos(){this.log(`
🔗 Vinculando eventos...`,"info"),x(document).on("change",".variation-pill-input",i=>{this.aoMudarVariacao(i)}),x(document).on("keydown",".variation-pills-container, .variation-swatches-container",i=>{this.handleKeyboardNavigation(i)}),x(document).on("click",".variation-pill, .variation-color-swatch-wrapper",function(){const i=x(this).is("label")?x("#"+x(this).attr("for")):x(this).closest("label").prev(".variation-pill-input");i.length&&!i.prop("disabled")&&x(this).closest(".variation-pill-group").addClass("is-loading")}),this.log("✅ Eventos vinculados","success")}handleKeyboardNavigation(i){const d=x(i.currentTarget).find(".variation-pill-input:not(:disabled)"),h=x(document.activeElement);if(!h.hasClass("variation-pill-input"))return;const f=d.index(h);let E=f;switch(i.key){case"ArrowRight":case"ArrowDown":i.preventDefault(),E=(f+1)%d.length;break;case"ArrowLeft":case"ArrowUp":i.preventDefault(),E=f-1<0?d.length-1:f-1;break;case"Home":i.preventDefault(),E=0;break;case"End":i.preventDefault(),E=d.length-1;break;default:return}d.eq(E).focus().prop("checked",!0).trigger("change")}aoMudarVariacao(i){const m=x(i.target),d=m.data("variacao-tipo"),h=m.val();this.log(`
🔄 Variação selecionada: ${d} = ${h}`,"info"),x(`.variation-pill-label-value[data-label-value="${d}"]`).text(h);const f={};x(".variation-pill-input:checked").each(function(){const v=x(this).data("variacao-tipo"),F=x(this).val();F&&(f[v]=F)}),this.log("📋 Seleção atual:","info",f);const E=this.encontrarProdutoPorVariacoes(f);if(E)this.log("✅ Produto encontrado!","success",E),this.navegarParaProduto(E);else{this.log("⚠️ Produto exato não encontrado, buscando melhor correspondência...","warning");const v=this.encontrarMelhorCorrespondencia(f);v?(this.log("✅ Melhor correspondência encontrada!","success",v),this.navegarParaProduto(v)):(this.log("❌ Nenhum produto correspondente encontrado","error"),x(".variation-pill-group").removeClass("is-loading"))}}encontrarProdutoPorVariacoes(i){return this.produtos.find(m=>Object.keys(i).every(d=>m.variacoes[d]===i[d]))}encontrarMelhorCorrespondencia(i){let m=null,d=0;return this.produtos.forEach(h=>{let f=0;Object.keys(i).forEach(E=>{h.variacoes[E]===i[E]&&f++}),f>d&&(d=f,m=h)}),d>0?m:null}navegarParaProduto(i){this.log(`
🚀 Navegando para: ${i.url}`,"info"),i.url?window.location.href=i.url:(this.log("❌ URL não encontrada para navegação","error"),x(".variation-pill-group").removeClass("is-loading"))}}setTimeout(function(){x(".product-variations-pills-container").remove(),x(".derivacoes-produto").remove();const g=new T;g.init(),window.GerenciadorVariacoesPillsMagazord=g},100)})(typeof jQuery<"u"?jQuery:window.jQuery||window.$),(function(){"use strict";function x(){if(!(typeof jQuery>"u"&&typeof $>"u")){var a=typeof jQuery<"u"?jQuery:$;a(document).ajaxComplete(function(l,p,y){y.url&&y.url.indexOf("checkout/cart")!==-1&&setTimeout(function(){window.dispatchEvent(new CustomEvent("reactItemAddedToCart"))},100)})}}function P(){var a=document.querySelector("#cart-preview-area .border-t.border-solid");if(!(!a||a.querySelector(".installment-total"))){var l=0,p=document.querySelectorAll("#cart-preview-area .cart-item");if(p.forEach(function(B){var _=parseFloat(B.getAttribute("data-item-price"))||0,Y=parseInt(B.getAttribute("data-item-quantity"))||1;l+=_*Y}),!(l<=0)){var y=(l/12).toFixed(2).replace(".",","),q=document.createElement("div");q.className="installment-total",q.textContent="ou 12x de R$ "+y;var S=a.querySelector(".valor-pix");S&&S.parentNode&&S.parentNode.insertBefore(q,S.nextSibling)}}}var j='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" aria-hidden="true"><path d="M5 12h14"/></svg>',T='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" aria-hidden="true"><path d="M12 5v14M5 12h14"/></svg>',g='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6M14 11v6"/><path d="M9 6V4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2"/></svg>';function i(){P();var a=document.querySelectorAll("#cart-preview-area .cart-item, .content-cart .cart-item");a.forEach(function(l){if(!l.querySelector(".qty-btn-minus")){var p=l.querySelector(".qtd-value");if(p){var y=l.querySelector(".cart-remove-item"),q=y?y.getAttribute("data-id"):null;if(q){var S=l.querySelector(".prod-remove");S&&!p.contains(y)&&(p.appendChild(y),S.style.display="none");var B=p.parentElement,_=null;if(B)for(var Y=0;Y<B.children.length;Y++){var V=B.children[Y];if(V!==p&&V.classList&&V.classList.contains("valor")){_=V;break}}_&&!p.contains(_)&&p.appendChild(_);var en=parseInt(l.getAttribute("data-item-quantity"));if(!en||isNaN(en)){var J=p.textContent.match(/(\d+)/);en=J?parseInt(J[1]):1}var mn=document.createElement("button");mn.className="qty-btn-minus",mn.type="button",mn.setAttribute("aria-label","Diminuir quantidade"),mn.innerHTML=j,mn.addEventListener("click",function(e){e.preventDefault(),e.stopPropagation();var r=parseInt(o.textContent)||1;if(r<=1){var s=l.querySelector(".cart-remove-item");s&&s.click();return}xt(l,q,-1,o,mn,n)});var o=document.createElement("span");o.className="qty-display",o.textContent=en;var n=document.createElement("button");n.className="qty-btn-plus",n.type="button",n.setAttribute("aria-label","Aumentar quantidade"),n.innerHTML=T,n.addEventListener("click",function(e){e.preventDefault(),e.stopPropagation(),xt(l,q,1,o,mn,n)});var t=document.createElement("div");t.className="mm-qty-wrap",t.appendChild(mn),t.appendChild(o),t.appendChild(n),p.insertBefore(t,p.firstChild),y&&(y.innerHTML=g,y.setAttribute("aria-label","Remover produto"))}}}})}function m(){document.addEventListener("click",function(a){var l=a.target.closest(".cart-remove-item");if(!(!l||!l.closest("#cart-preview-area"))){a.preventDefault(),a.stopPropagation(),a.stopImmediatePropagation();var p=l.getAttribute("data-id");if(p){var y=l.closest(".cart-item"),q=y&&y.querySelector(".prod-nome")?.textContent?.trim()||"este produto",S=q.length>50?q.substring(0,50)+"…":q,B=document.getElementById("mm-confirm-overlay");B&&B.remove();var _=document.createElement("div");_.id="mm-confirm-overlay",_.className="mm-confirm-overlay",_.innerHTML='<div class="mm-confirm-card"><p class="mm-confirm-title">Remover produto?</p><p class="mm-confirm-desc">'+S.replace(/&/g,"&amp;").replace(/</g,"&lt;")+'</p><div class="mm-confirm-actions"><button class="mm-confirm-btn mm-confirm-btn-cancel">Manter</button><button class="mm-confirm-btn mm-confirm-btn-delete">Remover</button></div></div>',document.body.appendChild(_),_.querySelector(".mm-confirm-btn-cancel").addEventListener("click",function(){_.remove()}),_.querySelector(".mm-confirm-btn-delete").addEventListener("click",function(){_.remove(),window.__mmDeleteItem&&y?window.__mmDeleteItem(y,p):typeof Zord<"u"&&Zord.checkout&&Zord.checkout.deleteItem(parseInt(p))}),_.addEventListener("click",function(Y){Y.target===_&&_.remove()})}}},!0)}function d(){document.addEventListener("click",function(a){var l=a.target.closest(".finalizar-compra");l&&l.closest("#cart-preview-area")&&(a.preventDefault(),a.stopPropagation(),window.location.href="/checkout/identify")},!0)}function h(a,l){var p="cep=&cupom-desconto=&nenhumCreditoSelecionado=true&id="+encodeURIComponent(String(l))+"&area=main-cart";return fetch("/checkout/cart?operation="+encodeURIComponent(a),{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/x-www-form-urlencoded",Accept:"text/html,application/json,*/*","X-Requested-With":"XMLHttpRequest"},body:p}).then(function(y){if(!y.ok)throw new Error("HTTP "+y.status);return y.text()})}var f=1500,E=2e3,v="mm_cep",F="mm_cart_snapshot",z=1800*1e3;function C(){try{var a=localStorage.getItem(v)||"",l=a.replace(/\D/g,"");if(l.length===8)return l}catch{}return null}function u(a){return!a||a.length!==8?"":a.slice(0,5)+"-"+a.slice(5)}function U(a){if(!a||a.length!==8)return E;var l=parseInt(a.slice(0,2),10);return isNaN(l)?E:l>=1&&l<=39||l>=80&&l<=99?f:E}function Z(){try{var a=localStorage.getItem(F);if(!a)return null;var l=JSON.parse(a);return!l||!l.ts||Date.now()-l.ts>z?null:l}catch{return null}}function N(a){var l=[];return a.forEach(function(p){var y=(p.querySelector(".prod-nome a, .prod-nome")||{}).textContent||"",q=p.querySelector(".qty-display"),S=q?parseInt(q.textContent):parseInt(p.getAttribute("data-item-quantity"))||1;l.push(y.trim().slice(0,30)+"x"+S)}),l.sort().join("|")}function H(a){if(!a||!Array.isArray(a.items))return"";var l=a.items.map(function(p){return(p.name||"").trim().slice(0,30)+"x"+(p.quantity||1)});return l.sort().join("|")}var D='<svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><polyline points="20 6 9 17 4 12"/></svg>',M='<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M18 6 6 18M6 6l12 12"/></svg>',tn=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"];function pn(a){if(!a)return null;var l=String(a).match(/\d+/g);return!l||!l.length?null:Math.max.apply(null,l.map(Number))}function dn(a,l){for(var p=new Date(a.getTime()),y=0;y<l;){p.setDate(p.getDate()+1);var q=p.getDay();q!==0&&q!==6&&y++}return p}function gn(a){var l=new Date,p="dia "+a.getDate()+" de "+tn[a.getMonth()];return a.getFullYear()!==l.getFullYear()&&(p+=" de "+a.getFullYear()),p}function Pn(a){var l=pn(a);if(!l||l<1)return null;var p=dn(new Date,l);return"Receba até "+gn(p)}var xn={},Xn=4e3,Bn={};function un(a,l){if(!a||a.length!==8)return Promise.resolve(null);if(xn[a])return xn[a];if(!l){var p=Bn[a]||0;if(Date.now()-p<Xn)return Promise.resolve(null)}var y="cep="+encodeURIComponent(a.slice(0,5)+"-"+a.slice(5))+"&cupom-desconto=&nenhumCreditoSelecionado=true&area=main-cart",q=fetch("/checkout/cart?operation=atualizaValoresCarrinho",{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/x-www-form-urlencoded",Accept:"text/html,application/json,*/*","X-Requested-With":"XMLHttpRequest"},body:y}).then(function(S){if(!S.ok)throw new Error("HTTP "+S.status);return S.text()}).then(function(S){return Bn[a]=Date.now(),Dn(S)}).catch(function(){return null}).then(function(S){return delete xn[a],S});return xn[a]=q,q}function Dn(a){try{var l=new DOMParser().parseFromString(a,"text/html"),p=l.querySelector("#resumo-compra .frete-calculado")||l.querySelector(".frete-calculado");if(!p)return null;var y="",q=p.querySelector(".frete-location .city");q&&(y=q.textContent.trim());var S=null,B="",_="",Y=p.querySelector(".info-frete-selec");if(Y){var V=Y.querySelector(".dias-entrega"),en=Y.querySelector(".info-title span, .info-title");V&&(B=(V.textContent||"").trim()),en&&(_=(en.textContent||"").trim())}var J=p.querySelector(".line.valor-frete .value, .value.valor-frete")||p.querySelector(".valor-compra-frete .value");if(J){var mn=(J.textContent||"").trim();if(/gr[áa]tis/i.test(mn))S=0;else{var o=mn.match(/[\d.,]+/);if(o){var n=parseFloat(o[0].replace(/\./g,"").replace(",","."));isNaN(n)||(S=n)}}}if(S==null){var t=p.querySelector(".servico-frete");if(t){var e=parseFloat(t.getAttribute("data-valor-frete")||"0");if(isNaN(e)||(S=e),_||(_=t.getAttribute("data-servico-frete")||""),!B){var r=t.querySelector(".dias-entrega");r&&(B=(r.textContent||"").trim())}}}if(S==null)return null;var s=null,c=l.querySelector(".total-boleto .value, .totais-valor.total-boleto .value");if(c){var b=(c.textContent||"").trim(),A=b.match(/[\d.,]+/);if(A){var O=parseFloat(A[0].replace(/\./g,"").replace(",","."));isNaN(O)||(s=O)}}return{city:y,shipping:S,shippingDeadline:B,shippingName:_,totalPix:s}}catch{return null}}function Fn(a,l,p){if(!(!a||!p)){En(a);try{let Y=function(V){for(var en=0;en<q.length;en++)if(q[en]&&q[en].name===V)return q[en];return null};var y=Z()||{};y.ts=Date.now(),y.cepValue=l.slice(0,5)+"-"+l.slice(5),y.shipping=p.shipping,y.shippingDeadline=p.shippingDeadline,y.shippingName=p.shippingName,y.shippingCity=p.city,p.totalPix!=null&&(y.subtotalPix=p.totalPix);var q=y.items&&y.items.length?y.items:[],S=a.querySelectorAll(".cart-item:not(.mm-removing)");y.items=Array.prototype.map.call(S,function(V){var en=V.querySelector(".prod-nome a, .prod-nome"),J=(en&&en.textContent||"").trim(),mn=V.querySelector(".qty-display"),o=mn?parseInt(mn.textContent):parseInt(V.getAttribute("data-item-quantity"))||1,n=Y(J);return n&&n.quantity===o&&(n.lineTotalPix>0||n.lineTotal>0||n.imgSrc)?n:{name:J,quantity:o}}),localStorage.setItem(F,JSON.stringify(y))}catch{}var B=a.querySelectorAll(".cart-item:not(.mm-removing)"),_=0;B.forEach(function(Y){var V=Y.querySelector(".valor");if(V){var en=qn(V.textContent);isNaN(en)||(_+=en)}}),a.querySelector(".box-total-btn")?jn(a):Un(a)}}function Tn(a){var l=C();if(l){var p=Z(),y=H(p),q=N(a.querySelectorAll(".cart-item:not(.mm-removing)")),S=p&&p.cepValue&&p.cepValue.replace(/\D/g,"")===l,B=p&&p.shipping!=null&&!isNaN(p.shipping);p&&y===q&&S&&B||un(l).then(function(_){_&&Fn(a,l,_)})}}function wn(a){return String(a||"").replace(/[&<>"']/g,function(l){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[l]})}function Ln(a){if(!a)return null;var l=a.querySelector(".box-total-btn");if(l)return{host:l,before:l.querySelector(".total")};var p=a.querySelector(".area-finalizar-compra");if(p)return{host:p,before:p.firstElementChild};var y=a.querySelector(".finalizar-compra");if(y&&y.parentElement){var q=y.parentElement;return{host:q,before:q.firstElementChild}}return null}function Qn(a){if(!a)return null;var l=a.closest(".carrinho-rapido-ctn");return l||(a.closest("#cart-preview-area")?bt():null)}function Cn(a,l,p,y){if(a){var q=Ln(a);if(q){var S=q.host;a.classList.add("mm-ship-scope");var B=C(),_=Z(),Y=N(a.querySelectorAll(".cart-item:not(.mm-removing)")),V=H(_),en=_&&V===Y,J=U(B),mn=l>=J,o=Math.max(0,J-l),n=Math.max(0,Math.min(100,l/J*100)),t=S.querySelector(".mm-cart-ship");if(!t){t=document.createElement("div"),t.className="mm-cart-ship",t.setAttribute("role","group"),t.setAttribute("aria-label","Informações de frete");var e=q.before;e&&e.parentNode===S?S.insertBefore(t,e):S.insertBefore(t,S.firstChild)}if(t.classList.toggle("is-free",mn),Rn(t),t.dataset.mmEditing!=="1"){var r=_&&_.cepValue&&_.cepValue.replace(/\D/g,"")===B,s=B&&en&&r&&_.shippingCity,c=s?Pn(_.shippingDeadline):null,b="";if(b+='<div class="mm-cart-ship-location">',B){var A=u(B);if(s&&(A+=" · "+wn(_.shippingCity)),b+='<span class="mm-cart-ship-label">Envio para</span><div class="mm-cart-ship-location-value"><span>'+A+'</span><button class="mm-cart-ship-edit" type="button" data-mm-ship="edit">Trocar</button></div>',c){var O=wn(c);y&&p>0?O+=" · <strong>"+wn(kn(p))+"</strong>":y&&p===0&&(O+=" · <strong>Grátis</strong>"),b+='<span class="mm-cart-ship-deadline">'+O+"</span>"}}else b+='<span class="mm-cart-ship-label">Calcule o frete</span><div class="mm-cart-ship-location-value"><span style="color:#9CA3AF;font-weight:500;">Informe seu CEP</span><button class="mm-cart-ship-edit" type="button" data-mm-ship="edit">Calcular</button></div>';b+="</div>";var L=mn?"Frete grátis desbloqueado":"Faltam "+kn(o)+" para frete grátis",R=parseFloat(a.dataset.mmShipPct||"0")||0;b+='<div class="mm-cart-ship-progress">',b+='<div class="mm-cart-ship-bar" role="progressbar" aria-valuenow="'+Math.round(l)+'" aria-valuemin="0" aria-valuemax="'+Math.round(J)+'" aria-valuetext="'+wn(L)+'" aria-label="Progresso para frete grátis"><div class="mm-cart-ship-bar-fill" style="width:'+R.toFixed(1)+'%"></div></div>',b+='<p class="mm-cart-ship-nudge'+(mn?" is-free":"")+'">',mn?b+=D+"Frete grátis garantido":b+="Faltam <strong>"+wn(kn(o))+"</strong> para frete grátis",b+="</p>",b+="</div>",t.innerHTML=b;var I=t.querySelector(".mm-cart-ship-bar-fill");I&&requestAnimationFrame(function(){I.style.width=n.toFixed(1)+"%"});var W=a.dataset.mmShipWasFree==="1";mn&&!W&&R>0&&(t.classList.remove("mm-just-unlocked"),t.offsetWidth,t.classList.add("mm-just-unlocked"),setTimeout(function(){t.classList.remove("mm-just-unlocked")},1400)),a.dataset.mmShipWasFree=mn?"1":"",a.dataset.mmShipPct=n.toFixed(1)}}}}var Zn='<svg class="mm-cart-ship-spinner" width="14" height="14" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"><style>.mm-sp{animation:mm-spin 1.2s linear infinite;transform-origin:center}.mm-sp circle{stroke:#4B664A;stroke-width:3;fill:none;stroke-linecap:round;stroke-dasharray:44;stroke-dashoffset:16;animation:mm-sp-dash 1.2s ease-in-out infinite}@keyframes mm-spin{to{transform:rotate(360deg)}}@keyframes mm-sp-dash{0%{stroke-dashoffset:44}50%{stroke-dashoffset:8}100%{stroke-dashoffset:44}}</style><g class="mm-sp"><circle cx="12" cy="12" r="9.5"/></g></svg>';function fn(a){if(a){var l=a.querySelector(".mm-cart-ship-deadline");if(l)l.innerHTML="Recalculando frete "+Zn;else{var p=a.querySelector(".mm-cart-ship-location");if(p){var y=document.createElement("span");y.className="mm-cart-ship-deadline",y.innerHTML="Recalculando frete "+Zn,p.appendChild(y)}}var q=Ln(a);q&&q.host.classList.add("mm-ship-loading")}}function En(a){if(a){var l=Ln(a);l&&l.host.classList.remove("mm-ship-loading")}}function Rn(a){!a||a.dataset.mmShipBound||(a.dataset.mmShipBound="1",a.addEventListener("click",function(l){var p=l.target.closest('[data-mm-ship="edit"]');if(p){l.preventDefault(),l.stopPropagation(),On(a);return}var y=l.target.closest('[data-mm-ship="cancel"]');if(y){l.preventDefault(),l.stopPropagation(),Yn(a);return}l.target.closest(".mm-cart-ship-cep-form")&&l.stopPropagation()},!0))}function On(a){var l=a.querySelector(".mm-cart-ship-location");if(l){a.dataset.mmEditing="1";var p=C()||"";l.innerHTML='<span class="mm-cart-ship-label">Digite seu CEP</span><form class="mm-cart-ship-cep-form" data-mm-ship-form="1" novalidate><input class="mm-cart-ship-cep-input" type="text" inputmode="numeric" autocomplete="postal-code" placeholder="00000-000" maxlength="9" value="'+wn(u(p))+'" aria-label="CEP" /><button class="mm-cart-ship-cep-save" type="submit">OK</button><button class="mm-cart-ship-cep-cancel" type="button" data-mm-ship="cancel" aria-label="Cancelar">'+M+"</button></form>";var y=l.querySelector(".mm-cart-ship-cep-input"),q=l.querySelector("form");y&&(setTimeout(function(){try{y.focus(),y.select()}catch{}},10),y.addEventListener("input",function(){y.classList.remove("is-invalid");var S=y.value.replace(/\D/g,"").slice(0,8);y.value=S.length>5?S.slice(0,5)+"-"+S.slice(5):S}),y.addEventListener("keydown",function(S){S.key==="Escape"&&(S.preventDefault(),Yn(a))})),q&&q.addEventListener("submit",function(S){S.preventDefault(),S.stopPropagation(),dt(a)})}}function Yn(a){a.dataset.mmEditing="";var l=Qn(a);if(l){var p=l.querySelectorAll(".cart-item:not(.mm-removing)"),y=0;p.forEach(function(q){var S=q.querySelector(".valor");if(S){var B=qn(S.textContent);isNaN(B)||(y+=B)}}),Cn(l,y)}}function dt(a){var l=a.querySelector(".mm-cart-ship-cep-input");if(l){var p=l.value.replace(/\D/g,"");if(p.length!==8){l.classList.add("is-invalid"),l.focus();return}try{localStorage.setItem(v,p)}catch{}var y=a.querySelector(".mm-cart-ship-cep-save");y&&(y.disabled=!0,y.textContent="...");var q=Qn(a);try{var S=Z();S&&(S.cepValue="",localStorage.setItem(F,JSON.stringify(S)))}catch{}Yn(a),un(p).then(function(B){B&&q&&Fn(q,p,B)})}}function qn(a){if(!a)return NaN;var l=String(a).replace(/\s/g,"").match(/([\d.,]+)/);return l?parseFloat(l[1].replace(/\./g,"").replace(",",".")):NaN}function kn(a){return isNaN(a)?"":"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2})}function hn(a){if(isNaN(a))return"";var l=a.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2}),p=l.split(",");return"R$&nbsp;"+p[0]+'<span class="mm-cents">,'+(p[1]||"00")+"</span>"}function nt(a){var l=0;return Array.prototype.forEach.call(a,function(p){var y=parseFloat(p.getAttribute("data-item-price"))||0,q=parseInt(p.getAttribute("data-item-quantity"));if(!q||isNaN(q)){var S=p.querySelector(".qty-display");S?q=parseInt(S.textContent)||1:q=1}l+=y*q}),l}function mt(a){var l=a.querySelectorAll(".cart-item:not(.mm-removing)");l.forEach(function(p){var y=parseFloat(p.getAttribute("data-item-price"))||0,q=parseInt(p.getAttribute("data-item-quantity"));if(!q||isNaN(q)){var S=p.querySelector(".qty-display");S?q=parseInt(S.textContent)||1:q=1}var B=p.querySelector(".valor");B&&y>0&&(B.innerHTML=hn(y*q))})}function Nn(a){if(!(!a||a.dataset.mmTotalRatio)){var l=a.querySelectorAll(".cart-item");if(l.length){var p=nt(l),y=a.querySelector(".box-total-btn .linha-total .valor-final > .valor > strong")||a.querySelector(".box-total-btn .linha-total .valor-final strong");if(y&&p>.01){var q=qn(y.textContent);isNaN(q)||(a.dataset.mmTotalRatio=String(q/p))}}}}function tt(a,l){var p=a.querySelector(".box-total-btn .linha-total");if(p){var y=p.parentElement.querySelector(".mm-cart-savings");if(y&&y.remove(),!(!l||l<.01)){var q=document.createElement("span");q.className="mm-cart-savings",q.textContent="Você economiza "+kn(l)+" com PIX",p.nextSibling?p.parentElement.insertBefore(q,p.nextSibling):p.parentElement.appendChild(q)}}}function jn(a,l){if(a){Nn(a);var p=a.querySelectorAll(".cart-item:not(.mm-removing)"),y=nt(p),q=a.querySelector(".box-total-btn .linha-total .valor-final > .valor > strong")||a.querySelector(".box-total-btn .linha-total .valor-final strong"),S=parseFloat(a.dataset.mmTotalRatio||"0.95")||.95,B=y*S,_=y-B,Y=C(),V=Z(),en=H(V),J=N(p),mn=V&&V.cepValue&&V.cepValue.replace(/\D/g,"")===Y,o=!!(Y&&V&&mn&&V.shipping!=null&&!isNaN(V.shipping)),n=a.dataset.mmShipPendingFetch==="1";!o&&n&&Y&&V&&V.shipping!=null&&(o=!0);var t=o?parseFloat(V.shipping):0,e=B+t,r=y+t;if(q){var s=qn(q.textContent);if(l)(isNaN(s)||Math.abs(e-s)>.005)&&(q.innerHTML=hn(e));else if(!isNaN(s)&&Math.abs(e-s)>.005){var c=a.querySelector(".box-total-btn .linha-total .valor-final");c&&(c.classList.remove("mm-pop"),c.offsetWidth,c.classList.add("mm-pop"),setTimeout(function(){c.classList.remove("mm-pop")},450)),gt(q,s,e)}else q.innerHTML=hn(e)}var b=a.querySelector(".box-total-btn .valor-final.card");if(b){var A=r/12;b.innerHTML="<span>ou em até <strong>12x</strong> de <strong>"+kn(A)+"</strong> no cartão</span>"}var O=a.querySelector(".box-total-btn .linha-total .valor-final .tipo-pagto");O&&(O.textContent="No PIX"),tt(a,_),Cn(a,y,t,o);try{var L=0;p.forEach(function(I){var W=I.querySelector(".qty-display");W&&(L+=parseInt(W.textContent)||0)});var R=document.getElementById("mm-h-cart-count");R&&(L>0?(R.textContent=L>99?"99+":String(L),R.hidden=!1):R.hidden=!0)}catch{}}}function et(){var a=document.querySelector(".carrinho-rapido-ctn");if(!(!a||!a.querySelector(".box-total-btn"))){var l=a.querySelectorAll(".cart-item:not(.mm-removing)");if(l.length){var p=a.querySelector(".box-total-btn .linha-total .valor-final > .valor > strong")||a.querySelector(".box-total-btn .linha-total .valor-final strong");if(p){var y=nt(l);if(y>.01){var q=parseFloat(a.dataset.mmTotalRatio||"0.95")||.95,S=C(),B=Z(),_=B&&B.cepValue&&B.cepValue.replace(/\D/g,"")===S,Y=!!(S&&B&&_&&B.shipping!=null&&!isNaN(B.shipping));!Y&&a.dataset.mmShipPendingFetch==="1"&&S&&B&&B.shipping!=null&&(Y=!0);var V=Y?parseFloat(B.shipping):0,en=y*q+V,J=qn(p.textContent);(isNaN(J)||Math.abs(en-J)>.01)&&jn(a,!0)}}}}}function bt(){var a=document.querySelector('#cart-preview-area > div[class*="z-[9999]"]');if(a)return a;var l=document.querySelector(".carrinho-rapido-ctn");return l&&!l.querySelector(".box-total-btn")&&l.querySelector(".valor-pix")?l:null}function Ft(a,l){var p=a.querySelector(".installment-total");if(!(!p||!p.parentElement)){var y=p.parentElement,q=y.querySelector(".mm-cart-savings-mobile");if(!l||l<.01){q&&q.remove();return}var S="Você economiza "+kn(l)+" com PIX";if(q){q.textContent!==S&&(q.textContent=S);return}var B=document.createElement("span");B.className="mm-cart-savings-mobile",B.textContent=S,p.nextSibling?y.insertBefore(B,p.nextSibling):y.appendChild(B)}}function _n(a,l,p){if(!(!a||!a.classList||!a.classList.contains("carrinho-rapido-ctn"))&&!a.querySelector(".box-total-btn")){var y=a.querySelector(".area-finalizar-compra");if(!(!y||!(l>0))){var q=y.querySelector(".forma-pix"),S=q?q.parentElement:null;if(S){var B=l*p,_=l/12,Y=l-B;S.classList.add("mm-native-pay-hidden");var V=y.querySelector(".mm-cart-total-b");V||(V=document.createElement("div"),V.className="mm-cart-total-b",V.innerHTML='<span class="mm-tb-label">Total</span><span class="mm-tb-row"><strong class="mm-tb-value"></strong><span class="mm-tb-pix">No PIX</span></span><span class="mm-tb-savings"></span><span class="mm-tb-parcela"></span>',S.nextSibling?y.insertBefore(V,S.nextSibling):y.appendChild(V));var en=V.querySelector(".mm-tb-value"),J=kn(B);en&&en.textContent!==J&&(en.textContent=J);var mn=V.querySelector(".mm-tb-savings");if(mn)if(Y>=.01){var o="Você economiza "+kn(Y)+" com PIX";mn.textContent!==o&&(mn.textContent=o),mn.style.display=""}else mn.style.display="none";var n=V.querySelector(".mm-tb-parcela");if(n){var t="ou em até 12x de "+kn(_)+" no cartão";n.textContent!==t&&(n.textContent=t)}}}}}function Un(a){if(a=a||bt(),!(!a||a.querySelector(".box-total-btn")||!a.querySelector(".valor-pix"))){var l=a.querySelectorAll(".cart-item:not(.mm-removing)"),p=l.length,y=document.getElementById("mm-h-cart-count");if(y&&p>0){var q=p>99?"99+":String(p);(y.textContent!==q||y.hidden)&&(y.textContent=q,y.hidden=!1)}if(l.length){var S=nt(l);if(S>0){Array.prototype.forEach.call(l,function(R){var I=parseFloat(R.getAttribute("data-item-price"))||0;if(I>0){var W=parseInt(R.getAttribute("data-item-quantity"));if(!W||isNaN(W)){var an=R.querySelector(".qty-display");W=an&&parseInt(an.textContent)||1}var K=R.querySelector(".valor");if(K){var X=I*W,cn=K.querySelector("span")||K,sn=qn(cn.textContent);(isNaN(sn)||Math.abs(sn-X)>.005)&&(cn.textContent=kn(X))}}});var B=a.querySelector(".valor-pix"),_=B?B.querySelector("span")||B:null;if(!a.dataset.mmMobileRatio&&_){var Y=qn(_.textContent);if(!isNaN(Y)&&Y>0){var V=Y/S;V>.8&&V<=1.0001&&(a.dataset.mmMobileRatio=String(V))}}var en=parseFloat(a.dataset.mmMobileRatio||"0.95");if(en>.8&&en<=1.0001||(en=.95),_){var J=S*en,mn=qn(_.textContent);(isNaN(mn)||Math.abs(mn-J)>.005)&&(_.textContent=kn(J))}var o=a.querySelector(".installment-total");if(o){var n=S/12,t=qn(o.textContent);(isNaN(t)||Math.abs(t-n)>.005)&&(o.textContent="ou 12x de "+kn(n))}var e=C(),r=Z(),s=r&&r.cepValue&&r.cepValue.replace(/\D/g,"")===e,c=!!(e&&r&&s&&r.shipping!=null&&!isNaN(r.shipping)),b=c?parseFloat(r.shipping):0,A=(e||"")+"|"+S.toFixed(2)+"|"+(c?1:0)+"|"+b,O=a.querySelector(".mm-cart-ship"),L=O&&O.dataset.mmEditing==="1";!L&&(!O||a.dataset.mmMobShipSig!==A)&&(a.dataset.mmMobShipSig=A,Cn(a,S,b,c)),Tn(a),Ft(a,S-S*en),_n(a,S,en)}}}}function gt(a,l,p){if(!a||isNaN(l)||isNaN(p))return;var y=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(y){a.innerHTML=hn(p);return}var q=420,S=performance.now();function B(_){return 1-Math.pow(1-_,3)}(function _(Y){var V=Math.min(1,(Y-S)/q);a.innerHTML=hn(l+(p-l)*B(V)),V<1&&requestAnimationFrame(_)})(S)}function xt(a,l,p,y,q,S){if(!(!a||!l)){var B=parseInt(y.textContent)||1,_=B+p;if(!(_<1)){var J=a.closest(".carrinho-rapido-ctn");Nn(J),q.disabled=!0,S.disabled=!0;var Y=parseFloat(a.getAttribute("data-item-price"))||0;y.textContent=_,a.setAttribute("data-item-quantity",_);var V=a.querySelector(".valor");if(V){var en=Y*_;V.textContent=kn(en),V.classList.remove("mm-pop"),V.offsetWidth,V.classList.add("mm-pop"),setTimeout(function(){V.classList.remove("mm-pop")},450)}var J=a.closest(".carrinho-rapido-ctn"),mn=p>0?"adicionaItem":"removeItem";C()&&J&&(J.dataset.mmShipPendingFetch="1"),jn(J),Un(),C()&&fn(J),h(mn,l).catch(function(){y.textContent=B,a.setAttribute("data-item-quantity",B),V&&(V.innerHTML=hn(Y*B)),J&&(J.dataset.mmShipPendingFetch=""),jn(J),Un()}).then(function(){q.disabled=!1,S.disabled=!1;var o=C();o&&J?(fn(J),un(o,!0).then(function(n){J.dataset.mmShipPendingFetch="",n?Fn(J,o,n):En(J)})):J&&(J.dataset.mmShipPendingFetch="")})}}}function wt(a,l){if(!(!a||!l)){var p=a.closest(".carrinho-rapido-ctn");Nn(p);var y=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,q=y?0:360;y||a.classList.add("mm-removing"),setTimeout(function(){a.parentNode&&a.parentNode.removeChild(a);var S=p?p.querySelectorAll(".cart-item:not(.mm-removing)"):[],B=S.length===0;if(B){if(p){p.dataset.mmShipPendingFetch="";var _=p.querySelector(".mm-cart-ship");_&&_.remove();var Y=p.querySelector(".box-total-btn, .area-finalizar-compra");Y&&(Y.style.display="none")}typeof window.__mmForceEmptyCartState=="function"&&window.__mmForceEmptyCartState(p)}else jn(p),C()&&fn(p);var V=document.getElementById("mm-h-cart-count"),en=document.getElementById("mm-h-cart"),J=S.length;V&&(V.textContent=J>99?"99+":String(J),V.hidden=J===0),en&&en.setAttribute("aria-label","Carrinho, "+J+" "+(J===1?"item":"itens")),Un()},q),h("deleteItem",l).catch(function(){}).then(function(){var S=p?p.querySelectorAll(".cart-item:not(.mm-removing)"):[],B=document.getElementById("mm-h-cart-count");if(B&&(B.textContent=S.length>99?"99+":String(S.length),B.hidden=S.length===0),S.length===0){p&&(p.dataset.mmShipPendingFetch="");return}var _=C();_&&p?(p.dataset.mmShipPendingFetch="1",fn(p),un(_,!0).then(function(Y){p.dataset.mmShipPendingFetch="",Y?Fn(p,_,Y):En(p)})):p&&(p.dataset.mmShipPendingFetch="")})}}window.__mmDeleteItem=wt;var Tt=null,yt=new Set,lt=null;function Hn(a){if(!a)return NaN;var l=String(a).replace(/\s/g,"").match(/([\d.,]+)/);if(!l)return NaN;var p=l[1].replace(/\./g,"").replace(",","."),y=parseFloat(p);return isNaN(y)?NaN:y}function st(a){return isNaN(a)?"":"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2})}function Lt(a,l,p){if(!a||isNaN(l)||isNaN(p))return;lt&&cancelAnimationFrame(lt);var y=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(y){a.textContent=st(p);return}var q=420,S=performance.now();function B(Y){return 1-Math.pow(1-Y,3)}function _(Y){var V=Y-S,en=Math.min(1,V/q),J=l+(p-l)*B(en);a.textContent=st(J),en<1?lt=requestAnimationFrame(_):lt=null}lt=requestAnimationFrame(_)}function ut(a){return a?a.querySelector(".box-total-btn .linha-total .valor-final > .valor > strong")||a.querySelector(".box-total-btn .linha-total .valor-final strong")||a.querySelector(".valor-pix strong")||a.querySelector(".valor-pix"):null}function Et(a){return a?a.querySelector(".box-total-btn .linha-total .valor-final"):null}function kt(a){var l=Et(a);l&&(l.classList.remove("mm-pop"),l.offsetWidth,l.classList.add("mm-pop"),setTimeout(function(){l.classList.remove("mm-pop")},450))}function Jn(){var a=document.querySelector(".carrinho-rapido-ctn");if(a){var l=a.querySelectorAll(".cart-item:not(.mm-removing)");if(l.length>0){var p=a.querySelector(".box-total-btn");p&&p.dataset.mmTotalEnhanced!=="1"&&(Nn(a),mt(a),jn(a),p.dataset.mmTotalEnhanced="1",a.dataset.mmShipRendered="1",Tn(a))}a.querySelector(".box-total-btn")||Un(a);var y=a.querySelectorAll(".cart-item"),q=new Set;y.forEach(function(S){var B=S.id||S.getAttribute("data-item-id")||"";B&&(q.add(B),!yt.has(B)&&yt.size>0&&(S.classList.add("mm-added"),setTimeout(function(){S.classList.remove("mm-added")},500)))}),yt=q}}function Vn(){var a=document.querySelector(".carrinho-rapido-ctn");if(!(!a||a.dataset.mmAnimObserved)){a.dataset.mmAnimObserved="1",Jn();var l=new MutationObserver(function(){clearTimeout(Vn._t),Vn._t=setTimeout(Jn,60)});l.observe(a,{childList:!0,subtree:!0,characterData:!0})}}function ft(){x(),m(),d();var a=document.getElementById("cart-preview-area");if(a){var l=new MutationObserver(function(){setTimeout(i,100),setTimeout(Vn,150),setTimeout(Un,180),setTimeout(et,220)});l.observe(a,{childList:!0,subtree:!0})}setInterval(i,800),setInterval(Vn,800),setInterval(Un,800),setInterval(et,800),i(),Vn(),Un(),et()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ft):ft()})(),(function x(){"use strict";var P="mm_cep",j="mm_cart_snapshot",T=18e5,g="mm_onepage_draft",i=1440*60*1e3,m=2e3,d="https://magazord-public.s3.sa-east-1.amazonaws.com/madeiramania/resources/Design%20sem%20nome%20(1).svg",h="https://api.whatsapp.com/send?phone=5511915299488&text="+encodeURIComponent("Olá! Estou no checkout e gostaria de tirar uma dúvida sobre meu pedido."),f=location.pathname,E=f.indexOf("/checkout/cart")!==-1,v=f.indexOf("/checkout/identify")!==-1,F=f.indexOf("/checkout/onepage")!==-1,z=f.indexOf("/checkout/payment")!==-1,C=f.indexOf("/checkout/done")!==-1;if(C){try{localStorage.removeItem("mm_onepage_draft")}catch{}return}if(!E&&!v&&!F&&!z)return;x._retries=(x._retries||0)+1;var u=document.querySelector("#checkout-main-area");if(!u){try{var U=document.body&&document.body.textContent||"",Z=/muito tempo inativo|realize login novamente/i.test(U);if((F||v)&&(Z||x._retries>=40)&&!sessionStorage.getItem("mm_checkout_recovery")){sessionStorage.setItem("mm_checkout_recovery","1"),location.href="/checkout/cart";return}}catch{}x._retries<40&&setTimeout(x,400);return}try{sessionStorage.removeItem("mm_checkout_recovery")}catch{}function N(n){return isNaN(n)||n<0?"R$ 0,00":"R$ "+n.toFixed(2).replace(".",",").replace(/(\d)(?=(\d{3})+,)/g,"$1.")}function H(n){if(!n)return 0;var t=String(n).match(/(-?[\d.]+,\d{2})/);return t&&parseFloat(t[1].replace(/\./g,"").replace(",","."))||0}function D(n){return String(n||"").replace(/[&<>"']/g,function(t){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[t]})}var M={truck:'<svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20 8h-3V4H3c-1.1 0-2 .9-2 2v11h2a3 3 0 0 0 6 0h6a3 3 0 0 0 6 0h2v-5l-3-4zM6 18.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm12 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm.5-7H17V9.5h2.04l1.46 2-.04 0z"/></svg>',check:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>',checkCircle:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>',bolt:'<svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>',shield:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 1 3 5v6c0 5.5 3.8 10.7 9 12 5.2-1.3 9-6.5 9-12V5l-9-4zm-1.4 16L6 12.4l1.4-1.4 3.2 3.2 6.8-6.8L18.8 8.8 10.6 17z"/></svg>',lock:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zM9 6c0-1.66 1.34-3 3-3s3 1.34 3 3v2H9V6z"/></svg>',card:'<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>',rotate:'<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.74 9.74 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/></svg>',minus:'<svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M3 7h8" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/></svg>',plus:'<svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M7 3v8M3 7h8" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/></svg>',trash:'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',close:'<svg width="12" height="12" viewBox="0 0 14 14" fill="none"><path d="M10.5 3.5l-7 7M3.5 3.5l7 7" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/></svg>',arrow:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>',tag:'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.59 13.41 13.42 20.58a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg>',whats:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893A11.821 11.821 0 0 0 20.464 3.488"/></svg>',box:'<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>'},tn={get:function(n){try{return localStorage.getItem(n)}catch{return null}},set:function(n,t){try{localStorage.setItem(n,t)}catch{}},remove:function(n){try{localStorage.removeItem(n)}catch{}}};function pn(n){try{var t={ts:Date.now(),items:n.items.map(function(e){return{name:e.name,variant:e.variant,imgSrc:e.imgSrc,quantity:e.quantity,lineTotal:e.lineTotal,lineTotalPix:e.lineTotalPix,isPix:e.isPix,deposito:e.deposito}}),subtotalPix:n.subtotalPix,subtotalFull:n.subtotalFull,discount:n.discount,couponCode:n.couponCode,shipping:n.shipping,shippingDeadline:n.shippingDeadline,shippingName:n.shippingName,shippingCity:n.shippingCity,shippingOptions:n.shippingOptions,cepValue:n.cepValue};tn.set(j,JSON.stringify(t))}catch{}}function dn(){try{var n=tn.get(j);if(!n)return null;var t=JSON.parse(n);return!t||!t.ts||Date.now()-t.ts>T?null:t}catch{return null}}function gn(){try{for(var n=["mm-op-email","mm-op-nome","mm-op-cpf","mm-op-tel","mm-op-cep","mm-op-rua","mm-op-num","mm-op-comp","mm-op-bairro","mm-op-cidade","mm-op-uf"],t={ts:Date.now()},e=0,r=0;r<n.length;r++){var s=document.getElementById(n[r]);s&&s.value&&(t[n[r]]=s.value,e++)}if(e===0){window._mmDraftDebug&&console.log("[mm-draft] skip save (0 fields)");return}tn.set(g,JSON.stringify(t)),window._mmDraftDebug&&console.log("[mm-draft] saved",e,"fields",t)}catch(c){window._mmDraftDebug&&console.warn("[mm-draft] save failed",c)}}function Pn(){try{var n=tn.get(g);if(!n)return null;var t=JSON.parse(n);return!t||!t.ts?null:Date.now()-t.ts>i?(tn.remove(g),null):t}catch{return null}}function xn(){try{tn.remove(g)}catch{}}function Xn(){var n=Pn();if(!n)return window._mmDraftDebug&&console.log("[mm-draft] no draft to restore"),null;for(var t=["mm-op-email","mm-op-nome","mm-op-cpf","mm-op-tel","mm-op-cep","mm-op-rua","mm-op-num","mm-op-comp","mm-op-bairro","mm-op-cidade","mm-op-uf"],e=0,r=0;r<t.length;r++){var s=document.getElementById(t[r]);if(s&&n[t[r]]){try{var c=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;c.call(s,n[t[r]])}catch{s.value=n[t[r]]}s.dispatchEvent(new Event("input",{bubbles:!0})),/^mm-op-(rua|bairro|cidade|uf)$/.test(t[r])&&(s.dataset.mmCepFill="1"),e++}}return window._mmDraftDebug&&console.log("[mm-draft] restored",e,"fields from draft",n),n}function Bn(){for(var n={items:[],subtotalPix:0,subtotalFull:0,discount:0,shipping:null,shippingRaw:"",shippingDeadline:"",shippingName:"",shippingCity:"",shippingOptions:[],couponCode:"",cepValue:"",canFinalize:!1,hasFinalizar:!1},t=u.querySelectorAll(".cart-item"),e=0;e<t.length;e++){var r=t[e],s=r.querySelector('.qtd-item[id^="item_carrinho_"]'),c=s&&s.id.match(/item_carrinho_(\d+)/),b=c?parseInt(c[1],10):null,A=r.querySelector("figure img")||r.querySelector("#product-img")||r.querySelector("img"),O=r.querySelector(".nome-produto .link")||r.querySelector("figure a"),L=r.querySelector(".column-valor-produto .valor"),R=L?L.textContent.trim():"",I=!!r.querySelector(".column-valor-produto .sub");n.items.push({dataId:b,sku:r.getAttribute("data-item-id")||"",name:r.getAttribute("data-item-name")||r.getAttribute("data-name")||"",variant:r.getAttribute("data-item-variant")||"",brand:r.getAttribute("data-item-brand")||"",category:r.getAttribute("data-item-category")||"",priceUnit:parseFloat(r.getAttribute("data-item-price")||"0"),lineTotal:parseFloat(r.getAttribute("data-valor")||"0"),quantity:parseInt(r.getAttribute("data-item-quantity")||"1",10),deposito:r.getAttribute("data-item-deposito")==="1",imgSrc:A?A.getAttribute("src")||A.currentSrc:"",href:O?O.getAttribute("href"):"",lineTotalPix:H(R),isPix:I}),n.subtotalFull+=parseFloat(r.getAttribute("data-valor")||"0")}var W=u.querySelector("#resumo-compra .resumo-valores .value");W&&(n.subtotalPix=H(W.textContent)),n.subtotalPix<=0&&(n.subtotalPix=n.items.reduce(function(St,Mt){return St+(Mt.lineTotalPix||0)},0));var an=u.querySelector("#resumo-compra .discount-value");an&&(n.discount=H(an.textContent));var K=u.querySelector("#resumo-compra .txt-cupom, #resumo-compra .alert.alert-type-1");if(K){var X=K.textContent.match(/([A-Z0-9]{3,})/);X&&(n.couponCode=X[1])}var cn=u.querySelector("#resumo-compra .frete-calculado, .frete-calculado");if(cn&&cn.textContent.trim()){n.shippingRaw=cn.textContent.trim();var sn=cn.querySelector(".frete-location .city");sn&&(n.shippingCity=sn.textContent.trim());for(var rn=cn.querySelectorAll(".servico-frete"),on=0;on<rn.length;on++){var ln=rn[on],Sn=ln.querySelector('input[type="radio"]'),w=ln.querySelector(".dias-entrega"),k=parseFloat(ln.getAttribute("data-valor-frete")||"0"),G=ln.getAttribute("data-servico-frete")||"",nn=w?w.textContent.trim().replace(/\s+/g," ").replace(/\s*-\s*$/,"").trim():"",Q=nn.match(/(\d+(?:\s*[aà]\s*\d+)?\s*dias?(?:\s*[úu]teis)?)/i),vn=Q?Q[1].replace(/\s+/g," "):nn;n.shippingOptions.push({id:Sn?Sn.value:"",name:G,deadline:vn,value:k,isFree:k===0,isSelected:Sn?Sn.checked:!1})}var bn=n.shippingOptions.filter(function(St){return St.isSelected})[0];if(!bn&&n.shippingOptions.length>0&&(bn=n.shippingOptions[0]),bn)n.shipping=bn.value,n.shippingName=bn.name,n.shippingDeadline=bn.deadline;else{var zn=cn.querySelector(".info-frete-selec"),Mn=cn.querySelector(".dias-entrega, .info-frete-selec .dias-entrega"),In=cn.querySelector(".valor-frete .value, .value.valor-frete"),Kn=cn.querySelector(".info-frete-selec .info-title span, .info-title span");if(In){var Gn=In.textContent.trim();if(/gr[aá]tis/i.test(Gn))n.shipping=0;else{var at=H(Gn);at>0&&(n.shipping=at)}}if(Mn){var rt=Mn.textContent.match(/(\d+(?:\s*[aà]\s*\d+)?\s*dias?(?:\s*\([^)]+\))?(?:\s*[úu]teis)?)/i);rt&&(n.shippingDeadline=rt[1].replace(/\s+/g," ").replace(/\(s\)/,"").trim())}if(Kn&&(n.shippingName=Kn.textContent.trim()),n.shipping===null)if(/gr[aá]tis/i.test(n.shippingRaw))n.shipping=0;else{var ht=H(n.shippingRaw);ht>0&&(n.shipping=ht)}if(!n.shippingDeadline){var An=n.shippingRaw.match(/(\d+(?:\s*[aà]\s*\d+)?)\s*dias?/i);An&&(n.shippingDeadline=An[1]+" dias úteis")}}}var vt=u.querySelector("#cep, .input-cep");return vt&&(n.cepValue=vt.value||""),n.hasFinalizar=!!u.querySelector("#finalizar-compra"),n.canFinalize=n.items.length>0,n}function un(n){n=n||"cart";var t='<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 1 3 5v6c0 5.5 3.8 10.7 9 12 5.2-1.3 9-6.5 9-12V5l-9-4zm-1.4 16L6 12.4l1.4-1.4 3.2 3.2 6.8-6.8L18.8 8.8 10.6 17z"/></svg>';function e(r,s){var c=r===n,b="mm-checkout-step"+(c?" is-active":""),A=c?' aria-current="step"':"";return'<li class="'+b+'"'+A+'><span class="mm-checkout-step-label">'+s+"</span></li>"}return'<header class="mm-checkout-header"><a class="mm-checkout-header-logo" href="/" aria-label="Madeira Mania - voltar à home"><img src="'+d+'" alt="Madeira Mania" width="180" height="44"></a><nav class="mm-checkout-steps" aria-label="Etapas do checkout"><ol>'+e("cart","Carrinho")+'<li class="mm-checkout-step-sep" aria-hidden="true">›</li>'+e("delivery","Entrega")+'<li class="mm-checkout-step-sep" aria-hidden="true">›</li>'+e("payment","Pagamento")+'</ol></nav><div class="mm-checkout-secure">'+t+'<span class="mm-checkout-secure-text"><strong>Compra 100% segura</strong><small>Site protegido por SSL</small></span></div></header>'}function Dn(n){var t=n.imgSrc?'<img src="'+D(n.imgSrc)+'" alt="'+D(n.name)+'" loading="lazy">':"",e=n.href?'<a class="mm-item-name" href="'+D(n.href)+'">'+D(n.name)+"</a>":'<span class="mm-item-name">'+D(n.name)+"</span>",r=n.variant?'<p class="mm-item-variant">'+D(n.variant)+"</p>":"",s="",c=n.quantity<=1?' disabled aria-disabled="true"':"",b;if(n.lineTotalPix>0&&n.isPix){var A='<span class="mm-item-price-sub">no PIX</span>',O=n.quantity>1?N(n.lineTotalPix/n.quantity)+" cada":"";b='<div class="mm-item-price"><span class="mm-item-price-value">'+N(n.lineTotalPix)+"</span>"+A+(O?'<span class="mm-item-price-unit">'+O+"</span>":"")+"</div>"}else{var L=n.quantity>1?N(n.priceUnit)+" cada":"";b='<div class="mm-item-price"><span class="mm-item-price-value">'+N(n.lineTotal)+"</span>"+(L?'<span class="mm-item-price-unit">'+L+"</span>":"")+"</div>"}return'<div class="mm-item" data-mm-id="'+n.dataId+'"><div class="mm-item-thumb">'+t+'</div><div class="mm-item-body">'+e+r+s+"</div>"+b+'<div class="mm-item-controls"><div class="mm-qty" role="group" aria-label="Quantidade"><button type="button" class="mm-qty-btn" data-mm-act="dec"'+c+' aria-label="Diminuir quantidade">'+M.minus+'</button><span class="mm-qty-value">'+n.quantity+'</span><button type="button" class="mm-qty-btn" data-mm-act="inc" aria-label="Aumentar quantidade">'+M.plus+'</button></div><button type="button" class="mm-item-remove" data-mm-act="remove" aria-label="Remover item" title="Remover">'+M.trash+"</button></div></div>"}function Fn(n){return n.items.length?n.items.map(Dn).join(""):'<div class="mm-empty"><div class="mm-empty-icon">'+M.box+'</div><h3 class="mm-empty-title">Seu carrinho está vazio</h3><p class="mm-empty-desc">Explore nossos móveis e encontre a peça certa para sua casa.</p><a class="mm-empty-cta" href="/">Explorar produtos '+M.arrow+'</a><p class="mm-empty-perks">Frete grátis acima de R$ 2.000 · 12x sem juros · 7% off no PIX</p></div>'}function Tn(n){for(var t="",e=0;e<n;e++)t+='<div class="mm-skel-item"><div class="mm-skel mm-skel-thumb"></div><div class="mm-skel-lines"><div class="mm-skel mm-skel-line w-3-4"></div><div class="mm-skel mm-skel-line w-1-2"></div><div class="mm-skel mm-skel-line w-1-3"></div></div><div class="mm-skel-lines"><div class="mm-skel mm-skel-line w-1-2"></div></div></div>';return t}function wn(n){var t=n.subtotalFull>0?n.subtotalFull:n.subtotalPix,e='<div class="mm-row"><span class="mm-row-label">Subtotal</span><span class="mm-row-value">'+N(t)+"</span></div>";if(n.shipping!==null){var r;n.shipping===0?r='<span class="mm-row-value is-free">'+M.check+" Grátis</span>":r='<span class="mm-row-value">'+N(n.shipping)+"</span>";var s='<span class="mm-row-label">Frete';n.shippingName&&(s+=' <span class="mm-row-sub">· '+D(n.shippingName)+"</span>"),n.shippingDeadline&&(s+=' <span class="mm-row-sub">· '+D(n.shippingDeadline)+"</span>"),s+="</span>",e+='<div class="mm-row">'+s+r+"</div>"}n.discount>0&&(e+='<div class="mm-row"><span class="mm-row-label">Desconto</span><span class="mm-row-value is-discount">− '+N(n.discount)+"</span></div>");var c="";if(n.shipping!==null){var b=Math.max(0,t+n.shipping-n.discount),A=Math.max(0,n.subtotalPix+n.shipping-n.discount),O=b-A,L=b/12;c='<div class="mm-total"><div class="mm-total-label">Total</div><div class="mm-total-value">'+N(b)+'</div><div class="mm-total-pix"><span>'+N(A)+" à vista no PIX</span>"+(O>0?'<span class="mm-total-pix-save">economia de '+N(O)+"</span>":"")+'</div><div class="mm-total-parcela">ou 12x de '+N(L)+" sem juros no cartão</div></div>"}else c='<div class="mm-total"><div class="mm-total-label">Subtotal</div><div class="mm-total-value">'+N(n.subtotalPix)+'</div><div class="mm-total-pix"><span>à vista no PIX</span></div><div class="mm-total-pending">Informe seu CEP para ver o frete e o total final.</div></div>';var R;return n.couponCode?R='<div class="mm-coupon-applied"><span class="mm-coupon-applied-left">'+M.tag+"<span>"+D(n.couponCode)+'</span></span><button type="button" data-mm-act="coupon-remove" aria-label="Remover cupom">'+M.close+"</button></div>":R='<div class="mm-coupon"><button type="button" class="mm-coupon-toggle" data-mm-act="coupon-toggle">'+M.tag+'<span>Tenho um cupom</span></button><form class="mm-coupon-form" data-mm-act="coupon-submit"><input type="text" class="mm-input" name="mm-coupon-code" placeholder="CUPOM" autocomplete="off" autocapitalize="characters" spellcheck="false" /><button type="submit" class="mm-btn-secondary">Aplicar</button></form></div>','<div class="mm-sum-stack"><div class="mm-rows">'+e+"</div>"+R+c+"</div>"}function Ln(){var n=document.getElementById("mm-layout");if(n)return n.parentElement!==u&&u.insertBefore(n,u.firstChild),n;var t=document.createElement("div");return t.id="mm-layout",t.innerHTML=un("cart")+'<div class="mm-grid"><section class="mm-items"><h2 class="mm-h">Carrinho</h2><div class="mm-items-card"><div id="mm-item-list">'+Tn(2)+'</div></div></section><aside class="mm-sum"><h2 class="mm-h">Resumo</h2><div class="mm-sum-card"><div class="mm-cep"><div class="mm-cep-label"><span class="mm-cep-label-text">Calcular frete</span><a class="mm-cep-label-link" href="https://buscacepinter.correios.com.br/app/endereco/index.php" target="_blank" rel="noopener">Não sei meu CEP</a></div><div class="mm-cep-row"><input type="text" class="mm-input" id="mm-cep-input" name="mm_cep_calc" inputmode="numeric" maxlength="9" placeholder="00000-000" autocomplete="off" data-lpignore="true" data-1p-ignore="true" data-bwignore="true" data-form-type="other" aria-label="CEP" /><button type="button" class="mm-btn-secondary" data-mm-act="calc-cep">Calcular</button></div></div><div id="mm-sum-dynamic"></div><button type="button" class="mm-cta" data-mm-act="finalizar">Finalizar compra'+M.arrow+'</button><div class="mm-trust"><span class="mm-trust-item">'+M.lock+'<span>Pagamento seguro</span></span><span class="mm-trust-item">'+M.rotate+'<span>7 dias para troca</span></span><span class="mm-trust-item">'+M.card+'<span>12x sem juros</span></span></div><a class="mm-help" href="'+h+'" target="_blank" rel="noopener" data-mm-track="help-whats">'+M.whats+"<span><strong>Ficou com alguma dúvida?</strong> Fale com a gente no WhatsApp</span></a></div></aside></div>",u.insertBefore(t,u.firstChild),u.classList.add("mm-shadow-mode"),document.body.classList.add("mm-checkout-rebuild"),document.documentElement.classList.remove("mm-cart-loading"),t}function Qn(){var n=Bn(),t=document.getElementById("mm-item-list");t&&(t.innerHTML=Fn(n));var e=document.getElementById("mm-sum-dynamic");e&&(e.innerHTML=wn(n));var r=document.querySelector(".mm-cta");r&&(r.disabled=!n.canFinalize,r.style.opacity=n.canFinalize?"1":"0.5",r.style.pointerEvents=n.canFinalize?"auto":"none");var s=document.getElementById("mm-cep-input");if(s&&!s.matches(":focus")){var c=tn.get(P),b=n.cepValue||c||"";b&&(s.value=Cn(b))}return n.items&&n.items.length>0&&pn(n),n}function Cn(n){var t=String(n||"").replace(/\D/g,"").slice(0,8);return t.length<=5?t:t.slice(0,5)+"-"+t.slice(5)}function Zn(n){var t=String(n||"").replace(/\D/g,"");t.length===8&&tn.set(P,t)}function fn(n){n=n||0;var t=tn.get(P);if(!(!t||t.length!==8)){var e=u.querySelector("#cep, .input-cep");if(!e){n<12&&setTimeout(function(){fn(n+1)},350);return}var r=u.querySelector("#resumo-compra .frete-calculado");if(r&&r.textContent.trim()){var s=document.getElementById("mm-cep-input");s&&!s.value&&(s.value=Cn(t));return}var c=document.getElementById("mm-cep-input");c&&!c.value&&(c.value=Cn(t)),e.value=Cn(t),En(e),setTimeout(function(){Rn()},200)}}function En(n){try{var t=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;t.call(n,n.value)}catch{}n.dispatchEvent(new Event("input",{bubbles:!0})),n.dispatchEvent(new Event("change",{bubbles:!0}))}function Rn(){try{if(window.Zord&&window.Zord.Cart&&typeof window.Zord.Cart.calculaFreteCarrinho=="function"){window.Zord.Cart.calculaFreteCarrinho();return}}catch{}var n=u.querySelector("#resumo-compra .calcula-frete > button, .area-frete button");n&&n.click()}function On(){var n=document.getElementById("mm-layout");!n||n._mmBound||(n._mmBound=!0,n.addEventListener("click",function(t){var e=t.target.closest("[data-mm-act]");if(e){var r=e.getAttribute("data-mm-act"),s=e.closest(".mm-item"),c=s?parseInt(s.getAttribute("data-mm-id"),10):null;switch(r){case"inc":Yn(c,s,"inc");break;case"dec":Yn(c,s,"dec");break;case"remove":dt(c,s);break;case"calc-cep":qn();break;case"coupon-toggle":var b=e.closest(".mm-coupon");if(b){b.classList.add("is-open");var A=b.querySelector("input");A&&setTimeout(function(){A.focus()},100)}break;case"coupon-remove":hn();break;case"finalizar":nt();break}}}),n.addEventListener("submit",function(t){var e=t.target.closest('[data-mm-act="coupon-submit"]');if(e){t.preventDefault();var r=e.querySelector("input");r&&kn(r.value.trim())}}),n.addEventListener("input",function(t){t.target&&t.target.id==="mm-cep-input"&&(t.target.value=Cn(t.target.value))}),n.addEventListener("keydown",function(t){t.key==="Enter"&&t.target&&t.target.id==="mm-cep-input"&&(t.preventDefault(),qn())}))}function Yn(n,t,e){if(!(!n||!t)&&!(!window.Zord||!window.Zord.checkout)){t.classList.add("is-updating");try{e==="inc"?window.Zord.checkout.adicionaQuantidade(n):window.Zord.checkout.removeQuantidade(n)}catch(r){console.warn("[mm-cart] qty change failed",r),t.classList.remove("is-updating")}}}function dt(n,t){if(!(!n||!t)&&!(!window.Zord||!window.Zord.checkout)){t.classList.add("is-updating"),t.style.transition="opacity 200ms, transform 200ms",t.style.opacity="0",t.style.transform="translateX(-12px)";try{typeof window.Zord.checkout.deleteItem=="function"?window.Zord.checkout.deleteItem(n):window.Zord.checkout.removeQuantidade(n)}catch(e){console.warn("[mm-cart] remove failed",e),t.classList.remove("is-updating"),t.style.opacity="1",t.style.transform=""}}}function qn(){var n=document.getElementById("mm-cep-input");if(n){var t=(n.value||"").replace(/\D/g,"");if(t.length!==8){n.focus(),n.classList.add("mm-input-error"),setTimeout(function(){n.classList.remove("mm-input-error")},1200);return}Zn(t);var e=u.querySelector("#cep, .input-cep");e&&(e.value=Cn(t),En(e)),Rn()}}function kn(n){if(n&&!(!window.Zord||!window.Zord.checkout)){var t=u.querySelector("#cupom-desconto");t&&(t.value=n.toUpperCase(),En(t));try{window.Zord.checkout.addCupomDesconto()}catch(e){console.warn("[mm-cart] coupon apply failed",e)}}}function hn(){if(!(!window.Zord||!window.Zord.checkout))try{window.Zord.checkout.removeCupomDesconto()}catch(n){console.warn("[mm-cart] coupon remove failed",n)}}function nt(){try{var n=Bn();n.items&&n.items.length>0&&pn(n)}catch{}var t=document.getElementById("finalizar-compra");if(t){t.click();return}location.href="/checkout/identify"}if(E){let n=function(e){if(e=e||0,e>30){t();return}var r=u.querySelectorAll(".cart-item").length>0,s=u.querySelector("#resumo-compra");r||s||e>8?t():setTimeout(function(){n(e+1)},250)},t=function(){Ln(),On(),Qn(),fn(),typeof jQuery<"u"&&jQuery(document).ajaxComplete(function(s,c,b){if(!(!b||!b.url)){var A=b.url;(A.indexOf("checkout/cart")!==-1||A.indexOf("atualiza")!==-1||A.indexOf("cupom")!==-1||A.indexOf("frete")!==-1||A.indexOf("removeItem")!==-1||A.indexOf("adicionaItem")!==-1)&&(setTimeout(Qn,120),setTimeout(function(){var O=Bn();O.shipping!==null&&O.cepValue&&Zn(O.cepValue)},200))}});try{var e=new MutationObserver(function(s){t._mutTimer&&clearTimeout(t._mutTimer),t._mutTimer=setTimeout(Qn,200)}),r=[u.querySelector("#cart-area"),u.querySelector(".cart-area"),u.querySelector("#resumo-compra")].filter(Boolean);r.forEach(function(s){e.observe(s,{childList:!0,subtree:!0,characterData:!0})})}catch{}};if(!document.getElementById("mm-checkout-cro-done")){var mt=document.createElement("div");mt.id="mm-checkout-cro-done",mt.style.display="none",document.body.appendChild(mt)}n()}function Nn(n){if(!n||!n.items||!n.items.length)return'<aside class="mm-id-sum mm-sum"><h2 class="mm-h">Resumo</h2><div class="mm-sum-card"><div class="mm-sum-empty"><p>Não conseguimos carregar o resumo do seu pedido.</p><a class="mm-btn-secondary" href="/checkout/cart">Voltar ao carrinho</a></div></div></aside>';var t=3,e=n.items.slice(0,t),r=n.items.length-t,s=e.map(function(X){var cn=X.quantity>1?'<strong class="mm-id-thumb-qty">'+X.quantity+"×</strong> ":"",sn=!X.imgSrc&&!(X.lineTotalPix>0)&&!(X.lineTotal>0);if(sn)return'<div class="mm-id-thumb"><div class="mm-id-thumb-img"><span class="mm-skel" style="display:block;width:100%;height:100%"></span></div><div class="mm-id-thumb-body"><p class="mm-id-thumb-name">'+cn+D(X.name)+"</p>"+(X.variant?'<p class="mm-id-thumb-variant">'+D(X.variant)+"</p>":"")+'</div><div class="mm-id-thumb-price"><span class="mm-skel" style="display:inline-block;width:56px;height:15px"></span></div></div>';var rn=X.imgSrc?'<img src="'+D(X.imgSrc)+'" alt="'+D(X.name)+'" loading="lazy">':'<div class="mm-id-thumb-placeholder">'+M.box+"</div>",on=X.lineTotalPix>0?X.lineTotalPix:X.lineTotal;return'<div class="mm-id-thumb"><div class="mm-id-thumb-img">'+rn+'</div><div class="mm-id-thumb-body"><p class="mm-id-thumb-name">'+cn+D(X.name)+"</p>"+(X.variant?'<p class="mm-id-thumb-variant">'+D(X.variant)+"</p>":"")+'</div><div class="mm-id-thumb-price">'+N(on)+"</div></div>"}).join("");r>0&&(s+='<div class="mm-id-thumb-more">+ '+r+" "+(r===1?"item":"itens")+" a mais</div>");var c=n.subtotalFull>0?n.subtotalFull:n.subtotalPix,b='<div class="mm-row"><span class="mm-row-label">Subtotal</span><span class="mm-row-value">'+N(c)+"</span></div>";if(n.shipping!==null&&n.shipping!==void 0){var A;n.shipping===0?A='<span class="mm-row-value is-free">'+M.check+" Grátis</span>":A='<span class="mm-row-value">'+N(n.shipping)+"</span>",b+='<div class="mm-row"><span class="mm-row-label">Frete'+(n.shippingDeadline?' <span class="mm-row-sub">· '+D(n.shippingDeadline)+"</span>":"")+"</span>"+A+"</div>"}n.discount>0&&(b+='<div class="mm-row"><span class="mm-row-label">Desconto'+(n.couponCode?' <span class="mm-row-sub">· '+D(n.couponCode)+"</span>":"")+'</span><span class="mm-row-value is-discount">− '+N(n.discount)+"</span></div>");var O,L=n.shipping!==null&&n.shipping!==void 0?n.shipping:0;if(n.shipping!==null&&n.shipping!==void 0){var R=Math.max(0,c+L-(n.discount||0)),I=Math.max(0,n.subtotalPix+L-(n.discount||0)),W=R-I,an=R/12;O='<div class="mm-total"><div class="mm-total-label">Total</div><div class="mm-total-value">'+N(R)+'</div><div class="mm-total-pix"><span>'+N(I)+" à vista no PIX</span>"+(W>0?'<span class="mm-total-pix-save">economia de '+N(W)+"</span>":"")+'</div><div class="mm-total-parcela">ou 12x de '+N(an)+" sem juros</div></div>"}else{var K=c/12;O='<div class="mm-total"><div class="mm-total-label">Subtotal</div><div class="mm-total-value">'+N(n.subtotalPix)+'</div><div class="mm-total-pix"><span>à vista no PIX</span></div><div class="mm-total-parcela">ou 12x de '+N(K)+" sem juros</div></div>"}return'<aside class="mm-id-sum mm-sum"><h2 class="mm-h">Resumo do pedido</h2><div class="mm-sum-card"><div class="mm-id-thumbs">'+s+'</div><div class="mm-rows">'+b+"</div>"+O+'<a class="mm-id-edit-cart" href="/checkout/cart"><span>Editar carrinho</span></a></div><a class="mm-help mm-sum-help" href="'+h+'" target="_blank" rel="noopener" data-mm-track="help-whats-sum">'+M.whats+"<span><strong>Ficou com alguma dúvida?</strong> Fale com a gente no WhatsApp</span></a></aside>"}function tt(){var n='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',t='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>',e='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="16" rx="2"/><line x1="7" y1="9" x2="17" y2="9"/><line x1="7" y1="13" x2="17" y2="13"/><line x1="7" y1="17" x2="13" y2="17"/></svg>',r='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>';return'<section class="mm-id-form-col"><h2 class="mm-id-h2">Quase lá! Identifique-se</h2><p class="mm-id-sub">Informe seu e-mail para finalizar a compra de forma rápida e segura.</p><form class="mm-id-form" data-mm-act="identify-submit" novalidate><div class="mm-input-wrap"><span class="mm-input-icon" aria-hidden="true">'+n+'</span><input type="email" id="mm-id-email" name="mm-email" class="mm-input" placeholder="seu@email.com" autocomplete="email" inputmode="email" required></div><p class="mm-id-microcopy">'+M.lock+'<span>Seu e-mail é seguro · Não compartilhamos com terceiros</span></p><button type="submit" class="mm-cta">Continuar'+M.arrow+'</button></form><div class="mm-id-divider"><span>ou</span></div><div class="mm-id-google-slot"></div><button type="button" class="mm-id-guest-toggle" data-mm-act="guest-go" aria-label="Continuar como visitante"><span class="mm-id-guest-icon" aria-hidden="true">'+t+'</span><span class="mm-id-guest-label">Continuar como visitante (sem criar conta)</span><span class="mm-id-guest-arrow" aria-hidden="true">'+M.arrow+'</span></button><div class="mm-trust mm-id-trust"><span class="mm-trust-item">'+M.lock+'<span>Pagamento seguro</span></span><span class="mm-trust-item">'+M.rotate+'<span>7 dias para troca</span></span><span class="mm-trust-item">'+M.shield+'<span>Garantia 12 meses</span></span></div><p class="mm-id-lgpd">Ao continuar, você concorda com nossa <a href="/politica-de-privacidade" target="_blank" rel="noopener">Política de Privacidade</a></p></section>'}function jn(n){var t=document.getElementById("mm-layout");if(t)return t.parentElement!==u&&u.insertBefore(t,u.firstChild),t;var e=document.createElement("div");return e.id="mm-layout",e.classList.add("mm-id-layout"),e.innerHTML=un("delivery")+'<div class="mm-grid mm-id-grid">'+tt()+Nn(n)+"</div>",u.insertBefore(e,u.firstChild),document.body.classList.add("mm-checkout-rebuild"),et(),u.classList.add("mm-shadow-mode"),document.documentElement.classList.remove("mm-cart-loading"),e}function et(){var n=document.querySelector(".mm-id-google-slot"),t=u.querySelector(".social-login-area");if(!(!n||!t)&&!n.contains(t))try{n.appendChild(t),n.classList.add("is-loaded")}catch{}}function bt(n){tn.set("mm_user_email",n);var t=u.querySelector("#login");if(!t)return!1;t.value=n,En(t);var e=t.closest("form"),r=e?e.querySelector('button.button-send, button[type="submit"]'):null;return r?(r.click(),!0):e?(e.submit(),!0):!1}function Ft(){var n=document.getElementById("mm-layout");!n||n._mmBound||(n._mmBound=!0,n.addEventListener("submit",function(t){var e=t.target.closest('[data-mm-act="identify-submit"]');if(e){t.preventDefault();var r=e.querySelector("#mm-id-email"),s=r?r.value.trim():"";if(!s||!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(s)){r&&(r.classList.add("mm-input-error"),r.focus(),setTimeout(function(){r.classList.remove("mm-input-error")},1500));return}var c=bt(s);if(c){var b=e.querySelector(".mm-cta");b&&b.classList.add("is-loading")}return}}),n.addEventListener("click",function(t){var e=t.target.closest("[data-mm-act]");if(e){var r=e.getAttribute("data-mm-act");r==="guest-go"&&(tn.set("mm_checkout_mode","guest"),e.classList.add("is-loading"),location.href="/checkout/onepage")}}))}function _n(n){try{var t=new DOMParser().parseFromString(n,"text/html"),e=t.querySelector("#checkout-main-area");if(!e)return null;for(var r=[],s=e.querySelectorAll(".cart-item"),c=0,b=0;b<s.length;b++){var A=s[b],O=A.querySelector("figure img")||A.querySelector("#product-img")||A.querySelector("img"),L=A.querySelector(".column-valor-produto .valor"),R=parseFloat(A.getAttribute("data-valor")||"0"),I=L?H(L.textContent):0;r.push({name:A.getAttribute("data-item-name")||A.getAttribute("data-name")||"",variant:A.getAttribute("data-item-variant")||"",imgSrc:O&&O.getAttribute("src")||"",quantity:parseInt(A.getAttribute("data-item-quantity")||"1",10),lineTotal:R,lineTotalPix:I,isPix:!!A.querySelector(".column-valor-produto .sub"),deposito:A.getAttribute("data-item-deposito")==="1"}),c+=R}if(r.length===0)return null;var W=e.querySelector("#resumo-compra .resumo-valores .value"),an=W?H(W.textContent):0;an<=0&&(an=r.reduce(function(bn,zn){return bn+(zn.lineTotalPix||0)},0));var K=e.querySelector("#resumo-compra .discount-value"),X=K?H(K.textContent):0,cn=e.querySelector("#resumo-compra .txt-cupom, #resumo-compra .alert.alert-type-1"),sn="";if(cn){var rn=cn.textContent.match(/([A-Z0-9]{3,})/);rn&&(sn=rn[1])}var on=e.querySelector("#resumo-compra .frete-calculado"),ln=null,Sn="";if(on){var w=on.querySelector(".servico-frete[data-valor-frete]");if(w){var k=w.getAttribute("data-valor-frete");if(k!==null&&k!==""){var G=parseFloat(k);isNaN(G)||(ln=G)}}var nn=on.textContent.trim();if(ln===null&&nn){var Q=H(nn);Q>0&&(ln=Q)}var vn=nn.match(/(\d+)\s*dias?/i);vn&&(Sn=vn[1]+" dias úteis")}return{ts:Date.now(),items:r,subtotalPix:an,subtotalFull:c,discount:X,couponCode:sn,shipping:ln,shippingDeadline:Sn,cepValue:""}}catch{return null}}function Un(n){try{fetch("/checkout/cart",{credentials:"include",headers:{"X-Requested-With":"XMLHttpRequest"}}).then(function(t){return t.text()}).then(function(t){var e=_n(t);e&&tn.set(j,JSON.stringify(e)),n(e)}).catch(function(){n(null)})}catch{n(null)}}function gt(n){var t=document.querySelector("#mm-layout .mm-id-sum");if(t){var e=t.parentNode;if(e){var r=document.createElement("div");r.innerHTML=Nn(n);var s=r.firstChild;s&&e.replaceChild(s,t)}}}function xt(){Un(function(n){n&&n.items&&n.items.length>0&&gt(n)})}if(v){let n=function(e){if(e=e||0,e>30){t();return}var r=u.querySelector("#login, #login-form-etapa-01");r||e>8?t():setTimeout(function(){n(e+1)},250)},t=function(){var e=dn();jn(e),Ft(),et(),setTimeout(et,600),setTimeout(et,1500),xt(),setTimeout(function(){var r=document.getElementById("mm-id-email");r&&!("ontouchstart"in window)&&r.focus()},250)};n()}function wt(n){var t=String(n||"").replace(/\D/g,"").slice(0,11);return t.length<=3?t:t.length<=6?t.slice(0,3)+"."+t.slice(3):t.length<=9?t.slice(0,3)+"."+t.slice(3,6)+"."+t.slice(6):t.slice(0,3)+"."+t.slice(3,6)+"."+t.slice(6,9)+"-"+t.slice(9)}function Tt(n){var t=String(n||"").replace(/\D/g,"").slice(0,11);return t.length<=2?t.length?"("+t:"":t.length<=6?"("+t.slice(0,2)+") "+t.slice(2):t.length<=10?"("+t.slice(0,2)+") "+t.slice(2,6)+"-"+t.slice(6):"("+t.slice(0,2)+") "+t.slice(2,7)+"-"+t.slice(7)}function yt(n){var t=String(n||"").replace(/\D/g,"").slice(0,8);return t.length<=5?t:t.slice(0,5)+"-"+t.slice(5)}function lt(n,t){var e=String(n||"").replace(/\D/g,"");if(e.length!==8){t(null);return}try{fetch("https://viacep.com.br/ws/"+e+"/json/",{headers:{Accept:"application/json"}}).then(function(r){return r.json()}).then(function(r){if(!r||r.erro){t(null);return}t({logradouro:r.logradouro||"",bairro:r.bairro||"",cidade:r.localidade||"",estado:r.uf||""})}).catch(function(){t(null)})}catch{t(null)}}var Hn={mail:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z"/></svg>',user:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',doc:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11zM8 12h8v2H8zm0 4h5v2H8z"/></svg>',phone:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20.01 15.38c-1.23 0-2.42-.2-3.53-.56-.35-.12-.74-.03-1.01.24l-1.57 1.97c-2.83-1.35-5.48-3.9-6.89-6.83l1.95-1.66c.27-.28.35-.67.24-1.02-.37-1.11-.56-2.3-.56-3.53 0-.54-.45-.99-.99-.99H4.19C3.65 3 3 3.24 3 3.99 3 13.28 10.73 21 20.01 21c.71 0 .99-.63.99-1.18v-3.45c0-.54-.45-.99-.99-.99z"/></svg>',pin:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>',home:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg>',pix:'<svg width="24" height="24" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true"><path d="M11.917 11.71a2.046 2.046 0 0 1-1.454-.602l-2.1-2.1a.4.4 0 0 0-.551 0l-2.108 2.108a2.044 2.044 0 0 1-1.454.602h-.414l2.66 2.66c.83.83 2.177.83 3.007 0l2.667-2.668h-.253zM4.25 4.282c.55 0 1.066.214 1.454.602l2.108 2.108a.39.39 0 0 0 .552 0l2.1-2.1a2.044 2.044 0 0 1 1.453-.602h.253L9.503 1.623a2.127 2.127 0 0 0-3.007 0l-2.66 2.66h.414z"/><path d="m14.377 6.496-1.612-1.612a.307.307 0 0 1-.114.023h-.733c-.379 0-.75.154-1.017.422l-2.1 2.1a1.005 1.005 0 0 1-1.425 0L5.268 5.32a1.448 1.448 0 0 0-1.018-.422h-.9a.306.306 0 0 1-.109-.021L1.623 6.496c-.83.83-.83 2.177 0 3.008l1.618 1.618a.305.305 0 0 1 .108-.022h.901c.38 0 .75-.153 1.018-.421L7.375 8.57a1.034 1.034 0 0 1 1.426 0l2.1 2.1c.267.268.638.421 1.017.421h.733c.04 0 .079.01.114.024l1.612-1.612c.83-.83.83-2.178 0-3.008z"/></svg>',cardBig:'<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4V6h16v2z"/></svg>',barcode:'<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M2 6h2v12H2zm3 0h1v12H5zm2 0h3v12H7zm4 0h1v12h-1zm3 0h2v12h-2zm3 0h1v12h-1zm2 0h3v12h-3z"/></svg>',editPencil:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04a.996.996 0 0 0 0-1.41l-2.34-2.34a.996.996 0 0 0-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>'};function st(n){var t=n?' value="'+D(n)+'"':"";return'<section class="mm-op-form-col"><h2 class="mm-id-h2">Falta pouco. Onde entregar?</h2><p class="mm-id-sub">Preencha seus dados e o endereço de entrega — o frete é calculado automaticamente.</p><form class="mm-op-form" data-mm-act="onepage-submit" novalidate><div class="mm-op-card"><h3 class="mm-op-card-title">'+Hn.user+'<span>Quem vai receber</span></h3><div class="mm-op-grid-2"><div class="mm-input-wrap mm-op-col-2"><span class="mm-input-icon" aria-hidden="true">'+Hn.mail+'</span><input type="email" id="mm-op-email" class="mm-input" placeholder="seu@email.com" autocomplete="email" inputmode="email" required'+t+'></div><div class="mm-input-wrap mm-op-col-2"><span class="mm-input-icon" aria-hidden="true">'+Hn.user+'</span><input type="text" id="mm-op-nome" class="mm-input" placeholder="Nome completo" autocomplete="name" required></div><div class="mm-input-wrap"><span class="mm-input-icon" aria-hidden="true">'+Hn.doc+'</span><input type="tel" id="mm-op-cpf" class="mm-input" placeholder="CPF" inputmode="numeric" autocomplete="off" maxlength="14" required></div><div class="mm-input-wrap"><span class="mm-input-icon" aria-hidden="true">'+Hn.phone+'</span><input type="tel" id="mm-op-tel" class="mm-input" placeholder="(11) 91234-5678" inputmode="tel" autocomplete="tel" maxlength="15" required></div></div><p class="mm-op-microcopy-soft">Usamos seus dados só pra emitir nota fiscal e te avisar da entrega.</p></div><div class="mm-op-card"><h3 class="mm-op-card-title">'+Hn.pin+'<span>Endereço de entrega</span></h3><div class="mm-op-grid-2"><div class="mm-input-wrap"><span class="mm-input-icon" aria-hidden="true">'+Hn.pin+'</span><input type="tel" id="mm-op-cep" class="mm-input" placeholder="CEP — 00000-000" inputmode="numeric" autocomplete="postal-code" maxlength="9" required><span class="mm-input-status" id="mm-op-cep-status" aria-live="polite"></span></div><a class="mm-op-cep-help" href="https://buscacepinter.correios.com.br/app/endereco/index.php" target="_blank" rel="noopener">Não sei meu CEP</a><div class="mm-input-wrap mm-op-col-2"><span class="mm-input-icon" aria-hidden="true">'+Hn.home+'</span><input type="text" id="mm-op-rua" class="mm-input" placeholder="Rua, Av, Travessa..." autocomplete="address-line1" required></div><div class="mm-input-wrap"><input type="tel" id="mm-op-num" class="mm-input mm-input-noicon" placeholder="Número" inputmode="numeric" required></div><div class="mm-input-wrap"><input type="text" id="mm-op-comp" class="mm-input mm-input-noicon" placeholder="Complemento (opcional)" autocomplete="address-line2"></div><div class="mm-input-wrap mm-op-col-2"><input type="text" id="mm-op-bairro" class="mm-input mm-input-noicon" placeholder="Bairro" autocomplete="address-level3" required></div><div class="mm-input-wrap"><input type="text" id="mm-op-cidade" class="mm-input mm-input-noicon" placeholder="Cidade" autocomplete="address-level2" required></div><div class="mm-input-wrap"><input type="text" id="mm-op-uf" class="mm-input mm-input-noicon" placeholder="UF" maxlength="2" autocomplete="address-level1" required></div></div><div class="mm-op-frete" id="mm-op-frete-slot"></div></div><button type="submit" class="mm-cta mm-op-cta">Última etapa: pagamento'+M.arrow+'</button><p class="mm-id-microcopy mm-op-cta-sub">'+M.lock+'<span>Você revisa tudo antes de finalizar</span></p></form><div class="mm-trust mm-id-trust"><span class="mm-trust-item">'+M.lock+'<span>Pagamento seguro</span></span><span class="mm-trust-item">'+M.rotate+'<span>7 dias para troca</span></span><span class="mm-trust-item">'+M.shield+"<span>Garantia 12 meses</span></span></div></section>"}function Lt(n,t){var e=document.getElementById("mm-layout");if(e)return e.parentElement!==u&&u.insertBefore(e,u.firstChild),e;var r=document.createElement("div");return r.id="mm-layout",r.classList.add("mm-id-layout"),r.classList.add("mm-op-layout"),r.innerHTML=un("delivery")+'<div class="mm-grid mm-id-grid mm-op-grid">'+st(t)+Nn(n)+"</div>",u.insertBefore(r,u.firstChild),document.body.classList.add("mm-checkout-rebuild"),u.classList.add("mm-shadow-mode"),document.documentElement.classList.remove("mm-cart-loading"),r}function ut(n){var t=document.getElementById("mm-op-frete-slot");if(t){if(n==="loading"){t.innerHTML='<div class="mm-op-frete-loading"><div class="mm-op-frete-spinner"></div><span>Calculando frete...</span></div>';return}if(n==="error"){t.innerHTML='<div class="mm-op-frete-error"><span>Não conseguimos calcular o frete. Confira o CEP e tente novamente.</span></div>';return}var e=n.value===0,r=e?'<strong class="mm-op-frete-value is-free">Grátis</strong>':'<strong class="mm-op-frete-value">'+N(n.value)+"</strong>",s=n.name?'<span class="mm-op-frete-name">'+D(n.name)+"</span>":"",c=n.deadline?'<span class="mm-op-frete-deadline">Entrega em '+D(n.deadline)+"</span>":"",b=n.city?'<span class="mm-op-frete-city">para '+D(n.city)+"</span>":"",A="";if(n.options&&n.options.length>1){A='<div class="mm-op-frete-options"><button type="button" class="mm-op-frete-toggle" data-mm-act="toggle-frete-opts" aria-expanded="false">Ver outras opções ('+n.options.length+')</button><div class="mm-op-frete-options-list" hidden>';for(var O=0;O<n.options.length;O++){var L=n.options[O],R=L.isSelected?" is-selected":"",I=L.isFree?'<span class="mm-op-frete-opt-value is-free">Grátis</span>':'<span class="mm-op-frete-opt-value">'+N(L.value)+"</span>";A+='<button type="button" class="mm-op-frete-opt'+R+'" data-mm-act="op-ship-select" data-ship-id="'+D(L.id)+'" aria-pressed="'+(L.isSelected?"true":"false")+'"><span class="mm-op-frete-opt-radio" aria-hidden="true"><span></span></span><span class="mm-op-frete-opt-body"><span class="mm-op-frete-opt-name">'+D(L.name||"Padrão")+"</span>"+(L.deadline?'<span class="mm-op-frete-opt-deadline">'+D(L.deadline)+"</span>":"")+"</span>"+I+"</button>"}A+="</div></div>"}t.innerHTML='<div class="mm-op-frete-card'+(e?" is-free":"")+'"><div class="mm-op-frete-icon">'+M.truck+'</div><div class="mm-op-frete-body"><div class="mm-op-frete-row">'+s+r+"</div>"+c+b+"</div></div>"+A}}function Et(n,t){var e=Cn(n),r="";try{var s=dn();r=s&&s.couponCode||""}catch{}var c="cep="+encodeURIComponent(e)+"&cupom-desconto="+encodeURIComponent(r);fetch("/checkout/cart?operation=atualizaValoresCarrinho",{method:"POST",credentials:"include",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},body:c}).then(function(b){return b.text()}).then(function(b){var A;try{A=new DOMParser().parseFromString(b,"text/html")}catch{t(null);return}for(var O=A.querySelectorAll(".servico-frete"),L=[],R=0;R<O.length;R++){var I=O[R],W=I.getAttribute("data-valor-frete");if(!(W===null||W==="")){var an=parseFloat(W);if(!isNaN(an)){var K=I.querySelector('input[type="radio"]'),X=I.querySelector(".dias-entrega"),cn=X?X.textContent.trim():"",sn=cn.match(/(\d+(?:\s*[aà]\s*\d+)?\s*dias?(?:\s*[úu]teis)?)/i);L.push({id:K?K.value:"",name:I.getAttribute("data-servico-frete")||"",deadline:sn?sn[1].replace(/\s+/g," "):"",value:an,isFree:an===0,isSelected:K?K.checked:!1})}}}if(!L.length){t(null);return}var rn=L.filter(function(ln){return ln.isSelected})[0];rn||(rn=L.reduce(function(ln,Sn){return Sn.value<ln.value?Sn:ln},L[0]),rn.isSelected=!0);var on=A.querySelector(".frete-location .city, .frete-calculado .city");t({value:rn.value,name:rn.name,deadline:rn.deadline,city:on?on.textContent.trim():"",options:L})}).catch(function(){t(null)})}function kt(){function n(nn){if(!nn)return"";var Q=nn.match(/(\d+(?:\s*[aà]\s*\d+)?)\s*dias?(?:\s*\([^)]+\))?\s*([úu]teis)?/i);return Q?Q[1].replace(/\s+/g," ")+" dias úteis":""}function t(nn){for(var Q=[],vn=nn.querySelectorAll(".servico-frete"),bn=0;bn<vn.length;bn++){var zn=vn[bn],Mn=zn.querySelector('input[type="radio"]'),In=zn.querySelector(".dias-entrega"),Kn=parseFloat(zn.getAttribute("data-valor-frete")||"0"),Gn=zn.getAttribute("data-servico-frete")||"",at=In?In.textContent.trim():"",rt=at.match(/(\d+(?:\s*[aà]\s*\d+)?\s*dias?(?:\s*[úu]teis)?)/i);Q.push({id:Mn?Mn.value:"",name:Gn,deadline:rt?rt[1].replace(/\s+/g," "):at,value:Kn,isFree:Kn===0,isSelected:Mn?Mn.checked:!1})}return Q}var e=u.querySelector(".frete-calculado");if(e&&e.textContent.trim()){var r=t(e),s=e.querySelector(".frete-location .city"),c=s?s.textContent.trim():"",b=r.filter(function(nn){return nn.isSelected})[0]||r[0];if(b)return{value:b.value,name:b.name,deadline:b.deadline,city:c,options:r};var A=e.querySelector(".info-frete-selec .info-title span, .info-title span"),O=e.querySelector(".info-frete-selec .dias-entrega, .dias-entrega"),L=e.querySelector(".value.valor-frete, .valor-frete .value"),R=e.textContent,I=null;if(L&&(/gr[aá]tis/i.test(L.textContent)?I=0:I=H(L.textContent)),I===null&&(/gr[aá]tis/i.test(R)?I=0:I=H(R)||null),I!==null)return{value:I,name:A?A.textContent.trim():"",deadline:n(O?O.textContent:R),city:c,options:[]}}var W=u.querySelector(".line-entrega"),an=u.querySelector(".value.valor-frete, .valor-frete .value");if(W||an){var K=((W||an).textContent||"").trim(),X=dn(),cn=X&&X.shippingName||"",sn=X&&X.shippingDeadline||"",rn=X&&X.shippingCity||"",on=X?X.shippingOptions||[]:[];if(K){var ln=(u.querySelector(".nome-servico-frete, .info-frete-selec .info-title span")||{}).textContent||"",Sn=(u.querySelector(".info-entrega, .prazo-entrega, .line-entrega .sub, .info-frete-selec .dias-entrega")||{}).textContent||"",w=n(Sn)||n(K)||sn,k=ln.trim()||cn;if(/gr[aá]tis/i.test(K))return{value:0,deadline:w,name:k,city:rn,options:on};var G=H(K);if(G>0)return{value:G,deadline:w,name:k,city:rn,options:on}}if(X&&X.shipping!==null&&X.shipping!==void 0)return{value:X.shipping,deadline:sn,name:cn,city:rn,options:on}}return null}function Jn(){var n=document.getElementById("mm-op-cep");if(n){var t=(n.value||"").replace(/\D/g,"");if(t.length===8){if(Jn._lastCep===t){var e=document.getElementById("mm-op-frete-slot");if(e&&e.querySelector(".mm-op-frete-card"))return}Jn._lastCep=t;var r=(Jn._token||0)+1;Jn._token=r,Zn(t);var s=u.querySelector("#cep, .input-cep");s&&(s.value=Cn(t),En(s)),ut("loading"),Et(t,function(c){if(Jn._token===r){if(!c){ut("error");return}ut(c);var b=dn();b&&(b.shipping=c.value,b.shippingDeadline=c.deadline,b.shippingName=c.name||"",b.shippingCity=c.city||"",b.shippingOptions=c.options||[],tn.set(j,JSON.stringify(b)),gt(b))}})}}}function Vn(){var n=document.getElementById("mm-layout");if(!n||n._mmOpBound)return;n._mmOpBound=!0,n.addEventListener("click",function(e){var r=e.target.closest('[data-mm-act="toggle-frete-opts"]');if(r){e.preventDefault();var s=r.parentElement.querySelector(".mm-op-frete-options-list");if(s){var c=s.hasAttribute("hidden");c?s.removeAttribute("hidden"):s.setAttribute("hidden",""),r.setAttribute("aria-expanded",c?"true":"false"),r.textContent=c?"Ocultar opções":"Ver outras opções"}return}var b=e.target.closest('[data-mm-act="op-ship-select"]');if(b){e.preventDefault();var A=b.getAttribute("data-ship-id");if(!A)return;var O=u.querySelector('.servico-frete input[type="radio"][value="'+A+'"]');if(!O){console.warn("[mm-op] modalidade não encontrada no DOM:",A);return}for(var L=n.querySelectorAll(".mm-op-frete-opt"),R=0;R<L.length;R++){var I=L[R],W=I.getAttribute("data-ship-id")===A;I.classList.toggle("is-selected",W),I.setAttribute("aria-pressed",W?"true":"false")}O.checked=!0,O.click();var an=dn();if(an&&an.shippingOptions&&an.shippingOptions.length){var K=an.shippingOptions.filter(function(X){return String(X.id)===String(A)})[0];K&&(an.shipping=K.value,an.shippingDeadline=K.deadline||"",an.shippingName=K.name||"",an.shippingOptions=an.shippingOptions.map(function(X){return X.isSelected=String(X.id)===String(A),X}),tn.set(j,JSON.stringify(an)),ut({value:K.value,deadline:K.deadline||"",name:K.name||"",city:an.shippingCity||"",options:an.shippingOptions}),gt(an))}return}}),n.addEventListener("submit",function(e){var r=e.target.closest('[data-mm-act="onepage-submit"]');if(r){e.preventDefault();var s={email:(document.getElementById("mm-op-email")||{}).value||"",nome:(document.getElementById("mm-op-nome")||{}).value||"",cpf:(document.getElementById("mm-op-cpf")||{}).value||"",tel:(document.getElementById("mm-op-tel")||{}).value||"",cep:(document.getElementById("mm-op-cep")||{}).value||"",rua:(document.getElementById("mm-op-rua")||{}).value||"",num:(document.getElementById("mm-op-num")||{}).value||"",comp:(document.getElementById("mm-op-comp")||{}).value||"",bairro:(document.getElementById("mm-op-bairro")||{}).value||"",cidade:(document.getElementById("mm-op-cidade")||{}).value||"",uf:(document.getElementById("mm-op-uf")||{}).value||""},c=[];if(/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(s.email.trim())||c.push("mm-op-email"),s.nome.trim().split(/\s+/).length<2&&c.push("mm-op-nome"),s.cpf.replace(/\D/g,"").length!==11&&c.push("mm-op-cpf"),s.tel.replace(/\D/g,"").length<10&&c.push("mm-op-tel"),s.cep.replace(/\D/g,"").length!==8&&c.push("mm-op-cep"),s.rua.trim()||c.push("mm-op-rua"),s.num.trim()||c.push("mm-op-num"),s.bairro.trim()||c.push("mm-op-bairro"),s.cidade.trim()||c.push("mm-op-cidade"),s.uf.trim()||c.push("mm-op-uf"),c.length){c.forEach(function(O){var L=document.getElementById(O);L&&(L.classList.add("mm-input-error"),setTimeout(function(){L.classList.remove("mm-input-error")},1800))});var b=document.getElementById(c[0]);b&&(b.focus(),b.scrollIntoView({block:"center",behavior:"smooth"}));return}var A=r.querySelector(".mm-cta");A&&A.classList.add("is-loading"),tn.set("mm_user_email",s.email.trim()),y(s)}}),n.addEventListener("input",function(e){var r=e.target;if(r){if(r.dataset&&r.dataset.mmCepFill==="1"&&delete r.dataset.mmCepFill,r.id==="mm-op-cpf")r.value=wt(r.value);else if(r.id==="mm-op-tel")r.value=Tt(r.value);else if(r.id==="mm-op-cep"){r.value=yt(r.value);var s=r.value.replace(/\D/g,"");s.length===8&&ft(s)}else r.id==="mm-op-uf"&&(r.value=(r.value||"").replace(/[^A-Za-z]/g,"").toUpperCase().slice(0,2));r.id&&r.id.indexOf("mm-op-")===0&&(Vn._draftTimer&&clearTimeout(Vn._draftTimer),Vn._draftTimer=setTimeout(gn,400))}});function t(){Vn._draftTimer&&(clearTimeout(Vn._draftTimer),Vn._draftTimer=null),gn()}n.addEventListener("blur",function(e){var r=e.target;r&&r.id&&r.id.indexOf("mm-op-")===0&&t()},!0),window.addEventListener("beforeunload",t)}function ft(n){var t=document.getElementById("mm-op-cep-status");t&&(t.className="mm-input-status is-loading",t.textContent="Buscando..."),lt(n,function(e){if(t&&(t.className="mm-input-status"),!e){t&&(t.className="mm-input-status is-error",t.textContent="CEP não encontrado",setTimeout(function(){t.className="mm-input-status",t.textContent=""},2500));return}t&&(t.className="mm-input-status is-ok",t.innerHTML=M.check,setTimeout(function(){t.className="mm-input-status",t.innerHTML=""},1800));var r=[["mm-op-rua",e.logradouro],["mm-op-bairro",e.bairro],["mm-op-cidade",e.cidade],["mm-op-uf",e.estado]];r.forEach(function(c){var b=document.getElementById(c[0]);!b||!c[1]||(!b.value||b.dataset.mmCepFill==="1")&&(b.value=c[1],b.dataset.mmCepFill="1")});var s=document.getElementById("mm-op-num");s&&setTimeout(function(){s.focus()},100),Jn._t&&clearTimeout(Jn._t),Jn._t=setTimeout(Jn,200)})}function a(n){if(!document.getElementById("mm-op-overlay")){var t=document.createElement("div");t.id="mm-op-overlay",t.innerHTML='<div class="mm-op-overlay-card"><div class="mm-op-overlay-spinner"></div><p class="mm-op-overlay-text">'+D(n||"Processando...")+"</p></div>",document.body.appendChild(t)}}var l=null;function p(){if(!window.__mmStep1Observed){window.__mmStep1Observed=!0;var n=/compraSemCadastro/i;try{var t=window.fetch;typeof t=="function"&&(window.fetch=function(s,c){var b=typeof s=="string"?s:s&&s.url||"",A=c&&c.body||"",O=n.test(b)||n.test(String(A)),L=t.apply(this,arguments);return O&&L.then(function(R){l&&(R&&R.ok?l.done=!0:l.failed=!0)}).catch(function(){l&&(l.failed=!0)}),L})}catch{}try{var e=XMLHttpRequest.prototype.open,r=XMLHttpRequest.prototype.send;XMLHttpRequest.prototype.open=function(s,c){return this.__mmU=c||"",e.apply(this,arguments)},XMLHttpRequest.prototype.send=function(s){try{if(n.test(this.__mmU||"")||n.test(String(s||""))){var c=this;c.addEventListener("load",function(){l&&(c.status>=200&&c.status<300?l.done=!0:l.failed=!0)}),c.addEventListener("error",function(){l&&(l.failed=!0)})}}catch{}return r.apply(this,arguments)}}catch{}}}function y(n){var t=document.querySelector(".mm-op-form .mm-op-retry");t&&t.remove();var e=n.nome.trim(),r=n.email.trim(),s=n.rua.trim(),c=n.bairro.trim(),b=n.cidade.trim(),A=n.uf.trim(),O=Cn(n.cep.replace(/\D/g,""));tn.set("mm_user_email",r);var L=function(R,I){var W=u.querySelector(R);if(!W)return!1;try{var an=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;an.call(W,I)}catch{W.value=I}return W.dispatchEvent(new Event("input",{bubbles:!0})),W.dispatchEvent(new Event("change",{bubbles:!0})),W.dispatchEvent(new Event("blur",{bubbles:!0})),!0};L("#nome-completo_2",e),L("#cpf_2",n.cpf),L("#email_3",r),L("#telefone_2",n.tel),L("#cep",O),L("#destinatario",e),L("#logradouro",s),L("#numero",n.num),L("#complemento",n.comp),L("#bairro",c),L("#cidade",b),L("#estado",A),a("Indo para o pagamento..."),setTimeout(function(){var R=document.getElementById("mm-layout");R&&(R.style.display="none"),u.classList.remove("mm-shadow-mode");function I(rn){var on=u.querySelector("#"+rn);return on?on.closest("form"):null}function W(){var rn=I("nome-completo_2");if(!rn)return!1;var on=rn.querySelector('button[type="submit"], input[type="submit"], button:not([type])');return on?(on.click(),!0):typeof rn.requestSubmit=="function"?(rn.requestSubmit(),!0):(rn.submit(),!0)}function an(){var rn=document.querySelector(".mz-toast-popup.error, .swal2-toast.swal2-icon-error");if(rn&&/inativo|realize login/i.test(rn.textContent||""))return"error";for(var on=document.querySelectorAll('button, [type="submit"]'),ln=0;ln<on.length;ln++){var Sn=(on[ln].textContent||"").toLowerCase();if(Sn.indexOf("cadastrar endere")!==-1&&on[ln].offsetParent!==null)return"ready"}return"wait"}function K(){var rn=I("cep");if(!rn)return!1;var on=rn.querySelector('button[type="submit"], input[type="submit"], button:not([type])');return on?(on.click(),!0):typeof rn.requestSubmit=="function"?(rn.requestSubmit(),!0):(rn.submit(),!0)}function X(rn){var on=document.getElementById("mm-op-overlay");on&&on.remove();var ln=document.getElementById("mm-layout");ln&&(ln.style.display=""),u.classList.add("mm-shadow-mode");var Sn=document.querySelector(".mm-op-form .mm-cta");Sn&&Sn.classList.remove("is-loading");var w=document.querySelector('.mm-op-form[data-mm-act="onepage-submit"]');if(w&&!w.querySelector(".mm-op-retry")){var k=document.createElement("div");k.className="mm-op-retry",k.setAttribute("data-mm-retry","1"),k.setAttribute("role","alert"),k.style.cssText="margin:14px 0;padding:12px 16px;border:1px solid #E7B84B;background:#FFF8E6;border-radius:12px;font-family:Poppins,system-ui,sans-serif;font-size:13px;color:#6B5313;line-height:1.45;",k.textContent=rn||"Quase lá — toque em “Última etapa: pagamento” novamente para concluir.",w.insertBefore(k,w.firstChild);try{k.scrollIntoView({block:"center",behavior:"smooth"})}catch{}}}function cn(rn){var on=document.querySelector('input[name="forma-pagto"], #forma-pagto-pix, #forma-pagto-cartao, #forma-pagto-boleto');if(on&&on.offsetParent!==null){try{S(n)}catch{var ln=document.getElementById("mm-op-overlay");ln&&ln.remove();var Sn=document.getElementById("mm-layout");Sn&&(Sn.style.display="none")}return}rn<30?setTimeout(function(){cn(rn+1)},250):X("Não conseguimos abrir o pagamento. Toque em “Última etapa: pagamento” para tentar de novo.")}p();var sn={done:!1,failed:!1};l=sn,setTimeout(function(){W();var rn=60,on=0;(function ln(){on++;var Sn=an();if(sn.failed||Sn==="error"){X("Não foi possível iniciar o pedido. Toque em “Última etapa: pagamento” para tentar de novo.");return}if(Sn==="ready"){K(),setTimeout(function(){cn(0)},800);return}if(on<rn){setTimeout(ln,400);return}sn.done?(K(),setTimeout(function(){cn(0)},800)):X("Está demorando mais que o normal. Toque em “Última etapa: pagamento” para tentar de novo.")})()},150)},100)}function q(){var n={pix:null,cartao:null,boleto:null},t=[];try{t=window.Zord&&window.Zord.Calculo&&window.Zord.Calculo.FormasPagamentoPedido||[]}catch{}t.forEach(function(I){var W=I.formaPagamento&&I.formaPagamento.id,an=I.formaPagamento&&I.formaPagamento.isCartao,K=I.condicoes||[];!K.length||!an||(!n.cartao||K.length>n.cartao.condicoes.length)&&(n.cartao={formaId:W,valorTotal:K[0].valorTotal,condicoes:K.map(function(X){return{nome:X.condicaoPagamento&&X.condicaoPagamento.nome,numParcelas:X.condicaoPagamento&&X.condicaoPagamento.numeroParcelas,valorParcela:X.valorParcela,valorTotal:X.valorTotal}})})});function e(I){if(!I)return 0;var W=I.getAttribute&&I.getAttribute("data-valor-total");if(W){var an=parseFloat(W);if(an>0)return an}var K=(I.textContent||"").replace(/[^\d,.]/g,"");return K.indexOf(",")!==-1&&(K=K.replace(/\./g,"").replace(",",".")),parseFloat(K)||0}var r=document.querySelector("#valor-total-pedido-pix, .valor-total-pix[data-valor-total]"),s=e(r);if(s>0)n.pix={formaId:17,valorTotal:s};else{var c=t.find&&t.find(function(I){return I.formaPagamento&&I.formaPagamento.id===17});c&&c.condicoes&&c.condicoes[0]&&(n.pix={formaId:17,valorTotal:c.condicoes[0].valorTotal})}var b=document.querySelector("#valor-total-pedido-boleto, .valor-total-boleto[data-valor-total]"),A=e(b);if(A>0)n.boleto={valorTotal:A};else{var O=t.find&&t.find(function(I){var W=I.formaPagamento&&I.formaPagamento.id,an=I.formaPagamento&&I.formaPagamento.isCartao;return!an&&W!==17&&I.condicoes&&I.condicoes.length});O&&(n.boleto={formaId:O.formaPagamento.id,valorTotal:O.condicoes[0].valorTotal})}if(!n.cartao){var L=document.querySelector(".valor-parcela-cartao");if(L){var R=e(L);R>0&&(n.cartao={valorTotal:R*12,condicoes:[]})}}return n}function S(n){var t=dn(),e=q();u.classList.add("mm-shadow-mode"),document.body.classList.add("mm-checkout-rebuild");var r=document.getElementById("mm-layout");(!r||r.parentElement!==u)&&(r&&r.parentElement&&r.parentElement.removeChild(r),r=document.createElement("div"),r.id="mm-layout",u.insertBefore(r,u.firstChild)),r.className="mm-op-layout mm-op-step3-layout",r.style.display="",r.innerHTML=B(t,n,e),document.documentElement.classList.remove("mm-cart-loading");var s=document.getElementById("mm-op-overlay");s&&s.remove();try{window.scrollTo({top:0,behavior:"smooth"})}catch{window.scrollTo(0,0)}J(n,e)}function B(n,t,e){var r=typeof renderGlobalFooter=="function"?renderGlobalFooter():"";return un("payment")+'<main class="mm-op-main"><div class="mm-op-step3-grid"><section class="mm-op-step3-left">'+Y(e)+V()+'</section><aside class="mm-op-step3-sum-wrap">'+_(t)+en(n,e,"pix")+"</aside></div></main>"+r}function _(n){var t=n||{},e=D(t.nome||""),r=D(t.email||""),s=D(t.cpf||""),c=D(t.tel||""),b=D(t.rua||""),A=D(t.num||""),O=t.comp?", "+D(t.comp):"",L=D(t.bairro||""),R=D(t.cidade||""),I=D(t.uf||""),W=D(t.cep||"");return'<div class="mm-op-step3-completed"><div class="mm-op-completed-card" data-section="dados"><div class="mm-op-completed-head"><span class="mm-op-completed-check">'+M.check+'</span><h3 class="mm-op-completed-title">Dados pessoais</h3><a href="/checkout/onepage" class="mm-op-completed-edit" data-mm-act="edit-dados" aria-label="Editar dados">'+Hn.editPencil+' Editar</a></div><dl class="mm-op-completed-body">'+(e?"<div><dt>Nome</dt><dd>"+e+"</dd></div>":"")+(r?"<div><dt>E-mail</dt><dd>"+r+"</dd></div>":"")+(s?"<div><dt>CPF</dt><dd>"+s+"</dd></div>":"")+(c?"<div><dt>Telefone</dt><dd>"+c+"</dd></div>":"")+'</dl></div><div class="mm-op-completed-card" data-section="endereco"><div class="mm-op-completed-head"><span class="mm-op-completed-check">'+M.check+'</span><h3 class="mm-op-completed-title">Endereço de entrega</h3><a href="/checkout/onepage" class="mm-op-completed-edit" data-mm-act="edit-endereco" aria-label="Editar endereço">'+Hn.editPencil+' Editar</a></div><address class="mm-op-completed-address">'+b+", "+A+O+"<br>"+L+" — "+R+"/"+I+"<br>"+(W?"CEP "+W:"")+"</address></div></div>"}function Y(n){var t=n.pix?n.pix.valorTotal:0,e=n.cartao?n.cartao.valorTotal:0,r=n.boleto?n.boleto.valorTotal:0,s=e>t?e-t:0,c=null;n.cartao&&n.cartao.condicoes&&n.cartao.condicoes.length&&(c=n.cartao.condicoes[n.cartao.condicoes.length-1]);var b=c?"até "+c.numParcelas+"x de "+N(c.valorParcela)+" sem juros":e>0?"até 12x sem juros":"Cartão de crédito",A='<label class="mm-op-pay-radio is-active" data-forma="pix"><input type="radio" name="mm-pay" value="pix" checked><div class="mm-op-pay-head"><span class="mm-op-pay-radio-dot" aria-hidden="true"></span><span class="mm-op-pay-icon">'+Hn.pix+'</span><div class="mm-op-pay-body"><span class="mm-op-pay-title">PIX</span><span class="mm-op-pay-sub">Aprovação instantânea · em 1 minuto</span></div><div class="mm-op-pay-price">'+(s>0?'<span class="mm-op-pay-badge-save">Economize '+N(s)+"</span>":"")+'<span class="mm-op-pay-amount">'+N(t)+'</span></div></div><div class="mm-op-pay-detail"><ul class="mm-op-pay-benefits"><li>'+M.check+"<span>QR Code e Copia-e-Cola após confirmar</span></li><li>"+M.check+"<span>Pedido aprovado em até 1 minuto</span></li><li>"+M.check+"<span>Pagamento 100% seguro · sem dados de cartão</span></li></ul></div></label>",O='<div class="mm-op-pay-brands"><img src="https://public-resources.zordcdn.com.br/assets/global/payment-vector/cartao-visa.svg" alt="Visa" width="32" height="20"><img src="https://public-resources.zordcdn.com.br/assets/global/payment-vector/cartao-mastercard.svg" alt="Mastercard" width="32" height="20"><img src="https://public-resources.zordcdn.com.br/assets/global/payment-vector/cartao-american-express.svg" alt="American Express" width="32" height="20"><img src="https://public-resources.zordcdn.com.br/assets/global/payment-vector/cartao-elo.svg" alt="Elo" width="32" height="20"><img src="https://public-resources.zordcdn.com.br/assets/global/payment-vector/cartao-hipercard.svg" alt="Hipercard" width="32" height="20"></div>',L='<span class="mm-op-req" aria-hidden="true">*</span>';function R(K){return'<span class="mm-op-field-err" id="'+K+'-err" role="alert" aria-live="polite"></span>'}var I='<div class="mm-op-card-form"><div class="mm-op-card-field mm-op-card-field-full"><label for="mm-pay-card-num">Número do cartão'+L+'</label><div class="mm-input-wrap mm-input-wrap-card"><span class="mm-input-icon" aria-hidden="true">'+M.card+'</span><input id="mm-pay-card-num" type="tel" class="mm-input" inputmode="numeric" autocomplete="off" data-mmac="cc-number" placeholder="0000 0000 0000 0000" maxlength="23" aria-describedby="mm-pay-card-num-err" aria-required="true" disabled><span class="mm-op-card-brand-detected" aria-live="polite"></span></div>'+R("mm-pay-card-num")+'</div><div class="mm-op-card-field mm-op-card-field-full"><label for="mm-pay-card-name">Nome impresso no cartão'+L+'</label><input id="mm-pay-card-name" type="text" class="mm-input mm-input-noicon" autocomplete="off" data-mmac="cc-name" placeholder="Como aparece no cartão" maxlength="100" aria-describedby="mm-pay-card-name-err" aria-required="true" disabled>'+R("mm-pay-card-name")+'</div><div class="mm-op-card-field mm-op-card-field-half"><label for="mm-pay-card-exp">Validade'+L+'</label><input id="mm-pay-card-exp" type="tel" class="mm-input mm-input-noicon" inputmode="numeric" autocomplete="off" data-mmac="cc-exp" placeholder="MM/AA" maxlength="5" aria-describedby="mm-pay-card-exp-err" aria-required="true" disabled>'+R("mm-pay-card-exp")+'</div><div class="mm-op-card-field mm-op-card-field-half"><label for="mm-pay-card-cvv">CVV'+L+'</label><input id="mm-pay-card-cvv" type="tel" class="mm-input mm-input-noicon" inputmode="numeric" autocomplete="off" data-mmac="cc-csc" placeholder="000" maxlength="4" aria-describedby="mm-pay-card-cvv-err" aria-required="true" disabled>'+R("mm-pay-card-cvv")+'</div><div class="mm-op-card-field mm-op-card-field-full"><label for="mm-pay-card-installments">Condições de pagamento'+L+'</label><select id="mm-pay-card-installments" class="mm-input mm-input-noicon mm-op-card-installments" aria-describedby="mm-pay-card-installments-err" aria-required="true" disabled><option value="">Digite o cartão pra ver as condições</option></select>'+R("mm-pay-card-installments")+"</div></div>",W='<label class="mm-op-pay-radio" data-forma="cartao"><input type="radio" name="mm-pay" value="cartao"><div class="mm-op-pay-head"><span class="mm-op-pay-radio-dot" aria-hidden="true"></span><span class="mm-op-pay-icon">'+Hn.cardBig+'</span><div class="mm-op-pay-body"><span class="mm-op-pay-title">Cartão de Crédito</span><span class="mm-op-pay-sub">'+D(b)+'</span></div><div class="mm-op-pay-price"><span class="mm-op-pay-amount">'+N(e)+'</span></div></div><div class="mm-op-pay-detail">'+O+I+"</div></label>",an='<label class="mm-op-pay-radio" data-forma="boleto"><input type="radio" name="mm-pay" value="boleto"><div class="mm-op-pay-head"><span class="mm-op-pay-radio-dot" aria-hidden="true"></span><span class="mm-op-pay-icon">'+Hn.barcode+'</span><div class="mm-op-pay-body"><span class="mm-op-pay-title">Boleto Bancário</span><span class="mm-op-pay-sub">Aprovação em 1 a 3 dias úteis</span></div><div class="mm-op-pay-price"><span class="mm-op-pay-amount">'+N(r)+'</span></div></div><div class="mm-op-pay-detail"><ul class="mm-op-pay-benefits"><li>'+M.check+"<span>Código de barras enviado por e-mail</span></li><li>"+M.check+"<span>Pagamento em banco, lotérica ou app</span></li><li>"+M.check+"<span>Vencimento em 3 dias úteis</span></li></ul></div></label>";return'<section class="mm-op-step3-card" aria-labelledby="mm-op-step3-h"><div class="mm-op-step3-heading"><h2 id="mm-op-step3-h" class="mm-h">Como você quer pagar?</h2><p class="mm-op-step3-sub">Última etapa · escolha sua forma de pagamento '+(s>0?"· PIX tem desconto de "+N(s):"")+'</p></div><div class="mm-op-pay-radios" role="radiogroup" aria-label="Forma de pagamento">'+A+W+an+'</div><button type="button" class="mm-cta mm-op-cta mm-op-finalizar" data-mm-act="finalizar-compra">'+M.lock+'<span class="mm-op-finalizar-label">Finalizar compra · '+N(t)+'</span></button><p class="mm-op-finalizar-sub">'+M.shield+"<span>Pagamento seguro · criptografia SSL-256 · seus dados não são armazenados</span></p></section>"}function V(){return'<div class="mm-op-trust-payment"><div class="mm-op-trust-payment-row"><span class="mm-trust-item">'+M.lock+'<span>Site 100% seguro</span></span><span class="mm-trust-item">'+M.shield+'<span>Garantia 12 meses</span></span><span class="mm-trust-item">'+M.rotate+'<span>7 dias pra trocar</span></span><span class="mm-trust-item">'+M.whats+'<span>Atendimento humano</span></span></div><p class="mm-op-trust-payment-note">Ao finalizar, você concorda com os <a href="/termos-de-uso" target="_blank" rel="noopener">termos de compra</a> e a <a href="/politica-privacidade" target="_blank" rel="noopener">política de privacidade</a>.</p></div>'}function en(n,t,e){if(!n||!n.items||!n.items.length)return'<aside class="mm-id-sum mm-sum mm-op-step3-sum"><h2 class="mm-h">Resumo</h2><div class="mm-sum-card"><p class="mm-sum-empty">Não conseguimos carregar o resumo do seu pedido.</p></div></aside>';var r=t.pix?t.pix.valorTotal:0,s=t.cartao?t.cartao.valorTotal:0,c=t.boleto?t.boleto.valorTotal:0,b=s>r?s-r:0,A=e==="pix"?r:e==="boleto"?c:s,O=e==="pix"?"no PIX":e==="boleto"?"no boleto":"no cartão",L=3,R=n.items.slice(0,L),I=n.items.length-L,W=R.map(function(sn){var rn=sn.imgSrc?'<img src="'+D(sn.imgSrc)+'" alt="'+D(sn.name)+'" loading="lazy">':'<div class="mm-id-thumb-placeholder">'+M.box+"</div>",on=sn.quantity>1?'<strong class="mm-id-thumb-qty">'+sn.quantity+"×</strong> ":"",ln=sn.lineTotalPix>0?sn.lineTotalPix:sn.lineTotal;return'<div class="mm-id-thumb"><div class="mm-id-thumb-img">'+rn+'</div><div class="mm-id-thumb-body"><p class="mm-id-thumb-name">'+on+D(sn.name)+"</p>"+(sn.variant?'<p class="mm-id-thumb-variant">'+D(sn.variant)+"</p>":"")+'</div><div class="mm-id-thumb-price">'+N(ln)+"</div></div>"}).join("");I>0&&(W+='<div class="mm-id-thumb-more">+ '+I+" "+(I===1?"item":"itens")+" a mais</div>");var an=n.subtotalFull>0?n.subtotalFull:n.subtotalPix,K='<div class="mm-row"><span class="mm-row-label">Subtotal</span><span class="mm-row-value">'+N(an)+"</span></div>";if(n.shipping!==null&&n.shipping!==void 0){var X=n.shipping===0?'<span class="mm-row-value is-free">'+M.check+" Grátis</span>":'<span class="mm-row-value">'+N(n.shipping)+"</span>";K+='<div class="mm-row"><span class="mm-row-label">Frete'+(n.shippingDeadline?' <span class="mm-row-sub">· '+D(n.shippingDeadline)+"</span>":"")+"</span>"+X+"</div>"}n.discount>0&&(K+='<div class="mm-row"><span class="mm-row-label">Cupom'+(n.couponCode?' <span class="mm-row-sub">· '+D(n.couponCode)+"</span>":"")+'</span><span class="mm-row-value is-discount">− '+N(n.discount)+"</span></div>"),b>0&&e==="pix"&&(K+='<div class="mm-row mm-row-pix-discount"><span class="mm-row-label">'+M.bolt+' Desconto PIX</span><span class="mm-row-value is-discount">− '+N(b)+"</span></div>");var cn='<div class="mm-total"><div class="mm-total-label">Total</div><div class="mm-total-value" data-mm-total>'+N(A)+'</div><div class="mm-total-pix" data-mm-total-sub><span>'+O+"</span></div></div>";return'<aside class="mm-id-sum mm-sum mm-op-step3-sum" data-active-forma="'+D(e)+'"><h2 class="mm-h">Resumo do pedido</h2><div class="mm-sum-card"><div class="mm-id-thumbs">'+W+'</div><div class="mm-sum-rows">'+K+"</div>"+cn+"</div></aside>"}function J(n,t){var e=document.getElementById("mm-layout");if(!e||e._mmStep3Bound)return;e._mmStep3Bound=!0;var r=dn(),s={activeForma:"pix",cardNumValid:!1,cardBrand:null,cardInstallments:null,submitting:!1};e.addEventListener("click",function(w){var k=w.target.closest(".mm-op-pay-radio");if(k){var G=k.querySelector('input[type="radio"]');G&&!G.checked&&(w.preventDefault(),G.checked=!0,L(k.getAttribute("data-forma")));return}if(w.target.closest('[data-mm-act="finalizar-compra"]')){w.preventDefault(),Sn();return}var nn=w.target.closest('[data-mm-act="edit-dados"], [data-mm-act="edit-endereco"]');if(nn){w.preventDefault(),location.reload();return}}),e.addEventListener("input",function(w){var k=w.target;!k||!k.id||(k.id==="mm-pay-card-num"?K(k):k.id==="mm-pay-card-exp"?X(k):k.id==="mm-pay-card-cvv"&&(k.value=(k.value||"").replace(/\D/g,"").slice(0,4)))}),e.addEventListener("change",function(w){if(w.target&&w.target.id==="mm-pay-card-installments"){var k=w.target,G=k.options[k.selectedIndex];G&&G.value&&(s.cardInstallments={numero:parseInt(G.value,10),label:G.textContent||""},rn(G.value),b("mm-pay-card-installments"))}}),e.addEventListener("blur",function(w){var k=w.target;if(!(!k||!k.id)){var G=["mm-pay-card-num","mm-pay-card-name","mm-pay-card-exp","mm-pay-card-cvv"];G.indexOf(k.id)!==-1&&A(k.id)}},!0),e.addEventListener("focus",function(w){var k=w.target;!k||!k.id||/^mm-pay-card-/.test(k.id)&&b(k.id)},!0);function c(w,k){var G=document.getElementById(w),nn=document.getElementById(w+"-err");G&&(G.classList.add("mm-input-error"),G.setAttribute("aria-invalid","true")),nn&&(nn.textContent=k,nn.classList.add("is-visible"))}function b(w){var k=document.getElementById(w),G=document.getElementById(w+"-err");k&&(k.classList.remove("mm-input-error"),k.removeAttribute("aria-invalid")),G&&(G.textContent="",G.classList.remove("is-visible"))}function A(w){var k=document.getElementById(w);if(!k)return!0;var G=(k.value||"").trim();if(w==="mm-pay-card-num"){var nn=G.replace(/\D/g,"");return nn?nn.length<13?(c(w,"Número do cartão incompleto"),!1):O(nn)?(b(w),!0):(c(w,"Número do cartão inválido — confira os dígitos"),!1):(c(w,"Informe o número do cartão"),!1)}if(w==="mm-pay-card-name")return G?G.split(/\s+/).length<2?(c(w,"Use o nome completo como aparece no cartão"),!1):(b(w),!0):(c(w,"Informe o nome impresso no cartão"),!1);if(w==="mm-pay-card-exp"){var Q=G.replace(/\D/g,"");if(Q.length!==4)return c(w,"Informe a validade no formato MM/AA"),!1;var vn=parseInt(Q.slice(0,2),10),bn=parseInt(Q.slice(2),10);if(vn<1||vn>12)return c(w,"Mês inválido (01 a 12)"),!1;var zn=new Date,Mn=zn.getFullYear()%100,In=zn.getMonth()+1;return bn<Mn||bn===Mn&&vn<In?(c(w,"Cartão expirado"),!1):(b(w),!0)}if(w==="mm-pay-card-cvv"){var Kn=G.replace(/\D/g,"");return Kn.length<3?(c(w,"CVV deve ter 3 ou 4 dígitos"),!1):(b(w),!0)}return w==="mm-pay-card-installments"?G?(b(w),!0):(c(w,"Selecione o número de parcelas"),!1):!0}function O(w){for(var k=0,G=!1,nn=w.length-1;nn>=0;nn--){var Q=parseInt(w.charAt(nn),10);G&&(Q*=2,Q>9&&(Q-=9)),k+=Q,G=!G}return k%10===0}function L(w){if(!(!w||s.activeForma===w)){s.activeForma=w,e.querySelectorAll(".mm-op-pay-radio").forEach(function(Q){Q.classList.toggle("is-active",Q.getAttribute("data-forma")===w)});var k=document.getElementById("forma-pagto-"+w);if(k&&!k.checked)try{k.click()}catch{}var G=e.querySelectorAll(".mm-op-card-form input, .mm-op-card-form select"),nn=w==="cartao";G.forEach(function(Q){Q.disabled=!nn,nn?Q.dataset.mmac&&Q.setAttribute("autocomplete",Q.dataset.mmac):Q.setAttribute("autocomplete","off")}),R(w),w==="cartao"&&setTimeout(function(){var Q=document.getElementById("mm-pay-card-num");Q&&!Q.value&&Q.focus()},250)}}function R(w){var k=e.querySelector(".mm-op-step3-sum");if(k){k.setAttribute("data-active-forma",w);var G=t.pix?t.pix.valorTotal:0,nn=t.cartao?t.cartao.valorTotal:0,Q=t.boleto?t.boleto.valorTotal:0,vn=nn>G?nn-G:0,bn=w==="pix"?G:w==="boleto"?Q:nn,zn=w==="pix"?"no PIX":w==="boleto"?"no boleto":"no cartão",Mn=k.querySelector("[data-mm-total]");if(Mn){var In=Mn.textContent||"",Kn=H(In);Kn!==bn?I(Mn,Kn,bn,360):Mn.textContent=N(bn)}var Gn=k.querySelector("[data-mm-total-sub] span");Gn&&Gn.textContent!==zn&&(Gn.textContent=zn);var at=k.querySelector(".mm-sum-rows"),rt=at?at.querySelector(".mm-row-pix-discount"):null;if(w==="pix"&&vn>0){if(!rt&&at){var ht=document.createElement("div");ht.innerHTML='<div class="mm-row mm-row-pix-discount"><span class="mm-row-label">'+M.bolt+' Desconto PIX</span><span class="mm-row-value is-discount">− '+N(vn)+"</span></div>",at.appendChild(ht.firstChild)}}else rt&&rt.remove();W(w)}}function I(w,k,G,nn){w._mmAnimToken&&cancelAnimationFrame(w._mmAnimToken);var Q=null,vn=G-k;function bn(zn){Q||(Q=zn);var Mn=zn-Q,In=Math.min(1,Mn/nn),Kn=1-Math.pow(1-In,3),Gn=k+vn*Kn;w.textContent=N(Gn),In<1?w._mmAnimToken=requestAnimationFrame(bn):(w.textContent=N(G),w._mmAnimToken=null)}w._mmAnimToken=requestAnimationFrame(bn)}function W(w){var k=e.querySelector(".mm-op-finalizar-label");if(k){var G=w==="pix"?t.pix&&t.pix.valorTotal:w==="boleto"?t.boleto&&t.boleto.valorTotal:t.cartao&&t.cartao.valorTotal;k.textContent="Finalizar compra · "+N(G||0)}}function an(w){var k=(w||"").replace(/\D/g,"");return k?/^4/.test(k)?"visa":/^(5[1-5]|22[2-9]|2[3-6]|27[01]|2720)/.test(k)?"mastercard":/^3[47]/.test(k)?"amex":/^(4011|4312|4389|4514|4573|5041|5066|5067|509|6277|6362|6363|650|6516|6550)/.test(k)?"elo":/^(606282|384100|384140|384160|606|637095|637568|637599|637609|637612)/.test(k)?"hipercard":null:null}function K(w){var k=(w.value||"").replace(/\D/g,"").slice(0,19),G=k.replace(/(\d{4})(?=\d)/g,"$1 ");if(G!==w.value){var nn=w.selectionStart;w.value=G;try{w.setSelectionRange(nn+1,nn+1)}catch{}}var Q=an(k);s.cardBrand=Q,s.cardNumValid=k.length>=13;var vn=e.querySelector(".mm-op-card-brand-detected");vn&&(vn.className="mm-op-card-brand-detected"+(Q?" is-"+Q:""),vn.textContent=Q?Q.toUpperCase():""),k.length>=6&&(cn(k),ln())}function X(w){var k=(w.value||"").replace(/\D/g,"").slice(0,4),G=k.length>2?k.slice(0,2)+"/"+k.slice(2):k;if(w.value=G,k.length===4){var nn=k.slice(0,2),Q="20"+k.slice(2);sn("pag-cartao-mes-validade",String(parseInt(nn,10))),sn("pag-cartao-ano-validade",Q)}}function cn(w){var k=document.getElementById("pag-cartao-numero");if(k){try{var G=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;G.call(k,w)}catch{k.value=w}k.dispatchEvent(new Event("input",{bubbles:!0})),k.dispatchEvent(new Event("change",{bubbles:!0})),k.dispatchEvent(new Event("blur",{bubbles:!0}))}}function sn(w,k){var G=document.getElementById(w);if(G){try{var nn=Object.getOwnPropertyDescriptor(window.HTMLSelectElement.prototype,"value").set;nn.call(G,k)}catch{G.value=k}G.dispatchEvent(new Event("change",{bubbles:!0}))}}function rn(w){sn("pag-cartao-parcela",w)}var on=null;function ln(){if(on)return;var w=document.getElementById("pag-cartao-parcela");if(!w)return;var k=document.getElementById("mm-pay-card-installments");if(!k)return;function G(){var nn=w.querySelectorAll("option");if(!(nn.length<=1)){var Q="";nn.forEach(function(vn){if(!vn.value){Q+='<option value="">Selecione as parcelas</option>';return}Q+='<option value="'+D(vn.value)+'">'+D(vn.textContent.trim())+"</option>"}),k.innerHTML=Q,k.options.length>1&&(k.selectedIndex=1,s.cardInstallments={numero:parseInt(k.options[1].value,10)||1,label:k.options[1].textContent},rn(k.options[1].value))}}G(),on=new MutationObserver(G),on.observe(w,{childList:!0,subtree:!0})}function Sn(){if(console.log("[mm-checkout] submitFinalizar() entry",{submitting:s.submitting,activeForma:s.activeForma}),s.submitting)return;var w=s.activeForma,k=e.querySelector(".mm-op-finalizar");if(!k){console.log("[mm-checkout] submitFinalizar: no .mm-op-finalizar btn");return}if(w==="cartao"){var G=["mm-pay-card-num","mm-pay-card-name","mm-pay-card-exp","mm-pay-card-cvv","mm-pay-card-installments"],nn=G.filter(function(yn){return!A(yn)});if(console.log("[mm-checkout] validation",{errorCount:nn.length,errors:nn}),nn.length){var Q=document.getElementById(nn[0]);if(Q){Q.focus();try{Q.scrollIntoView({block:"center",behavior:"smooth"})}catch{}}return}var vn=document.getElementById("mm-pay-card-name"),bn=document.getElementById("mm-pay-card-cvv"),zn=document.getElementById("pag-cartao-titular");if(zn){try{var Mn=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;Mn.call(zn,vn.value.trim())}catch{zn.value=vn.value.trim()}zn.dispatchEvent(new Event("input",{bubbles:!0})),zn.dispatchEvent(new Event("blur",{bubbles:!0}))}var In=document.getElementById("pag-cartao-vericacao");if(In){try{var Kn=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;Kn.call(In,bn.value.replace(/\D/g,""))}catch{In.value=bn.value.replace(/\D/g,"")}In.dispatchEvent(new Event("input",{bubbles:!0})),In.dispatchEvent(new Event("blur",{bubbles:!0}))}var Gn=document.getElementById("pag-cartao-cpf");if(Gn&&n&&n.cpf){try{var at=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;at.call(Gn,n.cpf)}catch{Gn.value=n.cpf}Gn.dispatchEvent(new Event("input",{bubbles:!0})),Gn.dispatchEvent(new Event("blur",{bubbles:!0}))}}s.submitting=!0,k.classList.add("is-loading"),k.setAttribute("aria-busy","true");var rt=k.querySelector(".mm-op-finalizar-label");if(rt&&(rt.textContent="Processando pagamento..."),a("Finalizando seu pedido..."),w==="cartao"){var ht=document.getElementById("mm-pay-card-installments");ht&&ht.value&&rn(ht.value)}window.__mmCheckoutDebug=window.__mmCheckoutDebug||[];function An(yn,$n){var Wn={t:new Date().toISOString(),msg:yn,data:$n};window.__mmCheckoutDebug.push(Wn),console.log("[mm-checkout]",yn,$n||"")}function vt(){if(An("doSubmit() called",{forma:w}),w==="cartao"){var yn=document.getElementById("aceito-termos-bcash-one-card");yn&&!yn.checked&&(yn.checked=!0,yn.dispatchEvent(new Event("change",{bubbles:!0}))),An("terms",{checked:yn?.checked})}var $n=w==="pix"?"form-pag-pix":w==="boleto"?"form-pag-boleto":"form-pag-cartao",Wn=document.getElementById($n);if(!Wn){An("ERROR: form not found",{formId:$n}),alert("Erro interno: formulário de pagamento não encontrado. Recarregue a página."),s.submitting=!1,k.classList.remove("is-loading");var ot=document.getElementById("mm-op-overlay");ot&&ot.remove();return}w==="cartao"&&An("pre-submit cartao state",{numero:document.getElementById("pag-cartao-numero")?.value,bandeira:document.getElementById("pag-cartao-bandeira")?.value,parcela:document.getElementById("pag-cartao-parcela")?.value,titular:document.getElementById("pag-cartao-titular")?.value,mes:document.getElementById("pag-cartao-mes-validade")?.value,ano:document.getElementById("pag-cartao-ano-validade")?.value,cvv:document.getElementById("pag-cartao-vericacao")?.value?.length,cpf:document.getElementById("pag-cartao-cpf")?.value,tokenMp:document.getElementById("pag-cartao-token-mp")?.value?.substring(0,20)});var it=Wn.querySelector('button.button-success, button[type="submit"], input[type="submit"]');if(it)An("clicking native button",{text:it.textContent?.trim()}),it.click();else if(typeof Wn.requestSubmit=="function"){An("no native btn, using requestSubmit");try{Wn.requestSubmit()}catch(pt){An("requestSubmit error",pt.message),Wn.submit()}}else An("no native btn, using form.submit()"),Wn.submit();setTimeout(function(){if(s.submitting&&location.pathname.indexOf("/onepage")!==-1){An("8s failsafe: still on /onepage, removing overlay"),s.submitting=!1,k.classList.remove("is-loading");var pt=document.getElementById("mm-op-overlay");pt&&pt.remove(),u.classList.remove("mm-shadow-mode"),e&&(e.style.display="none")}},8e3),setTimeout(function(){u.classList.remove("mm-shadow-mode"),e&&(e.style.display="none")},600)}function St(){s.submitting=!1,k.classList.remove("is-loading"),k.removeAttribute("aria-busy");var yn=k.querySelector(".mm-op-finalizar-label");yn&&(yn.textContent="Finalizar compra");var $n=document.getElementById("mm-op-overlay");$n&&$n.remove()}function Mt(){var yn=Date.now(),$n=1e4;(function Wn(){var ot=document.getElementById("pag-cartao-token-mp"),it=ot?(ot.value||"").trim():"",pt=it&&it!=="loading..."&&it.length>10;if(pt){An("fallback: token ready"),vt();return}if(Date.now()-yn>=$n){An("fallback: timeout",{lastVal:it}),vt();return}setTimeout(Wn,200)})()}function Dt(){if(An("generateMpTokenAndSubmit() start"),typeof Mercadopago>"u"){An("Mercadopago global missing, falling back to wait strategy"),Mt();return}var yn=document.getElementById("pag-cartao-token-mp"),$n=yn?(yn.value||"").trim():"";if($n&&$n!=="loading..."&&$n.length>10){An("token already present, submitting",{len:$n.length}),vt();return}var Wn=(document.getElementById("mm-pay-card-num")?.value||"").replace(/\D/g,""),ot=(document.getElementById("mm-pay-card-exp")?.value||"").replace(/\D/g,""),it=(document.getElementById("mm-pay-card-cvv")?.value||"").replace(/\D/g,""),pt=(document.getElementById("mm-pay-card-name")?.value||"").trim(),Bt=(n&&n.cpf||document.getElementById("mm-op-cpf")?.value||"").replace(/\D/g,"");if(!Wn||!ot||!it||!pt||!Bt){An("missing card fields",{num:Wn.length,exp:ot.length,cvv:it.length,name:!!pt,doc:Bt.length}),alert("Preencha todos os dados do cartão antes de finalizar."),St();return}var It=ot.slice(0,2),Pt=ot.length===4?"20"+ot.slice(2):ot.slice(2);An("calling Mercadopago.createToken",{numLen:Wn.length,month:It,year:Pt});try{Mercadopago.createToken({cardNumber:Wn,securityCode:it,cardExpirationMonth:It,cardExpirationYear:Pt,cardholderName:pt,docType:"CPF",docNumber:Bt},function(Ct,ct){if(An("createToken callback",{status:Ct,hasId:!!(ct&&ct.id),err:ct&&ct.error}),Ct===200||Ct===201){if(yn){var Rt=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;Rt.call(yn,ct.id),yn.dispatchEvent(new Event("input",{bubbles:!0})),yn.dispatchEvent(new Event("change",{bubbles:!0}))}vt()}else{var Ot="Não foi possível validar os dados do cartão.";ct&&ct.cause&&ct.cause[0]&&ct.cause[0].description&&(Ot=ct.cause[0].description),alert(Ot),St()}})}catch(Ct){An("createToken exception",Ct.message),Mt()}}w==="cartao"?Dt():setTimeout(vt,500)}}if(F){let n=function(e){if(e=e||0,e>30){t();return}var r=u.querySelector("#cep, .box-area-dados, #nome-completo_2");r||e>8?t():setTimeout(function(){n(e+1)},250)},t=function(){var e=dn(),r=tn.get("mm_user_email")||"";tn.remove("mm_checkout_mode"),typeof window._mmDraftDebug>"u"&&(window._mmDraftDebug=!1),Lt(e,r),Vn();var s=Xn(),c=tn.get(P),b=c&&String(c).replace(/\D/g,"").length===8;b?ut("loading"):e&&typeof e.shipping=="number"&&e.shipping>0&&ut({value:e.shipping,name:e.shippingName||"",deadline:e.shippingDeadline||"",city:e.shippingCity||"",options:e.shippingOptions||[]});try{var A=Array.from(u.querySelectorAll("a, button")).find(function(R){var I=(R.textContent||"").toLowerCase();return I.indexOf("sem cadastro")!==-1&&R.offsetParent!==null});A&&!A.classList.contains("active")&&A.click()}catch{}xt();var O=tn.get(P);if(O&&O.length===8){var L=document.getElementById("mm-op-cep");L&&(L.value=Cn(O),setTimeout(function(){ft(O)},400))}setTimeout(function(){if(!("ontouchstart"in window))for(var R=["mm-op-email","mm-op-nome","mm-op-cpf","mm-op-tel","mm-op-cep"],I=0;I<R.length;I++){var W=document.getElementById(R[I]);if(W&&!W.value){W.focus();break}}},350)};n()}if(z){document.documentElement.classList.remove("mm-cart-loading");var mn=u.querySelector('input[placeholder*="numero do cart" i]');mn&&(mn.inputMode="numeric");var o=u.querySelector('input[placeholder*="000" i]');o&&(!o.maxLength||o.maxLength<=4)&&(o.inputMode="numeric")}setTimeout(function(){document.documentElement.classList.contains("mm-cart-loading")&&(console.warn("[mm-cart] failsafe: removing mm-cart-loading after 2s timeout"),document.documentElement.classList.remove("mm-cart-loading"))},2e3)})(),(function(){var P=window.location.pathname,j=/^\/login\/?$/.test(P),T=P.indexOf("/cliente/pedidos")===0;if(!j&&!T)return;var g="5511915299488",i='<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>';function m(v){return"https://api.whatsapp.com/send?phone="+g+"&text="+encodeURIComponent(v)}function d(v){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",v):v()}function h(){function v(C){var u=C.slice(0,14);if(u.length<=11)return u.length>9?u.slice(0,3)+"."+u.slice(3,6)+"."+u.slice(6,9)+"-"+u.slice(9):u.length>6?u.slice(0,3)+"."+u.slice(3,6)+"."+u.slice(6):u.length>3?u.slice(0,3)+"."+u.slice(3):u;var U=u.slice(0,2)+"."+u.slice(2,5)+"."+u.slice(5,8)+"/"+u.slice(8,12);return u.length>12&&(U+="-"+u.slice(12)),U}function F(C){if(!(!C||C.getAttribute("data-mm-mask"))){C.setAttribute("data-mm-mask","1"),C.setAttribute("maxlength","18"),C.setAttribute("inputmode","numeric"),C.addEventListener("input",function(){var U=v(this.value.replace(/\D/g,""));this.value!==U&&(this.value=U)});var u=C.form;u&&!u.getAttribute("data-mm-mask")&&(u.setAttribute("data-mm-mask","1"),u.addEventListener("submit",function(){C.value=v(C.value.replace(/\D/g,""))}))}}var z=0;(function C(){var u=document.getElementById("form-consulta-pedido"),U=document.getElementById("cpfcnpj");if(!u||!U)return++z<20?void setTimeout(C,250):void 0;F(U);var Z=u.querySelector(".title-area h2");if(Z&&!u.querySelector(".mm-cp-eyebrow")){var N=document.createElement("span");N.className="mm-cp-eyebrow",N.textContent="Acompanhe sua compra",Z.insertAdjacentElement("beforebegin",N)}function H(fn,En){if(fn){var Rn=fn.closest(".line")||fn.parentElement;if(!Rn.querySelector(".mm-cp-label")){var On=document.createElement("label");On.className="mm-cp-label",On.textContent=En,fn.id&&On.setAttribute("for",fn.id),Rn.insertAdjacentElement("afterbegin",On)}}}H(U,"CPF ou CNPJ"),H(document.getElementById("numero-pedido"),"Nº do pedido"),U.placeholder="000.000.000-00";var D=document.getElementById("numero-pedido");D&&(D.placeholder="Ex.: 0012606865731");var M=u.querySelector("button.button-login");if(M)for(var tn=0;tn<M.childNodes.length;tn++){var pn=M.childNodes[tn];pn.nodeType===3&&/consultar/i.test(pn.textContent)&&(pn.textContent=" Consultar meu pedido ")}var dn=u.querySelector(".cancel-consulta span");dn&&(dn.textContent="Voltar para login");var gn=document.getElementById("numero-pedido");if(gn&&!u.querySelector(".mm-cp-hint")){var Pn=document.createElement("span");Pn.className="mm-cp-hint",Pn.textContent="O número do pedido está no e‑mail de confirmação da compra.";var xn=gn.closest(".line")||gn.parentElement;xn.appendChild(Pn)}var Xn=u.querySelector("form");if(Xn&&!u.querySelector(".mm-cp-wa")){var Bn=document.createElement("div");Bn.className="mm-cp-wa",Bn.innerHTML='Não encontra os dados? <a href="'+m("Olá! Preciso de ajuda para consultar o meu pedido.")+'" target="_blank" rel="noopener">'+i+" Fale com a gente</a>",Xn.insertAdjacentElement("afterend",Bn)}document.documentElement.classList.add("mm-consulta-on");var un=document.querySelector(".login-holder"),Dn=document.querySelector(".page.page-login");if(un&&Dn){var Fn=un.querySelector(".login-header");if(Fn&&!Fn.querySelector(".mm-lg-eyebrow")){var Tn=document.createElement("span");Tn.className="mm-lg-eyebrow",Tn.textContent="Área do cliente";var wn=Fn.querySelector("h2");wn&&wn.insertAdjacentElement("beforebegin",Tn)}var Ln=un.querySelector(".social-login-area");if(Ln&&!un.querySelector(".mm-lg-ou")){var Qn=document.createElement("div");Qn.className="mm-lg-ou",Qn.textContent="ou",Ln.insertAdjacentElement("beforebegin",Qn)}setTimeout(function(){try{var fn=un.querySelector(".social-login-area .render-button");fn&&window.google&&google.accounts&&google.accounts.id&&(fn.innerHTML="",google.accounts.id.renderButton(fn,{theme:"outline",size:"large",shape:"pill",width:320,text:"continue_with",logo_alignment:"center"}))}catch{}setTimeout(function(){var En=un.querySelector(".social-login-area"),Rn=un.querySelector(".mm-lg-ou"),On=En&&En.offsetParent!==null&&En.querySelector("iframe");On||(Rn&&(Rn.style.display="none"),En&&(En.style.display="none"))},2e3)},1200);var Cn=[].filter.call(un.querySelectorAll("span, div, button"),function(fn){return/pessoa jur/i.test(fn.textContent)&&fn.textContent.length<60&&fn.children.length===0})[0];Cn&&Cn.classList.add("mm-lg-link");var Zn=document.querySelector(".footer-login");Zn&&[].forEach.call(Zn.querySelectorAll("p"),function(fn){/nunca postaremos/i.test(fn.textContent)&&fn.classList.add("mm-lg-nopost")}),document.documentElement.classList.add("mm-login-on")}})(),/#consultar?-?pedido/i.test(window.location.hash)&&setTimeout(function(){var C=document.getElementById("form-consulta-pedido"),u=document.getElementById("cpfcnpj");C&&C.scrollIntoView({behavior:"smooth",block:"center"}),u&&setTimeout(function(){u.focus()},500)},600)}var f={"recebimento-pedido":"Pedido recebido","confirmacao-pagamento":"Pagamento confirmado","emissao-nota":"Nota fiscal emitida",transporte:"Em transporte",entrega:"Entregue"};function E(){var v=document.querySelector(".detalhes-pedido");if(!(!v||v.getAttribute("data-mm-ped"))){v.setAttribute("data-mm-ped","1");var F=v.querySelector(".numero-pedido"),z=F?(F.textContent.match(/[\d]+/)||[""])[0]:"",C=v.querySelector(".resumo-data strong"),u=C?C.textContent.trim().split(" ")[0]:"",U=v.querySelectorAll(".item-historico.status-waiting");U.length&&U[0].classList.add("mm-atual");for(var Z='viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"',N={"recebimento-pedido":"<svg "+Z+'><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><path d="M3 6h18"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>',"confirmacao-pagamento":"<svg "+Z+'><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>',"emissao-nota":"<svg "+Z+'><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7z"/><path d="M15 2v5h5"/><path d="M8 13h8"/><path d="M8 17h5"/></svg>',transporte:"<svg "+Z+'><path d="M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2"/><path d="M15 18H9"/><path d="M19 18h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.62l-3.48-4.35A1 1 0 0 0 17.52 8H14"/><circle cx="17" cy="18" r="2"/><circle cx="7" cy="18" r="2"/></svg>',entrega:"<svg "+Z+'><path d="M3 10.18v8.82a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-8.82"/><path d="M2.5 10.5 12 3l9.5 7.5"/><path d="m9 15 2 2 4-4"/></svg>'},H=v.querySelectorAll(".item-historico"),D=0;D<H.length;D++){var M=H[D];if(!M.querySelector(".mm-step-dot")){var tn="";for(var pn in N)if(M.classList.contains(pn)){tn=N[pn];break}var dn=document.createElement("span");dn.className="mm-step-dot",dn.innerHTML=tn,M.insertAdjacentElement("afterbegin",dn);var gn=document.createElement("span");gn.className="mm-step-line",M.appendChild(gn)}}var Pn=v.querySelectorAll(".item-historico.status-success"),xn="Pedido recebido";if(Pn.length){var Xn=Pn[Pn.length-1];for(var Bn in f)if(Xn.classList.contains(Bn)){xn=f[Bn];break}}if(!document.getElementById("mm-ped-hero")&&z){var un=document.createElement("div");un.id="mm-ped-hero",un.innerHTML='<div class="mm-ped-hero-info"><span class="mm-ped-eyebrow">Acompanhe sua compra</span><h1 class="mm-ped-num">Pedido #'+z+' <button type="button" class="mm-ped-copy" aria-label="Copiar número do pedido">copiar</button></h1><div class="mm-ped-meta">'+(u?"<span>Feito em "+u+"</span>":"")+'<span class="mm-ped-badge">'+xn+'</span></div></div><a class="mm-ped-hero-wa" target="_blank" rel="noopener" href="'+m("Olá! Gostaria de saber sobre o meu pedido #"+z+".")+'">'+i+" Falar sobre este pedido</a>",v.insertAdjacentElement("afterbegin",un);var Dn=v.querySelector(".resumo-pagamento .resumo-total > span:first-child");Dn&&/resumo do pedido/i.test(Dn.textContent)&&(Dn.textContent="Total");var Fn=v.querySelector(".title-itens-pedido h3");Fn&&/itens do pedido/i.test(Fn.textContent)&&(Fn.textContent=" Itens do pedido ");for(var Tn=document.querySelectorAll(".main-content h1, .main-content h2, .main-content .title-user-area, .main-content > div"),wn=0;wn<Tn.length;wn++){var Ln=Tn[wn];if(!Ln.contains(v)&&/meus pedidos/i.test(Ln.textContent||"")&&(Ln.textContent||"").trim().length<40){Ln.classList.add("mm-ped-native-title");break}}var Qn=un.querySelector(".mm-ped-copy");Qn.addEventListener("click",function(){var jn=this;try{navigator.clipboard.writeText(z).then(function(){jn.textContent="copiado ✓",jn.classList.add("mm-copiado"),setTimeout(function(){jn.textContent="copiar",jn.classList.remove("mm-copiado")},2e3)})}catch{}})}var Cn=v.querySelector(".rastreio-area"),Zn=Cn?Cn.querySelector(".previsao-entrega .previsao"):null,fn=Zn?Zn.textContent.trim():"";if(fn){var En=v.querySelector(".item-historico.entrega");if(En&&!En.querySelector(".mm-step-prev")){var Rn=document.createElement("span");Rn.className="mm-step-prev",Rn.textContent="Previsão: "+fn,En.appendChild(Rn)}}var On=v.querySelector(".status-pagamento-pedido");if(On&&!Cn&&!document.getElementById("mm-ped-entrega")){var Yn=document.createElement("div");Yn.id="mm-ped-entrega";for(var dt=null,qn=v.querySelectorAll("a[href]"),kn=0;kn<qn.length;kn++){var wn=(qn[kn].textContent||"")+" "+qn[kn].href;if(/rastre/i.test(wn)&&!/politica/i.test(qn[kn].href)){dt=qn[kn];break}}var hn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2"/><path d="M15 18H9"/><path d="M19 18h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.62l-3.48-4.35A1 1 0 0 0 17.52 8H14"/><circle cx="17" cy="18" r="2"/><circle cx="7" cy="18" r="2"/></svg>';dt?(Yn.classList.add("mm-tem-rastreio"),Yn.innerHTML=hn+'<span>Seu pedido está a caminho — <a href="'+dt.href+'" target="_blank" rel="noopener">acompanhe o rastreio aqui</a>.</span>'):Yn.innerHTML=hn+'<span>O código de rastreio aparece aqui assim que o pedido for despachado. Enquanto isso, acompanhe as etapas acima ou veja nossa <a href="/politica-de-entrega" target="_blank" rel="noopener">política de entrega</a>.</span>',On.insertAdjacentElement("afterend",Yn)}var nt=document.querySelector(".btn-comprar-novamente"),mt=document.querySelector(".btn-ajuda-pedido"),Nn=nt||mt?(nt||mt).parentElement:null;Nn&&!Nn.classList.contains("mm-ped-acoes")&&(Nn.classList.add("mm-ped-acoes"),Nn.parentElement!==v&&v.appendChild(Nn));var tt=document.querySelector("main.central-cliente");tt&&tt.children.length===1&&tt.classList.add("mm-ped-center"),document.documentElement.classList.add("mm-ped-on")}}d(function(){try{j&&h(),T&&E()}catch(v){window.console&&console.warn&&console.warn("[mm-pedidos]",v)}})})()})();

...
`),document.body.insertBefore(M,document.body.firstChild),document.documentElement.classList.remove("mm-header-loading");var v=(function(){try{var r=Array.from(document.scripts).find(function(n){return n.src&&n.src.indexOf("madeira-mania.js")!==-1});if(r&&r.src.indexOf("localhost")!==-1)return"http://localhost:8080/assets/mega-hero/";if(r){var m=r.src.match(/@([^/]+)/);if(m)return"https://cdn.jsdelivr.net/gh/luancamara/madeira-mania-cdn@"+m[1]+"/dist/assets/mega-hero/"}return"https://cdn.jsdelivr.net/gh/luancamara/madeira-mania-cdn@main/dist/assets/mega-hero/"}catch{return"https://cdn.jsdelivr.net/gh/luancamara/madeira-mania-cdn@main/dist/assets/mega-hero/"}})(),i={"sala-de-estar":"Sala de Estar","sala-de-jantar":"Sala de Jantar",cozinha:"Cozinha","bar-e-cafe":"Bar e Café",quarto:"Quarto",escritorio:"Escritório",lavanderia:"Lavanderia",banheiro:"Banheiro"},s=M.querySelector(".mm-h-mega-hero-img"),u=M.querySelector(".mm-h-mega-hero-label");Object.keys(i).forEach(function(r){var m=new Image;m.src=v+r+".jpg"});function g(r){s&&(s.onerror=function(){s.style.visibility="hidden"},s.style.visibility="",s.src=v+r+".jpg",s.alt=i[r]||"",u&&(u.textContent=i[r]||""))}g("sala-de-estar"),M.querySelectorAll(".mm-h-mega-heading-link[data-hero]").forEach(function(r){r.addEventListener("mouseenter",function(){g(r.dataset.hero)})});var h=M.querySelectorAll(".mm-h-nav-item[data-menu]"),C=null,b=null;h.forEach(function(r){r.addEventListener("mouseenter",function(){clearTimeout(b),clearTimeout(C),C=setTimeout(function(){h.forEach(function(n){n.classList.remove("is-open");var t=n.querySelector(".mm-h-nav-link");t&&t.setAttribute("aria-expanded","false")}),r.classList.add("is-open");var m=r.querySelector(".mm-h-nav-link");m&&m.setAttribute("aria-expanded","true")},150)}),r.addEventListener("mouseleave",function(){clearTimeout(C),b=setTimeout(function(){r.classList.remove("is-open");var m=r.querySelector(".mm-h-nav-link");m&&m.setAttribute("aria-expanded","false")},200)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&h.forEach(function(m){m.classList.remove("is-open");var n=m.querySelector(".mm-h-nav-link");n&&n.setAttribute("aria-expanded","false")})});var T=M.querySelector('.mm-h-nav-item[data-menu="ambientes"] > .mm-h-nav-link');T&&T.addEventListener("click",function(r){r.preventDefault()});var q=document.getElementById("mm-h-search-overlay"),z=document.getElementById("mm-h-buscar"),f=document.getElementById("mm-h-search-close"),W=document.getElementById("mm-h-search-input"),Z=q&&q.querySelector(".mm-h-search-backdrop"),D=null;function G(){q&&(D=document.activeElement,q.hidden=!1,document.body.style.overflow="hidden",setTimeout(function(){W&&W.focus()},50))}function O(){q&&(q.hidden=!0,document.body.style.overflow="",D&&D.focus&&D.focus())}z&&z.addEventListener("click",G),f&&f.addEventListener("click",O),Z&&Z.addEventListener("click",O),document.addEventListener("keydown",function(r){if(r.key==="Escape"&&q&&!q.hidden){O();return}if(r.key==="/"&&q&&q.hidden){var m=document.activeElement&&document.activeElement.tagName;m!=="INPUT"&&m!=="TEXTAREA"&&!(document.activeElement&&document.activeElement.isContentEditable)&&(r.preventDefault(),G())}}),q&&q.addEventListener("keydown",function(r){if(!(r.key!=="Tab"||q.hidden)){var m=q.querySelectorAll("button, input, a[href]");if(m.length!==0){var n=m[0],t=m[m.length-1];r.shiftKey&&document.activeElement===n?(r.preventDefault(),t.focus()):!r.shiftKey&&document.activeElement===t&&(r.preventDefault(),n.focus())}}});var B=document.getElementById("mm-h-search-results"),tn=document.getElementById("mm-h-search-suggestions"),pn=[{label:"Mesa de jantar",q:"mesa de jantar"},{label:"Mesa de centro",q:"mesa de centro"},{label:"Rack para TV",q:"rack"},{label:"Guarda-roupas",q:"guarda-roupas"},{label:"Cristaleira",q:"cristaleira"},{label:"Aparador",q:"aparador"},{label:"Buffet",q:"buffet"},{label:"Painel para TV",q:"painel"},{label:"Cabeceira",q:"cabeceira"},{label:"Cômoda",q:"comoda"},{label:"Estante",q:"estante"},{label:"Home theater",q:"home theater"}],cn="mm_recent_searches";function bn(){try{var r=localStorage.getItem(cn);if(!r)return[];var m=JSON.parse(r);return Array.isArray(m)?m.slice(0,5):[]}catch{return[]}}function On(r){if(r)try{var m=bn().filter(function(n){return n&&n.toLowerCase()!==r.toLowerCase()});m.unshift(r),localStorage.setItem(cn,JSON.stringify(m.slice(0,5)))}catch{}}function wn(r){return String(r).replace(/[&<>"']/g,function(m){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[m]})}var Un='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>',In='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg>',dn="mm_search_cache_v1",Rn=600*1e3,Tn=20,Ln=null;function Sn(){try{return JSON.parse(sessionStorage.getItem(dn)||"{}")}catch{return{}}}function Mn(r){try{var m=Object.keys(r);if(m.length>Tn){m.sort(function(t,e){return r[t].ts-r[e].ts});for(var n=0;n<m.length-Tn;n++)delete r[m[n]]}sessionStorage.setItem(dn,JSON.stringify(r))}catch{}}function Zn(r){var m=Sn(),n=m[r.toLowerCase()];return!n||Date.now()-n.ts>Rn?null:n.products}function zn(r,m){var n=Sn();n[r.toLowerCase()]={ts:Date.now(),products:m},Mn(n)}function Yn(r){for(var m="itens:",n=0;(n=r.indexOf(m,n))!==-1;){var t=r.indexOf("[",n);if(t===-1)return null;for(var e=0,o=!1,p=!1,d=-1,E=t;E<r.length;E++){var A=r.charAt(E);if(p){p=!1;continue}if(A==="\\"){p=!0;continue}if(A==='"'){o=!o;continue}if(!o){if(A==="[")e++;else if(A==="]"&&(e--,e===0)){d=E;break}}}if(d!==-1){var _=r.substring(t,d+1);try{var L=JSON.parse(_);if(Array.isArray(L)&&L.length>0)return L}catch{}}n=t+1}return null}function hn(r){var m=Yn(r);if(!m)return[];for(var n=[],t=0;t<m.length&&n.length<6;t++){var e=m[t];if(e){var o=e.titulo||e.nome||"";if(o){var p=e.link||"";p&&p.charAt(0)!=="/"&&p.indexOf("http")!==0&&(p="/"+p);var d=e.midia_url||"",E=parseFloat(e.valor),A=parseFloat(e.valor_de),_=isNaN(E)?"":"R$ "+E.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2}),L=!isNaN(A)&&A>E?"R$ "+A.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2}):"",V="";typeof e.percentual_off=="number"&&e.percentual_off>0&&(V="-"+Math.round(e.percentual_off)+"%"),n.push({href:p,title:o,img:d,price:_,oldPrice:L,discount:V})}}}return n}function Cn(r){var m=r.toLowerCase().trim();if(!m||m.length<3)return Promise.resolve([]);var n=Zn(m);if(n)return Promise.resolve(n);if(Ln)try{Ln.abort()}catch{}Ln=typeof AbortController<"u"?new AbortController:null;var t="/busca?q="+encodeURIComponent(m),e={credentials:"same-origin",headers:{Accept:"text/html"}};return Ln&&(e.signal=Ln.signal),fetch(t,e).then(function(o){if(!o.ok)throw new Error("HTTP "+o.status);return o.text()}).then(function(o){var p=hn(o);return zn(m,p),p}).catch(function(o){return o&&o.name==="AbortError"?null:[]})}function Nn(r){var m=r.img?'<img src="'+wn(r.img)+'" alt="" loading="lazy" width="64" height="64"/>':'<div class="mm-h-search-product-noimg"></div>',n=r.price?'<span class="mm-h-search-product-price">'+wn(r.price)+"</span>":"",t=r.oldPrice&&r.oldPrice!==r.price?'<span class="mm-h-search-product-oldprice">'+wn(r.oldPrice)+"</span>":"",e=r.discount?'<span class="mm-h-search-product-discount">'+wn(r.discount)+"</span>":"";return'<a class="mm-h-search-product" href="'+wn(r.href)+'" data-recent="1"><span class="mm-h-search-product-thumb">'+m+e+'</span><span class="mm-h-search-product-body"><span class="mm-h-search-product-name">'+wn(r.title)+'</span><span class="mm-h-search-product-prices">'+t+n+"</span></span></a>"}function Dn(){if(B){var r=bn();if(!r.length){B.hidden=!0,B.innerHTML="",tn&&(tn.hidden=!1);return}var m='<div class="mm-h-search-section">';m+='<span class="mm-h-search-sug-label">Buscas recentes</span>',m+='<ul class="mm-h-search-list">';for(var n=0;n<r.length;n++){var t=r[n];m+='<li><a class="mm-h-search-result" href="/busca?q='+encodeURIComponent(t)+'"><span class="mm-h-search-result-icon">'+In+'</span><span class="mm-h-search-result-label">'+wn(t)+"</span></a></li>"}m+="</ul></div>",B.innerHTML=m,B.hidden=!1,tn&&(tn.hidden=!1)}}function Jn(r){if(!B)return"";tn&&(tn.hidden=!0);var m=r.trim();if(m.length<2)return Dn(),"";var n=m.toLowerCase(),t=pn.filter(function(d){return d.label.toLowerCase().indexOf(n)!==-1||d.q.toLowerCase().indexOf(n)!==-1}).slice(0,4),e="";e+='<ul class="mm-h-search-list">',e+='<li><a class="mm-h-search-result mm-h-search-result-primary" href="/busca?q='+encodeURIComponent(m)+'" data-recent="1"><span class="mm-h-search-result-icon">'+Un+'</span><span class="mm-h-search-result-label">Buscar por <strong>&ldquo;'+wn(m)+'&rdquo;</strong></span><span class="mm-h-search-result-arrow" aria-hidden="true">&rarr;</span></a></li>';for(var o=0;o<t.length;o++){var p=t[o];e+='<li><a class="mm-h-search-result" href="/busca?q='+encodeURIComponent(p.q)+'" data-recent="1"><span class="mm-h-search-result-icon">'+Un+'</span><span class="mm-h-search-result-label">'+wn(p.label)+"</span></a></li>"}return e+="</ul>",m.length>=3&&(e+='<div class="mm-h-search-products-section" data-q="'+wn(m)+'"><span class="mm-h-search-sug-label">Produtos</span><div class="mm-h-search-products-grid mm-h-search-products-loading"><div class="mm-h-search-product-skel"></div><div class="mm-h-search-product-skel"></div><div class="mm-h-search-product-skel"></div><div class="mm-h-search-product-skel"></div></div></div>'),B.innerHTML=e,B.hidden=!1,m}function ut(r){var m=Jn(r);!m||m.length<3||Cn(m).then(function(n){if(W){var t=(W.value||"").trim();if(t===m&&n!==null){var e=B&&B.querySelector('.mm-h-search-products-section[data-q="'+m.replace(/"/g,'\\"')+'"]');if(e){var o=e.querySelector(".mm-h-search-products-grid");if(o){if(o.classList.remove("mm-h-search-products-loading"),!n||n.length===0){e.innerHTML='<span class="mm-h-search-sug-label">Nenhum produto encontrado para &ldquo;'+wn(m)+"&rdquo;</span>";return}for(var p="",d=0;d<n.length;d++)p+=Nn(n[d]);o.innerHTML=p}}}}})}var An=null;if(W){W.addEventListener("input",function(){clearTimeout(An);var r=W.value;An=setTimeout(function(){!r||r.trim().length<2?Dn():ut(r)},300)}),B&&B.addEventListener("click",function(r){var m=r.target.closest&&r.target.closest("a[data-recent]");if(m){var n=m.getAttribute("href").split("q=")[1];n&&On(decodeURIComponent(n.replace(/\+/g," ")))}});var En=q&&q.querySelector(".mm-h-search-form");En&&En.addEventListener("submit",function(){On((W.value||"").trim())})}z&&z.addEventListener("click",function(){Dn()});var gn=document.getElementById("mm-h-drawer"),tt=document.getElementById("mm-h-drawer-close"),st=gn&&gn.querySelector(".mm-h-drawer-backdrop");function jn(){gn&&(gn.hidden=!1,document.body.style.overflow="hidden",setTimeout(function(){var r=gn.querySelector(".mm-h-drawer-close");r&&r.focus()},100))}function et(){!gn||gn.hidden||(gn.classList.add("mm-h-drawer-closing"),document.body.style.overflow="",setTimeout(function(){gn.hidden=!0,gn.classList.remove("mm-h-drawer-closing");var r=document.getElementById("mm-h-burger");r&&r.focus()},320))}var _n=document.getElementById("mm-h-burger");if(_n&&_n.addEventListener("click",jn),tt&&tt.addEventListener("click",et),st&&st.addEventListener("click",et),document.addEventListener("keydown",function(r){r.key==="Escape"&&gn&&!gn.hidden&&et()}),gn){var at=0;gn.addEventListener("touchstart",function(r){at=r.touches[0].clientX},{passive:!0}),gn.addEventListener("touchend",function(r){var m=r.changedTouches[0].clientX;at-m>80&&et()},{passive:!0})}gn&&gn.querySelectorAll(".mm-h-drawer-section summary").forEach(function(r){r.addEventListener("click",function(m){m.preventDefault();var n=r.parentElement,t=n.querySelector("ul");if(t)if(n.open)t.style.maxHeight=t.scrollHeight+"px",t.style.opacity="1",requestAnimationFrame(function(){t.style.maxHeight="0",t.style.opacity="0",t.style.paddingTop="0",t.style.paddingBottom="0"}),setTimeout(function(){n.open=!1,t.style.maxHeight="",t.style.opacity="",t.style.paddingTop="",t.style.paddingBottom=""},300);else{n.open=!0;var e=t.scrollHeight;t.style.maxHeight="0",t.style.opacity="0",t.style.paddingTop="0",t.style.paddingBottom="0",requestAnimationFrame(function(){t.style.maxHeight=e+"px",t.style.opacity="1",t.style.paddingTop="",t.style.paddingBottom=""}),setTimeout(function(){t.style.maxHeight="",t.style.opacity=""},320)}})});var xt=document.getElementById("mm-h-cart"),Tt=null,Hn=null;function $n(){var r=document.querySelector(".carrinho-rapido-ctn");return r||document.querySelector('#cart-preview-area > div.z-\\[9999\\], #cart-preview-area > div[class*="z-[9999]"]')}function vt(r){return!!(r&&r.className&&r.className.indexOf("z-[9999]")!==-1)}var yt='<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M18 6 6 18M6 6l12 12"/></svg>';function kt(r){if(r){var m=r.querySelector(".close-car-fast");m&&!m.innerHTML.trim()&&(m.innerHTML=yt,m.setAttribute("aria-label","Fechar carrinho"),m.setAttribute("role","button"),m.setAttribute("tabindex","0"))}}function Lt(r){!r||r.dataset.mmCloseWired||(r.dataset.mmCloseWired="1",r.addEventListener("click",function(m){var n=m.target;n&&n.closest&&(n.closest(".close-car-fast")||n.closest(".icon-arrow-bottom"))&&(m.preventDefault(),m.stopPropagation(),l())},!0),r.addEventListener("keydown",function(m){(m.key==="Enter"||m.key===" ")&&m.target&&m.target.closest&&m.target.closest(".close-car-fast")&&(m.preventDefault(),l())}))}function wt(r){if(r){if(!r.dataset.mmLifted){r.dataset.mmLifted="1",r.style.position="fixed",r.style.display="block",r.style.zIndex="200";for(var m=r.parentElement;m&&!m.classList.contains("header-middle");)m.style.zIndex="auto",m.style.transform="none",m.style.filter="none",m.style.isolation="auto",m=m.parentElement}Lt(r),kt(r)}}var pt=[{href:"/rack-atenas-cor-naturalle-largura-220-cm",name:"Rack Atenas 220cm",img:"https://madeiramania.cdn.magazord.com.br/img/2025/12/produto/5519/am-2501-mavaular-rack-atenas-220-naturalle-lado.jpg?ims=200x200",priceFrom:"R$ 1.615,49",priceTo:"R$ 1.032,30"},{href:"/rack-atenas-cor-naturalle-largura-180-cm",name:"Rack Atenas 180cm",img:"https://madeiramania.cdn.magazord.com.br/img/2025/12/produto/5419/am-2501-mavaular-rack-atenas-180-naturalle.jpg?ims=200x200",priceFrom:"R$ 1.688,71",priceTo:"R$ 942,31"},{href:"/buffet-arcus-cor-naturalle-largura-92-cm",name:"Buffet Arcus 92cm",img:"https://madeiramania.cdn.magazord.com.br/img/2025/12/produto/5439/am-2501-mavaular-arcus-02-pts-naturalle.jpg?ims=200x200",priceFrom:"R$ 1.359,09",priceTo:"R$ 807,30"},{href:"/buffet-atenas-cor-naturalle",name:"Buffet Atenas",img:"https://madeiramania.cdn.magazord.com.br/img/2025/12/produto/4237/am-2502-mavaular-buffet-atenas-naturalle.jpg?ims=200x200",priceFrom:"R$ 2.124,07",priceTo:"R$ 1.032,30"}],Vn='<svg viewBox="0 0 48 48" width="56" height="56" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 14 8 20v22a4 4 0 0 0 4 4h24a4 4 0 0 0 4-4V20l-4-6z"/><path d="M8 20h32"/><path d="M32 28a8 8 0 0 1-16 0"/></svg>';function lt(){try{if(typeof Zord<"u"&&typeof Zord.get=="function"){var r=Zord.get("cart.size");if(typeof r=="number"&&r>0)return r;if(typeof r=="string"&&/^\d+$/.test(r)&&parseInt(r,10)>0)return parseInt(r,10)}}catch{}var m=document.querySelector("#cart-preview-area .item-ctn, .carrinho-container .item-ctn");if(m){var n=(m.textContent||"").trim();if(n&&/\d/.test(n)){var t=parseInt(n.replace(/\D/g,""),10);if(!isNaN(t))return t}}var e=document.querySelector(".carrinho-rapido-ctn");if(e){var o=0;if(e.querySelectorAll(".cart-item").forEach(function(p){p.closest(".mm-cart-empty-wrapper")||o++}),o>0)return o}return 0}function Mt(r){if(lt()!==0||!r)return!1;var m=r.querySelector(".box-empty-cart");if(!m)return!1;var n=getComputedStyle(m);return!(n.display==="none"||n.visibility==="hidden")}function ft(r){if(!r)return!1;var m=lt();if(m===0)return!1;var n=0;return r.querySelectorAll(".cart-item").forEach(function(t){t.closest(".mm-cart-empty-wrapper")||n++}),n>0}function Ct(r){if(r){r.classList.remove("mm-cart-has-empty-enhancement");var m=r.querySelector(":scope > .mm-cart-empty-wrapper");m&&m.remove()}}function St(r){if(r){var m=r.querySelector(".content-cart");if(m){if(ft(m)){Ct(m);return}var n=m.querySelectorAll(".cart-item").length===0;if(!(!Mt(m)&&!(n&&lt()===0))&&!m.querySelector(":scope > .mm-cart-empty-wrapper")){var t=document.createElement("div");t.className="mm-cart-empty-wrapper";for(var e="",o=0;o<pt.length;o++){var p=pt[o];e+='<a class="mm-cart-suggestion-card" href="'+p.href+'"><span class="mm-cart-suggestion-thumb"><img src="'+p.img+'" alt="" loading="lazy" width="80" height="80"/></span><span class="mm-cart-suggestion-body"><span class="mm-cart-suggestion-name">'+p.name+'</span><span class="mm-cart-suggestion-price"><span class="mm-cart-suggestion-price-from">'+p.priceFrom+'</span><span class="mm-cart-suggestion-price-to">'+p.priceTo+"</span></span></span></a>"}t.innerHTML='<div class="mm-cart-empty-hero"><div class="mm-cart-empty-icon">'+Vn+'</div><h3 class="mm-cart-empty-title">Seu carrinho está vazio</h3><p class="mm-cart-empty-copy">Dê uma olhada nos móveis que nossos clientes mais amam.</p></div><div class="mm-cart-suggestions"><span class="mm-cart-suggestions-label">Você pode gostar de</span><div class="mm-cart-suggestions-grid">'+e+"</div></div>",m.classList.add("mm-cart-has-empty-enhancement"),m.appendChild(t)}}}}function Kn(r){try{document.querySelectorAll("#cart-preview-area .item-ctn, .carrinho-container .item-ctn, .item-ctn").forEach(function(m){m.textContent="0"})}catch{}r&&St(r)}window.__mmForceEmptyCartState=Kn;function Gn(r,m){try{if(typeof Zord>"u"||!Zord.checkout||typeof Zord.checkout.atualizaPreview!="function"){m();return}var n=lt();if(n===0){m();return}if(r.querySelector(".cart-item")){m();return}Zord.checkout.atualizaPreview();var t=Date.now(),e=2e3;(function o(){if(r.querySelector(".cart-item")){m();return}if(Date.now()-t>=e){m();return}setTimeout(o,50)})()}catch{m()}}function ht(){if(window.innerWidth<=767){var r=document.querySelector("#cart-preview-area a.link-cart")||document.querySelector('#cart-preview-area a[href*="/checkout/cart"]');if(r){let o=function(d){!d||d.dataset.mmCloseWired||(d.dataset.mmCloseWired="1",d.addEventListener("click",function(E){var A=E.target;if(!(!A||!A.closest)){var _=A.closest('[class*="text-error-700"]');if(!_)for(var L=A,V=0;V<4&&L&&L!==d;V++){if((L.textContent||"").trim()==="Fechar"){_=L;break}L=L.parentElement}_&&(E.preventDefault(),E.stopImmediatePropagation(),d.classList.remove("translate-x-[0]"),d.classList.add("translate-x-[100%]"),delete d.dataset.mmUserOpened,document.body.style.overflow="")}},!0))},p=function(){var d=document.querySelector('#cart-preview-area > div[class*="z-[9999]"]');d&&(d.dataset.mmUserOpened="1",d.className.indexOf("translate-x-[0]")===-1&&(d.classList.remove("translate-x-[100%]"),d.classList.add("translate-x-[0]")),o(d))};document.documentElement.dataset.mmCartOpening="1",r.dataset.mmBypass="1",r.click(),delete r.dataset.mmBypass,setTimeout(p,120),setTimeout(p,380),setTimeout(p,700),setTimeout(function(){delete document.documentElement.dataset.mmCartOpening},800);return}window.location.href="/checkout/cart";return}var m=$n();if(m){Gn(m,function(){a(m)});return}var n=0,t=14,e=!1;(function o(){if(n++,m=$n(),m){Gn(m,function(){a(m)});return}if(!e&&n>=2){e=!0;try{typeof Zord<"u"&&Zord.checkout&&typeof Zord.checkout.atualizaPreview=="function"&&Zord.checkout.atualizaPreview()}catch{}}n<t?setTimeout(o,200):window.location.href="/checkout/cart"})()}function a(r){var m=vt(r);m||(wt(r),kt(r)),St(r);var n=r.querySelector(".content-cart");if(n&&!n.dataset.mmObserved){n.dataset.mmObserved="1";var t=new MutationObserver(function(){St(r)});t.observe(n,{childList:!0,subtree:!0,attributes:!1})}if(m){r.classList.remove("translate-x-[100%]"),r.classList.add("translate-x-[0]");var e=r.querySelector('.group.cursor-pointer, [class*="text-error-700"]');e&&!e.dataset.mmWired&&(e.dataset.mmWired="1",e.addEventListener("click",function(o){o.preventDefault(),o.stopPropagation(),l()},!0))}else r.classList.add("mm-drawer-open");!m&&!Hn&&(Hn=document.createElement("div"),Hn.id="mm-h-cart-scrim",Hn.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:150;opacity:0;transition:opacity 320ms;",Hn.addEventListener("click",l),document.body.appendChild(Hn),requestAnimationFrame(function(){Hn.style.opacity="1"})),document.body.style.overflow="hidden"}function l(){var r=$n();if(r&&(vt(r)?(r.classList.remove("translate-x-[0]"),r.classList.add("translate-x-[100%]")):r.classList.remove("mm-drawer-open")),Hn){Hn.style.opacity="0";var m=Hn;setTimeout(function(){m&&m.parentNode&&m.parentNode.removeChild(m)},320),Hn=null}document.body.style.overflow=""}xt&&xt.addEventListener("click",function(r){r.preventDefault(),ht()}),window.innerWidth<=767&&(function r(){var m=document.querySelector('#cart-preview-area > [class*="z-[9999]"]');if(!m){setTimeout(r,500);return}if(!m.dataset.mmGuardWired){m.dataset.mmGuardWired="1";var n=new MutationObserver(function(){if(m.className.indexOf("translate-x-[0]")===-1){delete m.dataset.mmUserOpened;return}document.documentElement.dataset.mmCartOpening||m.dataset.mmUserOpened||(m.classList.remove("translate-x-[0]"),m.classList.add("translate-x-[100%]"))});n.observe(m,{attributes:!0,attributeFilter:["class"]})}})(),document.addEventListener("click",function(r){var m=r.target.closest('#cart-preview-area a.link-cart, header.ra-header > .header-bottom a[href*="/checkout/cart"], header.ra-header > .header-bottom a[href*="carrinho"]');if(m){if(m.dataset.mmBypass)return;r.preventDefault(),r.stopPropagation(),ht()}},!0);var c=document.querySelector("header.ra-header > .header-bottom");c&&c.addEventListener("click",function(r){var m=r.target.closest('a[href*="carrinho"], a[href*="/checkout/cart"], [class*="carrinho"]');m&&(r.preventDefault(),r.stopPropagation(),ht())},!0),document.addEventListener("keydown",function(r){r.key==="Escape"&&Hn&&l()});var y=document.getElementById("mm-h-cart-count"),F=document.getElementById("mm-h-cart");function S(){if(y){var r=lt();r>0?(y.textContent=r>99?"99+":String(r),y.hidden=!1):y.hidden=!0,F&&F.setAttribute("aria-label","Carrinho, "+r+" "+(r===1?"item":"itens"));var m=$n();m&&m.dataset.mmLifted&&St(m)}}window.addEventListener("reactItemAddedToCart",S),typeof jQuery<"u"&&(jQuery(document).on("reactItemAddedToCart",S),jQuery(document).ajaxComplete(function(r,m,n){n&&n.url&&n.url.indexOf("checkout/cart")!==-1&&setTimeout(S,150)})),setTimeout(S,500),setTimeout(S,2e3),setTimeout(S,5e3);function I(){var r=document.querySelector("#cart-preview-area .item-ctn, .carrinho-container .item-ctn");if(!(!r||r.dataset.mmObserved)){r.dataset.mmObserved="1";var m=new MutationObserver(S);m.observe(r,{childList:!0,characterData:!0,subtree:!0})}}I(),setTimeout(I,1e3),setTimeout(I,3e3);var H=new MutationObserver(function(r){for(var m=0;m<r.length;m++)for(var n=r[m].addedNodes,t=0;t<n.length;t++){var e=n[t];if(e.nodeType===1){var o=e.classList&&e.classList.contains("popup-adicionado-ao-carrinho")||e.querySelector&&e.querySelector(".popup-adicionado-ao-carrinho");if(o){setTimeout(S,120),setTimeout(S,700);return}}}});H.observe(document.body,{childList:!0,subtree:!0});var Y=-1;setInterval(function(){var r=lt();r!==Y&&(Y=r,S())},1e3);var X=0,rn=!1,J=24;function sn(){var r=window.scrollY,m=r-X;r>J&&m>0?M.classList.add("is-compact"):(r<=J||m<0)&&M.classList.remove("is-compact"),X=r,rn=!1}window.addEventListener("scroll",function(){rn||(requestAnimationFrame(sn),rn=!0)},{passive:!0})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",x):x()})(),(function(){if(!document.getElementById("mm-org-schema")){var P=document.querySelector('.logo img, header img[alt*="logo" i], header img[alt*="Madeira" i]'),R=P&&P.getAttribute("src")||"";R&&R.indexOf("http")!==0&&(R="https://www.madeiramania.com.br"+R);var M={"@context":"https://schema.org","@type":"OnlineStore","@id":"https://www.madeiramania.com.br/#organization",name:"Madeira Mania",url:"https://www.madeiramania.com.br",description:"Loja online de móveis com preços abaixo dos marketplaces. Racks, mesas, cristaleiras, sofás, camas e estantes com entrega para todo o Brasil. Até 12x sem juros ou 7% de desconto no PIX.",sameAs:["https://www.instagram.com/madeiramaniabr/","https://www.facebook.com/madeiramaniabr/","https://www.reclameaqui.com.br/empresa/madeira-mania-comercio-de-moveis-ltda/","https://www.youtube.com/@madeiramaniabr","https://www.tiktok.com/@madeiramaniabr"],contactPoint:[{"@type":"ContactPoint",telephone:"+55-11-91529-9488",contactType:"customer service",availableLanguage:"Portuguese"},{"@type":"ContactPoint",url:"https://wa.me/5511915299488",contactType:"customer service",description:"WhatsApp"}],hasMerchantReturnPolicy:{"@type":"MerchantReturnPolicy",applicableCountry:"BR",returnPolicyCategory:"https://schema.org/MerchantReturnFiniteReturnWindow",merchantReturnDays:7,returnMethod:"https://schema.org/ReturnByMail"}};R&&R.indexOf("http")===0&&(M.logo=R);var v=document.createElement("script");v.type="application/ld+json",v.id="mm-org-schema",v.textContent=JSON.stringify(M),document.head.appendChild(v)}})(),(function x(){x._retries=(x._retries||0)+1;var P=document.querySelector("#produto-react-app");if(!P||!P.querySelector(".informacoes-compra-produto")){x._retries<30&&setTimeout(x,500);return}if((function(){var v=P.querySelector("#container-swiper"),i=P.querySelector(".swiper-pagination");if(!v||!i)return;var s=i.querySelectorAll(".swiper-pagination-bullet");if(s.length<2)return;var u=P.querySelector(".gallery-main");if(u)for(var g=u.querySelectorAll(".button-prev, .button-next"),h=0;h<g.length;h++)g[h].style.display="none";var C=document.createElement("div");C.id="mm-gallery-counter",C.style.cssText=["position: absolute","top: 12px","left: 12px","background: rgba(255,255,255,0.85)","color: #333","font-size: 12px","font-weight: 500","padding: 3px 10px","border-radius: 12px","z-index: 10","pointer-events: none","font-family: -apple-system, BlinkMacSystemFont, sans-serif","letter-spacing: 0.5px"].join(";"),u&&(u.style.position="relative",u.appendChild(C));function b(){var q=i.querySelector(".swiper-pagination-bullet-active"),z=i.querySelectorAll(".swiper-pagination-bullet");if(!(!q||!z.length)){var f=Array.prototype.indexOf.call(z,q)+1;C.textContent=f+" / "+z.length}}b();var T=new MutationObserver(b);T.observe(i,{subtree:!0,attributes:!0,attributeFilter:["class"]})})(),(function(){var v=P.querySelector(".avaliacoes");if(v){for(var i=document.querySelectorAll("script:not([src])"),s=0,u=0,g=0;g<i.length;g++){var h=i[g].textContent;if(!(h.indexOf("Zord.avaliacoes")===-1&&h.indexOf("produtoAvaliacoes")===-1)){var C=h.match(/produtoAvaliacoes\s*:\s*(\d+)/),b=h.match(/\bnota\s*:\s*(?:Number\()?([\d.]+)/);if(C&&(s=parseInt(C[1],10)),b&&(u=parseFloat(b[1])),s>0)break}}if(s===0){v.style.display="none";return}for(var T=(u%1===0,u.toFixed(1)),q="",z=1;z<=5;z++)z<=Math.floor(u)||z-u<1&&z-u>0?q+='<span style="color:#f5a623;font-size:14px;">&#9733;</span>':q+='<span style="color:#ddd;font-size:14px;">&#9733;</span>';var f=s===1?"avaliação":"avaliações";v.innerHTML='<a href="#avaliacoes" style="display:inline-flex;align-items:center;gap:4px;text-decoration:none;color:#555;font-size:13px;">'+q+' <span style="font-weight:600;color:#1a1a1a;">'+T+'</span> <span style="color:#777;">('+s+" "+f+")</span></a>",v.style.display="",v.style.marginTop="4px"}})(),(function(){var v=P.querySelector("h1");if(v){var i=v.parentElement.querySelector(".text-secondary-700.text-xs");if(i){var s=v.textContent.toLowerCase().replace(/\s+/g," ").trim(),u=i.textContent.toLowerCase().replace(/\s+/g," ").trim(),g=u.split(/[\s\-:,]+/).filter(function(C){return C.length>2}),h=g.filter(function(C){return s.indexOf(C)!==-1});h.length>=g.length*.6&&(i.style.display="none")}}})(),(function(){var v=P.querySelector(".informacoes-compra-produto");if(!v||document.getElementById("mm-action-row"))return;var i=v.querySelector(".salvar-favoritos"),s=v.querySelector(".exibe-botao-whatsapp"),u=v.querySelector(".compartilhar-produto");if(!i&&!s&&!u)return;var g=document.createElement("div");g.id="mm-action-row";function h(){var G=document.createElementNS("http://www.w3.org/2000/svg","svg");G.setAttribute("width","18"),G.setAttribute("height","18"),G.setAttribute("viewBox","0 0 24 24"),G.setAttribute("fill","none"),G.setAttribute("stroke","currentColor"),G.setAttribute("stroke-width","2"),G.setAttribute("stroke-linecap","round"),G.setAttribute("stroke-linejoin","round");var O=document.createElementNS("http://www.w3.org/2000/svg","path");return O.setAttribute("d","M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8M16 6l-4-4-4 4M12 2v13"),G.appendChild(O),G}function C(){var G=document.createElementNS("http://www.w3.org/2000/svg","svg");G.setAttribute("width","18"),G.setAttribute("height","18"),G.setAttribute("viewBox","0 0 24 24"),G.setAttribute("fill","none"),G.setAttribute("stroke","currentColor"),G.setAttribute("stroke-width","2"),G.setAttribute("stroke-linecap","round"),G.setAttribute("stroke-linejoin","round");var O=document.createElementNS("http://www.w3.org/2000/svg","path");return O.setAttribute("d","M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"),G.appendChild(O),G}if(i){var b=document.createElement("div");b.className="salvar-favoritos";var T=document.createElement("button");T.setAttribute("aria-label","Favoritar"),T.appendChild(C()),T.addEventListener("click",function(){var G=i.querySelector("button");G&&G.click()}),b.appendChild(T),g.appendChild(b),i.style.cssText+=";position:absolute !important;width:1px !important;height:1px !important;overflow:hidden !important;clip:rect(0,0,0,0) !important;"}if(s&&(s.style.display="none"),u){var q=document.createElement("div");q.className="compartilhar-produto";var z=document.createElement("button");z.setAttribute("aria-label","Compartilhar"),z.appendChild(h()),z.addEventListener("click",function(){var G=u.querySelector("button");G&&G.click()}),q.appendChild(z),g.appendChild(q),u.style.cssText+=";position:absolute !important;width:1px !important;height:1px !important;overflow:hidden !important;clip:rect(0,0,0,0) !important;"}var f=v.querySelector("#area-comprar");if(f){for(var W=f,Z=f.nextElementSibling;Z;){var D=window.getComputedStyle(Z).position;if(D==="fixed"||D==="sticky")W=Z,Z=Z.nextElementSibling;else break}W.parentNode.insertBefore(g,W.nextSibling)}else v.appendChild(g)})(),(function(){var v=P.querySelector(".comprar-fixo.area-compra-float");if(!(!v||v.querySelector("#mm-sticky-old-price"))){var i=P.querySelector(".informacoes-compra-produto");if(i){var s=i.querySelector(".line-through");if(s){var u=s.textContent.trim(),g=v.querySelector(".price-fixed");if(g){var h=document.createElement("span");h.id="mm-sticky-old-price",h.textContent=u,h.style.cssText=["text-decoration: line-through","color: #999","font-size: 11px","display: block","line-height: 1.2","margin-bottom: 1px"].join(";"),g.insertBefore(h,g.firstChild)}}}}})(),(function(){var v=P.querySelector(".informacoes-compra-produto");if(!(!v||document.getElementById("mm-trust-badges"))){var i=v.querySelector("#area-comprar");if(i){var s=document.createElement("div");s.id="mm-trust-badges",s.style.cssText=["display: flex","justify-content: center","align-items: center","flex-wrap: wrap","gap: 6px 10px","padding: 8px 0","margin-top: 2px"].join(";");var u=[{icon:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>',text:"Compra Segura"},{icon:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"/></svg>',text:"Troca 7 dias"},{icon:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 12 15 16 10" stroke="#4b664a"/></svg>',text:"Reclame Aqui"}],g="display:inline-flex;align-items:center;gap:4px;font-size:11px;color:#777;white-space:nowrap;";u.forEach(function(C,b){var T=document.createElement("span");if(T.style.cssText=g,T.innerHTML=C.icon+" "+C.text,s.appendChild(T),b<u.length-1){var q=document.createElement("span");q.textContent="|",q.style.cssText="color:#ddd;font-size:10px;",s.appendChild(q)}});for(var h=i.nextElementSibling;h&&window.getComputedStyle(h).position==="fixed";)h=h.nextElementSibling;h?v.insertBefore(s,h):v.appendChild(s)}}})(),(function(){var v=P.querySelector(".informacoes-compra-produto");if(!(!v||document.getElementById("mm-whatsapp-cta"))){var i=(document.querySelector("#prod-nome")||{}).value||"",s=(document.querySelector("#prod-valor")||{}).value||"",u=window.location.origin+window.location.pathname+(/^#derivacao=/.test(window.location.hash)?window.location.hash:""),g="5511915299488",h="";s&&(h=parseFloat(s).toLocaleString("pt-BR",{style:"currency",currency:"BRL"}));var C="Olá! Tenho interesse no "+i.trim();h&&(C+=" ("+h+")"),C+=". "+u;var b="https://api.whatsapp.com/send?phone="+g+"&text="+encodeURIComponent(C),T=document.createElement("a");T.id="mm-whatsapp-cta",T.href=b,T.target="_blank",T.rel="noopener noreferrer";var q='<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" style="flex-shrink:0;"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>';T.innerHTML=q+"<span>Compre pelo WhatsApp</span>";var z=document.getElementById("mm-action-row"),f=document.getElementById("mm-trust-badges"),W=z||f;W&&W.parentNode===v&&v.insertBefore(T,W.nextElementSibling)}})(),(function(){var v=P.querySelector(".informacoes-compra-produto");if(!(!v||document.getElementById("mm-stock-indicator"))){for(var i=10,s=document.querySelectorAll("script:not([src])"),u=-1,g=0;g<s.length;g++){var h=s[g].textContent,C=h.match(/"qtde_estoque"\s*:\s*(\d+)/);if(C){u=parseInt(C[1],10);break}}var b=u-i;if(!(b<1||b>9)){var T=document.createElement("div");T.id="mm-stock-indicator",T.style.cssText=["display: flex","align-items: center","gap: 6px","padding: 8px 12px","background: #fff8f0","border: 1px solid #fde0c2","border-radius: 8px","font-size: 13px","color: #c65d00","font-weight: 500","margin-top: 4px"].join(";");var q=b===1?"unidade":"unidades";T.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#c65d00" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>Restam apenas <strong>'+b+"</strong> "+q+" em estoque";var z=v.firstElementChild;z&&z.parentNode.insertBefore(T,z.nextElementSibling)}}})(),(function(){if(!document.getElementById("mm-trust-block")){var v=window.innerWidth>=769,i=document.createElement("div");i.id="mm-trust-block",i.style.cssText=["background: #f7f8f7","display: flex","align-items: center","justify-content: center","gap: "+(v?"40px":"10px"),"padding: "+(v?"14px 24px":"12px 16px"),v?"flex-direction: row":"flex-direction: column",v?"border-top: 1px solid #e8ece8":"border-radius: 10px",v?"border-bottom: 1px solid #e8ece8":"",v?"margin: 0":"margin-top: 10px"].filter(Boolean).join(";");var s=[{icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',label:"Atendimento",desc:"Seg à Sex 8h-18h"},{icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',label:"Garantia",desc:"12 meses fabricação"},{icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"/></svg>',label:"Trocas",desc:"Até 7 dias"},{icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="3" width="15" height="13"/><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>',label:"Frete",desc:"Todo o Brasil"},{icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>',label:"12x sem juros",desc:"No cartão"}],u="display:flex;align-items:center;gap:8px;",g="font-size:13px;font-weight:600;color:#1a1a1a;line-height:1.2;",h="font-size:11px;color:#777;line-height:1.2;";if(s.forEach(function(z){var f=document.createElement("div");f.style.cssText=u,f.innerHTML=z.icon+'<div><div style="'+g+'">'+z.label+'</div><div style="'+h+'">'+z.desc+"</div></div>",i.appendChild(f)}),v){var C=document.querySelector("#pagina-produto-react-app");if(C&&C.nextSibling)C.parentNode.insertBefore(i,C.nextSibling);else{var b=document.querySelector(".main-produto");b&&b.appendChild(i)}}else{var T=P.querySelector(".informacoes-compra-produto"),q=T?T.querySelector(".calculo-frete"):null;q?q.parentNode.insertBefore(i,q.nextElementSibling):T&&T.appendChild(i)}}})(),(function(){var v=P.querySelector(".informacoes-compra-produto");if(!v||document.getElementById("mm-inline-payments"))return;var i=v.querySelector(".form-pag-link");if(!i)return;var s=parseFloat(i.getAttribute("data-valor"))||0,u=parseFloat(i.getAttribute("data-valor-pix"))||0;if(s<=0)return;for(var g=[],h=1;h<=12;h++)g.push({vezes:h,valor:(s/h).toFixed(2).replace(".",",")});function C(bn){return"R$ "+bn.toFixed(2).replace(".",",")}var b=s-u,T=document.createElement("div");T.id="mm-inline-payments",T.style.cssText=["padding: 12px 0","border-top: 1px solid #f0f0f0","margin-top: 4px"].join(";");var q=window.innerWidth>=769,z="display:flex;align-items:center;gap:6px;padding:"+(q?"2px":"4px")+" 0;font-size:13px;color:#444;",f="width:5px;height:5px;border-radius:50%;background:#4b664a;flex-shrink:0;",W='<div style="'+z+'"><span style="'+f+'"></span><span><strong style="color:#1a1a1a;">PIX: '+C(u)+"</strong>"+(b>0?' <span style="color:#2e7d32;font-size:12px;font-weight:600;">(economize '+C(b)+")</span>":"")+"</span></div>";if(q)T.innerHTML=W+'<button id="mm-toggle-parcelas" style="background:none;border:none;color:#4b664a;font-size:13px;font-weight:500;padding:2px 0 0;cursor:pointer;display:flex;align-items:center;gap:4px;">Ver todas as parcelas <span style="font-size:10px;">&#9660;</span></button><div id="mm-more-parcelas" style="display:none;"></div>';else{for(var Z="",D=0;D<3;D++)Z+='<div style="'+z+'"><span style="'+f+'"></span><span>'+g[D].vezes+"x de R$ "+g[D].valor+" sem juros</span></div>";T.innerHTML=W+Z+'<button id="mm-toggle-parcelas" style="background:none;border:none;color:#4b664a;font-size:13px;font-weight:500;padding:6px 0 0;cursor:pointer;display:flex;align-items:center;gap:4px;">Ver todas as parcelas <span style="font-size:10px;">&#9660;</span></button><div id="mm-more-parcelas" style="display:none;"></div>'}for(var G="",O=q?0:3,B=O;B<12;B++)G+='<div style="'+z+'"><span style="'+f+'"></span><span>'+g[B].vezes+"x de R$ "+g[B].valor+" sem juros</span></div>";var tn=i.closest("div");tn&&(tn.parentNode.insertBefore(T,tn),i.style.display="none");var pn=document.getElementById("mm-more-parcelas");pn&&(pn.innerHTML=G);var cn=document.getElementById("mm-toggle-parcelas");cn&&pn&&cn.addEventListener("click",function(){var bn=pn.style.display!=="none";pn.style.display=bn?"none":"block",cn.innerHTML=bn?'Ver todas as parcelas <span style="font-size:10px;">&#9660;</span>':'Ver menos <span style="font-size:10px;">&#9650;</span>'})})(),(function(){var v=document.querySelector(".recomendacao-ctn-0.accordion"),i=document.querySelector(".descricao-produto.accordion");if(!(!v||!i)){var s=v.parentNode;if(!(!s||s!==i.parentNode)){var u=Array.prototype.slice.call(s.children),g=u.indexOf(v),h=u.indexOf(i);g<h&&s.insertBefore(i,v)}}})(),(function(){var v=document.querySelector("#cep");if(!v)return;var i="mm_cep",s=v.closest(".area-calculo");if(s){var u=s.querySelector("button");u&&u.addEventListener("click",function(){var q=v.value.replace(/\D/g,"");if(q.length===8)try{localStorage.setItem(i,q)}catch{}})}var g=null;try{g=localStorage.getItem(i)}catch{}if(!g||g.length!==8||v.value.replace(/\D/g,"").length>0)return;var h=g.substring(0,5)+"-"+g.substring(5);function C(q,z){q.focus();try{q.setSelectionRange(0,(q.value||"").length)}catch{}try{document.execCommand("delete")}catch{}try{document.execCommand("insertText",!1,z)}catch{}}function b(){var q=v.closest(".calculo-frete");return!!(q&&/R\$\s*\d/.test(q.innerText))}function T(q){q<=0||b()||(C(v,h),setTimeout(function(){if(!b()){var z=v.closest(".area-calculo"),f=z&&z.querySelector("button:not([disabled])");f&&f.click(),setTimeout(function(){b()||T(q-1)},2e3)}},2500))}setTimeout(function(){T(3)},600)})(),(function(){for(var v=document.querySelectorAll('.exibe-botao-whatsapp a[href*="whatsapp"]'),i=0;i<v.length;i++){var s=v[i].getAttribute("href");s&&s.indexOf("null")!==-1&&v[i].setAttribute("href",s.replace(/\s*null\s*/g," ").replace(/\s{2,}/g," "))}var u=document.querySelector(".exibe-botao-whatsapp");if(u){var g=new MutationObserver(function(){var h=u.querySelector('a[href*="whatsapp"]');h&&h.href.indexOf("null")!==-1&&h.setAttribute("href",h.getAttribute("href").replace(/\s*null\s*/g," ").replace(/\s{2,}/g," "))});g.observe(u,{subtree:!0,attributes:!0,attributeFilter:["href"]})}})(),(function(){var v=P.querySelector(".informacoes-compra-produto");if(!(!v||document.getElementById("mm-envio-badge"))){for(var i=!1,s=P.querySelectorAll(".tag-produto .text-tag, .tag-produto"),u=0;u<s.length;u++)if(s[u].textContent.toLowerCase().indexOf("envio")!==-1){i=!0;break}if(!i)for(var g=document.querySelectorAll("script:not([src])"),h=0;h<g.length;h++){var C=g[h].textContent.match(/"qtde_estoque"\s*:\s*(\d+)/);if(C){parseInt(C[1],10)>10&&(i=!0);break}}if(i){var b=document.createElement("div");b.id="mm-envio-badge",b.style.cssText=["display: inline-flex","align-items: center","gap: 6px","padding: 4px 0","font-size: 13px","color: #1a1a1a","margin-top: 4px"].join(";"),b.innerHTML='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#c65d00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0;"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg><span><strong style="color:#1a1a1a;">Pronta entrega</strong> <span style="color:#777;font-weight:400;">·</span> <span style="color:#555;font-weight:400;">Enviamos em 24h</span></span>';var T=v.firstElementChild;T&&T.nextElementSibling&&T.parentNode.insertBefore(b,T.nextElementSibling)}}})(),(function(){for(var v=P.querySelectorAll(".tag-1.tag-produto"),i=0;i<v.length;i++){var s=v[i].textContent.trim();(s.indexOf("%")!==-1||s.indexOf("OFF")!==-1)&&(v[i].style.display="none")}})(),(function(){for(var v=document.querySelectorAll('a[href*="avaliacoes"], a[href="#avaliacoes"]'),i=0;i<v.length;i++)v[i].addEventListener("click",function(s){s.preventDefault();var u=document.querySelector("#avaliacoes")||document.querySelector(".container-avaliacoes");u&&u.scrollIntoView({behavior:"smooth",block:"start"})})})(),(function(){var v=P.querySelector("h1");if(!(!v||document.getElementById("mm-brand"))){var i=document.querySelector("#prod-marca");if(!(!i||!i.value||i.value.trim()==="")){var s=document.createElement("span");s.id="mm-brand",s.style.cssText="display:block;font-size:13px;color:#777;font-weight:400;margin-top:2px;",s.textContent="por "+i.value.trim();var u=v.parentElement;if(u){var g=v.nextElementSibling;g?u.insertBefore(s,g):u.appendChild(s)}}}})(),(function(){var v=document.getElementById("mm-trust-badges");if(v){for(var i=v.querySelectorAll("span"),s=0;s<i.length;s++)if(i[s].textContent.indexOf("Reclame")!==-1){var u=document.querySelector('footer .reclame-aqui a, footer a[href*="reclameaqui"]'),g=u?u.href:"https://www.reclameaqui.com.br/empresa/madeira-mania-comercio-de-moveis-ltda/";i[s].innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 12 15 16 10" stroke="#4b664a"/></svg> <a href="'+g+'" target="_blank" rel="noopener" style="color:#777;text-decoration:none;">RA Verificada</a>'}}})(),(function(){var v=P.querySelector(".informacoes-compra-produto");if(v){var i=v.querySelector(".calculo-frete");if(i){v.style.cssText+=";display:flex !important;flex-direction:column !important;",i.style.cssText+=";order:20 !important;";var s=document.getElementById("mm-trust-block");s&&(s.style.cssText+=";order:30 !important;")}}})(),(function(){var v=P.querySelector(".informacoes-compra-produto");if(!(!v||document.getElementById("mm-mini-specs"))){var i=document.querySelector(".descricao-produto"),s={};if(i)for(var u=i.querySelectorAll("td"),g=0;g<u.length-1;g+=2){var h=u[g].textContent.trim().toLowerCase(),C=u[g+1].textContent.trim();h.indexOf("largura")!==-1&&(s.largura=C),h.indexOf("altura")!==-1&&(s.altura=C),h.indexOf("profundidade")!==-1&&(s.profundidade=C),h.indexOf("material")!==-1&&(s.material=C),h.indexOf("dobradi")!==-1&&(s.dobradicas=C),(h.indexOf("pes")!==-1||h.indexOf("pés")!==-1)&&(s.pes=C)}if(!(!s.largura&&!s.material)){var b=[];if(s.material&&b.push(s.material),s.dobradicas&&b.push("Dobradiças "+s.dobradicas),s.pes&&b.push("Pés: "+s.pes),s.largura&&b.push(s.largura+" × "+(s.altura||"")+" × "+(s.profundidade||"")),b.length!==0){var T=document.createElement("div");T.id="mm-mini-specs",T.style.cssText="padding:8px 0;border-top:1px solid #f0f0f0;margin-top:4px;";var q="";b.forEach(function(f){q+='<div style="display:flex;align-items:center;gap:6px;padding:2px 0;font-size:13px;color:#555;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0;"><polyline points="20 6 9 17 4 12"/></svg><span>'+f+"</span></div>"}),T.innerHTML=q;var z=v.querySelector("#area-comprar");z&&v.insertBefore(T,z)}}}})(),(function(){if(window.innerWidth<769||document.getElementById("mm-desktop-sticky"))return;var v=P.querySelector(".informacoes-compra-produto");if(!v)return;var i=v.querySelector(".line-through"),s=(document.querySelector("#prod-valor-principal")||{}).value,u=(document.querySelector("#prod-valor")||{}).value,g=(document.querySelector("#prod-nome")||{}).value||"",h=g.split(" - ")[0]||g;if(!s)return;var C=i?i.textContent.trim():"",b=parseFloat(s).toLocaleString("pt-BR",{style:"currency",currency:"BRL"}),T=u?parseFloat(u).toLocaleString("pt-BR",{style:"currency",currency:"BRL"}):"",q=u?(parseFloat(u)/12).toFixed(2).replace(".",","):"",z=document.createElement("div");z.id="mm-desktop-sticky",z.style.cssText=["position: fixed","top: -60px","left: 0","width: 100%","height: 56px","background: #ffffff","border-bottom: 1px solid #e8ece8","box-shadow: 0 2px 8px rgba(0,0,0,0.06)","z-index: 100","display: flex","align-items: center","justify-content: center","padding: 0 24px","transition: top 0.25s ease","font-family: -apple-system, BlinkMacSystemFont, sans-serif"].join(";");var f="display:flex;align-items:center;gap:16px;max-width:1200px;width:100%;",W="font-size:14px;font-weight:500;color:#1a1a1a;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:300px;",Z="display:flex;align-items:center;gap:8px;margin-left:auto;",D="text-decoration:line-through;color:#999;font-size:12px;",G="font-size:15px;font-weight:600;color:#1a1a1a;",O="font-size:12px;color:#666;",B="display:inline-flex;align-items:center;justify-content:center;padding:8px 20px;background:#4b664a;color:#fff;border:none;border-radius:8px;font-size:14px;font-weight:500;cursor:pointer;white-space:nowrap;";z.innerHTML='<div style="'+f+'"><span style="'+W+'">'+h+'</span><div style="'+Z+'">'+(C?'<span style="'+D+'">'+C+"</span>":"")+'<span style="'+G+'">'+b+' <small style="font-weight:400;font-size:11px;color:#666;">PIX</small></span>'+(q?'<span style="'+O+'">12x R$ '+q+"</span>":"")+'</div><button id="mm-desktop-sticky-btn" style="'+B+'">Comprar</button></div>',document.body.appendChild(z);var tn=document.getElementById("mm-desktop-sticky-btn");tn&&tn.addEventListener("click",function(){var bn=P.querySelector(".btn-comprar");bn&&bn.click()});var pn=v.querySelector("#area-comprar");if(!pn)return;function cn(){var bn=pn.getBoundingClientRect();z.style.top=bn.bottom<0?"0px":"-60px"}window.addEventListener("scroll",cn,{passive:!0}),cn()})(),(function(){var v=[".selos-seguranca",".formas-pagto"];v.forEach(function(i){var s=document.querySelector("footer "+i);s&&s.classList.contains("closed")&&(s.classList.remove("closed"),s.classList.add("open"))})})(),window.innerWidth>=769){var R=P.querySelector(".informacoes-compra-produto");R&&(R.style.setProperty("gap","12px","important"),R.style.setProperty("row-gap","12px","important"))}document.body.classList.add("mm-ready")})();var qt=document.currentScript;(function x(){x._retries=(x._retries||0)+1;var P=document.querySelector("#produto-react-app");if(!P||!P.querySelector(".informacoes-compra-produto")){x._retries<30&&setTimeout(x,500);return}if(!document.getElementById("mm-product-schema")){var R=P.querySelector("h1"),M=R?R.textContent.trim():"";if(M){var v=document.querySelector('link[rel="canonical"]'),i=v?v.href:location.href.split("?")[0],s=document.querySelector("#prod-marca"),u=s?s.value.trim():"";!u&&window.dataLayer&&window.dataLayer[0]&&(u=window.dataLayer[0].brand||"");var g=P.querySelector(".form-pag-link"),h=document.querySelector("#prod-valor-principal"),C=document.querySelector("#prod-valor"),b=0,T=0;g&&(b=parseFloat(g.getAttribute("data-valor-pix"))||0,T=parseFloat(g.getAttribute("data-valor"))||0),!T&&C&&(T=parseFloat(C.value)||0),!b&&h&&(b=parseFloat(h.value)||0);var q=b>0?b:T;if(!(q<=0)){var z="";window.dataLayer&&window.dataLayer[0]&&(z=window.dataLayer[0].sku||"");var f="",W="";window.dataLayer&&window.dataLayer[0]&&(f=window.dataLayer[0].category||"",W=window.dataLayer[0].category2||"");for(var Z=document.querySelector("#prod-deposito"),D=Z?Z.value==="1":!0,G=[],O=P.querySelectorAll(".gallery-main img, #block-imagem img"),B=0;B<O.length;B++){var tn=O[B].getAttribute("src")||O[B].getAttribute("data-src")||"";tn&&tn.indexOf("http")===0&&G.indexOf(tn)===-1&&G.push(tn)}if(G.length===0){var pn=document.querySelector('meta[property="og:image"]');pn&&pn.content&&G.push(pn.content)}var cn=document.querySelector('meta[name="description"]'),bn=cn?cn.content.trim():"";if(!bn){var On=document.querySelector(".descricao-produto .accordion-content p");On&&(bn=On.textContent.trim().substring(0,500))}for(var wn=0,Un=0,In=document.querySelectorAll("script:not([src])"),dn=0;dn<In.length;dn++){var Rn=In[dn].textContent;if(!(Rn.indexOf("Zord.avaliacoes")===-1&&Rn.indexOf("produtoAvaliacoes")===-1)){var Tn=Rn.match(/produtoAvaliacoes\s*:\s*(\d+)/),Ln=Rn.match(/\bnota\s*:\s*(?:Number\()?([\d.]+)/);Tn&&(wn=parseInt(Tn[1],10)),Ln&&(Un=parseFloat(Ln[1]))}}var Sn={"@context":"https://schema.org","@type":"Product",name:M,url:i,image:G,description:bn,sku:z,brand:{"@type":"Brand",name:u||"Madeira Mania"},offers:{"@type":"Offer",url:i,price:q.toFixed(2),priceCurrency:"BRL",availability:D?"https://schema.org/InStock":"https://schema.org/OutOfStock",itemCondition:"https://schema.org/NewCondition",seller:{"@type":"Organization",name:"Madeira Mania"},hasMerchantReturnPolicy:{"@type":"MerchantReturnPolicy",applicableCountry:"BR",returnPolicyCategory:"https://schema.org/MerchantReturnFiniteReturnWindow",merchantReturnDays:7,returnMethod:"https://schema.org/ReturnByMail"},shippingDetails:{"@type":"OfferShippingDetails",shippingDestination:{"@type":"DefinedRegion",addressCountry:"BR"},deliveryTime:{"@type":"ShippingDeliveryTime",handlingTime:{"@type":"QuantitativeValue",minValue:1,maxValue:3,unitCode:"DAY"},transitTime:{"@type":"QuantitativeValue",minValue:5,maxValue:20,unitCode:"DAY"}}}}};T>0&&(Sn.offers.priceSpecification=[{"@type":"UnitPriceSpecification",price:b>0?b.toFixed(2):q.toFixed(2),priceCurrency:"BRL",name:"PIX"},{"@type":"UnitPriceSpecification",price:(T/12).toFixed(2),priceCurrency:"BRL",name:"12x sem juros",referenceQuantity:{"@type":"QuantitativeValue",value:12,unitCode:"MON"}}]),wn>0&&Un>0&&(Sn.aggregateRating={"@type":"AggregateRating",ratingValue:Un.toFixed(1),bestRating:"5",worstRating:"1",reviewCount:String(wn)}),f&&(Sn.category=f+(W?" > "+W:""));var Mn=document.createElement("script");Mn.type="application/ld+json",Mn.id="mm-product-schema",Mn.textContent=JSON.stringify(Sn),document.head.appendChild(Mn),qt&&qt.parentNode&&qt.parentNode.removeChild(qt)}}}})();var At=document.currentScript;(function x(){x._retries=(x._retries||0)+1;var P=document.querySelector("#produto-react-app"),R=P?P.querySelector("h1"):null;if(!R){x._retries<30&&setTimeout(x,500);return}if(!document.getElementById("mm-breadcrumb-schema")){var M=[],v=1;M.push({"@type":"ListItem",position:v++,name:"Home",item:"https://www.madeiramania.com.br"});var i=document.querySelectorAll('.breadcrumb a, nav[aria-label*="breadcrumb" i] a, .migalha a, .breadcrumb-item a');if(i.length>0)for(var s=0;s<i.length;s++){var u=i[s],g=u.textContent.trim(),h=u.href;!g||g.toLowerCase()==="home"||g.toLowerCase()==="início"||!h||h==="#"||M.push({"@type":"ListItem",position:v++,name:g,item:h})}else if(window.dataLayer&&window.dataLayer[0]){var C=window.dataLayer[0].category||"",b=window.dataLayer[0].category2||"";C&&M.push({"@type":"ListItem",position:v++,name:C,item:"https://www.madeiramania.com.br/"+C.toLowerCase().replace(/\s+/g,"-").replace(/[àáâã]/g,"a").replace(/[éêë]/g,"e").replace(/[íî]/g,"i").replace(/[óôõ]/g,"o").replace(/[úû]/g,"u").replace(/ç/g,"c")}),b&&b!==C&&M.push({"@type":"ListItem",position:v++,name:b,item:"https://www.madeiramania.com.br/"+b.toLowerCase().replace(/\s+/g,"-").replace(/[àáâã]/g,"a").replace(/[éêë]/g,"e").replace(/[íî]/g,"i").replace(/[óôõ]/g,"o").replace(/[úû]/g,"u").replace(/ç/g,"c")})}if(M.push({"@type":"ListItem",position:v,name:R.textContent.trim()}),!(M.length<2)){var T={"@context":"https://schema.org","@type":"BreadcrumbList",itemListElement:M},q=document.createElement("script");q.type="application/ld+json",q.id="mm-breadcrumb-schema",q.textContent=JSON.stringify(T),document.head.appendChild(q),At&&At.parentNode&&At.parentNode.removeChild(At)}}})();var Ft=document.currentScript;(function x(){x._retries=(x._retries||0)+1;var P=document.querySelector(".descricao-produto");if(!P){x._retries<30&&setTimeout(x,500);return}if(!document.getElementById("mm-faq-section")){var R=[{q:"Como funciona a entrega de móveis?",a:"Enviamos para todo o Brasil por transportadora especializada em móveis. O prazo varia de 5 a 20 dias úteis dependendo da sua região. Você pode calcular o frete e prazo exato informando seu CEP na página do produto, acima do botão de compra."},{q:"O móvel vem montado ou precisa montar?",a:"A maioria dos móveis é enviada desmontada para garantir segurança no transporte. Cada produto inclui manual de montagem com instruções passo a passo e todas as ferragens necessárias. Produtos de madeira maciça geralmente exigem apenas encaixe simples de pés ou portas."},{q:"Vocês entregam em apartamento e zona rural?",a:"Sim, entregamos em apartamentos e áreas urbanas em todo o Brasil. Para zonas rurais, a disponibilidade depende da região — consulte informando seu CEP. A entrega é realizada até a portaria ou térreo do edifício."},{q:"E se o produto chegar com defeito?",a:"Você tem 7 dias para solicitar troca ou devolução a partir do recebimento, conforme o Código de Defesa do Consumidor (Art. 49). Basta entrar em contato pelo nosso WhatsApp com fotos do defeito. Todos os produtos possuem garantia de 12 meses contra defeitos de fabricação."},{q:"Quais as formas de pagamento?",a:"Aceitamos PIX com 7% de desconto (processado na hora), cartão de crédito em até 12x sem juros (Visa, Mastercard, Elo, American Express) e boleto bancário. O pagamento via PIX agiliza o despacho do seu pedido."},{q:"O preço de vocês é realmente menor que nos marketplaces?",a:"Sim. Como vendemos direto ao consumidor, sem comissões de marketplace, nossos preços são consistentemente 10% a 25% menores que MadeiraMadeira, Mercado Livre e outros. Compare o mesmo produto pelo código SKU do fabricante e confira a diferença."},{q:"Como funciona a garantia?",a:"Todos os produtos possuem garantia de 12 meses contra defeitos de fabricação, além do direito de arrependimento de 7 dias garantido pelo CDC. Móveis de madeira maciça, com os cuidados adequados, possuem durabilidade superior a 30 anos."}];if(!document.getElementById("mm-faq-styles")){var M=document.createElement("style");M.id="mm-faq-styles",M.textContent=["#mm-faq-section button:focus-visible { outline: 2px solid #4b664a; outline-offset: 2px; border-radius: 4px; }","#mm-faq-section button:active { opacity: 0.7; }","@media (prefers-reduced-motion: reduce) { #mm-faq-section * { transition: none !important; } }"].join(`
`),document.head.appendChild(M)}var v=document.createElement("div");v.id="mm-faq-section",v.style.cssText=["margin: 24px 0","padding: 0 8px"].join(";");var i=document.createElement("h2");i.style.cssText=["font-size: 18px","font-weight: 700","color: #1a1a1a","margin-bottom: 16px","padding-bottom: 8px","border-bottom: 2px solid #4b664a"].join(";"),i.textContent="Perguntas Frequentes",v.appendChild(i);var s=document.createElement("div");s.style.cssText=["display: flex","flex-direction: column","gap: 0"].join(";"),R.forEach(function(b,T){var q=document.createElement("div");q.style.cssText="border-bottom: 1px solid #e8ece8;";var z=document.createElement("button");z.setAttribute("aria-expanded","false"),z.setAttribute("aria-controls","mm-faq-answer-"+T),z.style.cssText=["display: flex","justify-content: space-between","align-items: center","width: 100%","padding: 16px 0","background: none","border: none","cursor: pointer","text-align: left","font-size: 15px","font-weight: 600","color: #1a1a1a","line-height: 1.4","font-family: inherit","-webkit-tap-highlight-color: transparent"].join(";");var f=document.createElement("span");f.textContent=b.q,f.style.cssText="flex: 1; padding-right: 12px;";var W=document.createElement("span");W.textContent="+",W.style.cssText=["font-size: 20px","font-weight: 300","color: #4b664a","flex-shrink: 0","transition: transform 0.2s ease","width: 24px","text-align: center"].join(";"),z.appendChild(f),z.appendChild(W);var Z=document.createElement("div");Z.id="mm-faq-answer-"+T,Z.setAttribute("role","region"),Z.setAttribute("aria-labelledby","mm-faq-q-"+T),z.id="mm-faq-q-"+T,Z.style.cssText=["max-height: 0","overflow: hidden","transition: max-height 0.3s ease, padding 0.3s ease","font-size: 14px","line-height: 1.6","color: #444"].join(";");var D=document.createElement("div");D.style.cssText="padding: 0 0 14px 0;",D.textContent=b.a,Z.appendChild(D),z.addEventListener("click",function(){var G=z.getAttribute("aria-expanded")==="true";G?(Z.style.maxHeight="0px",W.textContent="+",z.setAttribute("aria-expanded","false")):(Z.style.maxHeight=Z.scrollHeight+"px",W.textContent="−",z.setAttribute("aria-expanded","true"))}),z.addEventListener("touchstart",function(){z.style.opacity="0.7"},{passive:!0}),z.addEventListener("touchend",function(){z.style.opacity="1"},{passive:!0}),q.appendChild(z),q.appendChild(Z),s.appendChild(q)}),v.appendChild(s);var u=document.querySelector(".produtos-relacionados"),g=document.querySelector(".container-avaliacoes");if(u&&u.nextSibling?u.parentNode.insertBefore(v,u.nextSibling):g?g.parentNode.insertBefore(v,g):P.parentNode.appendChild(v),!document.getElementById("mm-faq-schema")){var h={"@context":"https://schema.org","@type":"FAQPage",mainEntity:R.map(function(b){return{"@type":"Question",name:b.q,acceptedAnswer:{"@type":"Answer",text:b.a}}})},C=document.createElement("script");C.type="application/ld+json",C.id="mm-faq-schema",C.textContent=JSON.stringify(h),document.head.appendChild(C)}Ft&&Ft.parentNode&&Ft.parentNode.removeChild(Ft)}})(),(function x(){x._retries=(x._retries||0)+1;var P=document.querySelector("#produto-react-app");if(!P||!P.querySelector("h1")){x._retries<30&&setTimeout(x,500);return}if(!document.querySelector('meta[property="og:title"]')){var R=P.querySelector("h1"),M=R?R.textContent.trim():document.title,v=document.querySelector('meta[name="description"]'),i=v?v.content.trim():"";if(!i){var s=document.querySelector(".descricao-produto .accordion-content p");s&&(i=s.textContent.trim().substring(0,200))}i||(i=M+" - Compre online na Madeira Mania com até 12x sem juros ou 7% de desconto no PIX.");var u=document.querySelector('link[rel="canonical"]'),g=u?u.href:location.href.split("?")[0],h="",C=P.querySelector(".gallery-main img, #block-imagem img");if(C&&(h=C.getAttribute("src")||C.getAttribute("data-src")||""),!h){var b=document.querySelector('meta[property="og:image"]');b&&(h=b.content)}var T=P.querySelector(".form-pag-link"),q=T&&parseFloat(T.getAttribute("data-valor-pix"))||0;if(q>0){var z="R$ "+q.toFixed(2).replace(".",",");i.indexOf("R$")===-1&&(i=i.replace(/\.$/,"")+" | A partir de "+z+" no PIX.")}i.length>200&&(i=i.substring(0,197)+"...");var f=[{property:"og:type",content:"product"},{property:"og:title",content:M},{property:"og:description",content:i},{property:"og:url",content:g},{property:"og:site_name",content:"Madeira Mania"},{property:"og:locale",content:"pt_BR"}];h&&(f.push({property:"og:image",content:h}),f.push({property:"og:image:width",content:"600"}),f.push({property:"og:image:height",content:"600"})),f.push({name:"twitter:card",content:"summary_large_image"}),f.push({name:"twitter:title",content:M}),f.push({name:"twitter:description",content:i}),h&&f.push({name:"twitter:image",content:h}),f.forEach(function(W){var Z=document.createElement("meta");W.property&&Z.setAttribute("property",W.property),W.name&&Z.setAttribute("name",W.name),Z.setAttribute("content",W.content),document.head.appendChild(Z)})}})(),(function(x){"use strict";if(!document.getElementById("produto-react-app")&&!document.getElementById("pagina-produto-react-app"))return;const P="3.0.0";window.innerWidth>=1500&&x(document).ready(function(){function v(){x(".gallery-main .swiper-slide img").each(function(){var i=this,s=x(this).closest(".swiper-slide"),u=s.closest(".swiper");function g(){var h=i.naturalWidth,C=i.naturalHeight;h&&C&&h===C&&u.css({"max-width":h+"px",overflow:"hidden"})}i.complete?g():i.addEventListener("load",g)})}v()}),window._variacoesMagazordCarregado&&(console.log(`%c⚠️ Variações Magazord v${P} - Substituindo instância anterior`,"color: #ff9800; font-weight: bold"),window.GerenciadorVariacoesPillsMagazord&&x(".product-variations-pills-container").remove()),window._variacoesMagazordCarregado=P,console.log(`%c🚀 Variações Magazord v${P} (dataProduct) - Inicializando...`,"color: #2196f3; font-weight: bold");const R={formatoNome:{separador:" - ",separadorTipoValor:": ",exibirNomeCompleto:!1,primeiraParte:"nome_base"},labels:{ALTURA:"Altura",LARGURA:"Largura",ILUMINACAO:"Iluminação",ILUMINAÇÃO:"Iluminação",PROFUNDIDADE:"Profundidade",COR:"Cor",ACABAMENTO:"Acabamento",TAMANHO:"Tamanho",PORTAS:"Número de Portas",ESPELHO:"Espelho",GAVETAS:"Gavetas",MODELO:"Modelo",MATERIAL:"Material",LUGARES:"Lugares",FORMATO:"Formato"},variacoesComImagem:["COR","ACABAMENTO"],ignorarPalavras:[],selectors:{areaProdutosSugeridos:".sugestoes-cores",areaVariacoes:".derivacoes-produto .area-derivacoes",containerProduto:".info-produto, .box-info-produto, main",subtituloProduto:".informacoes-compra-produto .text-secondary-700.text-xs"},retry:{maxTentativas:10,intervaloMs:500,usarMutationObserver:!0},debug:!0,performance:{useRequestAnimationFrame:!0,debounceDelay:150}};class M{constructor(){this.variacoes={},this.produtoAtualId=null,this.produtos=[],this.tentativasDeCarregamento=0,this.observer=null,this.inicializado=!1}init(){this.log("🎯 Gerenciador de Variações Magazord v3 (dataProduct)","info"),this.log("🎨 Swatches de imagem para cores + Pills para outras variações","info"),this.esperarDOMPronto()}esperarDOMPronto(){if(typeof jQuery>"u"){setTimeout(()=>this.esperarDOMPronto(),100);return}x(document).ready(()=>{this.log("✅ DOM pronto! Aguardando dataProduct...","success"),this.esperarDataProduct()})}esperarDataProduct(){typeof dataProduct<"u"&&dataProduct.listaProdutosSugeridos?(this.log("✅ dataProduct encontrado!","success"),this.tentarCarregar()):(this.log("⏳ Aguardando dataProduct...","info"),setTimeout(()=>this.esperarDataProduct(),300))}tentarCarregar(){this.tentativasDeCarregamento++,this.log(`
...
🎉 Inicialização concluída com sucesso!`,"success"),R.retry.usarMutationObserver&&this.observarMudancasDOM()):this.tentativasDeCarregamento<R.retry.maxTentativas?setTimeout(()=>this.tentarCarregar(),R.retry.intervaloMs):this.log("❌ Número máximo de tentativas atingido.","error")}observarMudancasDOM(){this.log("ℹ️ MutationObserver desativado - dados carregados via dataProduct","info")}log(i,s="log",u=null){if(!R.debug)return;const g={info:"color: #2196f3; font-weight: bold",success:"color: #4caf50; font-weight: bold",warning:"color: #ff9800; font-weight: bold",error:"color: #f44336; font-weight: bold",log:"color: #666"};console.log(`%c${i}`,g[s]||g.log),u&&console.log(u)}carregarProdutos(){if(this.produtos=[],typeof dataProduct>"u"||!dataProduct.listaProdutosSugeridos)return this.log("❌ dataProduct ou listaProdutosSugeridos não encontrado","error"),!1;const i=dataProduct.listaProdutosSugeridos,s=dataProduct.produto,u=dataProduct.hostImagem||"";if(this.log(`📦 Encontrados ${i.length} produtos sugeridos + produto atual`,"info"),s&&s.complemento){const g=s.midia_path&&s.midia_arquivo_nome?`${u}/${s.midia_path}${s.midia_arquivo_nome}`:"",h={id:s.derivacao_id||s.produto_id,nomeCompleto:s.complemento.trim(),estoque:s.qtde_estoque,url:s.link?`/${s.link}`:"",imagem:g,imagemData:g,elemento:null,variacoes:{},nomeBase:"",nomeExibicao:"",isAtual:!0};this.produtoAtualId=h.id,this.extrairVariacoesDoNome(h),this.produtos.push(h),this.log(`   ✓ Produto atual: "${h.nomeCompleto}"`,"success")}return i.forEach((g,h)=>{const C=g.complemento||g.nome||"";if(!C)return;const b=g.derivacao_id||g.produto_id;if(b===this.produtoAtualId){this.log(`   ⏭️ Ignorando duplicata: "${C}"`,"info");return}const T=g.midia_path&&g.midia_arquivo_nome?`${u}/${g.midia_path}${g.midia_arquivo_nome}`:"",q={id:b||h,nomeCompleto:C.trim(),estoque:g.qtde_estoque,url:g.link?`/${g.link}`:"",imagem:T,imagemData:T,elemento:null,variacoes:{},nomeBase:"",nomeExibicao:"",isAtual:!1};this.extrairVariacoesDoNome(q),this.produtos.push(q),this.log(`   ✓ Sugerido: "${q.nomeCompleto}"`,"log")}),this.produtos.length===0?!1:(this.log("✅ Produtos carregados e processados:","success",this.produtos),!0)}normalizarSeparadores(i){const s=["–","—","−","‐","‑","⁃"];let u=i;return s.forEach(g=>{const h=new RegExp(`\\s${g}\\s`,"g");u=u.replace(h," - ")}),u}extrairVariacoesDoNome(i){const u=this.normalizarSeparadores(i.nomeCompleto).split(R.formatoNome.separador);this.log(`
📝 Processando: "${i.nomeCompleto}"`,"log"),R.formatoNome.primeiraParte==="nome_base"&&(i.nomeBase=u[0].trim(),u.shift()),u.forEach(g=>{const h=g.trim();if(h&&h.includes(R.formatoNome.separadorTipoValor)){const[C,...b]=h.split(R.formatoNome.separadorTipoValor),T=b.join(R.formatoNome.separadorTipoValor).trim(),q=this.normalizarTipo(C.trim());if(R.ignorarPalavras.includes(q))return;i.variacoes[q]=T,this.log(`   ✓ ${q}: ${T}`,"success")}}),i.nomeExibicao=R.formatoNome.exibirNomeCompleto?i.nomeCompleto:i.nomeBase||i.nomeCompleto,Object.keys(i.variacoes).length===0&&(i.variacoes.MODELO=i.nomeCompleto,i.nomeExibicao=i.nomeCompleto)}normalizarTipo(i){return i.toUpperCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").trim()}processarVariacoes(){this.log(`
🔄 Processando variações...`,"info");const i=new Set;this.produtos.forEach(s=>{Object.keys(s.variacoes).forEach(u=>i.add(u))}),i.forEach(s=>{const u=new Set,g={};this.produtos.forEach(C=>{const b=C.variacoes[s];b&&(u.add(b),g[b]||(g[b]=[]),g[b].push(C))});const h=Array.from(u).sort();this.variacoes[s]={label:R.labels[s]||s,valores:h,produtosPorValor:g,usarImagem:R.variacoesComImagem.includes(s)},this.log(`   📊 ${s}: ${h.length} valor(es) único(s) → [${h.join(", ")}]`,h.length>1?"success":"warning")}),this.log("✅ Variações processadas:","success",this.variacoes)}renderizarVariacoes(){this.log(`
🎨 Renderizando variações...`,"info");let i=x(R.selectors.areaVariacoes);if(i.length===0&&(this.criarAreaVariacoes(),i=x(R.selectors.areaVariacoes)),Object.keys(this.variacoes).length===0)return;const s=x("<div>",{class:"product-variations-pills-container"});let u=0;if(Object.keys(this.variacoes).forEach(g=>{const h=this.variacoes[g];if(h.valores.length<=1){this.log(`⏭️ Ignorando "${g}" - apenas ${h.valores.length} valor(es)`,"info");return}if(h.usarImagem){const C=this.criarGrupoSwatches(g,h);s.append(C),u++}}),Object.keys(this.variacoes).forEach(g=>{const h=this.variacoes[g];if(!(h.valores.length<=1)&&!h.usarImagem){const C=this.criarGrupoPills(g,h);s.append(C),u++}}),u===0){this.log("ℹ️ Nenhuma variação com múltiplas opções - ocultando área","info"),i.closest(".derivacoes-produto").hide(),x(R.selectors.subtituloProduto).hide();return}R.performance.useRequestAnimationFrame&&window.requestAnimationFrame?requestAnimationFrame(()=>{i.empty().append(s),this.log(`✅ ${u} variação(ões) renderizada(s)!`,"success"),this.atualizarNomeProduto()}):(i.empty().append(s),this.log(`✅ ${u} variação(ões) renderizada(s)!`,"success"),this.atualizarNomeProduto())}criarAreaVariacoes(){const i=x(R.selectors.areaProdutosSugeridos);i.length>0?i.before('<div class="derivacoes-produto"><div class="area-derivacoes"></div></div>'):x("body").prepend('<div class="derivacoes-produto"><div class="area-derivacoes"></div></div>')}criarGrupoSwatches(i,s){const u=this.obterValorAtualParaTipo(i),g=x("<div>",{class:"variation-pill-group variation-pill-group--swatches","data-variacao-tipo":i,role:"group","aria-labelledby":`pill-label-${i.toLowerCase()}`}),h=x("<div>",{class:"variation-pill-label",id:`pill-label-${i.toLowerCase()}`});h.append(x("<span>").text(s.label+":")),h.append(x("<span>",{class:"variation-pill-label-value","data-label-value":i}).text(u||""));const C=x("<div>",{class:"variation-swatches-container",role:"radiogroup","aria-labelledby":`pill-label-${i.toLowerCase()}`});return s.valores.forEach((b,T)=>{const q=s.produtosPorValor[b],z=q.some(pn=>pn.estoque===void 0||pn.estoque>0),f=b===u,W=`pill-${i.toLowerCase()}-${this.sanitizeId(b)}`,Z=this.encontrarMelhorProdutoParaSwatch(i,b,q);let D=null;Z&&(D=Z.imagemData||Z.imagem);const G=x("<input>",{type:"radio",class:"variation-pill-input",id:W,name:`variation-${i}`,value:b,"data-variacao-tipo":i,"data-produtos":JSON.stringify(q.map(pn=>({id:pn.id,url:pn.url}))),checked:f,disabled:!z,"aria-label":`${s.label}: ${b}${z?"":" (Indisponível)"}`}),O=x("<label>",{class:"variation-color-swatch-wrapper",for:W,"data-tooltip":b}),B=x("<div>",{class:"variation-color-swatch","data-valor":b,tabindex:f?0:-1});D?B.append(x("<img>",{src:D,alt:b,class:"variation-color-swatch-image",loading:"lazy"})):B.css({"background-color":"#E5E7EB",display:"flex","align-items":"center","justify-content":"center","font-size":"14px",color:"#6B7280"}).text(b.charAt(0).toUpperCase());const tn=x("<span>",{class:"variation-color-swatch-name",text:b,title:b});O.append(B).append(tn),C.append(G).append(O)}),g.append(h).append(C),g}criarGrupoPills(i,s){const u=this.obterValorAtualParaTipo(i),g=x("<div>",{class:"variation-pill-group variation-pill-group--pills","data-variacao-tipo":i,role:"group","aria-labelledby":`pill-label-${i.toLowerCase()}`}),h=x("<div>",{class:"variation-pill-label",id:`pill-label-${i.toLowerCase()}`});h.append(x("<span>").text(s.label+":")),h.append(x("<span>",{class:"variation-pill-label-value","data-label-value":i}).text(u||""));const C=x("<div>",{class:"variation-pills-container",role:"radiogroup","aria-labelledby":`pill-label-${i.toLowerCase()}`});return s.valores.forEach((b,T)=>{const q=s.produtosPorValor[b],z=q.some(O=>O.estoque===void 0||O.estoque>0),f=b===u,W=`pill-${i.toLowerCase()}-${this.sanitizeId(b)}`,Z=x("<input>",{type:"radio",class:"variation-pill-input",id:W,name:`variation-${i}`,value:b,"data-variacao-tipo":i,"data-produtos":JSON.stringify(q.map(O=>({id:O.id,url:O.url}))),checked:f,disabled:!z,"aria-label":`${s.label}: ${b}${z?"":" (Indisponível)"}`});let D=b;z||(D+=' <span class="variation-pill-badge">Indisponível</span>');const G=x("<label>",{class:"variation-pill",for:W,html:D,"data-valor":b,tabindex:f?0:-1});C.append(Z).append(G)}),g.append(h).append(C),g}sanitizeId(i){return i.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}encontrarMelhorProdutoParaSwatch(i,s,u){const g=this.produtos.find(T=>T.isAtual||T.id===this.produtoAtualId);if(!g||u.length===0)return u[0]||null;if(u.length===1)return u[0];const h=g.variacoes;let C=null,b=-1;return u.forEach(T=>{let q=0;Object.keys(h).forEach(z=>{z!==i&&T.variacoes[z]===h[z]&&q++}),(T.imagemData||T.imagem)&&(q+=.5),q>b&&(b=q,C=T)}),this.log(`   🎯 Melhor produto para ${i}="${s}": score=${b}`,"log"),C||u[0]}obterValorAtualParaTipo(i){const s=this.produtos.find(u=>u.isAtual||u.id===this.produtoAtualId);return s?s.variacoes[i]:null}atualizarNomeProduto(){const i=this.produtos.find(u=>u.isAtual||u.id===this.produtoAtualId);if(!i)return;["h1.nome-produto",".product-name h1",".info-produto h1",'h1[itemprop="name"]',".box-info-produto h1"].forEach(u=>{const g=x(u);g.length>0&&g.text(i.nomeExibicao)})}bindEventos(){this.log(`
🔗 Vinculando eventos...`,"info"),x(document).on("change",".variation-pill-input",i=>{this.aoMudarVariacao(i)}),x(document).on("keydown",".variation-pills-container, .variation-swatches-container",i=>{this.handleKeyboardNavigation(i)}),x(document).on("click",".variation-pill, .variation-color-swatch-wrapper",function(){const i=x(this).is("label")?x("#"+x(this).attr("for")):x(this).closest("label").prev(".variation-pill-input");i.length&&!i.prop("disabled")&&x(this).closest(".variation-pill-group").addClass("is-loading")}),this.log("✅ Eventos vinculados","success")}handleKeyboardNavigation(i){const u=x(i.currentTarget).find(".variation-pill-input:not(:disabled)"),g=x(document.activeElement);if(!g.hasClass("variation-pill-input"))return;const h=u.index(g);let C=h;switch(i.key){case"ArrowRight":case"ArrowDown":i.preventDefault(),C=(h+1)%u.length;break;case"ArrowLeft":case"ArrowUp":i.preventDefault(),C=h-1<0?u.length-1:h-1;break;case"Home":i.preventDefault(),C=0;break;case"End":i.preventDefault(),C=u.length-1;break;default:return}u.eq(C).focus().prop("checked",!0).trigger("change")}aoMudarVariacao(i){const s=x(i.target),u=s.data("variacao-tipo"),g=s.val();this.log(`
🔄 Variação selecionada: ${u} = ${g}`,"info"),x(`.variation-pill-label-value[data-label-value="${u}"]`).text(g);const h={};x(".variation-pill-input:checked").each(function(){const b=x(this).data("variacao-tipo"),T=x(this).val();T&&(h[b]=T)}),this.log("📋 Seleção atual:","info",h);const C=this.encontrarProdutoPorVariacoes(h);if(C)this.log("✅ Produto encontrado!","success",C),this.navegarParaProduto(C);else{this.log("⚠️ Produto exato não encontrado, buscando melhor correspondência...","warning");const b=this.encontrarMelhorCorrespondencia(h);b?(this.log("✅ Melhor correspondência encontrada!","success",b),this.navegarParaProduto(b)):(this.log("❌ Nenhum produto correspondente encontrado","error"),x(".variation-pill-group").removeClass("is-loading"))}}encontrarProdutoPorVariacoes(i){return this.produtos.find(s=>Object.keys(i).every(u=>s.variacoes[u]===i[u]))}encontrarMelhorCorrespondencia(i){let s=null,u=0;return this.produtos.forEach(g=>{let h=0;Object.keys(i).forEach(C=>{g.variacoes[C]===i[C]&&h++}),h>u&&(u=h,s=g)}),u>0?s:null}navegarParaProduto(i){this.log(`
🚀 Navegando para: ${i.url}`,"info"),i.url?window.location.href=i.url:(this.log("❌ URL não encontrada para navegação","error"),x(".variation-pill-group").removeClass("is-loading"))}}setTimeout(function(){x(".product-variations-pills-container").remove(),x(".derivacoes-produto").remove();const v=new M;v.init(),window.GerenciadorVariacoesPillsMagazord=v},100)})(typeof jQuery<"u"?jQuery:window.jQuery||window.$),(function(){"use strict";function x(){if(!(typeof jQuery>"u"&&typeof $>"u")){var a=typeof jQuery<"u"?jQuery:$;a(document).ajaxComplete(function(l,c,y){y.url&&y.url.indexOf("checkout/cart")!==-1&&setTimeout(function(){window.dispatchEvent(new CustomEvent("reactItemAddedToCart"))},100)})}}function P(){var a=document.querySelector("#cart-preview-area .border-t.border-solid");if(!(!a||a.querySelector(".installment-total"))){var l=0,c=document.querySelectorAll("#cart-preview-area .cart-item");if(c.forEach(function(I){var H=parseFloat(I.getAttribute("data-item-price"))||0,Y=parseInt(I.getAttribute("data-item-quantity"))||1;l+=H*Y}),!(l<=0)){var y=(l/12).toFixed(2).replace(".",","),F=document.createElement("div");F.className="installment-total",F.textContent="ou 12x de R$ "+y;var S=a.querySelector(".valor-pix");S&&S.parentNode&&S.parentNode.insertBefore(F,S.nextSibling)}}}var R='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" aria-hidden="true"><path d="M5 12h14"/></svg>',M='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" aria-hidden="true"><path d="M12 5v14M5 12h14"/></svg>',v='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6M14 11v6"/><path d="M9 6V4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2"/></svg>';function i(){P();var a=document.querySelectorAll("#cart-preview-area .cart-item, .content-cart .cart-item");a.forEach(function(l){if(!l.querySelector(".qty-btn-minus")){var c=l.querySelector(".qtd-value");if(c){var y=l.querySelector(".cart-remove-item"),F=y?y.getAttribute("data-id"):null;if(F){var S=l.querySelector(".prod-remove");S&&!c.contains(y)&&(c.appendChild(y),S.style.display="none");var I=c.parentElement,H=null;if(I)for(var Y=0;Y<I.children.length;Y++){var X=I.children[Y];if(X!==c&&X.classList&&X.classList.contains("valor")){H=X;break}}H&&!c.contains(H)&&c.appendChild(H);var rn=parseInt(l.getAttribute("data-item-quantity"));if(!rn||isNaN(rn)){var J=c.textContent.match(/(\d+)/);rn=J?parseInt(J[1]):1}var sn=document.createElement("button");sn.className="qty-btn-minus",sn.type="button",sn.setAttribute("aria-label","Diminuir quantidade"),sn.innerHTML=R,sn.addEventListener("click",function(t){t.preventDefault(),t.stopPropagation();var e=parseInt(r.textContent)||1;if(e<=1){var o=l.querySelector(".cart-remove-item");o&&o.click();return}yt(l,F,-1,r,sn,m)});var r=document.createElement("span");r.className="qty-display",r.textContent=rn;var m=document.createElement("button");m.className="qty-btn-plus",m.type="button",m.setAttribute("aria-label","Aumentar quantidade"),m.innerHTML=M,m.addEventListener("click",function(t){t.preventDefault(),t.stopPropagation(),yt(l,F,1,r,sn,m)});var n=document.createElement("div");n.className="mm-qty-wrap",n.appendChild(sn),n.appendChild(r),n.appendChild(m),c.insertBefore(n,c.firstChild),y&&(y.innerHTML=v,y.setAttribute("aria-label","Remover produto"))}}}})}function s(){document.addEventListener("click",function(a){var l=a.target.closest(".cart-remove-item");if(!(!l||!l.closest("#cart-preview-area"))){a.preventDefault(),a.stopPropagation(),a.stopImmediatePropagation();var c=l.getAttribute("data-id");if(c){var y=l.closest(".cart-item"),F=y&&y.querySelector(".prod-nome")?.textContent?.trim()||"este produto",S=F.length>50?F.substring(0,50)+"…":F,I=document.getElementById("mm-confirm-overlay");I&&I.remove();var H=document.createElement("div");H.id="mm-confirm-overlay",H.className="mm-confirm-overlay",H.innerHTML='<div class="mm-confirm-card"><p class="mm-confirm-title">Remover produto?</p><p class="mm-confirm-desc">'+S.replace(/&/g,"&amp;").replace(/</g,"&lt;")+'</p><div class="mm-confirm-actions"><button class="mm-confirm-btn mm-confirm-btn-cancel">Manter</button><button class="mm-confirm-btn mm-confirm-btn-delete">Remover</button></div></div>',document.body.appendChild(H),H.querySelector(".mm-confirm-btn-cancel").addEventListener("click",function(){H.remove()}),H.querySelector(".mm-confirm-btn-delete").addEventListener("click",function(){H.remove(),window.__mmDeleteItem&&y?window.__mmDeleteItem(y,c):typeof Zord<"u"&&Zord.checkout&&Zord.checkout.deleteItem(parseInt(c))}),H.addEventListener("click",function(Y){Y.target===H&&H.remove()})}}},!0)}function u(){document.addEventListener("click",function(a){var l=a.target.closest(".finalizar-compra");l&&l.closest("#cart-preview-area")&&(a.preventDefault(),a.stopPropagation(),window.location.href="/checkout/identify")},!0)}function g(a,l){var c="cep=&cupom-desconto=&nenhumCreditoSelecionado=true&id="+encodeURIComponent(String(l))+"&area=main-cart";return fetch("/checkout/cart?operation="+encodeURIComponent(a),{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/x-www-form-urlencoded",Accept:"text/html,application/json,*/*","X-Requested-With":"XMLHttpRequest"},body:c}).then(function(y){if(!y.ok)throw new Error("HTTP "+y.status);return y.text()})}var h=1500,C=2e3,b="mm_cep",T="mm_cart_snapshot",q=1800*1e3;function z(){try{var a=localStorage.getItem(b)||"",l=a.replace(/\D/g,"");if(l.length===8)return l}catch{}return null}function f(a){return!a||a.length!==8?"":a.slice(0,5)+"-"+a.slice(5)}function W(a){if(!a||a.length!==8)return C;var l=parseInt(a.slice(0,2),10);return isNaN(l)?C:l>=1&&l<=39||l>=80&&l<=99?h:C}function Z(){try{var a=localStorage.getItem(T);if(!a)return null;var l=JSON.parse(a);return!l||!l.ts||Date.now()-l.ts>q?null:l}catch{return null}}function D(a){var l=[];return a.forEach(function(c){var y=(c.querySelector(".prod-nome a, .prod-nome")||{}).textContent||"",F=c.querySelector(".qty-display"),S=F?parseInt(F.textContent):parseInt(c.getAttribute("data-item-quantity"))||1;l.push(y.trim().slice(0,30)+"x"+S)}),l.sort().join("|")}function G(a){if(!a||!Array.isArray(a.items))return"";var l=a.items.map(function(c){return(c.name||"").trim().slice(0,30)+"x"+(c.quantity||1)});return l.sort().join("|")}var O='<svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><polyline points="20 6 9 17 4 12"/></svg>',B='<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M18 6 6 18M6 6l12 12"/></svg>',tn=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"];function pn(a){if(!a)return null;var l=String(a).match(/\d+/g);return!l||!l.length?null:Math.max.apply(null,l.map(Number))}function cn(a,l){for(var c=new Date(a.getTime()),y=0;y<l;){c.setDate(c.getDate()+1);var F=c.getDay();F!==0&&F!==6&&y++}return c}function bn(a){var l=new Date,c="dia "+a.getDate()+" de "+tn[a.getMonth()];return a.getFullYear()!==l.getFullYear()&&(c+=" de "+a.getFullYear()),c}function On(a){var l=pn(a);if(!l||l<1)return null;var c=cn(new Date,l);return"Receba até "+bn(c)}var wn={},Un=4e3,In={};function dn(a,l){if(!a||a.length!==8)return Promise.resolve(null);if(wn[a])return wn[a];if(!l){var c=In[a]||0;if(Date.now()-c<Un)return Promise.resolve(null)}var y="cep="+encodeURIComponent(a.slice(0,5)+"-"+a.slice(5))+"&cupom-desconto=&nenhumCreditoSelecionado=true&area=main-cart",F=fetch("/checkout/cart?operation=atualizaValoresCarrinho",{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/x-www-form-urlencoded",Accept:"text/html,application/json,*/*","X-Requested-With":"XMLHttpRequest"},body:y}).then(function(S){if(!S.ok)throw new Error("HTTP "+S.status);return S.text()}).then(function(S){return In[a]=Date.now(),Rn(S)}).catch(function(){return null}).then(function(S){return delete wn[a],S});return wn[a]=F,F}function Rn(a){try{var l=new DOMParser().parseFromString(a,"text/html"),c=l.querySelector("#resumo-compra .frete-calculado")||l.querySelector(".frete-calculado");if(!c)return null;var y="",F=c.querySelector(".frete-location .city");F&&(y=F.textContent.trim());var S=null,I="",H="",Y=c.querySelector(".info-frete-selec");if(Y){var X=Y.querySelector(".dias-entrega"),rn=Y.querySelector(".info-title span, .info-title");X&&(I=(X.textContent||"").trim()),rn&&(H=(rn.textContent||"").trim())}var J=c.querySelector(".line.valor-frete .value, .value.valor-frete")||c.querySelector(".valor-compra-frete .value");if(J){var sn=(J.textContent||"").trim();if(/gr[áa]tis/i.test(sn))S=0;else{var r=sn.match(/[\d.,]+/);if(r){var m=parseFloat(r[0].replace(/\./g,"").replace(",","."));isNaN(m)||(S=m)}}}if(S==null){var n=c.querySelector(".servico-frete");if(n){var t=parseFloat(n.getAttribute("data-valor-frete")||"0");if(isNaN(t)||(S=t),H||(H=n.getAttribute("data-servico-frete")||""),!I){var e=n.querySelector(".dias-entrega");e&&(I=(e.textContent||"").trim())}}}if(S==null)return null;var o=null,p=l.querySelector(".total-boleto .value, .totais-valor.total-boleto .value");if(p){var d=(p.textContent||"").trim(),E=d.match(/[\d.,]+/);if(E){var A=parseFloat(E[0].replace(/\./g,"").replace(",","."));isNaN(A)||(o=A)}}return{city:y,shipping:S,shippingDeadline:I,shippingName:H,totalPix:o}}catch{return null}}function Tn(a,l,c){if(!(!a||!c)){Cn(a);try{let Y=function(X){for(var rn=0;rn<F.length;rn++)if(F[rn]&&F[rn].name===X)return F[rn];return null};var y=Z()||{};y.ts=Date.now(),y.cepValue=l.slice(0,5)+"-"+l.slice(5),y.shipping=c.shipping,y.shippingDeadline=c.shippingDeadline,y.shippingName=c.shippingName,y.shippingCity=c.city,c.totalPix!=null&&(y.subtotalPix=c.totalPix);var F=y.items&&y.items.length?y.items:[],S=a.querySelectorAll(".cart-item:not(.mm-removing)");y.items=Array.prototype.map.call(S,function(X){var rn=X.querySelector(".prod-nome a, .prod-nome"),J=(rn&&rn.textContent||"").trim(),sn=X.querySelector(".qty-display"),r=sn?parseInt(sn.textContent):parseInt(X.getAttribute("data-item-quantity"))||1,m=Y(J);return m&&m.quantity===r&&(m.lineTotalPix>0||m.lineTotal>0||m.imgSrc)?m:{name:J,quantity:r}}),localStorage.setItem(T,JSON.stringify(y))}catch{}var I=a.querySelectorAll(".cart-item:not(.mm-removing)"),H=0;I.forEach(function(Y){var X=Y.querySelector(".valor");if(X){var rn=An(X.textContent);isNaN(rn)||(H+=rn)}}),a.querySelector(".box-total-btn")?_n(a):$n(a)}}function Ln(a){var l=z();if(l){var c=Z(),y=G(c),F=D(a.querySelectorAll(".cart-item:not(.mm-removing)")),S=c&&c.cepValue&&c.cepValue.replace(/\D/g,"")===l,I=c&&c.shipping!=null&&!isNaN(c.shipping);c&&y===F&&S&&I||dn(l).then(function(H){H&&Tn(a,l,H)})}}function Sn(a){return String(a||"").replace(/[&<>"']/g,function(l){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[l]})}function Mn(a){if(!a)return null;var l=a.querySelector(".box-total-btn");if(l)return{host:l,before:l.querySelector(".total")};var c=a.querySelector(".area-finalizar-compra");if(c)return{host:c,before:c.firstElementChild};var y=a.querySelector(".finalizar-compra");if(y&&y.parentElement){var F=y.parentElement;return{host:F,before:F.firstElementChild}}return null}function Zn(a){if(!a)return null;var l=a.closest(".carrinho-rapido-ctn");return l||(a.closest("#cart-preview-area")?xt():null)}function zn(a,l,c,y){if(a){var F=Mn(a);if(F){var S=F.host;a.classList.add("mm-ship-scope");var I=z(),H=Z(),Y=D(a.querySelectorAll(".cart-item:not(.mm-removing)")),X=G(H),rn=H&&X===Y,J=W(I),sn=l>=J,r=Math.max(0,J-l),m=Math.max(0,Math.min(100,l/J*100)),n=S.querySelector(".mm-cart-ship");if(!n){n=document.createElement("div"),n.className="mm-cart-ship",n.setAttribute("role","group"),n.setAttribute("aria-label","Informações de frete");var t=F.before;t&&t.parentNode===S?S.insertBefore(n,t):S.insertBefore(n,S.firstChild)}if(n.classList.toggle("is-free",sn),Nn(n),n.dataset.mmEditing!=="1"){var e=H&&H.cepValue&&H.cepValue.replace(/\D/g,"")===I,o=I&&rn&&e&&H.shippingCity,p=o?On(H.shippingDeadline):null,d="";if(d+='<div class="mm-cart-ship-location">',I){var E=f(I);if(o&&(E+=" · "+Sn(H.shippingCity)),d+='<span class="mm-cart-ship-label">Envio para</span><div class="mm-cart-ship-location-value"><span>'+E+'</span><button class="mm-cart-ship-edit" type="button" data-mm-ship="edit">Trocar</button></div>',p){var A=Sn(p);y&&c>0?A+=" · <strong>"+Sn(En(c))+"</strong>":y&&c===0&&(A+=" · <strong>Grátis</strong>"),d+='<span class="mm-cart-ship-deadline">'+A+"</span>"}}else d+='<span class="mm-cart-ship-label">Calcule o frete</span><div class="mm-cart-ship-location-value"><span style="color:#9CA3AF;font-weight:500;">Informe seu CEP</span><button class="mm-cart-ship-edit" type="button" data-mm-ship="edit">Calcular</button></div>';d+="</div>";var _=sn?"Frete grátis desbloqueado":"Faltam "+En(r)+" para frete grátis",L=parseFloat(a.dataset.mmShipPct||"0")||0;d+='<div class="mm-cart-ship-progress">',d+='<div class="mm-cart-ship-bar" role="progressbar" aria-valuenow="'+Math.round(l)+'" aria-valuemin="0" aria-valuemax="'+Math.round(J)+'" aria-valuetext="'+Sn(_)+'" aria-label="Progresso para frete grátis"><div class="mm-cart-ship-bar-fill" style="width:'+L.toFixed(1)+'%"></div></div>',d+='<p class="mm-cart-ship-nudge'+(sn?" is-free":"")+'">',sn?d+=O+"Frete grátis garantido":d+="Faltam <strong>"+Sn(En(r))+"</strong> para frete grátis",d+="</p>",d+="</div>",n.innerHTML=d;var V=n.querySelector(".mm-cart-ship-bar-fill");V&&requestAnimationFrame(function(){V.style.width=m.toFixed(1)+"%"});var N=a.dataset.mmShipWasFree==="1";sn&&!N&&L>0&&(n.classList.remove("mm-just-unlocked"),n.offsetWidth,n.classList.add("mm-just-unlocked"),setTimeout(function(){n.classList.remove("mm-just-unlocked")},1400)),a.dataset.mmShipWasFree=sn?"1":"",a.dataset.mmShipPct=m.toFixed(1)}}}}var Yn='<svg class="mm-cart-ship-spinner" width="14" height="14" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"><style>.mm-sp{animation:mm-spin 1.2s linear infinite;transform-origin:center}.mm-sp circle{stroke:#4B664A;stroke-width:3;fill:none;stroke-linecap:round;stroke-dasharray:44;stroke-dashoffset:16;animation:mm-sp-dash 1.2s ease-in-out infinite}@keyframes mm-spin{to{transform:rotate(360deg)}}@keyframes mm-sp-dash{0%{stroke-dashoffset:44}50%{stroke-dashoffset:8}100%{stroke-dashoffset:44}}</style><g class="mm-sp"><circle cx="12" cy="12" r="9.5"/></g></svg>';function hn(a){if(a){var l=a.querySelector(".mm-cart-ship-deadline");if(l)l.innerHTML="Recalculando frete "+Yn;else{var c=a.querySelector(".mm-cart-ship-location");if(c){var y=document.createElement("span");y.className="mm-cart-ship-deadline",y.innerHTML="Recalculando frete "+Yn,c.appendChild(y)}}var F=Mn(a);F&&F.host.classList.add("mm-ship-loading")}}function Cn(a){if(a){var l=Mn(a);l&&l.host.classList.remove("mm-ship-loading")}}function Nn(a){!a||a.dataset.mmShipBound||(a.dataset.mmShipBound="1",a.addEventListener("click",function(l){var c=l.target.closest('[data-mm-ship="edit"]');if(c){l.preventDefault(),l.stopPropagation(),Dn(a);return}var y=l.target.closest('[data-mm-ship="cancel"]');if(y){l.preventDefault(),l.stopPropagation(),Jn(a);return}l.target.closest(".mm-cart-ship-cep-form")&&l.stopPropagation()},!0))}function Dn(a){var l=a.querySelector(".mm-cart-ship-location");if(l){a.dataset.mmEditing="1";var c=z()||"";l.innerHTML='<span class="mm-cart-ship-label">Digite seu CEP</span><form class="mm-cart-ship-cep-form" data-mm-ship-form="1" novalidate><input class="mm-cart-ship-cep-input" type="text" inputmode="numeric" autocomplete="postal-code" placeholder="00000-000" maxlength="9" value="'+Sn(f(c))+'" aria-label="CEP" /><button class="mm-cart-ship-cep-save" type="submit">OK</button><button class="mm-cart-ship-cep-cancel" type="button" data-mm-ship="cancel" aria-label="Cancelar">'+B+"</button></form>";var y=l.querySelector(".mm-cart-ship-cep-input"),F=l.querySelector("form");y&&(setTimeout(function(){try{y.focus(),y.select()}catch{}},10),y.addEventListener("input",function(){y.classList.remove("is-invalid");var S=y.value.replace(/\D/g,"").slice(0,8);y.value=S.length>5?S.slice(0,5)+"-"+S.slice(5):S}),y.addEventListener("keydown",function(S){S.key==="Escape"&&(S.preventDefault(),Jn(a))})),F&&F.addEventListener("submit",function(S){S.preventDefault(),S.stopPropagation(),ut(a)})}}function Jn(a){a.dataset.mmEditing="";var l=Zn(a);if(l){var c=l.querySelectorAll(".cart-item:not(.mm-removing)"),y=0;c.forEach(function(F){var S=F.querySelector(".valor");if(S){var I=An(S.textContent);isNaN(I)||(y+=I)}}),zn(l,y)}}function ut(a){var l=a.querySelector(".mm-cart-ship-cep-input");if(l){var c=l.value.replace(/\D/g,"");if(c.length!==8){l.classList.add("is-invalid"),l.focus();return}try{localStorage.setItem(b,c)}catch{}var y=a.querySelector(".mm-cart-ship-cep-save");y&&(y.disabled=!0,y.textContent="...");var F=Zn(a);try{var S=Z();S&&(S.cepValue="",localStorage.setItem(T,JSON.stringify(S)))}catch{}Jn(a),dn(c).then(function(I){I&&F&&Tn(F,c,I)})}}function An(a){if(!a)return NaN;var l=String(a).replace(/\s/g,"").match(/([\d.,]+)/);return l?parseFloat(l[1].replace(/\./g,"").replace(",",".")):NaN}function En(a){return isNaN(a)?"":"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2})}function gn(a){if(isNaN(a))return"";var l=a.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2}),c=l.split(",");return"R$&nbsp;"+c[0]+'<span class="mm-cents">,'+(c[1]||"00")+"</span>"}function tt(a){var l=0;return Array.prototype.forEach.call(a,function(c){var y=parseFloat(c.getAttribute("data-item-price"))||0,F=parseInt(c.getAttribute("data-item-quantity"));if(!F||isNaN(F)){var S=c.querySelector(".qty-display");S?F=parseInt(S.textContent)||1:F=1}l+=y*F}),l}function st(a){var l=a.querySelectorAll(".cart-item:not(.mm-removing)");l.forEach(function(c){var y=parseFloat(c.getAttribute("data-item-price"))||0,F=parseInt(c.getAttribute("data-item-quantity"));if(!F||isNaN(F)){var S=c.querySelector(".qty-display");S?F=parseInt(S.textContent)||1:F=1}var I=c.querySelector(".valor");I&&y>0&&(I.innerHTML=gn(y*F))})}function jn(a){if(!(!a||a.dataset.mmTotalRatio)){var l=a.querySelectorAll(".cart-item");if(l.length){var c=tt(l),y=a.querySelector(".box-total-btn .linha-total .valor-final > .valor > strong")||a.querySelector(".box-total-btn .linha-total .valor-final strong");if(y&&c>.01){var F=An(y.textContent);isNaN(F)||(a.dataset.mmTotalRatio=String(F/c))}}}}function et(a,l){var c=a.querySelector(".box-total-btn .linha-total");if(c){var y=c.parentElement.querySelector(".mm-cart-savings");if(y&&y.remove(),!(!l||l<.01)){var F=document.createElement("span");F.className="mm-cart-savings",F.textContent="Você economiza "+En(l)+" com PIX",c.nextSibling?c.parentElement.insertBefore(F,c.nextSibling):c.parentElement.appendChild(F)}}}function _n(a,l){if(a){jn(a);var c=a.querySelectorAll(".cart-item:not(.mm-removing)"),y=tt(c),F=a.querySelector(".box-total-btn .linha-total .valor-final > .valor > strong")||a.querySelector(".box-total-btn .linha-total .valor-final strong"),S=parseFloat(a.dataset.mmTotalRatio||"0.95")||.95,I=y*S,H=y-I,Y=z(),X=Z(),rn=G(X),J=D(c),sn=X&&X.cepValue&&X.cepValue.replace(/\D/g,"")===Y,r=!!(Y&&X&&sn&&X.shipping!=null&&!isNaN(X.shipping)),m=a.dataset.mmShipPendingFetch==="1";!r&&m&&Y&&X&&X.shipping!=null&&(r=!0);var n=r?parseFloat(X.shipping):0,t=I+n,e=y+n;if(F){var o=An(F.textContent);if(l)(isNaN(o)||Math.abs(t-o)>.005)&&(F.innerHTML=gn(t));else if(!isNaN(o)&&Math.abs(t-o)>.005){var p=a.querySelector(".box-total-btn .linha-total .valor-final");p&&(p.classList.remove("mm-pop"),p.offsetWidth,p.classList.add("mm-pop"),setTimeout(function(){p.classList.remove("mm-pop")},450)),vt(F,o,t)}else F.innerHTML=gn(t)}var d=a.querySelector(".box-total-btn .valor-final.card");if(d){var E=e/12;d.innerHTML="<span>ou em até <strong>12x</strong> de <strong>"+En(E)+"</strong> no cartão</span>"}var A=a.querySelector(".box-total-btn .linha-total .valor-final .tipo-pagto");A&&(A.textContent="No PIX"),et(a,H),zn(a,y,n,r);try{var _=0;c.forEach(function(V){var N=V.querySelector(".qty-display");N&&(_+=parseInt(N.textContent)||0)});var L=document.getElementById("mm-h-cart-count");L&&(_>0?(L.textContent=_>99?"99+":String(_),L.hidden=!1):L.hidden=!0)}catch{}}}function at(){var a=document.querySelector(".carrinho-rapido-ctn");if(!(!a||!a.querySelector(".box-total-btn"))){var l=a.querySelectorAll(".cart-item:not(.mm-removing)");if(l.length){var c=a.querySelector(".box-total-btn .linha-total .valor-final > .valor > strong")||a.querySelector(".box-total-btn .linha-total .valor-final strong");if(c){var y=tt(l);if(y>.01){var F=parseFloat(a.dataset.mmTotalRatio||"0.95")||.95,S=z(),I=Z(),H=I&&I.cepValue&&I.cepValue.replace(/\D/g,"")===S,Y=!!(S&&I&&H&&I.shipping!=null&&!isNaN(I.shipping));!Y&&a.dataset.mmShipPendingFetch==="1"&&S&&I&&I.shipping!=null&&(Y=!0);var X=Y?parseFloat(I.shipping):0,rn=y*F+X,J=An(c.textContent);(isNaN(J)||Math.abs(rn-J)>.01)&&_n(a,!0)}}}}}function xt(){var a=document.querySelector('#cart-preview-area > div[class*="z-[9999]"]');if(a)return a;var l=document.querySelector(".carrinho-rapido-ctn");return l&&!l.querySelector(".box-total-btn")&&l.querySelector(".valor-pix")?l:null}function Tt(a,l){var c=a.querySelector(".installment-total");if(!(!c||!c.parentElement)){var y=c.parentElement,F=y.querySelector(".mm-cart-savings-mobile");if(!l||l<.01){F&&F.remove();return}var S="Você economiza "+En(l)+" com PIX";if(F){F.textContent!==S&&(F.textContent=S);return}var I=document.createElement("span");I.className="mm-cart-savings-mobile",I.textContent=S,c.nextSibling?y.insertBefore(I,c.nextSibling):y.appendChild(I)}}function Hn(a,l,c){if(!(!a||!a.classList||!a.classList.contains("carrinho-rapido-ctn"))&&!a.querySelector(".box-total-btn")){var y=a.querySelector(".area-finalizar-compra");if(!(!y||!(l>0))){var F=y.querySelector(".forma-pix"),S=F?F.parentElement:null;if(S){var I=l*c,H=l/12,Y=l-I;S.classList.add("mm-native-pay-hidden");var X=y.querySelector(".mm-cart-total-b");X||(X=document.createElement("div"),X.className="mm-cart-total-b",X.innerHTML='<span class="mm-tb-label">Total</span><span class="mm-tb-row"><strong class="mm-tb-value"></strong><span class="mm-tb-pix">No PIX</span></span><span class="mm-tb-savings"></span><span class="mm-tb-parcela"></span>',S.nextSibling?y.insertBefore(X,S.nextSibling):y.appendChild(X));var rn=X.querySelector(".mm-tb-value"),J=En(I);rn&&rn.textContent!==J&&(rn.textContent=J);var sn=X.querySelector(".mm-tb-savings");if(sn)if(Y>=.01){var r="Você economiza "+En(Y)+" com PIX";sn.textContent!==r&&(sn.textContent=r),sn.style.display=""}else sn.style.display="none";var m=X.querySelector(".mm-tb-parcela");if(m){var n="ou em até 12x de "+En(H)+" no cartão";m.textContent!==n&&(m.textContent=n)}}}}}function $n(a){if(a=a||xt(),!(!a||a.querySelector(".box-total-btn")||!a.querySelector(".valor-pix"))){var l=a.querySelectorAll(".cart-item:not(.mm-removing)"),c=l.length,y=document.getElementById("mm-h-cart-count");if(y&&c>0){var F=c>99?"99+":String(c);(y.textContent!==F||y.hidden)&&(y.textContent=F,y.hidden=!1)}if(l.length){var S=tt(l);if(S>0){Array.prototype.forEach.call(l,function(L){var V=parseFloat(L.getAttribute("data-item-price"))||0;if(V>0){var N=parseInt(L.getAttribute("data-item-quantity"));if(!N||isNaN(N)){var nn=L.querySelector(".qty-display");N=nn&&parseInt(nn.textContent)||1}var en=L.querySelector(".valor");if(en){var an=V*N,U=en.querySelector("span")||en,un=An(U.textContent);(isNaN(un)||Math.abs(un-an)>.005)&&(U.textContent=En(an))}}});var I=a.querySelector(".valor-pix"),H=I?I.querySelector("span")||I:null;if(!a.dataset.mmMobileRatio&&H){var Y=An(H.textContent);if(!isNaN(Y)&&Y>0){var X=Y/S;X>.8&&X<=1.0001&&(a.dataset.mmMobileRatio=String(X))}}var rn=parseFloat(a.dataset.mmMobileRatio||"0.95");if(rn>.8&&rn<=1.0001||(rn=.95),H){var J=S*rn,sn=An(H.textContent);(isNaN(sn)||Math.abs(sn-J)>.005)&&(H.textContent=En(J))}var r=a.querySelector(".installment-total");if(r){var m=S/12,n=An(r.textContent);(isNaN(n)||Math.abs(n-m)>.005)&&(r.textContent="ou 12x de "+En(m))}var t=z(),e=Z(),o=e&&e.cepValue&&e.cepValue.replace(/\D/g,"")===t,p=!!(t&&e&&o&&e.shipping!=null&&!isNaN(e.shipping)),d=p?parseFloat(e.shipping):0,E=(t||"")+"|"+S.toFixed(2)+"|"+(p?1:0)+"|"+d,A=a.querySelector(".mm-cart-ship"),_=A&&A.dataset.mmEditing==="1";!_&&(!A||a.dataset.mmMobShipSig!==E)&&(a.dataset.mmMobShipSig=E,zn(a,S,d,p)),Ln(a),Tt(a,S-S*rn),Hn(a,S,rn)}}}}function vt(a,l,c){if(!a||isNaN(l)||isNaN(c))return;var y=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(y){a.innerHTML=gn(c);return}var F=420,S=performance.now();function I(H){return 1-Math.pow(1-H,3)}(function H(Y){var X=Math.min(1,(Y-S)/F);a.innerHTML=gn(l+(c-l)*I(X)),X<1&&requestAnimationFrame(H)})(S)}function yt(a,l,c,y,F,S){if(!(!a||!l)){var I=parseInt(y.textContent)||1,H=I+c;if(!(H<1)){var J=a.closest(".carrinho-rapido-ctn");jn(J),F.disabled=!0,S.disabled=!0;var Y=parseFloat(a.getAttribute("data-item-price"))||0;y.textContent=H,a.setAttribute("data-item-quantity",H);var X=a.querySelector(".valor");if(X){var rn=Y*H;X.textContent=En(rn),X.classList.remove("mm-pop"),X.offsetWidth,X.classList.add("mm-pop"),setTimeout(function(){X.classList.remove("mm-pop")},450)}var J=a.closest(".carrinho-rapido-ctn"),sn=c>0?"adicionaItem":"removeItem";z()&&J&&(J.dataset.mmShipPendingFetch="1"),_n(J),$n(),z()&&hn(J),g(sn,l).catch(function(){y.textContent=I,a.setAttribute("data-item-quantity",I),X&&(X.innerHTML=gn(Y*I)),J&&(J.dataset.mmShipPendingFetch=""),_n(J),$n()}).then(function(){F.disabled=!1,S.disabled=!1;var r=z();r&&J?(hn(J),dn(r,!0).then(function(m){J.dataset.mmShipPendingFetch="",m?Tn(J,r,m):Cn(J)})):J&&(J.dataset.mmShipPendingFetch="")})}}}function kt(a,l){if(!(!a||!l)){var c=a.closest(".carrinho-rapido-ctn");jn(c);var y=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,F=y?0:360;y||a.classList.add("mm-removing"),setTimeout(function(){a.parentNode&&a.parentNode.removeChild(a);var S=c?c.querySelectorAll(".cart-item:not(.mm-removing)"):[],I=S.length===0;if(I){if(c){c.dataset.mmShipPendingFetch="";var H=c.querySelector(".mm-cart-ship");H&&H.remove();var Y=c.querySelector(".box-total-btn, .area-finalizar-compra");Y&&(Y.style.display="none")}typeof window.__mmForceEmptyCartState=="function"&&window.__mmForceEmptyCartState(c)}else _n(c),z()&&hn(c);var X=document.getElementById("mm-h-cart-count"),rn=document.getElementById("mm-h-cart"),J=S.length;X&&(X.textContent=J>99?"99+":String(J),X.hidden=J===0),rn&&rn.setAttribute("aria-label","Carrinho, "+J+" "+(J===1?"item":"itens")),$n()},F),g("deleteItem",l).catch(function(){}).then(function(){var S=c?c.querySelectorAll(".cart-item:not(.mm-removing)"):[],I=document.getElementById("mm-h-cart-count");if(I&&(I.textContent=S.length>99?"99+":String(S.length),I.hidden=S.length===0),S.length===0){c&&(c.dataset.mmShipPendingFetch="");return}var H=z();H&&c?(c.dataset.mmShipPendingFetch="1",hn(c),dn(H,!0).then(function(Y){c.dataset.mmShipPendingFetch="",Y?Tn(c,H,Y):Cn(c)})):c&&(c.dataset.mmShipPendingFetch="")})}}window.__mmDeleteItem=kt;var Lt=null,wt=new Set,pt=null;function Vn(a){if(!a)return NaN;var l=String(a).replace(/\s/g,"").match(/([\d.,]+)/);if(!l)return NaN;var c=l[1].replace(/\./g,"").replace(",","."),y=parseFloat(c);return isNaN(y)?NaN:y}function lt(a){return isNaN(a)?"":"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2})}function Mt(a,l,c){if(!a||isNaN(l)||isNaN(c))return;pt&&cancelAnimationFrame(pt);var y=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(y){a.textContent=lt(c);return}var F=420,S=performance.now();function I(Y){return 1-Math.pow(1-Y,3)}function H(Y){var X=Y-S,rn=Math.min(1,X/F),J=l+(c-l)*I(rn);a.textContent=lt(J),rn<1?pt=requestAnimationFrame(H):pt=null}pt=requestAnimationFrame(H)}function ft(a){return a?a.querySelector(".box-total-btn .linha-total .valor-final > .valor > strong")||a.querySelector(".box-total-btn .linha-total .valor-final strong")||a.querySelector(".valor-pix strong")||a.querySelector(".valor-pix"):null}function Ct(a){return a?a.querySelector(".box-total-btn .linha-total .valor-final"):null}function St(a){var l=Ct(a);l&&(l.classList.remove("mm-pop"),l.offsetWidth,l.classList.add("mm-pop"),setTimeout(function(){l.classList.remove("mm-pop")},450))}function Kn(){var a=document.querySelector(".carrinho-rapido-ctn");if(a){var l=a.querySelectorAll(".cart-item:not(.mm-removing)");if(l.length>0){var c=a.querySelector(".box-total-btn");c&&c.dataset.mmTotalEnhanced!=="1"&&(jn(a),st(a),_n(a),c.dataset.mmTotalEnhanced="1",a.dataset.mmShipRendered="1",Ln(a))}a.querySelector(".box-total-btn")||$n(a);var y=a.querySelectorAll(".cart-item"),F=new Set;y.forEach(function(S){var I=S.id||S.getAttribute("data-item-id")||"";I&&(F.add(I),!wt.has(I)&&wt.size>0&&(S.classList.add("mm-added"),setTimeout(function(){S.classList.remove("mm-added")},500)))}),wt=F}}function Gn(){var a=document.querySelector(".carrinho-rapido-ctn");if(!(!a||a.dataset.mmAnimObserved)){a.dataset.mmAnimObserved="1",Kn();var l=new MutationObserver(function(){clearTimeout(Gn._t),Gn._t=setTimeout(Kn,60)});l.observe(a,{childList:!0,subtree:!0,characterData:!0})}}function ht(){x(),s(),u();var a=document.getElementById("cart-preview-area");if(a){var l=new MutationObserver(function(){setTimeout(i,100),setTimeout(Gn,150),setTimeout($n,180),setTimeout(at,220)});l.observe(a,{childList:!0,subtree:!0})}setInterval(i,800),setInterval(Gn,800),setInterval($n,800),setInterval(at,800),i(),Gn(),$n(),at()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ht):ht()})(),(function x(){"use strict";var P="mm_cep",R="mm_cart_snapshot",M=18e5,v="mm_onepage_draft",i=1440*60*1e3,s=2e3,u="https://magazord-public.s3.sa-east-1.amazonaws.com/madeiramania/resources/Design%20sem%20nome%20(1).svg",g="https://api.whatsapp.com/send?phone=5511915299488&text="+encodeURIComponent("Olá! Estou no checkout e gostaria de tirar uma dúvida sobre meu pedido."),h=location.pathname,C=h.indexOf("/checkout/cart")!==-1,b=h.indexOf("/checkout/identify")!==-1,T=h.indexOf("/checkout/onepage")!==-1,q=h.indexOf("/checkout/payment")!==-1,z=h.indexOf("/checkout/done")!==-1;if(z){try{localStorage.removeItem("mm_onepage_draft")}catch{}return}if(!C&&!b&&!T&&!q)return;x._retries=(x._retries||0)+1;var f=document.querySelector("#checkout-main-area");if(!f){try{var W=document.body&&document.body.textContent||"",Z=/muito tempo inativo|realize login novamente/i.test(W);if((T||b)&&(Z||x._retries>=40)&&!sessionStorage.getItem("mm_checkout_recovery")){sessionStorage.setItem("mm_checkout_recovery","1"),location.href="/checkout/cart";return}}catch{}x._retries<40&&setTimeout(x,400);return}try{sessionStorage.removeItem("mm_checkout_recovery")}catch{}function D(n){return isNaN(n)||n<0?"R$ 0,00":"R$ "+n.toFixed(2).replace(".",",").replace(/(\d)(?=(\d{3})+,)/g,"$1.")}function G(n){if(!n)return 0;var t=String(n).match(/(-?[\d.]+,\d{2})/);return t&&parseFloat(t[1].replace(/\./g,"").replace(",","."))||0}function O(n){return String(n||"").replace(/[&<>"']/g,function(t){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[t]})}var B={truck:'<svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20 8h-3V4H3c-1.1 0-2 .9-2 2v11h2a3 3 0 0 0 6 0h6a3 3 0 0 0 6 0h2v-5l-3-4zM6 18.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm12 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm.5-7H17V9.5h2.04l1.46 2-.04 0z"/></svg>',check:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>',checkCircle:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>',bolt:'<svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>',shield:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 1 3 5v6c0 5.5 3.8 10.7 9 12 5.2-1.3 9-6.5 9-12V5l-9-4zm-1.4 16L6 12.4l1.4-1.4 3.2 3.2 6.8-6.8L18.8 8.8 10.6 17z"/></svg>',lock:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zM9 6c0-1.66 1.34-3 3-3s3 1.34 3 3v2H9V6z"/></svg>',card:'<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>',rotate:'<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.74 9.74 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/></svg>',minus:'<svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M3 7h8" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/></svg>',plus:'<svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M7 3v8M3 7h8" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/></svg>',trash:'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',close:'<svg width="12" height="12" viewBox="0 0 14 14" fill="none"><path d="M10.5 3.5l-7 7M3.5 3.5l7 7" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/></svg>',arrow:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>',tag:'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.59 13.41 13.42 20.58a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg>',whats:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893A11.821 11.821 0 0 0 20.464 3.488"/></svg>',box:'<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>'},tn={get:function(n){try{return localStorage.getItem(n)}catch{return null}},set:function(n,t){try{localStorage.setItem(n,t)}catch{}},remove:function(n){try{localStorage.removeItem(n)}catch{}}};function pn(n){try{var t={ts:Date.now(),items:n.items.map(function(e){return{name:e.name,variant:e.variant,imgSrc:e.imgSrc,quantity:e.quantity,lineTotal:e.lineTotal,lineTotalPix:e.lineTotalPix,isPix:e.isPix,deposito:e.deposito}}),subtotalPix:n.subtotalPix,subtotalFull:n.subtotalFull,discount:n.discount,couponCode:n.couponCode,shipping:n.shipping,shippingDeadline:n.shippingDeadline,shippingName:n.shippingName,shippingCity:n.shippingCity,shippingOptions:n.shippingOptions,cepValue:n.cepValue};tn.set(R,JSON.stringify(t))}catch{}}function cn(){try{var n=tn.get(R);if(!n)return null;var t=JSON.parse(n);return!t||!t.ts||Date.now()-t.ts>M?null:t}catch{return null}}function bn(){try{for(var n=["mm-op-email","mm-op-nome","mm-op-cpf","mm-op-tel","mm-op-cep","mm-op-rua","mm-op-num","mm-op-comp","mm-op-bairro","mm-op-cidade","mm-op-uf"],t={ts:Date.now()},e=0,o=0;o<n.length;o++){var p=document.getElementById(n[o]);p&&p.value&&(t[n[o]]=p.value,e++)}if(e===0){window._mmDraftDebug&&console.log("[mm-draft] skip save (0 fields)");return}tn.set(v,JSON.stringify(t)),window._mmDraftDebug&&console.log("[mm-draft] saved",e,"fields",t)}catch(d){window._mmDraftDebug&&console.warn("[mm-draft] save failed",d)}}function On(){try{var n=tn.get(v);if(!n)return null;var t=JSON.parse(n);return!t||!t.ts?null:Date.now()-t.ts>i?(tn.remove(v),null):t}catch{return null}}function wn(){try{tn.remove(v)}catch{}}function Un(){var n=On();if(!n)return window._mmDraftDebug&&console.log("[mm-draft] no draft to restore"),null;for(var t=["mm-op-email","mm-op-nome","mm-op-cpf","mm-op-tel","mm-op-cep","mm-op-rua","mm-op-num","mm-op-comp","mm-op-bairro","mm-op-cidade","mm-op-uf"],e=0,o=0;o<t.length;o++){var p=document.getElementById(t[o]);if(p&&n[t[o]]){try{var d=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;d.call(p,n[t[o]])}catch{p.value=n[t[o]]}p.dispatchEvent(new Event("input",{bubbles:!0})),/^mm-op-(rua|bairro|cidade|uf)$/.test(t[o])&&(p.dataset.mmCepFill="1"),e++}}return window._mmDraftDebug&&console.log("[mm-draft] restored",e,"fields from draft",n),n}function In(){for(var n={items:[],subtotalPix:0,subtotalFull:0,discount:0,shipping:null,shippingRaw:"",shippingDeadline:"",shippingName:"",shippingCity:"",shippingOptions:[],couponCode:"",cepValue:"",canFinalize:!1,hasFinalizar:!1},t=f.querySelectorAll(".cart-item"),e=0;e<t.length;e++){var o=t[e],p=o.querySelector('.qtd-item[id^="item_carrinho_"]'),d=p&&p.id.match(/item_carrinho_(\d+)/),E=d?parseInt(d[1],10):null,A=o.querySelector("figure img")||o.querySelector("#product-img")||o.querySelector("img"),_=o.querySelector(".nome-produto .link")||o.querySelector("figure a"),L=o.querySelector(".column-valor-produto .valor"),V=L?L.textContent.trim():"",N=!!o.querySelector(".column-valor-produto .sub");n.items.push({dataId:E,sku:o.getAttribute("data-item-id")||"",name:o.getAttribute("data-item-name")||o.getAttribute("data-name")||"",variant:o.getAttribute("data-item-variant")||"",brand:o.getAttribute("data-item-brand")||"",category:o.getAttribute("data-item-category")||"",priceUnit:parseFloat(o.getAttribute("data-item-price")||"0"),lineTotal:parseFloat(o.getAttribute("data-valor")||"0"),quantity:parseInt(o.getAttribute("data-item-quantity")||"1",10),deposito:o.getAttribute("data-item-deposito")==="1",imgSrc:A?A.getAttribute("src")||A.currentSrc:"",href:_?_.getAttribute("href"):"",lineTotalPix:G(V),isPix:N}),n.subtotalFull+=parseFloat(o.getAttribute("data-valor")||"0")}var nn=f.querySelector("#resumo-compra .resumo-valores .value");nn&&(n.subtotalPix=G(nn.textContent)),n.subtotalPix<=0&&(n.subtotalPix=n.items.reduce(function(Et,Bt){return Et+(Bt.lineTotalPix||0)},0));var en=f.querySelector("#resumo-compra .discount-value");en&&(n.discount=G(en.textContent));var an=f.querySelector("#resumo-compra .txt-cupom, #resumo-compra .alert.alert-type-1");if(an){var U=an.textContent.match(/([A-Z0-9]{3,})/);U&&(n.couponCode=U[1])}var un=f.querySelector("#resumo-compra .frete-calculado, .frete-calculado");if(un&&un.textContent.trim()){n.shippingRaw=un.textContent.trim();var ln=un.querySelector(".frete-location .city");ln&&(n.shippingCity=ln.textContent.trim());for(var vn=un.querySelectorAll(".servico-frete"),on=0;on<vn.length;on++){var mn=vn[on],fn=mn.querySelector('input[type="radio"]'),w=mn.querySelector(".dias-entrega"),k=parseFloat(mn.getAttribute("data-valor-frete")||"0"),j=mn.getAttribute("data-servico-frete")||"",K=w?w.textContent.trim().replace(/\s+/g," ").replace(/\s*-\s*$/,"").trim():"",Q=K.match(/(\d+(?:\s*[aà]\s*\d+)?\s*dias?(?:\s*[úu]teis)?)/i),xn=Q?Q[1].replace(/\s+/g," "):K;n.shippingOptions.push({id:fn?fn.value:"",name:j,deadline:xn,value:k,isFree:k===0,isSelected:fn?fn.checked:!1})}var yn=n.shippingOptions.filter(function(Et){return Et.isSelected})[0];if(!yn&&n.shippingOptions.length>0&&(yn=n.shippingOptions[0]),yn)n.shipping=yn.value,n.shippingName=yn.name,n.shippingDeadline=yn.deadline;else{var qn=un.querySelector(".info-frete-selec"),Bn=un.querySelector(".dias-entrega, .info-frete-selec .dias-entrega"),Pn=un.querySelector(".valor-frete .value, .value.valor-frete"),nt=un.querySelector(".info-frete-selec .info-title span, .info-title span");if(Pn){var Xn=Pn.textContent.trim();if(/gr[aá]tis/i.test(Xn))n.shipping=0;else{var rt=G(Xn);rt>0&&(n.shipping=rt)}}if(Bn){var ot=Bn.textContent.match(/(\d+(?:\s*[aà]\s*\d+)?\s*dias?(?:\s*\([^)]+\))?(?:\s*[úu]teis)?)/i);ot&&(n.shippingDeadline=ot[1].replace(/\s+/g," ").replace(/\(s\)/,"").trim())}if(nt&&(n.shippingName=nt.textContent.trim()),n.shipping===null)if(/gr[aá]tis/i.test(n.shippingRaw))n.shipping=0;else{var gt=G(n.shippingRaw);gt>0&&(n.shipping=gt)}if(!n.shippingDeadline){var Fn=n.shippingRaw.match(/(\d+(?:\s*[aà]\s*\d+)?)\s*dias?/i);Fn&&(n.shippingDeadline=Fn[1]+" dias úteis")}}}var bt=f.querySelector("#cep, .input-cep");return bt&&(n.cepValue=bt.value||""),n.hasFinalizar=!!f.querySelector("#finalizar-compra"),n.canFinalize=n.items.length>0,n}function dn(n){n=n||"cart";var t='<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 1 3 5v6c0 5.5 3.8 10.7 9 12 5.2-1.3 9-6.5 9-12V5l-9-4zm-1.4 16L6 12.4l1.4-1.4 3.2 3.2 6.8-6.8L18.8 8.8 10.6 17z"/></svg>';function e(o,p){var d=o===n,E="mm-checkout-step"+(d?" is-active":""),A=d?' aria-current="step"':"";return'<li class="'+E+'"'+A+'><span class="mm-checkout-step-label">'+p+"</span></li>"}return'<header class="mm-checkout-header"><a class="mm-checkout-header-logo" href="/" aria-label="Madeira Mania - voltar à home"><img src="'+u+'" alt="Madeira Mania" width="180" height="44"></a><nav class="mm-checkout-steps" aria-label="Etapas do checkout"><ol>'+e("cart","Carrinho")+'<li class="mm-checkout-step-sep" aria-hidden="true">›</li>'+e("delivery","Entrega")+'<li class="mm-checkout-step-sep" aria-hidden="true">›</li>'+e("payment","Pagamento")+'</ol></nav><div class="mm-checkout-secure">'+t+'<span class="mm-checkout-secure-text"><strong>Compra 100% segura</strong><small>Site protegido por SSL</small></span></div></header>'}function Rn(n){var t=n.imgSrc?'<img src="'+O(n.imgSrc)+'" alt="'+O(n.name)+'" loading="lazy">':"",e=n.href?'<a class="mm-item-name" href="'+O(n.href)+'">'+O(n.name)+"</a>":'<span class="mm-item-name">'+O(n.name)+"</span>",o=n.variant?'<p class="mm-item-variant">'+O(n.variant)+"</p>":"",p="",d=n.quantity<=1?' disabled aria-disabled="true"':"",E;if(n.lineTotalPix>0&&n.isPix){var A='<span class="mm-item-price-sub">no PIX</span>',_=n.quantity>1?D(n.lineTotalPix/n.quantity)+" cada":"";E='<div class="mm-item-price"><span class="mm-item-price-value">'+D(n.lineTotalPix)+"</span>"+A+(_?'<span class="mm-item-price-unit">'+_+"</span>":"")+"</div>"}else{var L=n.quantity>1?D(n.priceUnit)+" cada":"";E='<div class="mm-item-price"><span class="mm-item-price-value">'+D(n.lineTotal)+"</span>"+(L?'<span class="mm-item-price-unit">'+L+"</span>":"")+"</div>"}return'<div class="mm-item" data-mm-id="'+n.dataId+'"><div class="mm-item-thumb">'+t+'</div><div class="mm-item-body">'+e+o+p+"</div>"+E+'<div class="mm-item-controls"><div class="mm-qty" role="group" aria-label="Quantidade"><button type="button" class="mm-qty-btn" data-mm-act="dec"'+d+' aria-label="Diminuir quantidade">'+B.minus+'</button><span class="mm-qty-value">'+n.quantity+'</span><button type="button" class="mm-qty-btn" data-mm-act="inc" aria-label="Aumentar quantidade">'+B.plus+'</button></div><button type="button" class="mm-item-remove" data-mm-act="remove" aria-label="Remover item" title="Remover">'+B.trash+"</button></div></div>"}function Tn(n){return n.items.length?n.items.map(Rn).join(""):'<div class="mm-empty"><div class="mm-empty-icon">'+B.box+'</div><h3 class="mm-empty-title">Seu carrinho está vazio</h3><p class="mm-empty-desc">Explore nossos móveis e encontre a peça certa para sua casa.</p><a class="mm-empty-cta" href="/">Explorar produtos '+B.arrow+'</a><p class="mm-empty-perks">Frete grátis acima de R$ 2.000 · 12x sem juros · 7% off no PIX</p></div>'}function Ln(n){for(var t="",e=0;e<n;e++)t+='<div class="mm-skel-item"><div class="mm-skel mm-skel-thumb"></div><div class="mm-skel-lines"><div class="mm-skel mm-skel-line w-3-4"></div><div class="mm-skel mm-skel-line w-1-2"></div><div class="mm-skel mm-skel-line w-1-3"></div></div><div class="mm-skel-lines"><div class="mm-skel mm-skel-line w-1-2"></div></div></div>';return t}function Sn(n){var t=n.subtotalFull>0?n.subtotalFull:n.subtotalPix,e='<div class="mm-row"><span class="mm-row-label">Subtotal</span><span class="mm-row-value">'+D(t)+"</span></div>";if(n.shipping!==null){var o;n.shipping===0?o='<span class="mm-row-value is-free">'+B.check+" Grátis</span>":o='<span class="mm-row-value">'+D(n.shipping)+"</span>";var p='<span class="mm-row-label">Frete';n.shippingName&&(p+=' <span class="mm-row-sub">· '+O(n.shippingName)+"</span>"),n.shippingDeadline&&(p+=' <span class="mm-row-sub">· '+O(n.shippingDeadline)+"</span>"),p+="</span>",e+='<div class="mm-row">'+p+o+"</div>"}n.discount>0&&(e+='<div class="mm-row"><span class="mm-row-label">Desconto</span><span class="mm-row-value is-discount">− '+D(n.discount)+"</span></div>");var d="";if(n.shipping!==null){var E=Math.max(0,t+n.shipping-n.discount),A=Math.max(0,n.subtotalPix+n.shipping-n.discount),_=E-A,L=E/12;d='<div class="mm-total"><div class="mm-total-label">Total</div><div class="mm-total-value">'+D(E)+'</div><div class="mm-total-pix"><span>'+D(A)+" à vista no PIX</span>"+(_>0?'<span class="mm-total-pix-save">economia de '+D(_)+"</span>":"")+'</div><div class="mm-total-parcela">ou 12x de '+D(L)+" sem juros no cartão</div></div>"}else d='<div class="mm-total"><div class="mm-total-label">Subtotal</div><div class="mm-total-value">'+D(n.subtotalPix)+'</div><div class="mm-total-pix"><span>à vista no PIX</span></div><div class="mm-total-pending">Informe seu CEP para ver o frete e o total final.</div></div>';var V;return n.couponCode?V='<div class="mm-coupon-applied"><span class="mm-coupon-applied-left">'+B.tag+"<span>"+O(n.couponCode)+'</span></span><button type="button" data-mm-act="coupon-remove" aria-label="Remover cupom">'+B.close+"</button></div>":V='<div class="mm-coupon"><button type="button" class="mm-coupon-toggle" data-mm-act="coupon-toggle">'+B.tag+'<span>Tenho um cupom</span></button><form class="mm-coupon-form" data-mm-act="coupon-submit"><input type="text" class="mm-input" name="mm-coupon-code" placeholder="CUPOM" autocomplete="off" autocapitalize="characters" spellcheck="false" /><button type="submit" class="mm-btn-secondary">Aplicar</button></form></div>','<div class="mm-sum-stack"><div class="mm-rows">'+e+"</div>"+V+d+"</div>"}function Mn(){var n=document.getElementById("mm-layout");if(n)return n.parentElement!==f&&f.insertBefore(n,f.firstChild),n;var t=document.createElement("div");return t.id="mm-layout",t.innerHTML=dn("cart")+'<div class="mm-grid"><section class="mm-items"><h2 class="mm-h">Carrinho</h2><div class="mm-items-card"><div id="mm-item-list">'+Ln(2)+'</div></div></section><aside class="mm-sum"><h2 class="mm-h">Resumo</h2><div class="mm-sum-card"><div class="mm-cep"><div class="mm-cep-label"><span class="mm-cep-label-text">Calcular frete</span><a class="mm-cep-label-link" href="https://buscacepinter.correios.com.br/app/endereco/index.php" target="_blank" rel="noopener">Não sei meu CEP</a></div><div class="mm-cep-row"><input type="text" class="mm-input" id="mm-cep-input" name="mm_cep_calc" inputmode="numeric" maxlength="9" placeholder="00000-000" autocomplete="off" data-lpignore="true" data-1p-ignore="true" data-bwignore="true" data-form-type="other" aria-label="CEP" /><button type="button" class="mm-btn-secondary" data-mm-act="calc-cep">Calcular</button></div></div><div id="mm-sum-dynamic"></div><button type="button" class="mm-cta" data-mm-act="finalizar">Finalizar compra'+B.arrow+'</button><div class="mm-trust"><span class="mm-trust-item">'+B.lock+'<span>Pagamento seguro</span></span><span class="mm-trust-item">'+B.rotate+'<span>7 dias para troca</span></span><span class="mm-trust-item">'+B.card+'<span>12x sem juros</span></span></div><a class="mm-help" href="'+g+'" target="_blank" rel="noopener" data-mm-track="help-whats">'+B.whats+"<span><strong>Ficou com alguma dúvida?</strong> Fale com a gente no WhatsApp</span></a></div></aside></div>",f.insertBefore(t,f.firstChild),f.classList.add("mm-shadow-mode"),document.body.classList.add("mm-checkout-rebuild"),document.documentElement.classList.remove("mm-cart-loading"),t}function Zn(){var n=In(),t=document.getElementById("mm-item-list");t&&(t.innerHTML=Tn(n));var e=document.getElementById("mm-sum-dynamic");e&&(e.innerHTML=Sn(n));var o=document.querySelector(".mm-cta");o&&(o.disabled=!n.canFinalize,o.style.opacity=n.canFinalize?"1":"0.5",o.style.pointerEvents=n.canFinalize?"auto":"none");var p=document.getElementById("mm-cep-input");if(p&&!p.matches(":focus")){var d=tn.get(P),E=n.cepValue||d||"";E&&(p.value=zn(E))}return n.items&&n.items.length>0&&pn(n),n}function zn(n){var t=String(n||"").replace(/\D/g,"").slice(0,8);return t.length<=5?t:t.slice(0,5)+"-"+t.slice(5)}function Yn(n){var t=String(n||"").replace(/\D/g,"");t.length===8&&tn.set(P,t)}function hn(n){n=n||0;var t=tn.get(P);if(!(!t||t.length!==8)){var e=f.querySelector("#cep, .input-cep");if(!e){n<12&&setTimeout(function(){hn(n+1)},350);return}var o=f.querySelector("#resumo-compra .frete-calculado");if(o&&o.textContent.trim()){var p=document.getElementById("mm-cep-input");p&&!p.value&&(p.value=zn(t));return}var d=document.getElementById("mm-cep-input");d&&!d.value&&(d.value=zn(t)),e.value=zn(t),Cn(e),setTimeout(function(){Nn()},200)}}function Cn(n){try{var t=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;t.call(n,n.value)}catch{}n.dispatchEvent(new Event("input",{bubbles:!0})),n.dispatchEvent(new Event("change",{bubbles:!0}))}function Nn(){try{if(window.Zord&&window.Zord.Cart&&typeof window.Zord.Cart.calculaFreteCarrinho=="function"){window.Zord.Cart.calculaFreteCarrinho();return}}catch{}var n=f.querySelector("#resumo-compra .calcula-frete > button, .area-frete button");n&&n.click()}function Dn(){var n=document.getElementById("mm-layout");!n||n._mmBound||(n._mmBound=!0,n.addEventListener("click",function(t){var e=t.target.closest("[data-mm-act]");if(e){var o=e.getAttribute("data-mm-act"),p=e.closest(".mm-item"),d=p?parseInt(p.getAttribute("data-mm-id"),10):null;switch(o){case"inc":Jn(d,p,"inc");break;case"dec":Jn(d,p,"dec");break;case"remove":ut(d,p);break;case"calc-cep":An();break;case"coupon-toggle":var E=e.closest(".mm-coupon");if(E){E.classList.add("is-open");var A=E.querySelector("input");A&&setTimeout(function(){A.focus()},100)}break;case"coupon-remove":gn();break;case"finalizar":tt();break}}}),n.addEventListener("submit",function(t){var e=t.target.closest('[data-mm-act="coupon-submit"]');if(e){t.preventDefault();var o=e.querySelector("input");o&&En(o.value.trim())}}),n.addEventListener("input",function(t){t.target&&t.target.id==="mm-cep-input"&&(t.target.value=zn(t.target.value))}),n.addEventListener("keydown",function(t){t.key==="Enter"&&t.target&&t.target.id==="mm-cep-input"&&(t.preventDefault(),An())}))}function Jn(n,t,e){if(!(!n||!t)&&!(!window.Zord||!window.Zord.checkout)){t.classList.add("is-updating");try{e==="inc"?window.Zord.checkout.adicionaQuantidade(n):window.Zord.checkout.removeQuantidade(n)}catch(o){console.warn("[mm-cart] qty change failed",o),t.classList.remove("is-updating")}}}function ut(n,t){if(!(!n||!t)&&!(!window.Zord||!window.Zord.checkout)){t.classList.add("is-updating"),t.style.transition="opacity 200ms, transform 200ms",t.style.opacity="0",t.style.transform="translateX(-12px)";try{typeof window.Zord.checkout.deleteItem=="function"?window.Zord.checkout.deleteItem(n):window.Zord.checkout.removeQuantidade(n)}catch(e){console.warn("[mm-cart] remove failed",e),t.classList.remove("is-updating"),t.style.opacity="1",t.style.transform=""}}}function An(){var n=document.getElementById("mm-cep-input");if(n){var t=(n.value||"").replace(/\D/g,"");if(t.length!==8){n.focus(),n.classList.add("mm-input-error"),setTimeout(function(){n.classList.remove("mm-input-error")},1200);return}Yn(t);var e=f.querySelector("#cep, .input-cep");e&&(e.value=zn(t),Cn(e)),Nn()}}function En(n){if(n&&!(!window.Zord||!window.Zord.checkout)){var t=f.querySelector("#cupom-desconto");t&&(t.value=n.toUpperCase(),Cn(t));try{window.Zord.checkout.addCupomDesconto()}catch(e){console.warn("[mm-cart] coupon apply failed",e)}}}function gn(){if(!(!window.Zord||!window.Zord.checkout))try{window.Zord.checkout.removeCupomDesconto()}catch(n){console.warn("[mm-cart] coupon remove failed",n)}}function tt(){try{var n=In();n.items&&n.items.length>0&&pn(n)}catch{}var t=document.getElementById("finalizar-compra");if(t){t.click();return}location.href="/checkout/identify"}if(C){let n=function(e){if(e=e||0,e>30){t();return}var o=f.querySelectorAll(".cart-item").length>0,p=f.querySelector("#resumo-compra");o||p||e>8?t():setTimeout(function(){n(e+1)},250)},t=function(){Mn(),Dn(),Zn(),hn(),typeof jQuery<"u"&&jQuery(document).ajaxComplete(function(p,d,E){if(!(!E||!E.url)){var A=E.url;(A.indexOf("checkout/cart")!==-1||A.indexOf("atualiza")!==-1||A.indexOf("cupom")!==-1||A.indexOf("frete")!==-1||A.indexOf("removeItem")!==-1||A.indexOf("adicionaItem")!==-1)&&(setTimeout(Zn,120),setTimeout(function(){var _=In();_.shipping!==null&&_.cepValue&&Yn(_.cepValue)},200))}});try{var e=new MutationObserver(function(p){t._mutTimer&&clearTimeout(t._mutTimer),t._mutTimer=setTimeout(Zn,200)}),o=[f.querySelector("#cart-area"),f.querySelector(".cart-area"),f.querySelector("#resumo-compra")].filter(Boolean);o.forEach(function(p){e.observe(p,{childList:!0,subtree:!0,characterData:!0})})}catch{}};if(!document.getElementById("mm-checkout-cro-done")){var st=document.createElement("div");st.id="mm-checkout-cro-done",st.style.display="none",document.body.appendChild(st)}n()}function jn(n){if(!n||!n.items||!n.items.length)return'<aside class="mm-id-sum mm-sum"><h2 class="mm-h">Resumo</h2><div class="mm-sum-card"><div class="mm-sum-empty"><p>Não conseguimos carregar o resumo do seu pedido.</p><a class="mm-btn-secondary" href="/checkout/cart">Voltar ao carrinho</a></div></div></aside>';var t=3,e=n.items.slice(0,t),o=n.items.length-t,p=e.map(function(U){var un=U.quantity>1?'<strong class="mm-id-thumb-qty">'+U.quantity+"×</strong> ":"",ln=!U.imgSrc&&!(U.lineTotalPix>0)&&!(U.lineTotal>0);if(ln)return'<div class="mm-id-thumb"><div class="mm-id-thumb-img"><span class="mm-skel" style="display:block;width:100%;height:100%"></span></div><div class="mm-id-thumb-body"><p class="mm-id-thumb-name">'+un+O(U.name)+"</p>"+(U.variant?'<p class="mm-id-thumb-variant">'+O(U.variant)+"</p>":"")+'</div><div class="mm-id-thumb-price"><span class="mm-skel" style="display:inline-block;width:56px;height:15px"></span></div></div>';var vn=U.imgSrc?'<img src="'+O(U.imgSrc)+'" alt="'+O(U.name)+'" loading="lazy">':'<div class="mm-id-thumb-placeholder">'+B.box+"</div>",on=U.lineTotal>0?U.lineTotal:U.lineTotalPix;return'<div class="mm-id-thumb"><div class="mm-id-thumb-img">'+vn+'</div><div class="mm-id-thumb-body"><p class="mm-id-thumb-name">'+un+O(U.name)+"</p>"+(U.variant?'<p class="mm-id-thumb-variant">'+O(U.variant)+"</p>":"")+'</div><div class="mm-id-thumb-price">'+D(on)+"</div></div>"}).join("");o>0&&(p+='<div class="mm-id-thumb-more">+ '+o+" "+(o===1?"item":"itens")+" a mais</div>");var d=n.subtotalFull>0?n.subtotalFull:n.subtotalPix,E='<div class="mm-row"><span class="mm-row-label">Subtotal</span><span class="mm-row-value">'+D(d)+"</span></div>";if(n.shipping!==null&&n.shipping!==void 0){var A;n.shipping===0?A='<span class="mm-row-value is-free">'+B.check+" Grátis</span>":A='<span class="mm-row-value">'+D(n.shipping)+"</span>",E+='<div class="mm-row"><span class="mm-row-label">Frete'+(n.shippingDeadline?' <span class="mm-row-sub">· '+O(n.shippingDeadline)+"</span>":"")+"</span>"+A+"</div>"}n.discount>0&&(E+='<div class="mm-row"><span class="mm-row-label">Desconto'+(n.couponCode?' <span class="mm-row-sub">· '+O(n.couponCode)+"</span>":"")+'</span><span class="mm-row-value is-discount">− '+D(n.discount)+"</span></div>");var _,L=n.shipping!==null&&n.shipping!==void 0?n.shipping:0;if(n.shipping!==null&&n.shipping!==void 0){var V=Math.max(0,d+L-(n.discount||0)),N=Math.max(0,n.subtotalPix+L-(n.discount||0)),nn=V-N,en=V/12;_='<div class="mm-total"><div class="mm-total-label">Total</div><div class="mm-total-value">'+D(V)+'</div><div class="mm-total-pix"><span>'+D(N)+" à vista no PIX</span>"+(nn>0?'<span class="mm-total-pix-save">economia de '+D(nn)+"</span>":"")+'</div><div class="mm-total-parcela">ou 12x de '+D(en)+" sem juros</div></div>"}else{var an=d/12;_='<div class="mm-total"><div class="mm-total-label">Subtotal</div><div class="mm-total-value">'+D(n.subtotalPix)+'</div><div class="mm-total-pix"><span>à vista no PIX</span></div><div class="mm-total-parcela">ou 12x de '+D(an)+" sem juros</div></div>"}return'<aside class="mm-id-sum mm-sum"><h2 class="mm-h">Resumo do pedido</h2><div class="mm-sum-card"><div class="mm-id-thumbs">'+p+'</div><div class="mm-rows">'+E+"</div>"+_+'<a class="mm-id-edit-cart" href="/checkout/cart"><span>Editar carrinho</span></a></div><a class="mm-help mm-sum-help" href="'+g+'" target="_blank" rel="noopener" data-mm-track="help-whats-sum">'+B.whats+"<span><strong>Ficou com alguma dúvida?</strong> Fale com a gente no WhatsApp</span></a></aside>"}function et(){var n='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',t='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>',e='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="16" rx="2"/><line x1="7" y1="9" x2="17" y2="9"/><line x1="7" y1="13" x2="17" y2="13"/><line x1="7" y1="17" x2="13" y2="17"/></svg>',o='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>';return'<section class="mm-id-form-col"><h2 class="mm-id-h2">Quase lá! Identifique-se</h2><p class="mm-id-sub">Informe seu e-mail para finalizar a compra de forma rápida e segura.</p><form class="mm-id-form" data-mm-act="identify-submit" novalidate><div class="mm-input-wrap"><span class="mm-input-icon" aria-hidden="true">'+n+'</span><input type="email" id="mm-id-email" name="mm-email" class="mm-input" placeholder="seu@email.com" autocomplete="email" inputmode="email" required></div><p class="mm-id-microcopy">'+B.lock+'<span>Seu e-mail é seguro · Não compartilhamos com terceiros</span></p><button type="submit" class="mm-cta">Continuar'+B.arrow+'</button></form><div class="mm-id-divider"><span>ou</span></div><div class="mm-id-google-slot"></div><button type="button" class="mm-id-guest-toggle" data-mm-act="guest-go" aria-label="Continuar como visitante"><span class="mm-id-guest-icon" aria-hidden="true">'+t+'</span><span class="mm-id-guest-label">Continuar como visitante (sem criar conta)</span><span class="mm-id-guest-arrow" aria-hidden="true">'+B.arrow+'</span></button><div class="mm-trust mm-id-trust"><span class="mm-trust-item">'+B.lock+'<span>Pagamento seguro</span></span><span class="mm-trust-item">'+B.rotate+'<span>7 dias para troca</span></span><span class="mm-trust-item">'+B.shield+'<span>Garantia 12 meses</span></span></div><p class="mm-id-lgpd">Ao continuar, você concorda com nossa <a href="/politica-de-privacidade" target="_blank" rel="noopener">Política de Privacidade</a></p></section>'}function _n(n){var t=document.getElementById("mm-layout");if(t)return t.parentElement!==f&&f.insertBefore(t,f.firstChild),t;var e=document.createElement("div");return e.id="mm-layout",e.classList.add("mm-id-layout"),e.innerHTML=dn("delivery")+'<div class="mm-grid mm-id-grid">'+et()+jn(n)+"</div>",f.insertBefore(e,f.firstChild),document.body.classList.add("mm-checkout-rebuild"),at(),f.classList.add("mm-shadow-mode"),document.documentElement.classList.remove("mm-cart-loading"),e}function at(){var n=document.querySelector(".mm-id-google-slot"),t=f.querySelector(".social-login-area");if(!(!n||!t)&&!n.contains(t))try{n.appendChild(t),n.classList.add("is-loaded")}catch{}}function xt(n){tn.set("mm_user_email",n);var t=f.querySelector("#login");if(!t)return!1;t.value=n,Cn(t);var e=t.closest("form"),o=e?e.querySelector('button.button-send, button[type="submit"]'):null;return o?(o.click(),!0):e?(e.submit(),!0):!1}function Tt(){var n=document.getElementById("mm-layout");!n||n._mmBound||(n._mmBound=!0,n.addEventListener("submit",function(t){var e=t.target.closest('[data-mm-act="identify-submit"]');if(e){t.preventDefault();var o=e.querySelector("#mm-id-email"),p=o?o.value.trim():"";if(!p||!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(p)){o&&(o.classList.add("mm-input-error"),o.focus(),setTimeout(function(){o.classList.remove("mm-input-error")},1500));return}var d=xt(p);if(d){var E=e.querySelector(".mm-cta");E&&E.classList.add("is-loading")}return}}),n.addEventListener("click",function(t){var e=t.target.closest("[data-mm-act]");if(e){var o=e.getAttribute("data-mm-act");o==="guest-go"&&(tn.set("mm_checkout_mode","guest"),e.classList.add("is-loading"),location.href="/checkout/onepage")}}))}function Hn(n){try{var t=new DOMParser().parseFromString(n,"text/html"),e=t.querySelector("#checkout-main-area");if(!e)return null;for(var o=[],p=e.querySelectorAll(".cart-item"),d=0,E=0;E<p.length;E++){var A=p[E],_=A.querySelector("figure img")||A.querySelector("#product-img")||A.querySelector("img"),L=A.querySelector(".column-valor-produto .valor"),V=parseFloat(A.getAttribute("data-valor")||"0"),N=L?G(L.textContent):0;o.push({name:A.getAttribute("data-item-name")||A.getAttribute("data-name")||"",variant:A.getAttribute("data-item-variant")||"",imgSrc:_&&_.getAttribute("src")||"",quantity:parseInt(A.getAttribute("data-item-quantity")||"1",10),lineTotal:V,lineTotalPix:N,isPix:!!A.querySelector(".column-valor-produto .sub"),deposito:A.getAttribute("data-item-deposito")==="1"}),d+=V}if(o.length===0)return null;var nn=e.querySelector("#resumo-compra .resumo-valores .value"),en=nn?G(nn.textContent):0;en<=0&&(en=o.reduce(function(yn,qn){return yn+(qn.lineTotalPix||0)},0));var an=e.querySelector("#resumo-compra .discount-value"),U=an?G(an.textContent):0,un=e.querySelector("#resumo-compra .txt-cupom, #resumo-compra .alert.alert-type-1"),ln="";if(un){var vn=un.textContent.match(/([A-Z0-9]{3,})/);vn&&(ln=vn[1])}var on=e.querySelector("#resumo-compra .frete-calculado"),mn=null,fn="";if(on){var w=on.querySelector(".servico-frete[data-valor-frete]");if(w){var k=w.getAttribute("data-valor-frete");if(k!==null&&k!==""){var j=parseFloat(k);isNaN(j)||(mn=j)}}var K=on.textContent.trim();if(mn===null&&K){var Q=G(K);Q>0&&(mn=Q)}var xn=K.match(/(\d+)\s*dias?/i);xn&&(fn=xn[1]+" dias úteis")}return{ts:Date.now(),items:o,subtotalPix:en,subtotalFull:d,discount:U,couponCode:ln,shipping:mn,shippingDeadline:fn,cepValue:""}}catch{return null}}function $n(n){try{fetch("/checkout/cart",{credentials:"include",headers:{"X-Requested-With":"XMLHttpRequest"}}).then(function(t){return t.text()}).then(function(t){var e=Hn(t);e&&tn.set(R,JSON.stringify(e)),n(e)}).catch(function(){n(null)})}catch{n(null)}}function vt(n){var t=document.querySelector("#mm-layout .mm-id-sum");if(t){var e=t.parentNode;if(e){var o=document.createElement("div");o.innerHTML=jn(n);var p=o.firstChild;p&&e.replaceChild(p,t)}}}function yt(){$n(function(n){n&&n.items&&n.items.length>0&&vt(n)})}if(b){let n=function(e){if(e=e||0,e>30){t();return}var o=f.querySelector("#login, #login-form-etapa-01");o||e>8?t():setTimeout(function(){n(e+1)},250)},t=function(){var e=cn();_n(e),Tt(),at(),setTimeout(at,600),setTimeout(at,1500),yt(),setTimeout(function(){var o=document.getElementById("mm-id-email");o&&!("ontouchstart"in window)&&o.focus()},250)};n()}function kt(n){var t=String(n||"").replace(/\D/g,"").slice(0,11);return t.length<=3?t:t.length<=6?t.slice(0,3)+"."+t.slice(3):t.length<=9?t.slice(0,3)+"."+t.slice(3,6)+"."+t.slice(6):t.slice(0,3)+"."+t.slice(3,6)+"."+t.slice(6,9)+"-"+t.slice(9)}function Lt(n){var t=String(n||"").replace(/\D/g,"").slice(0,11);return t.length<=2?t.length?"("+t:"":t.length<=6?"("+t.slice(0,2)+") "+t.slice(2):t.length<=10?"("+t.slice(0,2)+") "+t.slice(2,6)+"-"+t.slice(6):"("+t.slice(0,2)+") "+t.slice(2,7)+"-"+t.slice(7)}function wt(n){var t=String(n||"").replace(/\D/g,"").slice(0,8);return t.length<=5?t:t.slice(0,5)+"-"+t.slice(5)}function pt(n,t){var e=String(n||"").replace(/\D/g,"");if(e.length!==8){t(null);return}try{fetch("https://viacep.com.br/ws/"+e+"/json/",{headers:{Accept:"application/json"}}).then(function(o){return o.json()}).then(function(o){if(!o||o.erro){t(null);return}t({logradouro:o.logradouro||"",bairro:o.bairro||"",cidade:o.localidade||"",estado:o.uf||""})}).catch(function(){t(null)})}catch{t(null)}}var Vn={mail:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z"/></svg>',user:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',doc:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11zM8 12h8v2H8zm0 4h5v2H8z"/></svg>',phone:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20.01 15.38c-1.23 0-2.42-.2-3.53-.56-.35-.12-.74-.03-1.01.24l-1.57 1.97c-2.83-1.35-5.48-3.9-6.89-6.83l1.95-1.66c.27-.28.35-.67.24-1.02-.37-1.11-.56-2.3-.56-3.53 0-.54-.45-.99-.99-.99H4.19C3.65 3 3 3.24 3 3.99 3 13.28 10.73 21 20.01 21c.71 0 .99-.63.99-1.18v-3.45c0-.54-.45-.99-.99-.99z"/></svg>',pin:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>',home:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg>',pix:'<svg width="24" height="24" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true"><path d="M11.917 11.71a2.046 2.046 0 0 1-1.454-.602l-2.1-2.1a.4.4 0 0 0-.551 0l-2.108 2.108a2.044 2.044 0 0 1-1.454.602h-.414l2.66 2.66c.83.83 2.177.83 3.007 0l2.667-2.668h-.253zM4.25 4.282c.55 0 1.066.214 1.454.602l2.108 2.108a.39.39 0 0 0 .552 0l2.1-2.1a2.044 2.044 0 0 1 1.453-.602h.253L9.503 1.623a2.127 2.127 0 0 0-3.007 0l-2.66 2.66h.414z"/><path d="m14.377 6.496-1.612-1.612a.307.307 0 0 1-.114.023h-.733c-.379 0-.75.154-1.017.422l-2.1 2.1a1.005 1.005 0 0 1-1.425 0L5.268 5.32a1.448 1.448 0 0 0-1.018-.422h-.9a.306.306 0 0 1-.109-.021L1.623 6.496c-.83.83-.83 2.177 0 3.008l1.618 1.618a.305.305 0 0 1 .108-.022h.901c.38 0 .75-.153 1.018-.421L7.375 8.57a1.034 1.034 0 0 1 1.426 0l2.1 2.1c.267.268.638.421 1.017.421h.733c.04 0 .079.01.114.024l1.612-1.612c.83-.83.83-2.178 0-3.008z"/></svg>',cardBig:'<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4V6h16v2z"/></svg>',barcode:'<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M2 6h2v12H2zm3 0h1v12H5zm2 0h3v12H7zm4 0h1v12h-1zm3 0h2v12h-2zm3 0h1v12h-1zm2 0h3v12h-3z"/></svg>',editPencil:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04a.996.996 0 0 0 0-1.41l-2.34-2.34a.996.996 0 0 0-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>'};function lt(n){var t=n?' value="'+O(n)+'"':"";return'<section class="mm-op-form-col"><h2 class="mm-id-h2">Falta pouco. Onde entregar?</h2><p class="mm-id-sub">Preencha seus dados e o endereço de entrega — o frete é calculado automaticamente.</p><form class="mm-op-form" data-mm-act="onepage-submit" novalidate><div class="mm-op-card"><h3 class="mm-op-card-title">'+Vn.user+'<span>Quem vai receber</span></h3><div class="mm-op-grid-2"><div class="mm-input-wrap mm-op-col-2"><span class="mm-input-icon" aria-hidden="true">'+Vn.mail+'</span><input type="email" id="mm-op-email" class="mm-input" placeholder="seu@email.com" autocomplete="email" inputmode="email" required'+t+'></div><div class="mm-input-wrap mm-op-col-2"><span class="mm-input-icon" aria-hidden="true">'+Vn.user+'</span><input type="text" id="mm-op-nome" class="mm-input" placeholder="Nome completo" autocomplete="name" required></div><div class="mm-input-wrap"><span class="mm-input-icon" aria-hidden="true">'+Vn.doc+'</span><input type="tel" id="mm-op-cpf" class="mm-input" placeholder="CPF" inputmode="numeric" autocomplete="off" maxlength="14" required></div><div class="mm-input-wrap"><span class="mm-input-icon" aria-hidden="true">'+Vn.phone+'</span><input type="tel" id="mm-op-tel" class="mm-input" placeholder="(11) 91234-5678" inputmode="tel" autocomplete="tel" maxlength="15" required></div></div><p class="mm-op-microcopy-soft">Usamos seus dados só pra emitir nota fiscal e te avisar da entrega.</p></div><div class="mm-op-card"><h3 class="mm-op-card-title">'+Vn.pin+'<span>Endereço de entrega</span></h3><div class="mm-op-grid-2"><div class="mm-input-wrap"><span class="mm-input-icon" aria-hidden="true">'+Vn.pin+'</span><input type="tel" id="mm-op-cep" class="mm-input" placeholder="CEP — 00000-000" inputmode="numeric" autocomplete="postal-code" maxlength="9" required><span class="mm-input-status" id="mm-op-cep-status" aria-live="polite"></span></div><a class="mm-op-cep-help" href="https://buscacepinter.correios.com.br/app/endereco/index.php" target="_blank" rel="noopener">Não sei meu CEP</a><div class="mm-input-wrap mm-op-col-2"><span class="mm-input-icon" aria-hidden="true">'+Vn.home+'</span><input type="text" id="mm-op-rua" class="mm-input" placeholder="Rua, Av, Travessa..." autocomplete="address-line1" required></div><div class="mm-input-wrap"><input type="tel" id="mm-op-num" class="mm-input mm-input-noicon" placeholder="Número" inputmode="numeric" required></div><div class="mm-input-wrap"><input type="text" id="mm-op-comp" class="mm-input mm-input-noicon" placeholder="Complemento (opcional)" autocomplete="address-line2"></div><div class="mm-input-wrap mm-op-col-2"><input type="text" id="mm-op-bairro" class="mm-input mm-input-noicon" placeholder="Bairro" autocomplete="address-level3" required></div><div class="mm-input-wrap"><input type="text" id="mm-op-cidade" class="mm-input mm-input-noicon" placeholder="Cidade" autocomplete="address-level2" required></div><div class="mm-input-wrap"><input type="text" id="mm-op-uf" class="mm-input mm-input-noicon" placeholder="UF" maxlength="2" autocomplete="address-level1" required></div></div><div class="mm-op-frete" id="mm-op-frete-slot"></div></div><button type="submit" class="mm-cta mm-op-cta">Última etapa: pagamento'+B.arrow+'</button><p class="mm-id-microcopy mm-op-cta-sub">'+B.lock+'<span>Você revisa tudo antes de finalizar</span></p></form><div class="mm-trust mm-id-trust"><span class="mm-trust-item">'+B.lock+'<span>Pagamento seguro</span></span><span class="mm-trust-item">'+B.rotate+'<span>7 dias para troca</span></span><span class="mm-trust-item">'+B.shield+"<span>Garantia 12 meses</span></span></div></section>"}function Mt(n,t){var e=document.getElementById("mm-layout");if(e)return e.parentElement!==f&&f.insertBefore(e,f.firstChild),e;var o=document.createElement("div");return o.id="mm-layout",o.classList.add("mm-id-layout"),o.classList.add("mm-op-layout"),o.innerHTML=dn("delivery")+'<div class="mm-grid mm-id-grid mm-op-grid">'+lt(t)+jn(n)+"</div>",f.insertBefore(o,f.firstChild),document.body.classList.add("mm-checkout-rebuild"),f.classList.add("mm-shadow-mode"),document.documentElement.classList.remove("mm-cart-loading"),o}function ft(n){var t=document.getElementById("mm-op-frete-slot");if(t){if(n==="loading"){t.innerHTML='<div class="mm-op-frete-loading"><div class="mm-op-frete-spinner"></div><span>Calculando frete...</span></div>';return}if(n==="error"){t.innerHTML='<div class="mm-op-frete-error"><span>Não conseguimos calcular o frete. Confira o CEP e tente novamente.</span></div>';return}var e=n.value===0,o=e?'<strong class="mm-op-frete-value is-free">Grátis</strong>':'<strong class="mm-op-frete-value">'+D(n.value)+"</strong>",p=n.name?'<span class="mm-op-frete-name">'+O(n.name)+"</span>":"",d=n.deadline?'<span class="mm-op-frete-deadline">Entrega em '+O(n.deadline)+"</span>":"",E=n.city?'<span class="mm-op-frete-city">para '+O(n.city)+"</span>":"",A="";if(n.options&&n.options.length>1){A='<div class="mm-op-frete-options"><button type="button" class="mm-op-frete-toggle" data-mm-act="toggle-frete-opts" aria-expanded="false">Ver outras opções ('+n.options.length+')</button><div class="mm-op-frete-options-list" hidden>';for(var _=0;_<n.options.length;_++){var L=n.options[_],V=L.isSelected?" is-selected":"",N=L.isFree?'<span class="mm-op-frete-opt-value is-free">Grátis</span>':'<span class="mm-op-frete-opt-value">'+D(L.value)+"</span>";A+='<button type="button" class="mm-op-frete-opt'+V+'" data-mm-act="op-ship-select" data-ship-id="'+O(L.id)+'" aria-pressed="'+(L.isSelected?"true":"false")+'"><span class="mm-op-frete-opt-radio" aria-hidden="true"><span></span></span><span class="mm-op-frete-opt-body"><span class="mm-op-frete-opt-name">'+O(L.name||"Padrão")+"</span>"+(L.deadline?'<span class="mm-op-frete-opt-deadline">'+O(L.deadline)+"</span>":"")+"</span>"+N+"</button>"}A+="</div></div>"}t.innerHTML='<div class="mm-op-frete-card'+(e?" is-free":"")+'"><div class="mm-op-frete-icon">'+B.truck+'</div><div class="mm-op-frete-body"><div class="mm-op-frete-row">'+p+o+"</div>"+d+E+"</div></div>"+A}}function Ct(n,t){var e=zn(n),o="";try{var p=cn();o=p&&p.couponCode||""}catch{}var d="cep="+encodeURIComponent(e)+"&cupom-desconto="+encodeURIComponent(o);fetch("/checkout/cart?operation=atualizaValoresCarrinho",{method:"POST",credentials:"include",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},body:d}).then(function(E){return E.text()}).then(function(E){var A;try{A=new DOMParser().parseFromString(E,"text/html")}catch{t(null);return}for(var _=A.querySelectorAll(".servico-frete"),L=[],V=0;V<_.length;V++){var N=_[V],nn=N.getAttribute("data-valor-frete");if(!(nn===null||nn==="")){var en=parseFloat(nn);if(!isNaN(en)){var an=N.querySelector('input[type="radio"]'),U=N.querySelector(".dias-entrega"),un=U?U.textContent.trim():"",ln=un.match(/(\d+(?:\s*[aà]\s*\d+)?\s*dias?(?:\s*[úu]teis)?)/i);L.push({id:an?an.value:"",name:N.getAttribute("data-servico-frete")||"",deadline:ln?ln[1].replace(/\s+/g," "):"",value:en,isFree:en===0,isSelected:an?an.checked:!1})}}}if(!L.length){t(null);return}var vn=L.filter(function(mn){return mn.isSelected})[0];vn||(vn=L.reduce(function(mn,fn){return fn.value<mn.value?fn:mn},L[0]),vn.isSelected=!0);var on=A.querySelector(".frete-location .city, .frete-calculado .city");t({value:vn.value,name:vn.name,deadline:vn.deadline,city:on?on.textContent.trim():"",options:L})}).catch(function(){t(null)})}function St(){function n(K){if(!K)return"";var Q=K.match(/(\d+(?:\s*[aà]\s*\d+)?)\s*dias?(?:\s*\([^)]+\))?\s*([úu]teis)?/i);return Q?Q[1].replace(/\s+/g," ")+" dias úteis":""}function t(K){for(var Q=[],xn=K.querySelectorAll(".servico-frete"),yn=0;yn<xn.length;yn++){var qn=xn[yn],Bn=qn.querySelector('input[type="radio"]'),Pn=qn.querySelector(".dias-entrega"),nt=parseFloat(qn.getAttribute("data-valor-frete")||"0"),Xn=qn.getAttribute("data-servico-frete")||"",rt=Pn?Pn.textContent.trim():"",ot=rt.match(/(\d+(?:\s*[aà]\s*\d+)?\s*dias?(?:\s*[úu]teis)?)/i);Q.push({id:Bn?Bn.value:"",name:Xn,deadline:ot?ot[1].replace(/\s+/g," "):rt,value:nt,isFree:nt===0,isSelected:Bn?Bn.checked:!1})}return Q}var e=f.querySelector(".frete-calculado");if(e&&e.textContent.trim()){var o=t(e),p=e.querySelector(".frete-location .city"),d=p?p.textContent.trim():"",E=o.filter(function(K){return K.isSelected})[0]||o[0];if(E)return{value:E.value,name:E.name,deadline:E.deadline,city:d,options:o};var A=e.querySelector(".info-frete-selec .info-title span, .info-title span"),_=e.querySelector(".info-frete-selec .dias-entrega, .dias-entrega"),L=e.querySelector(".value.valor-frete, .valor-frete .value"),V=e.textContent,N=null;if(L&&(/gr[aá]tis/i.test(L.textContent)?N=0:N=G(L.textContent)),N===null&&(/gr[aá]tis/i.test(V)?N=0:N=G(V)||null),N!==null)return{value:N,name:A?A.textContent.trim():"",deadline:n(_?_.textContent:V),city:d,options:[]}}var nn=f.querySelector(".line-entrega"),en=f.querySelector(".value.valor-frete, .valor-frete .value");if(nn||en){var an=((nn||en).textContent||"").trim(),U=cn(),un=U&&U.shippingName||"",ln=U&&U.shippingDeadline||"",vn=U&&U.shippingCity||"",on=U?U.shippingOptions||[]:[];if(an){var mn=(f.querySelector(".nome-servico-frete, .info-frete-selec .info-title span")||{}).textContent||"",fn=(f.querySelector(".info-entrega, .prazo-entrega, .line-entrega .sub, .info-frete-selec .dias-entrega")||{}).textContent||"",w=n(fn)||n(an)||ln,k=mn.trim()||un;if(/gr[aá]tis/i.test(an))return{value:0,deadline:w,name:k,city:vn,options:on};var j=G(an);if(j>0)return{value:j,deadline:w,name:k,city:vn,options:on}}if(U&&U.shipping!==null&&U.shipping!==void 0)return{value:U.shipping,deadline:ln,name:un,city:vn,options:on}}return null}function Kn(){var n=document.getElementById("mm-op-cep");if(n){var t=(n.value||"").replace(/\D/g,"");if(t.length===8){if(Kn._lastCep===t){var e=document.getElementById("mm-op-frete-slot");if(e&&e.querySelector(".mm-op-frete-card"))return}Kn._lastCep=t;var o=(Kn._token||0)+1;Kn._token=o,Yn(t);var p=f.querySelector("#cep, .input-cep");p&&(p.value=zn(t),Cn(p)),ft("loading"),Ct(t,function(d){if(Kn._token===o){if(!d){ft("error");return}ft(d);var E=cn();E&&(E.shipping=d.value,E.shippingDeadline=d.deadline,E.shippingName=d.name||"",E.shippingCity=d.city||"",E.shippingOptions=d.options||[],tn.set(R,JSON.stringify(E)),vt(E))}})}}}function Gn(){var n=document.getElementById("mm-layout");if(!n||n._mmOpBound)return;n._mmOpBound=!0,n.addEventListener("click",function(e){var o=e.target.closest('[data-mm-act="toggle-frete-opts"]');if(o){e.preventDefault();var p=o.parentElement.querySelector(".mm-op-frete-options-list");if(p){var d=p.hasAttribute("hidden");d?p.removeAttribute("hidden"):p.setAttribute("hidden",""),o.setAttribute("aria-expanded",d?"true":"false"),o.textContent=d?"Ocultar opções":"Ver outras opções"}return}var E=e.target.closest('[data-mm-act="op-ship-select"]');if(E){e.preventDefault();var A=E.getAttribute("data-ship-id");if(!A)return;var _=f.querySelector('.servico-frete input[type="radio"][value="'+A+'"]');if(!_){console.warn("[mm-op] modalidade não encontrada no DOM:",A);return}for(var L=n.querySelectorAll(".mm-op-frete-opt"),V=0;V<L.length;V++){var N=L[V],nn=N.getAttribute("data-ship-id")===A;N.classList.toggle("is-selected",nn),N.setAttribute("aria-pressed",nn?"true":"false")}_.checked=!0,_.click();var en=cn();if(en&&en.shippingOptions&&en.shippingOptions.length){var an=en.shippingOptions.filter(function(U){return String(U.id)===String(A)})[0];an&&(en.shipping=an.value,en.shippingDeadline=an.deadline||"",en.shippingName=an.name||"",en.shippingOptions=en.shippingOptions.map(function(U){return U.isSelected=String(U.id)===String(A),U}),tn.set(R,JSON.stringify(en)),ft({value:an.value,deadline:an.deadline||"",name:an.name||"",city:en.shippingCity||"",options:en.shippingOptions}),vt(en))}return}}),n.addEventListener("submit",function(e){var o=e.target.closest('[data-mm-act="onepage-submit"]');if(o){e.preventDefault();var p={email:(document.getElementById("mm-op-email")||{}).value||"",nome:(document.getElementById("mm-op-nome")||{}).value||"",cpf:(document.getElementById("mm-op-cpf")||{}).value||"",tel:(document.getElementById("mm-op-tel")||{}).value||"",cep:(document.getElementById("mm-op-cep")||{}).value||"",rua:(document.getElementById("mm-op-rua")||{}).value||"",num:(document.getElementById("mm-op-num")||{}).value||"",comp:(document.getElementById("mm-op-comp")||{}).value||"",bairro:(document.getElementById("mm-op-bairro")||{}).value||"",cidade:(document.getElementById("mm-op-cidade")||{}).value||"",uf:(document.getElementById("mm-op-uf")||{}).value||""},d=[];if(/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(p.email.trim())||d.push("mm-op-email"),p.nome.trim().split(/\s+/).length<2&&d.push("mm-op-nome"),p.cpf.replace(/\D/g,"").length!==11&&d.push("mm-op-cpf"),p.tel.replace(/\D/g,"").length<10&&d.push("mm-op-tel"),p.cep.replace(/\D/g,"").length!==8&&d.push("mm-op-cep"),p.rua.trim()||d.push("mm-op-rua"),p.num.trim()||d.push("mm-op-num"),p.bairro.trim()||d.push("mm-op-bairro"),p.cidade.trim()||d.push("mm-op-cidade"),p.uf.trim()||d.push("mm-op-uf"),d.length){d.forEach(function(_){var L=document.getElementById(_);L&&(L.classList.add("mm-input-error"),setTimeout(function(){L.classList.remove("mm-input-error")},1800))});var E=document.getElementById(d[0]);E&&(E.focus(),E.scrollIntoView({block:"center",behavior:"smooth"}));return}var A=o.querySelector(".mm-cta");A&&A.classList.add("is-loading"),tn.set("mm_user_email",p.email.trim()),F(p)}}),n.addEventListener("input",function(e){var o=e.target;if(o){if(o.dataset&&o.dataset.mmCepFill==="1"&&delete o.dataset.mmCepFill,o.id==="mm-op-cpf")o.value=kt(o.value);else if(o.id==="mm-op-tel")o.value=Lt(o.value);else if(o.id==="mm-op-cep"){o.value=wt(o.value);var p=o.value.replace(/\D/g,"");p.length===8&&ht(p)}else o.id==="mm-op-uf"&&(o.value=(o.value||"").replace(/[^A-Za-z]/g,"").toUpperCase().slice(0,2));o.id&&o.id.indexOf("mm-op-")===0&&(Gn._draftTimer&&clearTimeout(Gn._draftTimer),Gn._draftTimer=setTimeout(bn,400))}});function t(){Gn._draftTimer&&(clearTimeout(Gn._draftTimer),Gn._draftTimer=null),bn()}n.addEventListener("blur",function(e){var o=e.target;o&&o.id&&o.id.indexOf("mm-op-")===0&&t()},!0),window.addEventListener("beforeunload",t)}function ht(n){var t=document.getElementById("mm-op-cep-status");t&&(t.className="mm-input-status is-loading",t.textContent="Buscando..."),pt(n,function(e){if(t&&(t.className="mm-input-status"),!e){t&&(t.className="mm-input-status is-error",t.textContent="CEP não encontrado",setTimeout(function(){t.className="mm-input-status",t.textContent=""},2500));return}t&&(t.className="mm-input-status is-ok",t.innerHTML=B.check,setTimeout(function(){t.className="mm-input-status",t.innerHTML=""},1800));var o=[["mm-op-rua",e.logradouro],["mm-op-bairro",e.bairro],["mm-op-cidade",e.cidade],["mm-op-uf",e.estado]];o.forEach(function(d){var E=document.getElementById(d[0]);!E||!d[1]||(!E.value||E.dataset.mmCepFill==="1")&&(E.value=d[1],E.dataset.mmCepFill="1")});var p=document.getElementById("mm-op-num");p&&setTimeout(function(){p.focus()},100),Kn._t&&clearTimeout(Kn._t),Kn._t=setTimeout(Kn,200)})}function a(n){if(!document.getElementById("mm-op-overlay")){var t=document.createElement("div");t.id="mm-op-overlay",t.innerHTML='<div class="mm-op-overlay-card"><div class="mm-op-overlay-spinner"></div><p class="mm-op-overlay-text">'+O(n||"Processando...")+"</p></div>",document.body.appendChild(t)}}function l(n){var t=document.querySelector("#mm-op-overlay .mm-op-overlay-text");t&&(t.textContent=n)}var c=null;function y(){if(!window.__mmStep1Observed){window.__mmStep1Observed=!0;var n=/compraSemCadastro/i;try{var t=window.fetch;typeof t=="function"&&(window.fetch=function(p,d){var E=typeof p=="string"?p:p&&p.url||"",A=d&&d.body||"",_=n.test(E)||n.test(String(A)),L=t.apply(this,arguments);return _&&L.then(function(V){c&&(V&&V.ok?c.done=!0:c.failed=!0)}).catch(function(){c&&(c.failed=!0)}),L})}catch{}try{var e=XMLHttpRequest.prototype.open,o=XMLHttpRequest.prototype.send;XMLHttpRequest.prototype.open=function(p,d){return this.__mmU=d||"",e.apply(this,arguments)},XMLHttpRequest.prototype.send=function(p){try{if(n.test(this.__mmU||"")||n.test(String(p||""))){var d=this;d.addEventListener("load",function(){c&&(d.status>=200&&d.status<300?c.done=!0:c.failed=!0)}),d.addEventListener("error",function(){c&&(c.failed=!0)})}}catch{}return o.apply(this,arguments)}}catch{}}}function F(n){var t=document.querySelector(".mm-op-form .mm-op-retry");t&&t.remove();var e=n.nome.trim(),o=n.email.trim(),p=n.rua.trim(),d=n.bairro.trim(),E=n.cidade.trim(),A=n.uf.trim(),_=zn(n.cep.replace(/\D/g,""));tn.set("mm_user_email",o);var L=function(V,N){var nn=f.querySelector(V);if(!nn)return!1;try{var en=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;en.call(nn,N)}catch{nn.value=N}return nn.dispatchEvent(new Event("input",{bubbles:!0})),nn.dispatchEvent(new Event("change",{bubbles:!0})),nn.dispatchEvent(new Event("blur",{bubbles:!0})),!0};L("#nome-completo_2",e),L("#cpf_2",n.cpf),L("#email_3",o),L("#telefone_2",n.tel),L("#cep",_),L("#destinatario",e),L("#logradouro",p),L("#numero",n.num),L("#complemento",n.comp),L("#bairro",d),L("#cidade",E),L("#estado",A),a("Confirmando seus dados..."),setTimeout(function(){var V=document.getElementById("mm-layout");V&&(V.style.display="none"),f.classList.remove("mm-shadow-mode");function N(on){var mn=f.querySelector("#"+on);return mn?mn.closest("form"):null}function nn(){var on=N("nome-completo_2");if(!on)return!1;var mn=on.querySelector('button[type="submit"], input[type="submit"], button:not([type])');return mn?(mn.click(),!0):typeof on.requestSubmit=="function"?(on.requestSubmit(),!0):(on.submit(),!0)}function en(){var on=document.querySelector(".mz-toast-popup.error, .swal2-toast.swal2-icon-error");if(on&&/inativo|realize login/i.test(on.textContent||""))return"error";for(var mn=document.querySelectorAll('button, [type="submit"]'),fn=0;fn<mn.length;fn++){var w=(mn[fn].textContent||"").toLowerCase();if(w.indexOf("cadastrar endere")!==-1&&mn[fn].offsetParent!==null)return"ready"}return"wait"}function an(){var on=N("cep");if(!on)return!1;var mn=on.querySelector('button[type="submit"], input[type="submit"], button:not([type])');return mn?(mn.click(),!0):typeof on.requestSubmit=="function"?(on.requestSubmit(),!0):(on.submit(),!0)}function U(on){var mn=document.getElementById("mm-op-overlay");mn&&mn.remove();var fn=document.getElementById("mm-layout");fn&&(fn.style.display=""),f.classList.add("mm-shadow-mode");var w=document.querySelector(".mm-op-form .mm-cta");w&&w.classList.remove("is-loading");var k=document.querySelector('.mm-op-form[data-mm-act="onepage-submit"]');if(k&&!k.querySelector(".mm-op-retry")){var j=document.createElement("div");j.className="mm-op-retry",j.setAttribute("data-mm-retry","1"),j.setAttribute("role","alert"),j.style.cssText="margin:14px 0;padding:12px 16px;border:1px solid #E7B84B;background:#FFF8E6;border-radius:12px;font-family:Poppins,system-ui,sans-serif;font-size:13px;color:#6B5313;line-height:1.45;",j.textContent=on||"Quase lá — toque em “Última etapa: pagamento” novamente para concluir.",k.insertBefore(j,k.firstChild);try{j.scrollIntoView({block:"center",behavior:"smooth"})}catch{}}}function un(on){on===0&&l("Abrindo o pagamento...");var mn=document.querySelector('input[name="forma-pagto"], #forma-pagto-pix, #forma-pagto-cartao, #forma-pagto-boleto');if(mn&&mn.offsetParent!==null){try{I(n)}catch{var fn=document.getElementById("mm-op-overlay");fn&&fn.remove();var w=document.getElementById("mm-layout");w&&(w.style.display="none")}return}on<40?setTimeout(function(){un(on+1)},200):U("Não conseguimos abrir o pagamento. Toque em “Última etapa: pagamento” para tentar de novo.")}function ln(){l("Salvando sua entrega..."),an(),un(0)}y();var vn={done:!1,failed:!1};c=vn,setTimeout(function(){nn();var on=80,mn=4,fn=0,w=null;(function k(){fn++;var j=en();if(vn.failed||j==="error"){U("Não foi possível iniciar o pedido. Toque em “Última etapa: pagamento” para tentar de novo.");return}if(j==="ready"){ln();return}if(vn.done&&(w===null&&(w=fn),fn-w>=mn)){ln();return}if(fn<on){setTimeout(k,250);return}vn.done?ln():U("Está demorando mais que o normal. Toque em “Última etapa: pagamento” para tentar de novo.")})()},120)},80)}function S(){var n={pix:null,cartao:null,boleto:null},t=[];try{t=window.Zord&&window.Zord.Calculo&&window.Zord.Calculo.FormasPagamentoPedido||[]}catch{}t.forEach(function(N){var nn=N.formaPagamento&&N.formaPagamento.id,en=N.formaPagamento&&N.formaPagamento.isCartao,an=N.condicoes||[];!an.length||!en||(!n.cartao||an.length>n.cartao.condicoes.length)&&(n.cartao={formaId:nn,valorTotal:an[0].valorTotal,condicoes:an.map(function(U){return{nome:U.condicaoPagamento&&U.condicaoPagamento.nome,numParcelas:U.condicaoPagamento&&U.condicaoPagamento.numeroParcelas,valorParcela:U.valorParcela,valorTotal:U.valorTotal}})})});function e(N){if(!N)return 0;var nn=N.getAttribute&&N.getAttribute("data-valor-total");if(nn){var en=parseFloat(nn);if(en>0)return en}var an=(N.textContent||"").replace(/[^\d,.]/g,"");return an.indexOf(",")!==-1&&(an=an.replace(/\./g,"").replace(",",".")),parseFloat(an)||0}var o=document.querySelector("#valor-total-pedido-pix, .valor-total-pix[data-valor-total]"),p=e(o);if(p>0)n.pix={formaId:17,valorTotal:p};else{var d=t.find&&t.find(function(N){return N.formaPagamento&&N.formaPagamento.id===17});d&&d.condicoes&&d.condicoes[0]&&(n.pix={formaId:17,valorTotal:d.condicoes[0].valorTotal})}var E=document.querySelector("#valor-total-pedido-boleto, .valor-total-boleto[data-valor-total]"),A=e(E);if(A>0)n.boleto={valorTotal:A};else{var _=t.find&&t.find(function(N){var nn=N.formaPagamento&&N.formaPagamento.id,en=N.formaPagamento&&N.formaPagamento.isCartao;return!en&&nn!==17&&N.condicoes&&N.condicoes.length});_&&(n.boleto={formaId:_.formaPagamento.id,valorTotal:_.condicoes[0].valorTotal})}if(!n.cartao){var L=document.querySelector(".valor-parcela-cartao");if(L){var V=e(L);V>0&&(n.cartao={valorTotal:V*12,condicoes:[]})}}return n}function I(n){var t=cn(),e=S();f.classList.add("mm-shadow-mode"),document.body.classList.add("mm-checkout-rebuild");var o=document.getElementById("mm-layout");(!o||o.parentElement!==f)&&(o&&o.parentElement&&o.parentElement.removeChild(o),o=document.createElement("div"),o.id="mm-layout",f.insertBefore(o,f.firstChild)),o.className="mm-op-layout mm-op-step3-layout",o.style.display="",o.innerHTML=H(t,n,e),document.documentElement.classList.remove("mm-cart-loading");var p=document.getElementById("mm-op-overlay");p&&p.remove();try{window.scrollTo({top:0,behavior:"smooth"})}catch{window.scrollTo(0,0)}sn(n,e)}function H(n,t,e){var o=typeof renderGlobalFooter=="function"?renderGlobalFooter():"";return dn("payment")+'<main class="mm-op-main"><div class="mm-op-step3-grid"><section class="mm-op-step3-left">'+X(e)+rn()+'</section><aside class="mm-op-step3-sum-wrap">'+Y(t)+J(n,e,"pix")+"</aside></div></main>"+o}function Y(n){var t=n||{},e=O(t.nome||""),o=O(t.email||""),p=O(t.cpf||""),d=O(t.tel||""),E=O(t.rua||""),A=O(t.num||""),_=t.comp?", "+O(t.comp):"",L=O(t.bairro||""),V=O(t.cidade||""),N=O(t.uf||""),nn=O(t.cep||"");return'<div class="mm-op-step3-completed"><div class="mm-op-completed-card" data-section="dados"><div class="mm-op-completed-head"><span class="mm-op-completed-check">'+B.check+'</span><h3 class="mm-op-completed-title">Dados pessoais</h3><a href="/checkout/onepage" class="mm-op-completed-edit" data-mm-act="edit-dados" aria-label="Editar dados">'+Vn.editPencil+' Editar</a></div><dl class="mm-op-completed-body">'+(e?"<div><dt>Nome</dt><dd>"+e+"</dd></div>":"")+(o?"<div><dt>E-mail</dt><dd>"+o+"</dd></div>":"")+(p?"<div><dt>CPF</dt><dd>"+p+"</dd></div>":"")+(d?"<div><dt>Telefone</dt><dd>"+d+"</dd></div>":"")+'</dl></div><div class="mm-op-completed-card" data-section="endereco"><div class="mm-op-completed-head"><span class="mm-op-completed-check">'+B.check+'</span><h3 class="mm-op-completed-title">Endereço de entrega</h3><a href="/checkout/onepage" class="mm-op-completed-edit" data-mm-act="edit-endereco" aria-label="Editar endereço">'+Vn.editPencil+' Editar</a></div><address class="mm-op-completed-address">'+E+", "+A+_+"<br>"+L+" — "+V+"/"+N+"<br>"+(nn?"CEP "+nn:"")+"</address></div></div>"}function X(n){var t=n.pix?n.pix.valorTotal:0,e=n.cartao?n.cartao.valorTotal:0,o=n.boleto?n.boleto.valorTotal:0,p=e>t?e-t:0,d=null;n.cartao&&n.cartao.condicoes&&n.cartao.condicoes.length&&(d=n.cartao.condicoes[n.cartao.condicoes.length-1]);var E=d?"até "+d.numParcelas+"x de "+D(d.valorParcela)+" sem juros":e>0?"até 12x sem juros":"Cartão de crédito",A='<label class="mm-op-pay-radio is-active" data-forma="pix"><input type="radio" name="mm-pay" value="pix" checked><div class="mm-op-pay-head"><span class="mm-op-pay-radio-dot" aria-hidden="true"></span><span class="mm-op-pay-icon">'+Vn.pix+'</span><div class="mm-op-pay-body"><span class="mm-op-pay-title">PIX</span><span class="mm-op-pay-sub">Aprovação instantânea · em 1 minuto</span></div><div class="mm-op-pay-price">'+(p>0?'<span class="mm-op-pay-badge-save">Economize '+D(p)+"</span>":"")+'<span class="mm-op-pay-amount">'+D(t)+'</span></div></div><div class="mm-op-pay-detail"><ul class="mm-op-pay-benefits"><li>'+B.check+"<span>QR Code e Copia-e-Cola após confirmar</span></li><li>"+B.check+"<span>Pedido aprovado em até 1 minuto</span></li><li>"+B.check+"<span>Pagamento 100% seguro · sem dados de cartão</span></li></ul></div></label>",_='<div class="mm-op-pay-brands"><img src="https://public-resources.zordcdn.com.br/assets/global/payment-vector/cartao-visa.svg" alt="Visa" width="32" height="20"><img src="https://public-resources.zordcdn.com.br/assets/global/payment-vector/cartao-mastercard.svg" alt="Mastercard" width="32" height="20"><img src="https://public-resources.zordcdn.com.br/assets/global/payment-vector/cartao-american-express.svg" alt="American Express" width="32" height="20"><img src="https://public-resources.zordcdn.com.br/assets/global/payment-vector/cartao-elo.svg" alt="Elo" width="32" height="20"><img src="https://public-resources.zordcdn.com.br/assets/global/payment-vector/cartao-hipercard.svg" alt="Hipercard" width="32" height="20"></div>',L='<span class="mm-op-req" aria-hidden="true">*</span>';function V(an){return'<span class="mm-op-field-err" id="'+an+'-err" role="alert" aria-live="polite"></span>'}var N='<div class="mm-op-card-form"><div class="mm-op-card-field mm-op-card-field-full"><label for="mm-pay-card-num">Número do cartão'+L+'</label><div class="mm-input-wrap mm-input-wrap-card"><span class="mm-input-icon" aria-hidden="true">'+B.card+'</span><input id="mm-pay-card-num" type="tel" class="mm-input" inputmode="numeric" autocomplete="off" data-mmac="cc-number" placeholder="0000 0000 0000 0000" maxlength="23" aria-describedby="mm-pay-card-num-err" aria-required="true" disabled><span class="mm-op-card-brand-detected" aria-live="polite"></span></div>'+V("mm-pay-card-num")+'</div><div class="mm-op-card-field mm-op-card-field-full"><label for="mm-pay-card-name">Nome impresso no cartão'+L+'</label><input id="mm-pay-card-name" type="text" class="mm-input mm-input-noicon" autocomplete="off" data-mmac="cc-name" placeholder="Como aparece no cartão" maxlength="100" aria-describedby="mm-pay-card-name-err" aria-required="true" disabled>'+V("mm-pay-card-name")+'</div><div class="mm-op-card-field mm-op-card-field-half"><label for="mm-pay-card-exp">Validade'+L+'</label><input id="mm-pay-card-exp" type="tel" class="mm-input mm-input-noicon" inputmode="numeric" autocomplete="off" data-mmac="cc-exp" placeholder="MM/AA" maxlength="5" aria-describedby="mm-pay-card-exp-err" aria-required="true" disabled>'+V("mm-pay-card-exp")+'</div><div class="mm-op-card-field mm-op-card-field-half"><label for="mm-pay-card-cvv">CVV'+L+'</label><input id="mm-pay-card-cvv" type="tel" class="mm-input mm-input-noicon" inputmode="numeric" autocomplete="off" data-mmac="cc-csc" placeholder="000" maxlength="4" aria-describedby="mm-pay-card-cvv-err" aria-required="true" disabled>'+V("mm-pay-card-cvv")+'</div><div class="mm-op-card-field mm-op-card-field-full"><label for="mm-pay-card-installments">Condições de pagamento'+L+'</label><select id="mm-pay-card-installments" class="mm-input mm-input-noicon mm-op-card-installments" aria-describedby="mm-pay-card-installments-err" aria-required="true" disabled><option value="">Digite o cartão pra ver as condições</option></select>'+V("mm-pay-card-installments")+"</div></div>",nn='<label class="mm-op-pay-radio" data-forma="cartao"><input type="radio" name="mm-pay" value="cartao"><div class="mm-op-pay-head"><span class="mm-op-pay-radio-dot" aria-hidden="true"></span><span class="mm-op-pay-icon">'+Vn.cardBig+'</span><div class="mm-op-pay-body"><span class="mm-op-pay-title">Cartão de Crédito</span><span class="mm-op-pay-sub">'+O(E)+'</span></div><div class="mm-op-pay-price"><span class="mm-op-pay-amount">'+D(e)+'</span></div></div><div class="mm-op-pay-detail">'+_+N+"</div></label>",en='<label class="mm-op-pay-radio" data-forma="boleto"><input type="radio" name="mm-pay" value="boleto"><div class="mm-op-pay-head"><span class="mm-op-pay-radio-dot" aria-hidden="true"></span><span class="mm-op-pay-icon">'+Vn.barcode+'</span><div class="mm-op-pay-body"><span class="mm-op-pay-title">Boleto Bancário</span><span class="mm-op-pay-sub">Aprovação em 1 a 3 dias úteis</span></div><div class="mm-op-pay-price"><span class="mm-op-pay-amount">'+D(o)+'</span></div></div><div class="mm-op-pay-detail"><ul class="mm-op-pay-benefits"><li>'+B.check+"<span>Código de barras enviado por e-mail</span></li><li>"+B.check+"<span>Pagamento em banco, lotérica ou app</span></li><li>"+B.check+"<span>Vencimento em 3 dias úteis</span></li></ul></div></label>";return'<section class="mm-op-step3-card" aria-labelledby="mm-op-step3-h"><div class="mm-op-step3-heading"><h2 id="mm-op-step3-h" class="mm-h">Como você quer pagar?</h2><p class="mm-op-step3-sub">Última etapa · escolha sua forma de pagamento '+(p>0?"· PIX tem desconto de "+D(p):"")+'</p></div><div class="mm-op-pay-radios" role="radiogroup" aria-label="Forma de pagamento">'+A+nn+en+'</div><button type="button" class="mm-cta mm-op-cta mm-op-finalizar" data-mm-act="finalizar-compra">'+B.lock+'<span class="mm-op-finalizar-label">Finalizar compra · '+D(t)+'</span></button><p class="mm-op-finalizar-sub">'+B.shield+"<span>Pagamento seguro · criptografia SSL-256 · seus dados não são armazenados</span></p></section>"}function rn(){return'<div class="mm-op-trust-payment"><div class="mm-op-trust-payment-row"><span class="mm-trust-item">'+B.lock+'<span>Site 100% seguro</span></span><span class="mm-trust-item">'+B.shield+'<span>Garantia 12 meses</span></span><span class="mm-trust-item">'+B.rotate+'<span>7 dias pra trocar</span></span><span class="mm-trust-item">'+B.whats+'<span>Atendimento humano</span></span></div><p class="mm-op-trust-payment-note">Ao finalizar, você concorda com os <a href="/termos-de-uso" target="_blank" rel="noopener">termos de compra</a> e a <a href="/politica-privacidade" target="_blank" rel="noopener">política de privacidade</a>.</p></div>'}function J(n,t,e){if(!n||!n.items||!n.items.length)return'<aside class="mm-id-sum mm-sum mm-op-step3-sum"><h2 class="mm-h">Resumo</h2><div class="mm-sum-card"><p class="mm-sum-empty">Não conseguimos carregar o resumo do seu pedido.</p></div></aside>';var o=t.pix?t.pix.valorTotal:0,p=t.cartao?t.cartao.valorTotal:0,d=t.boleto?t.boleto.valorTotal:0,E=p>o?p-o:0,A=e==="pix"?o:e==="boleto"?d:p,_=e==="pix"?"no PIX":e==="boleto"?"no boleto":"no cartão",L=3,V=n.items.slice(0,L),N=n.items.length-L,nn=V.map(function(ln){var vn=ln.imgSrc?'<img src="'+O(ln.imgSrc)+'" alt="'+O(ln.name)+'" loading="lazy">':'<div class="mm-id-thumb-placeholder">'+B.box+"</div>",on=ln.quantity>1?'<strong class="mm-id-thumb-qty">'+ln.quantity+"×</strong> ":"",mn=ln.lineTotal>0?ln.lineTotal:ln.lineTotalPix;return'<div class="mm-id-thumb"><div class="mm-id-thumb-img">'+vn+'</div><div class="mm-id-thumb-body"><p class="mm-id-thumb-name">'+on+O(ln.name)+"</p>"+(ln.variant?'<p class="mm-id-thumb-variant">'+O(ln.variant)+"</p>":"")+'</div><div class="mm-id-thumb-price">'+D(mn)+"</div></div>"}).join("");N>0&&(nn+='<div class="mm-id-thumb-more">+ '+N+" "+(N===1?"item":"itens")+" a mais</div>");var en=n.subtotalFull>0?n.subtotalFull:n.subtotalPix,an='<div class="mm-row"><span class="mm-row-label">Subtotal</span><span class="mm-row-value">'+D(en)+"</span></div>";if(n.shipping!==null&&n.shipping!==void 0){var U=n.shipping===0?'<span class="mm-row-value is-free">'+B.check+" Grátis</span>":'<span class="mm-row-value">'+D(n.shipping)+"</span>";an+='<div class="mm-row"><span class="mm-row-label">Frete'+(n.shippingDeadline?' <span class="mm-row-sub">· '+O(n.shippingDeadline)+"</span>":"")+"</span>"+U+"</div>"}n.discount>0&&(an+='<div class="mm-row"><span class="mm-row-label">Cupom'+(n.couponCode?' <span class="mm-row-sub">· '+O(n.couponCode)+"</span>":"")+'</span><span class="mm-row-value is-discount">− '+D(n.discount)+"</span></div>"),E>0&&e==="pix"&&(an+='<div class="mm-row mm-row-pix-discount"><span class="mm-row-label">'+B.bolt+' Desconto PIX</span><span class="mm-row-value is-discount">− '+D(E)+"</span></div>");var un='<div class="mm-total"><div class="mm-total-label">Total</div><div class="mm-total-value" data-mm-total>'+D(A)+'</div><div class="mm-total-pix" data-mm-total-sub><span>'+_+"</span></div></div>";return'<aside class="mm-id-sum mm-sum mm-op-step3-sum" data-active-forma="'+O(e)+'"><h2 class="mm-h">Resumo do pedido</h2><div class="mm-sum-card"><div class="mm-id-thumbs">'+nn+'</div><div class="mm-sum-rows">'+an+"</div>"+un+"</div></aside>"}function sn(n,t){var e=document.getElementById("mm-layout");if(!e||e._mmStep3Bound)return;e._mmStep3Bound=!0;var o=cn(),p={activeForma:"pix",cardNumValid:!1,cardBrand:null,cardInstallments:null,submitting:!1};e.addEventListener("click",function(w){var k=w.target.closest(".mm-op-pay-radio");if(k){var j=k.querySelector('input[type="radio"]');j&&!j.checked&&(w.preventDefault(),j.checked=!0,L(k.getAttribute("data-forma")));return}if(w.target.closest('[data-mm-act="finalizar-compra"]')){w.preventDefault(),fn();return}var K=w.target.closest('[data-mm-act="edit-dados"], [data-mm-act="edit-endereco"]');if(K){w.preventDefault(),location.reload();return}}),e.addEventListener("input",function(w){var k=w.target;!k||!k.id||(k.id==="mm-pay-card-num"?an(k):k.id==="mm-pay-card-exp"?U(k):k.id==="mm-pay-card-cvv"&&(k.value=(k.value||"").replace(/\D/g,"").slice(0,4)))}),e.addEventListener("change",function(w){if(w.target&&w.target.id==="mm-pay-card-installments"){var k=w.target,j=k.options[k.selectedIndex];j&&j.value&&(p.cardInstallments={numero:parseInt(j.value,10),label:j.textContent||""},vn(j.value),E("mm-pay-card-installments"))}}),e.addEventListener("blur",function(w){var k=w.target;if(!(!k||!k.id)){var j=["mm-pay-card-num","mm-pay-card-name","mm-pay-card-exp","mm-pay-card-cvv"];j.indexOf(k.id)!==-1&&A(k.id)}},!0),e.addEventListener("focus",function(w){var k=w.target;!k||!k.id||/^mm-pay-card-/.test(k.id)&&E(k.id)},!0);function d(w,k){var j=document.getElementById(w),K=document.getElementById(w+"-err");j&&(j.classList.add("mm-input-error"),j.setAttribute("aria-invalid","true")),K&&(K.textContent=k,K.classList.add("is-visible"))}function E(w){var k=document.getElementById(w),j=document.getElementById(w+"-err");k&&(k.classList.remove("mm-input-error"),k.removeAttribute("aria-invalid")),j&&(j.textContent="",j.classList.remove("is-visible"))}function A(w){var k=document.getElementById(w);if(!k)return!0;var j=(k.value||"").trim();if(w==="mm-pay-card-num"){var K=j.replace(/\D/g,"");return K?K.length<13?(d(w,"Número do cartão incompleto"),!1):_(K)?(E(w),!0):(d(w,"Número do cartão inválido — confira os dígitos"),!1):(d(w,"Informe o número do cartão"),!1)}if(w==="mm-pay-card-name")return j?j.split(/\s+/).length<2?(d(w,"Use o nome completo como aparece no cartão"),!1):(E(w),!0):(d(w,"Informe o nome impresso no cartão"),!1);if(w==="mm-pay-card-exp"){var Q=j.replace(/\D/g,"");if(Q.length!==4)return d(w,"Informe a validade no formato MM/AA"),!1;var xn=parseInt(Q.slice(0,2),10),yn=parseInt(Q.slice(2),10);if(xn<1||xn>12)return d(w,"Mês inválido (01 a 12)"),!1;var qn=new Date,Bn=qn.getFullYear()%100,Pn=qn.getMonth()+1;return yn<Bn||yn===Bn&&xn<Pn?(d(w,"Cartão expirado"),!1):(E(w),!0)}if(w==="mm-pay-card-cvv"){var nt=j.replace(/\D/g,"");return nt.length<3?(d(w,"CVV deve ter 3 ou 4 dígitos"),!1):(E(w),!0)}return w==="mm-pay-card-installments"?j?(E(w),!0):(d(w,"Selecione o número de parcelas"),!1):!0}function _(w){for(var k=0,j=!1,K=w.length-1;K>=0;K--){var Q=parseInt(w.charAt(K),10);j&&(Q*=2,Q>9&&(Q-=9)),k+=Q,j=!j}return k%10===0}function L(w){if(!(!w||p.activeForma===w)){p.activeForma=w,e.querySelectorAll(".mm-op-pay-radio").forEach(function(Q){Q.classList.toggle("is-active",Q.getAttribute("data-forma")===w)});var k=document.getElementById("forma-pagto-"+w);if(k&&!k.checked)try{k.click()}catch{}var j=e.querySelectorAll(".mm-op-card-form input, .mm-op-card-form select"),K=w==="cartao";j.forEach(function(Q){Q.disabled=!K,K?Q.dataset.mmac&&Q.setAttribute("autocomplete",Q.dataset.mmac):Q.setAttribute("autocomplete","off")}),V(w),w==="cartao"&&setTimeout(function(){var Q=document.getElementById("mm-pay-card-num");Q&&!Q.value&&Q.focus()},250)}}function V(w){var k=e.querySelector(".mm-op-step3-sum");if(k){k.setAttribute("data-active-forma",w);var j=t.pix?t.pix.valorTotal:0,K=t.cartao?t.cartao.valorTotal:0,Q=t.boleto?t.boleto.valorTotal:0,xn=K>j?K-j:0,yn=w==="pix"?j:w==="boleto"?Q:K,qn=w==="pix"?"no PIX":w==="boleto"?"no boleto":"no cartão",Bn=k.querySelector("[data-mm-total]");if(Bn){var Pn=Bn.textContent||"",nt=G(Pn);nt!==yn?N(Bn,nt,yn,360):Bn.textContent=D(yn)}var Xn=k.querySelector("[data-mm-total-sub] span");Xn&&Xn.textContent!==qn&&(Xn.textContent=qn);var rt=k.querySelector(".mm-sum-rows"),ot=rt?rt.querySelector(".mm-row-pix-discount"):null;if(w==="pix"&&xn>0){if(!ot&&rt){var gt=document.createElement("div");gt.innerHTML='<div class="mm-row mm-row-pix-discount"><span class="mm-row-label">'+B.bolt+' Desconto PIX</span><span class="mm-row-value is-discount">− '+D(xn)+"</span></div>",rt.appendChild(gt.firstChild)}}else ot&&ot.remove();nn(w)}}function N(w,k,j,K){w._mmAnimToken&&cancelAnimationFrame(w._mmAnimToken);var Q=null,xn=j-k;function yn(qn){Q||(Q=qn);var Bn=qn-Q,Pn=Math.min(1,Bn/K),nt=1-Math.pow(1-Pn,3),Xn=k+xn*nt;w.textContent=D(Xn),Pn<1?w._mmAnimToken=requestAnimationFrame(yn):(w.textContent=D(j),w._mmAnimToken=null)}w._mmAnimToken=requestAnimationFrame(yn)}function nn(w){var k=e.querySelector(".mm-op-finalizar-label");if(k){var j=w==="pix"?t.pix&&t.pix.valorTotal:w==="boleto"?t.boleto&&t.boleto.valorTotal:t.cartao&&t.cartao.valorTotal;k.textContent="Finalizar compra · "+D(j||0)}}function en(w){var k=(w||"").replace(/\D/g,"");return k?/^4/.test(k)?"visa":/^(5[1-5]|22[2-9]|2[3-6]|27[01]|2720)/.test(k)?"mastercard":/^3[47]/.test(k)?"amex":/^(4011|4312|4389|4514|4573|5041|5066|5067|509|6277|6362|6363|650|6516|6550)/.test(k)?"elo":/^(606282|384100|384140|384160|606|637095|637568|637599|637609|637612)/.test(k)?"hipercard":null:null}function an(w){var k=(w.value||"").replace(/\D/g,"").slice(0,19),j=k.replace(/(\d{4})(?=\d)/g,"$1 ");if(j!==w.value){var K=w.selectionStart;w.value=j;try{w.setSelectionRange(K+1,K+1)}catch{}}var Q=en(k);p.cardBrand=Q,p.cardNumValid=k.length>=13;var xn=e.querySelector(".mm-op-card-brand-detected");xn&&(xn.className="mm-op-card-brand-detected"+(Q?" is-"+Q:""),xn.textContent=Q?Q.toUpperCase():""),k.length>=6&&(un(k),mn())}function U(w){var k=(w.value||"").replace(/\D/g,"").slice(0,4),j=k.length>2?k.slice(0,2)+"/"+k.slice(2):k;if(w.value=j,k.length===4){var K=k.slice(0,2),Q="20"+k.slice(2);ln("pag-cartao-mes-validade",String(parseInt(K,10))),ln("pag-cartao-ano-validade",Q)}}function un(w){var k=document.getElementById("pag-cartao-numero");if(k){try{var j=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;j.call(k,w)}catch{k.value=w}k.dispatchEvent(new Event("input",{bubbles:!0})),k.dispatchEvent(new Event("change",{bubbles:!0})),k.dispatchEvent(new Event("blur",{bubbles:!0}))}}function ln(w,k){var j=document.getElementById(w);if(j){try{var K=Object.getOwnPropertyDescriptor(window.HTMLSelectElement.prototype,"value").set;K.call(j,k)}catch{j.value=k}j.dispatchEvent(new Event("change",{bubbles:!0}))}}function vn(w){ln("pag-cartao-parcela",w)}var on=null;function mn(){if(on)return;var w=document.getElementById("pag-cartao-parcela");if(!w)return;var k=document.getElementById("mm-pay-card-installments");if(!k)return;function j(){var K=w.querySelectorAll("option");if(!(K.length<=1)){var Q="";K.forEach(function(xn){if(!xn.value){Q+='<option value="">Selecione as parcelas</option>';return}Q+='<option value="'+O(xn.value)+'">'+O(xn.textContent.trim())+"</option>"}),k.innerHTML=Q,k.options.length>1&&(k.selectedIndex=1,p.cardInstallments={numero:parseInt(k.options[1].value,10)||1,label:k.options[1].textContent},vn(k.options[1].value))}}j(),on=new MutationObserver(j),on.observe(w,{childList:!0,subtree:!0})}function fn(){if(console.log("[mm-checkout] submitFinalizar() entry",{submitting:p.submitting,activeForma:p.activeForma}),p.submitting)return;var w=p.activeForma,k=e.querySelector(".mm-op-finalizar");if(!k){console.log("[mm-checkout] submitFinalizar: no .mm-op-finalizar btn");return}if(w==="cartao"){var j=["mm-pay-card-num","mm-pay-card-name","mm-pay-card-exp","mm-pay-card-cvv","mm-pay-card-installments"],K=j.filter(function(kn){return!A(kn)});if(console.log("[mm-checkout] validation",{errorCount:K.length,errors:K}),K.length){var Q=document.getElementById(K[0]);if(Q){Q.focus();try{Q.scrollIntoView({block:"center",behavior:"smooth"})}catch{}}return}var xn=document.getElementById("mm-pay-card-name"),yn=document.getElementById("mm-pay-card-cvv"),qn=document.getElementById("pag-cartao-titular");if(qn){try{var Bn=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;Bn.call(qn,xn.value.trim())}catch{qn.value=xn.value.trim()}qn.dispatchEvent(new Event("input",{bubbles:!0})),qn.dispatchEvent(new Event("blur",{bubbles:!0}))}var Pn=document.getElementById("pag-cartao-vericacao");if(Pn){try{var nt=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;nt.call(Pn,yn.value.replace(/\D/g,""))}catch{Pn.value=yn.value.replace(/\D/g,"")}Pn.dispatchEvent(new Event("input",{bubbles:!0})),Pn.dispatchEvent(new Event("blur",{bubbles:!0}))}var Xn=document.getElementById("pag-cartao-cpf");if(Xn&&n&&n.cpf){try{var rt=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;rt.call(Xn,n.cpf)}catch{Xn.value=n.cpf}Xn.dispatchEvent(new Event("input",{bubbles:!0})),Xn.dispatchEvent(new Event("blur",{bubbles:!0}))}}p.submitting=!0,k.classList.add("is-loading"),k.setAttribute("aria-busy","true");var ot=k.querySelector(".mm-op-finalizar-label");if(ot&&(ot.textContent="Processando pagamento..."),a("Finalizando seu pedido..."),w==="cartao"){var gt=document.getElementById("mm-pay-card-installments");gt&&gt.value&&vn(gt.value)}window.__mmCheckoutDebug=window.__mmCheckoutDebug||[];function Fn(kn,Wn){var Qn={t:new Date().toISOString(),msg:kn,data:Wn};window.__mmCheckoutDebug.push(Qn),console.log("[mm-checkout]",kn,Wn||"")}function bt(){if(Fn("doSubmit() called",{forma:w}),w==="cartao"){var kn=document.getElementById("aceito-termos-bcash-one-card");kn&&!kn.checked&&(kn.checked=!0,kn.dispatchEvent(new Event("change",{bubbles:!0}))),Fn("terms",{checked:kn?.checked})}var Wn=w==="pix"?"form-pag-pix":w==="boleto"?"form-pag-boleto":"form-pag-cartao",Qn=document.getElementById(Wn);if(!Qn){Fn("ERROR: form not found",{formId:Wn}),alert("Erro interno: formulário de pagamento não encontrado. Recarregue a página."),p.submitting=!1,k.classList.remove("is-loading");var it=document.getElementById("mm-op-overlay");it&&it.remove();return}w==="cartao"&&Fn("pre-submit cartao state",{numero:document.getElementById("pag-cartao-numero")?.value,bandeira:document.getElementById("pag-cartao-bandeira")?.value,parcela:document.getElementById("pag-cartao-parcela")?.value,titular:document.getElementById("pag-cartao-titular")?.value,mes:document.getElementById("pag-cartao-mes-validade")?.value,ano:document.getElementById("pag-cartao-ano-validade")?.value,cvv:document.getElementById("pag-cartao-vericacao")?.value?.length,cpf:document.getElementById("pag-cartao-cpf")?.value,tokenMp:document.getElementById("pag-cartao-token-mp")?.value?.substring(0,20)});var mt=Qn.querySelector('button.button-success, button[type="submit"], input[type="submit"]');if(mt)Fn("clicking native button",{text:mt.textContent?.trim()}),mt.click();else if(typeof Qn.requestSubmit=="function"){Fn("no native btn, using requestSubmit");try{Qn.requestSubmit()}catch(ct){Fn("requestSubmit error",ct.message),Qn.submit()}}else Fn("no native btn, using form.submit()"),Qn.submit();setTimeout(function(){if(p.submitting&&location.pathname.indexOf("/onepage")!==-1){Fn("8s failsafe: still on /onepage, removing overlay"),p.submitting=!1,k.classList.remove("is-loading");var ct=document.getElementById("mm-op-overlay");ct&&ct.remove(),f.classList.remove("mm-shadow-mode"),e&&(e.style.display="none")}},8e3),setTimeout(function(){f.classList.remove("mm-shadow-mode"),e&&(e.style.display="none")},600)}function Et(){p.submitting=!1,k.classList.remove("is-loading"),k.removeAttribute("aria-busy");var kn=k.querySelector(".mm-op-finalizar-label");kn&&(kn.textContent="Finalizar compra");var Wn=document.getElementById("mm-op-overlay");Wn&&Wn.remove()}function Bt(){var kn=Date.now(),Wn=1e4;(function Qn(){var it=document.getElementById("pag-cartao-token-mp"),mt=it?(it.value||"").trim():"",ct=mt&&mt!=="loading..."&&mt.length>10;if(ct){Fn("fallback: token ready"),bt();return}if(Date.now()-kn>=Wn){Fn("fallback: timeout",{lastVal:mt}),bt();return}setTimeout(Qn,200)})()}function Rt(){if(Fn("generateMpTokenAndSubmit() start"),typeof Mercadopago>"u"){Fn("Mercadopago global missing, falling back to wait strategy"),Bt();return}var kn=document.getElementById("pag-cartao-token-mp"),Wn=kn?(kn.value||"").trim():"";if(Wn&&Wn!=="loading..."&&Wn.length>10){Fn("token already present, submitting",{len:Wn.length}),bt();return}var Qn=(document.getElementById("mm-pay-card-num")?.value||"").replace(/\D/g,""),it=(document.getElementById("mm-pay-card-exp")?.value||"").replace(/\D/g,""),mt=(document.getElementById("mm-pay-card-cvv")?.value||"").replace(/\D/g,""),ct=(document.getElementById("mm-pay-card-name")?.value||"").trim(),It=(n&&n.cpf||document.getElementById("mm-op-cpf")?.value||"").replace(/\D/g,"");if(!Qn||!it||!mt||!ct||!It){Fn("missing card fields",{num:Qn.length,exp:it.length,cvv:mt.length,name:!!ct,doc:It.length}),alert("Preencha todos os dados do cartão antes de finalizar."),Et();return}var Pt=it.slice(0,2),Ot=it.length===4?"20"+it.slice(2):it.slice(2);Fn("calling Mercadopago.createToken",{numLen:Qn.length,month:Pt,year:Ot});try{Mercadopago.createToken({cardNumber:Qn,securityCode:mt,cardExpirationMonth:Pt,cardExpirationYear:Ot,cardholderName:ct,docType:"CPF",docNumber:It},function(zt,dt){if(Fn("createToken callback",{status:zt,hasId:!!(dt&&dt.id),err:dt&&dt.error}),zt===200||zt===201){if(kn){var Nt=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;Nt.call(kn,dt.id),kn.dispatchEvent(new Event("input",{bubbles:!0})),kn.dispatchEvent(new Event("change",{bubbles:!0}))}bt()}else{var Dt="Não foi possível validar os dados do cartão.";dt&&dt.cause&&dt.cause[0]&&dt.cause[0].description&&(Dt=dt.cause[0].description),alert(Dt),Et()}})}catch(zt){Fn("createToken exception",zt.message),Bt()}}w==="cartao"?Rt():setTimeout(bt,500)}}if(T){let n=function(e){if(e=e||0,e>30){t();return}var o=f.querySelector("#cep, .box-area-dados, #nome-completo_2");o||e>8?t():setTimeout(function(){n(e+1)},250)},t=function(){var e=cn(),o=tn.get("mm_user_email")||"";tn.remove("mm_checkout_mode"),typeof window._mmDraftDebug>"u"&&(window._mmDraftDebug=!1),Mt(e,o),Gn();var p=Un(),d=tn.get(P),E=d&&String(d).replace(/\D/g,"").length===8;E?ft("loading"):e&&typeof e.shipping=="number"&&e.shipping>0&&ft({value:e.shipping,name:e.shippingName||"",deadline:e.shippingDeadline||"",city:e.shippingCity||"",options:e.shippingOptions||[]});try{var A=Array.from(f.querySelectorAll("a, button")).find(function(V){var N=(V.textContent||"").toLowerCase();return N.indexOf("sem cadastro")!==-1&&V.offsetParent!==null});A&&!A.classList.contains("active")&&A.click()}catch{}yt();var _=tn.get(P);if(_&&_.length===8){var L=document.getElementById("mm-op-cep");L&&(L.value=zn(_),setTimeout(function(){ht(_)},400))}setTimeout(function(){if(!("ontouchstart"in window))for(var V=["mm-op-email","mm-op-nome","mm-op-cpf","mm-op-tel","mm-op-cep"],N=0;N<V.length;N++){var nn=document.getElementById(V[N]);if(nn&&!nn.value){nn.focus();break}}},350)};n()}if(q){document.documentElement.classList.remove("mm-cart-loading");var r=f.querySelector('input[placeholder*="numero do cart" i]');r&&(r.inputMode="numeric");var m=f.querySelector('input[placeholder*="000" i]');m&&(!m.maxLength||m.maxLength<=4)&&(m.inputMode="numeric")}setTimeout(function(){document.documentElement.classList.contains("mm-cart-loading")&&(console.warn("[mm-cart] failsafe: removing mm-cart-loading after 2s timeout"),document.documentElement.classList.remove("mm-cart-loading"))},2e3)})(),(function(){var P=window.location.pathname,R=/^\/login\/?$/.test(P),M=P.indexOf("/cliente/pedidos")===0;if(!R&&!M)return;var v="5511915299488",i='<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>';function s(b){return"https://api.whatsapp.com/send?phone="+v+"&text="+encodeURIComponent(b)}function u(b){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",b):b()}function g(){function b(z){var f=z.slice(0,14);if(f.length<=11)return f.length>9?f.slice(0,3)+"."+f.slice(3,6)+"."+f.slice(6,9)+"-"+f.slice(9):f.length>6?f.slice(0,3)+"."+f.slice(3,6)+"."+f.slice(6):f.length>3?f.slice(0,3)+"."+f.slice(3):f;var W=f.slice(0,2)+"."+f.slice(2,5)+"."+f.slice(5,8)+"/"+f.slice(8,12);return f.length>12&&(W+="-"+f.slice(12)),W}function T(z){if(!(!z||z.getAttribute("data-mm-mask"))){z.setAttribute("data-mm-mask","1"),z.setAttribute("maxlength","18"),z.setAttribute("inputmode","numeric"),z.addEventListener("input",function(){var W=b(this.value.replace(/\D/g,""));this.value!==W&&(this.value=W)});var f=z.form;f&&!f.getAttribute("data-mm-mask")&&(f.setAttribute("data-mm-mask","1"),f.addEventListener("submit",function(){z.value=b(z.value.replace(/\D/g,""))}))}}var q=0;(function z(){var f=document.getElementById("form-consulta-pedido"),W=document.getElementById("cpfcnpj");if(!f||!W)return++q<20?void setTimeout(z,250):void 0;T(W);var Z=f.querySelector(".title-area h2");if(Z&&!f.querySelector(".mm-cp-eyebrow")){var D=document.createElement("span");D.className="mm-cp-eyebrow",D.textContent="Acompanhe sua compra",Z.insertAdjacentElement("beforebegin",D)}function G(hn,Cn){if(hn){var Nn=hn.closest(".line")||hn.parentElement;if(!Nn.querySelector(".mm-cp-label")){var Dn=document.createElement("label");Dn.className="mm-cp-label",Dn.textContent=Cn,hn.id&&Dn.setAttribute("for",hn.id),Nn.insertAdjacentElement("afterbegin",Dn)}}}G(W,"CPF ou CNPJ"),G(document.getElementById("numero-pedido"),"Nº do pedido"),W.placeholder="000.000.000-00";var O=document.getElementById("numero-pedido");O&&(O.placeholder="Ex.: 0012606865731");var B=f.querySelector("button.button-login");if(B)for(var tn=0;tn<B.childNodes.length;tn++){var pn=B.childNodes[tn];pn.nodeType===3&&/consultar/i.test(pn.textContent)&&(pn.textContent=" Consultar meu pedido ")}var cn=f.querySelector(".cancel-consulta span");cn&&(cn.textContent="Voltar para login");var bn=document.getElementById("numero-pedido");if(bn&&!f.querySelector(".mm-cp-hint")){var On=document.createElement("span");On.className="mm-cp-hint",On.textContent="O número do pedido está no e‑mail de confirmação da compra.";var wn=bn.closest(".line")||bn.parentElement;wn.appendChild(On)}var Un=f.querySelector("form");if(Un&&!f.querySelector(".mm-cp-wa")){var In=document.createElement("div");In.className="mm-cp-wa",In.innerHTML='Não encontra os dados? <a href="'+s("Olá! Preciso de ajuda para consultar o meu pedido.")+'" target="_blank" rel="noopener">'+i+" Fale com a gente</a>",Un.insertAdjacentElement("afterend",In)}document.documentElement.classList.add("mm-consulta-on");var dn=document.querySelector(".login-holder"),Rn=document.querySelector(".page.page-login");if(dn&&Rn){var Tn=dn.querySelector(".login-header");if(Tn&&!Tn.querySelector(".mm-lg-eyebrow")){var Ln=document.createElement("span");Ln.className="mm-lg-eyebrow",Ln.textContent="Área do cliente";var Sn=Tn.querySelector("h2");Sn&&Sn.insertAdjacentElement("beforebegin",Ln)}var Mn=dn.querySelector(".social-login-area");if(Mn&&!dn.querySelector(".mm-lg-ou")){var Zn=document.createElement("div");Zn.className="mm-lg-ou",Zn.textContent="ou",Mn.insertAdjacentElement("beforebegin",Zn)}setTimeout(function(){try{var hn=dn.querySelector(".social-login-area .render-button");hn&&window.google&&google.accounts&&google.accounts.id&&(hn.innerHTML="",google.accounts.id.renderButton(hn,{theme:"outline",size:"large",shape:"pill",width:320,text:"continue_with",logo_alignment:"center"}))}catch{}setTimeout(function(){var Cn=dn.querySelector(".social-login-area"),Nn=dn.querySelector(".mm-lg-ou"),Dn=Cn&&Cn.offsetParent!==null&&Cn.querySelector("iframe");Dn||(Nn&&(Nn.style.display="none"),Cn&&(Cn.style.display="none"))},2e3)},1200);var zn=[].filter.call(dn.querySelectorAll("span, div, button"),function(hn){return/pessoa jur/i.test(hn.textContent)&&hn.textContent.length<60&&hn.children.length===0})[0];zn&&zn.classList.add("mm-lg-link");var Yn=document.querySelector(".footer-login");Yn&&[].forEach.call(Yn.querySelectorAll("p"),function(hn){/nunca postaremos/i.test(hn.textContent)&&hn.classList.add("mm-lg-nopost")}),document.documentElement.classList.add("mm-login-on")}})(),/#consultar?-?pedido/i.test(window.location.hash)&&setTimeout(function(){var z=document.getElementById("form-consulta-pedido"),f=document.getElementById("cpfcnpj");z&&z.scrollIntoView({behavior:"smooth",block:"center"}),f&&setTimeout(function(){f.focus()},500)},600)}var h={"recebimento-pedido":"Pedido recebido","confirmacao-pagamento":"Pagamento confirmado","emissao-nota":"Nota fiscal emitida",transporte:"Em transporte",entrega:"Entregue"};function C(){var b=document.querySelector(".detalhes-pedido");if(!(!b||b.getAttribute("data-mm-ped"))){b.setAttribute("data-mm-ped","1");var T=b.querySelector(".numero-pedido"),q=T?(T.textContent.match(/[\d]+/)||[""])[0]:"",z=b.querySelector(".resumo-data strong"),f=z?z.textContent.trim().split(" ")[0]:"",W=b.querySelectorAll(".item-historico.status-waiting");W.length&&W[0].classList.add("mm-atual");for(var Z='viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"',D={"recebimento-pedido":"<svg "+Z+'><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><path d="M3 6h18"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>',"confirmacao-pagamento":"<svg "+Z+'><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>',"emissao-nota":"<svg "+Z+'><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7z"/><path d="M15 2v5h5"/><path d="M8 13h8"/><path d="M8 17h5"/></svg>',transporte:"<svg "+Z+'><path d="M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2"/><path d="M15 18H9"/><path d="M19 18h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.62l-3.48-4.35A1 1 0 0 0 17.52 8H14"/><circle cx="17" cy="18" r="2"/><circle cx="7" cy="18" r="2"/></svg>',entrega:"<svg "+Z+'><path d="M3 10.18v8.82a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-8.82"/><path d="M2.5 10.5 12 3l9.5 7.5"/><path d="m9 15 2 2 4-4"/></svg>'},G=b.querySelectorAll(".item-historico"),O=0;O<G.length;O++){var B=G[O];if(!B.querySelector(".mm-step-dot")){var tn="";for(var pn in D)if(B.classList.contains(pn)){tn=D[pn];break}var cn=document.createElement("span");cn.className="mm-step-dot",cn.innerHTML=tn,B.insertAdjacentElement("afterbegin",cn);var bn=document.createElement("span");bn.className="mm-step-line",B.appendChild(bn)}}var On=b.querySelectorAll(".item-historico.status-success"),wn="Pedido recebido";if(On.length){var Un=On[On.length-1];for(var In in h)if(Un.classList.contains(In)){wn=h[In];break}}if(!document.getElementById("mm-ped-hero")&&q){var dn=document.createElement("div");dn.id="mm-ped-hero",dn.innerHTML='<div class="mm-ped-hero-info"><span class="mm-ped-eyebrow">Acompanhe sua compra</span><h1 class="mm-ped-num">Pedido #'+q+' <button type="button" class="mm-ped-copy" aria-label="Copiar número do pedido">copiar</button></h1><div class="mm-ped-meta">'+(f?"<span>Feito em "+f+"</span>":"")+'<span class="mm-ped-badge">'+wn+'</span></div></div><a class="mm-ped-hero-wa" target="_blank" rel="noopener" href="'+s("Olá! Gostaria de saber sobre o meu pedido #"+q+".")+'">'+i+" Falar sobre este pedido</a>",b.insertAdjacentElement("afterbegin",dn);var Rn=b.querySelector(".resumo-pagamento .resumo-total > span:first-child");Rn&&/resumo do pedido/i.test(Rn.textContent)&&(Rn.textContent="Total");var Tn=b.querySelector(".title-itens-pedido h3");Tn&&/itens do pedido/i.test(Tn.textContent)&&(Tn.textContent=" Itens do pedido ");for(var Ln=document.querySelectorAll(".main-content h1, .main-content h2, .main-content .title-user-area, .main-content > div"),Sn=0;Sn<Ln.length;Sn++){var Mn=Ln[Sn];if(!Mn.contains(b)&&/meus pedidos/i.test(Mn.textContent||"")&&(Mn.textContent||"").trim().length<40){Mn.classList.add("mm-ped-native-title");break}}var Zn=dn.querySelector(".mm-ped-copy");Zn.addEventListener("click",function(){var _n=this;try{navigator.clipboard.writeText(q).then(function(){_n.textContent="copiado ✓",_n.classList.add("mm-copiado"),setTimeout(function(){_n.textContent="copiar",_n.classList.remove("mm-copiado")},2e3)})}catch{}})}var zn=b.querySelector(".rastreio-area"),Yn=zn?zn.querySelector(".previsao-entrega .previsao"):null,hn=Yn?Yn.textContent.trim():"";if(hn){var Cn=b.querySelector(".item-historico.entrega");if(Cn&&!Cn.querySelector(".mm-step-prev")){var Nn=document.createElement("span");Nn.className="mm-step-prev",Nn.textContent="Previsão: "+hn,Cn.appendChild(Nn)}}var Dn=b.querySelector(".status-pagamento-pedido");if(Dn&&!zn&&!document.getElementById("mm-ped-entrega")){var Jn=document.createElement("div");Jn.id="mm-ped-entrega";for(var ut=null,An=b.querySelectorAll("a[href]"),En=0;En<An.length;En++){var Sn=(An[En].textContent||"")+" "+An[En].href;if(/rastre/i.test(Sn)&&!/politica/i.test(An[En].href)){ut=An[En];break}}var gn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4b664a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2"/><path d="M15 18H9"/><path d="M19 18h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.62l-3.48-4.35A1 1 0 0 0 17.52 8H14"/><circle cx="17" cy="18" r="2"/><circle cx="7" cy="18" r="2"/></svg>';ut?(Jn.classList.add("mm-tem-rastreio"),Jn.innerHTML=gn+'<span>Seu pedido está a caminho — <a href="'+ut.href+'" target="_blank" rel="noopener">acompanhe o rastreio aqui</a>.</span>'):Jn.innerHTML=gn+'<span>O código de rastreio aparece aqui assim que o pedido for despachado. Enquanto isso, acompanhe as etapas acima ou veja nossa <a href="/politica-de-entrega" target="_blank" rel="noopener">política de entrega</a>.</span>',Dn.insertAdjacentElement("afterend",Jn)}var tt=document.querySelector(".btn-comprar-novamente"),st=document.querySelector(".btn-ajuda-pedido"),jn=tt||st?(tt||st).parentElement:null;jn&&!jn.classList.contains("mm-ped-acoes")&&(jn.classList.add("mm-ped-acoes"),jn.parentElement!==b&&b.appendChild(jn));var et=document.querySelector("main.central-cliente");et&&et.children.length===1&&et.classList.add("mm-ped-center"),document.documentElement.classList.add("mm-ped-on")}}u(function(){try{R&&g(),M&&C()}catch(b){window.console&&console.warn&&console.warn("[mm-pedidos]",b)}})})()})();
